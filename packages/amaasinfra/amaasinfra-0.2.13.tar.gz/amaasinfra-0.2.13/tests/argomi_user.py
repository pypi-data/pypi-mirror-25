...
from amaasinfra.authorization.argomi_user import ArgomiUser
from amaasinfra.authorization.token_utils import TokenAttribute

class ArgomiUserTest(unittest.TestCase):
    def setUp(self):
        pass
    ...
    @patch('amaasinfra.authorization.argomi_user.unpack_token')
    @patch('amaasinfra.authorization.argomi_user.AssetManagerRelationship')
    def testCheckAmidPermissions(self, mock_relationship, mock_unpack_token):
        ...
        errors = user.check_asset_manager_permissions([102])
