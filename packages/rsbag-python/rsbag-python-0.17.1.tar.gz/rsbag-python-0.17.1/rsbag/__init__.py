# ============================================================
#
# Copyright (C) 2013, 2014, 2015, 2016, 2017 Jan Moringen <jmoringe@techfak.uni-bielefeld.de>
#
...
class Bag (Connection):
    def __init__(self, file, channels = None, rsbag = None, converters = None):
        if rsbag is None:
            raise RuntimeError('rsbag keyword argument not supplied')
...
def openBag(file, channels = None, rsbag = None, converters = None):
    """
