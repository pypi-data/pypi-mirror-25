...
swmmobject = PySWMM('./TestModel4_toolkitUnits.inp',\
                    './TestModel4_toolkitUnits.rpt',\
                    './TestModel4_toolkitUnits.out')
...
if ShowFig == True:
    ...
    ani.save("TestModel4_toolkitUnits.mp4", fps=20,dpi=170, bitrate=50000)
