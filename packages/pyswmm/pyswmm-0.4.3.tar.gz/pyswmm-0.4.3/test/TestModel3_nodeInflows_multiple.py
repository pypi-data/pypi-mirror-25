...
def data_gen(t=0):
    ...
    while(True):
        if i >= 80:
            print i
            swmmobject.setNodeInflow('J1',1)
            swmmobject.setNodeInflow('J2',1)
...
def run(t):
    ...
    xdata.append(t)
    new_y = swmmobject.getLinkResult('C2',LinkResults.newFlow.value)
    ydata.append(new_y)
    
    new_y2 = swmmobject.getNodeResult('J1',NodeResults.newLatFlow.value)
