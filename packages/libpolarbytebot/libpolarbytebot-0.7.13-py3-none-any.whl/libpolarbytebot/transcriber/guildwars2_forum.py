...
if __name__ == '__main__':
    ...
    print(guildwars2_forum_parse('https://en-forum.guildwars2.com/discussion/2704/spellbreaker-specialization-updates-for-the-path-of-fire-launch#latest'))
