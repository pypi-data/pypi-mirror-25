...
__all__ = ['findall_forum_urls', 'findall_forum_urls_mentions', 'forum_parse']
...
def forum_parse(url, parse_refs=True):
    ...
    all_links = findall_forum_urls(content)
    if parse_refs and all_links != []:
        all_links = set(all_links)
        for link in all_links:
            post.referenced_posts.append(forum_parse(link, parse_refs=False))
...
if __name__ == '__main__':
    forum_parse('https://us.battle.net/forums/en/overwatch/topic/20759376545#post-1')
