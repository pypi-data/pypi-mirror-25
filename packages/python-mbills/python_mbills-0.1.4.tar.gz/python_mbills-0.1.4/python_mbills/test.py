...
try:
    #transaction_id, payment_token_number, status = api.create_new_sale(Decimal(1), 'Some purpose here', capture=False)
    #print("Payment token number: %s" % payment_token_number)

    transaction_id = '235253'
    api.capture_sale(transaction_id, capture_amount=Decimal(1))
