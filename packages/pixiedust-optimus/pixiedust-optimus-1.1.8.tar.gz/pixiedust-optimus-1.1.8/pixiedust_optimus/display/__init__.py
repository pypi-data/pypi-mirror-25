...
from pixiedust_optimus.utils.environment import Environment as PD_Environment
...
def display(entity, **kwargs):
    with warnings.catch_warnings():
        ...
        try:
            ...
            from pixiedust_optimus.utils.sparkJobProgressMonitor import progressMonitor
            if progressMonitor:
