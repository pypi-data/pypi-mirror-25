...
class LightMode2(ISerializable):
    ...
    def __init__(self):
        self.mode1   = LightMode()
        self.mode2   = LightMode()
    ...
    def toArray(self):
        dataArray = bytearray()
        dataArray.extend(self.mode1.toArray())
        dataArray.extend(self.mode2.toArray())
        return dataArray
    ...
    def parse(cls, dataArray):
        ...
        indexStart = 0;        indexEnd = LightMode.getSize();  data.mode1   = LightMode.parse(dataArray[indexStart:indexEnd])
        indexStart = indexEnd; indexEnd += LightMode.getSize(); data.mode2   = LightMode.parse(dataArray[indexStart:indexEnd])
        return data
...
class LightModeColor(ISerializable):
    ...
    def parse(cls, dataArray):
        ...
        indexStart = indexEnd; indexEnd = 1;                        data.mode       = unpack('<B', dataArray[indexStart:indexEnd])
...
class LightModeColor2(ISerializable):
    ...
    def __init__(self):
        self.modeColor1     = LightModeColor()
        self.modeColor2     = LightModeColor()
    ...
    def toArray(self):
        dataArray = bytearray()
        dataArray.extend(self.modeColor1.toArray())
        dataArray.extend(self.modeColor2.toArray())
        return dataArray
    ...
    def parse(cls, dataArray):
        ...
        indexStart = 0;        indexEnd = LightModeColor.getSize();  data.modeColor1   = LightModeColor.parse(dataArray[indexStart:indexEnd])
        indexStart = indexEnd; indexEnd += LightModeColor.getSize(); data.modeColor2   = LightModeColor.parse(dataArray[indexStart:indexEnd])
        return data
...
class LightEvent(ISerializable):
    ...
    def parse(cls, dataArray):
        ...
        data.event  = LightMode(data.event)
        data.colors = Colors(data.colors)
...
class LightEvent2(ISerializable):
    ...
    def __init__(self):
        self.event1     = LightEvent()
        self.event2     = LightEvent()
    ...
    def toArray(self):
        dataArray = bytearray()
        dataArray.extend(self.event1.toArray())
        dataArray.extend(self.event2.toArray())
        return dataArray
    ...
    def parse(cls, dataArray):
        ...
        indexStart = 0;        indexEnd = LightEvent.getSize();  data.event1   = LightEvent.parse(dataArray[indexStart:indexEnd])
        indexStart = indexEnd; indexEnd += LightEvent.getSize(); data.event2   = LightEvent.parse(dataArray[indexStart:indexEnd])
        return data
...
class LightEventColor2(ISerializable):
    ...
    def __init__(self):
        self.eventColor1   = LightEventColor()
        self.eventColor2   = LightEventColor()
    ...
    def toArray(self):
        dataArray = bytearray()
        dataArray.extend(self.eventColor1.toArray())
        dataArray.extend(self.eventColor2.toArray())
        return dataArray
    ...
    def parse(cls, dataArray):
        ...
        indexStart = 0;        indexEnd = LightEventColor.getSize();  data.eventColor1   = LightEventColor.parse(dataArray[indexStart:indexEnd])
        indexStart = indexEnd; indexEnd += LightEventColor.getSize(); data.eventColor2   = LightEventColor.parse(dataArray[indexStart:indexEnd])
        return data
...
class UpdateLookupTarget(ISerializable):
    ...
    def parse(cls, dataArray):
        ...
        data.deviceType, = unpack('<H', dataArray)
...
class LinkEvent(ISerializable):
    ...
    def parse(cls, dataArray):
        ...
        data.eventLink = EventLink(data.modeLink)
