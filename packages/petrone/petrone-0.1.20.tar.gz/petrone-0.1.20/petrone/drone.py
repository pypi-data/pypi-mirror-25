            ...
            if len(self._devices) > 0:
                for i in range(len(self._devices)):
                    ...
                    if self._flagShowLogMessage:
                        ...
                        print(Fore.GREEN + "Compare {0} / {1} / {2}".format(deviceName.encode()), self._devices[i].name.encode(), (deviceName == self._devices[i].name)) + Style.RESET_ALL)
