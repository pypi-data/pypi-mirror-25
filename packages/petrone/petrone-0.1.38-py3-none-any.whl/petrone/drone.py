...
# BaseFunctions Start
    ...
    def _printLog(self, message):
        ...
        if self._flagShowLogMessage:
            print(Fore.GREEN + "[{0:10.3}] {1}]".format((time.time() - self.timeStartProgram), message) + Style.RESET_ALL)
    ...
    def _printError(self, message):
        ...
        if self._flagShowErrorMessage:
            print(Fore.RED + "[{0:10.3}] {1}]".format((time.time() - self.timeStartProgram), message) + Style.RESET_ALL)
