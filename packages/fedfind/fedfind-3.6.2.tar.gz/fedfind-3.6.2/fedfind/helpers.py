...
def get_current_release(branched=False):
    ...
    """
    # HACK HACK HACK: pkgdb has been disabled, and PDC can't yet
    # distinguish between branched and stable. So for now we're just
    # hard coding the current 'right answers'.
    if branched:
        return 27
    else:
        return 26
