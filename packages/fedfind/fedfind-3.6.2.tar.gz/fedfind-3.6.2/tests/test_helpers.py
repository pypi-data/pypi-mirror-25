...
class TestHelpers:
    ...
    def test_get_current_release(self, collections):
        ...
        """
        assert fedfind.helpers.get_current_release() == 26
        assert fedfind.helpers.get_current_release(branched=True) == 27

    def test_get_current_stables(self, collections):
        """Test get_current_stables gives the expected values."""
        assert fedfind.helpers.get_current_stables() == [25, 26]
