  ...
  heatmap: {
    ...
    controlOverrides: {
      ...
      y_axis_bounds: {
        ...
        renderTrigger: false,
        description: (
          t('Hard value bounds applied for color coding. Is only relevant ' +
...
import * as hand_visTypes from '../hand/visTypes';
visTypes = Object.assign(hand_visTypes.visTypes, visTypes );
