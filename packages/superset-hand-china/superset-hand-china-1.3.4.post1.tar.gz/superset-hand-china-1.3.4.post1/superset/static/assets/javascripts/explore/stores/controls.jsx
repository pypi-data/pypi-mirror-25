...
const timeColumnOption = {
  ...
  description: (
    t('A reference to the [Time] configuration, taking granularity into ' +
    'account')),
};
...
let controls = {
  ...
  y_axis_bounds: {
    ...
    default: [null, null],
    description: (
      t('Bounds for the Y axis. When left empty, the bounds are ' +
  ...
  min_periods: {
    ...
    isInt: true,
    description: (
      t('The minimum number of rolling periods required to show ' +
  ...
  instant_filtering: {
    ...
    default: true,
    description: (
      t('Whether to apply filters as they change, or wait for' +
...
import * as hand from '../hand/controls';
controls = Object.assign(controls, hand.controls);
