...
OAUTH2_CHECK_TOKEN_URL = 'http://apistage.huilianyi.com/api/check_token'
...
# SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123123@172.30.28.125:3306/superset18_perm'
