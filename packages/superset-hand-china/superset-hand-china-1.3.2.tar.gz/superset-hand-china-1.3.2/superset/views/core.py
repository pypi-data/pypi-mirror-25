...
class SliceModelView(SupersetModelView, DeleteMixin, SupersetFilter):  # noqa
    ...
    edit_columns = [
        'slice_name', 'description', 'subtitle', 'subtitleAble', 'viz_type', 'dashboards',
...
class DashboardModelView(SupersetModelView, DeleteMixin):  # noqa
    ...
    edit_columns = [
        'dashboard_title', 'slug', 'slices', 'only_download', 'position_json', 'css', 'theme',
