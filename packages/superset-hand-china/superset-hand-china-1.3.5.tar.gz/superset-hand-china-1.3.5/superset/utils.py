...
from superset.hand.interceptor import intercept
...
def parse_human_datetime(s):
    ...
    try:
        ...
        try:
            ...
            raise ValueError(__("Couldn't parse date string [") + s + "]")
    return dttm
...
def validate_json(obj):
    if obj:
        try:
            ...
            raise SupersetException(__("JSON is not valid"))
