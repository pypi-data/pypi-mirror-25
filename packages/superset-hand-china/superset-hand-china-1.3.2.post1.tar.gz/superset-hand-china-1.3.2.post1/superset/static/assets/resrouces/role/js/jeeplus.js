...
//打开对话框(添加修改)
function openDialog(title, url, width, height, target, refresh) {
	...
	top.layer.open({
		...
		yes: function (index, layero) {
			...
			if (target) {
				...
				top_iframe = top;//获取当前active的tab的iframe 
			}
			//  inputForm.attr("target",'/roles/list');//表单提交成功后，从服务器返回的url在当前tab中展示
