    ...
    return (
      <div>
        <Row className="space-1">
          <Col md={6}>
            <label className="control-label">metric1:</label>
            <Select
              multi={false}
              simpleValue
              placeholder="Select Metric1"
              options={colChoices}
              clearable={false}
          ...
          <Col md={6}>
            <label className="control-label">metric2:</label>
            <Select
              multi={false}
              simpleValue
              placeholder="Select Metric2"
              options={colChoices}
              clearable={false}
        ...
        <Row className="space-1">
          <Col md={6}>
            ...
            <input
              ...
              type="text"
              placeholder="compare expr(x, y => metric1, metric2)"
