...
class CssEditor extends React.PureComponent {
      ...
      return (
        <div style={{ zIndex: 10 }}>
          ...
          <Select
            ...
            placeholder="Choose Slice Theme"
  ...
  renderResizeSelector(dashboard) {
    if (this.props.sliceResizeAble) {
      return (
        <div style={{ zIndex: 10 }}>
          <h5>The window changes the size to refresh the slice</h5>
          <Select
            options={this.props.sliceResizeAble.map((o) => ({ value: o, label: o }))}
            placeholder="The window changes the size to refresh the slice"
