  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row className="space-1">
          <Col md={6}>
            <label className="control-label">navigate_Type:</label>
            <Select
              multi={false}
              simpleValue
              placeholder="Select Navigate Type"
          ...
          <Col md={6}>
            <label className="control-label">Open_Type:</label>
            <Select
              multi={false}
              simpleValue
              placeholder="Select Open Type"
        ...
        <Row className="space-1">
          { this.state.navigate_type === 'slice' &&
            <Col md={6}>
              <label className="control-label">Slice:</label>
              <Select
                multi={false}
                simpleValue
          ...
          { this.state.navigate_type === 'dashboard' &&
            <div>
              <Col md={6}>
                <label className="control-label">Dashboard:</label>
                <Select
                  multi={false}
                  simpleValue
              ...
              <Col md={5}>
                <label className="control-label">Is_Filter_Frozen:</label>
                <Select
                  multi={false}
                  simpleValue
                  placeholder="Is Filter Frozen"
