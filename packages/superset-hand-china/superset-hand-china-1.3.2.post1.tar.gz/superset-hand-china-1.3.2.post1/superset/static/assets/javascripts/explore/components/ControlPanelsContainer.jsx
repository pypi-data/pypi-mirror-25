      ...
      <div className="scrollbar-container">
        <div className="scrollbar-content">
          ...
          {this.sectionsToRender().map(section => (
            ['baseStyle', 'condition', 'compare', 'navigator', 'agGrid', 'agGrid_pivot',
             'baseSetting', 'setDefaultValue', 'setDateValue',
             'setDefaultValueFilterTree', 'cascadeSetting'].indexOf(section.label) === -1 &&
            <ControlPanelSection
              key={section.label}
              label={section.label}
