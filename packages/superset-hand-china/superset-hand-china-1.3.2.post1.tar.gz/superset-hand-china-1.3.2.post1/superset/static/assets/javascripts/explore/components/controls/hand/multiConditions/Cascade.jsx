    ...
    return (
      <div>
        <Row className="space-1">
          ...
          {this.state.level > 1 &&
            <Col md={6}>
              <label className="control-label">ParentNode:</label>
              <Select
                multi={false}
                simpleValue
                placeholder="Select ParentNode"
        ...
        <Row className="space-1">
          <Col md={11}>
            <label className="control-label">ChildNodes:</label>
            <Select
              multi
              simpleValue
              placeholder="Select ChildNodes"
