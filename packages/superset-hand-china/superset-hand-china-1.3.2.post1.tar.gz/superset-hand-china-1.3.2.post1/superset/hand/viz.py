...
class ChinaMapViz(BaseViz):
    ...
    verbose_name = "Chinaecharts_china_map Map"
    is_timeseries = False
...
class echartsChinaCityMapMigrationViz(BaseViz):
    ...
    verbose_name = "echarts china city map migration"
    is_timeseries = False
