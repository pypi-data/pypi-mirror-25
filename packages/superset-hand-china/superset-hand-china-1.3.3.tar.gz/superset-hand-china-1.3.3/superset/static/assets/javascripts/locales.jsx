...
function getTranslations() {
  const ctxEn = require('../../translations/en/LC_MESSAGES/messages.po');
  const ctxZh = require('../../translations/zh/LC_MESSAGES/messages.po');
  const translations = {};
  const lang = getLanguage();
  translations['en'] = ctxEn;
  translations['zh'] = ctxZh;
  return translations[lang];
  // const lang = getLanguage();
  // const ctx = require(`../../translations/${lang}/LC_MESSAGES/messages.po`);
  // const translations = {};
  // translations[lang] = ctx;
  // return translations[lang];
}
