...
SERVER_ADDRESS = 'superset18-staging.cloud.saas.hand-china.com'
SEND_MAIL_LOG = BASE_DIR + '/../../supersetLog/mail.log'

# The SQLAlchemy connection string.
# SQLALCHEMY_DATABASE_URI = 'sqlite:///' + os.path.join(DATA_DIR, 'superset.db')
# SQLALCHEMY_DATABASE_URI = 'mysql://myapp@localhost/myapp'
# SQLALCHEMY_DATABASE_URI = 'postgresql://root:password@localhost/myapp'
SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123123@localhost:3306/superset18'
# SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123123@172.30.238.33:3306/superset18_perm'
# SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123456@192.168.248.1:3306/superset'
...
FILENAME = BASE_DIR + '/../../supersetLog/superset.log'
ROLLOVER = 'midnight'
INTERVAL = 1
BACKUP_COUNT = 30
