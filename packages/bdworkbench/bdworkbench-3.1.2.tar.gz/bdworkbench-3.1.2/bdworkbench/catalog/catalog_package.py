...
class CatalogPackage(SubCommand):
    ...
    def run(self, pargs):
        ...
        if imageDict.has_key('import_url'):
            image = 'undefined'
            imageMd5 = 'undefined'
        ...
        elif imageDict.has_key('source_file') and delivDict.has_key('image'):
            image = delivDict['image']
            ...
            registryAuthEnabled = 'undefined'
            contentTrustEnabled = 'undefined'
        elif imageDict.has_key('registry_url'):
            image = 'undefined'
            imageMd5 = 'undefined'
            imageOS = delivDict['imageOS']
            imageOSMajor = delivDict['imageOSMajor']
            imageName = imageDict['image_name']
            registryAuthEnabled = 'true' if imageDict['registry_auth_enabled'] else 'false'
            contentTrustEnabled = 'true' if imageDict['content_trust_enabled'] else 'false'
        else:
        ...
        if entryDict.has_key('distro_dependency'):
            independent = 'false'
        else:
            independent = 'true'
        ...
        pkgScript = os.path.join(baseDir, 'appbuild', 'bundle', 'package.sh')
