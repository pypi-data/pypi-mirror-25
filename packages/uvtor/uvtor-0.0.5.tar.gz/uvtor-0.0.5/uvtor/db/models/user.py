...
class User(BaseModel):
    id = postgres_ext.BigIntegerField(primary_key=True)

    date_joined = postgres_ext.DateTimeField(null=True)
    email = postgres_ext.CharField(null=True, unique=True)
    first_name = postgres_ext.CharField(null=True)
    is_active = postgres_ext.BooleanField(null=True)
    is_superuser = postgres_ext.BooleanField(null=True)
