...
class NHDPlusExtractor(object):
    ...
    def plot_HUC8(self,
        ...
        pyplot.close()
        pyplot.clf()
x = NHDPlusExtractor(destination="c:/Data")
x.download_decompress(vpu='11',filename='NHDSnapshot')
VPU='11'
DA = x.VPU_to_DA[VPU]
destination = '{}/NHDPlus{}'.format(x.destination, DA)
NHDPlus = '{}/NHDPlus{}'.format(destination, VPU)
its = NHDPlus, 'NHDSnapshot', 'Hydrography', 'NHDFlowline.shp'
sourceflowlinefile = '{}/{}/{}/{}'.format(*its)
x.extract_flowlines(sourceflowlinefile,'c:/Data/Poster/Poster',11050003)
