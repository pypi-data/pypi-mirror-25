...
from relevance.engine import SearchEngineError
...
class ElasticSearchEngine(SearchEngine, MappingEngine, IngestionEngine):
    """
    ...
    def search(self, search: Search) -> ResultSet:
        ...
        try:
            ...
            raise SearchEngineError(str(ex))
    ...
    def output_status(self) -> dict:
        ...
        try:
            response = requests.get(url).json()['_all']['total']
        except Exception as ex:
            raise SearchEngineError(str(ex))
