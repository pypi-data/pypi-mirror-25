...
BASE_GDAX_URL = 'https://api.gdax.com'
...
class GDAX(object):
  ...
  '''
  def __init__(self, key=None, b64secret=None, passphrase=None, api_url=BASE_GDAX_URL):
  ...
  def get_product_order_book(self, product_id='BTC-USD', level=1):
    '''
  ...
  def get_product_trades(self, product_id='BTC-USD'):
    '''
  ...
  def get_product_historic_rates(self, product_id='BTC-USD', start=None, end=None,
                                 granularity=None):
    '''
  ...
  def get_product_24hr_stats(self, product_id='BTC-USD'):
    '''
