...
def corrMatGen(output_size, input_size=0, molecularFormula = '' ):
    ...
    %output_size: length of output MDV (truncated length) (number of values in measured MID
...
def stepCV(CV,columns):
    ...
    specify columns: number of columns for correction matrix (CM) i.e. input_size
