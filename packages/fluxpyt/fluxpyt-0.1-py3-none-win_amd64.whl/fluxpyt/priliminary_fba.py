...
def priliminary_fba(model_metabolite,stoich_matrix):
    '''
    model_metabolite:
        model_metabolite[0] = reaction ids
        model_metabolite[1] = reaction formulae
        model_metabolite[2] = rate #mostly ignored
        model_metabolite[3] = basis #used as inputs to perform fba
        model_metabolite[4] = deviation in the basis fluxes
    This function will return the maximum and minimum values of fluxes with respect to the basis values.
    Objective function = minimization of total fluxes
    '''
...
def flux_range(rxnId,model_metabolite,stoich_matrix,bounds):
    ...
    '''calculate minimum and maximum value a flux can take'''
#    rxnId = 'vLAC_out1'
