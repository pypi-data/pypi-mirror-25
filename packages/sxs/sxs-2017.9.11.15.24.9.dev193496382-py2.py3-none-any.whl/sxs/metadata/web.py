...
def create_web_files(catalog_root_directory='.', relative_directory_path=None,
    ...
    for directory in public_dirs:
        replacement = os.path.join(relative_directory_path, os.relpath(directory, catalog_root_directory))
        print(replacement, relative_directory_path, os.relpath(directory, catalog_root_directory))
