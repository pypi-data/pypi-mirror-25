...
""":class:`TestIStoragePortion` class."""



__all__ = ["TestIStoragePortion"]
...
class TestIStoragePortion(unittest.TestCase):
    "Test of :class:`.IStoragePortion` provided interface."
    ...
    def setUp(self):
        ...
        ConfigurationTestUtils._setUpConfigurationComponent()
        self.__storagePortion = \
            ConfigurationTestUtils._mockInterfaceAccessor.getComponentInterface(IStorage).createStoragePortion()



    def tearDown(self):
        ConfigurationTestUtils._removeStorageDirContent()
