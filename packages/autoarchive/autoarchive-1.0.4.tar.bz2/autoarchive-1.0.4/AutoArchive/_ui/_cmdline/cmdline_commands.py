...
""":class:`CmdlineCommands` and :class:`CmdlineCommandsUtils` static classes."""



__all__ = ["CmdlineCommands", "CmdlineCommandsUtils"]
...
class CmdlineCommandsUtils(metaclass = ABCMeta):
    ...
    def isExistingCommand(cls, commandName):
        """Check whether a command with name ``commandName`` does exists in :class:`CmdlineCommandsUtils`.
