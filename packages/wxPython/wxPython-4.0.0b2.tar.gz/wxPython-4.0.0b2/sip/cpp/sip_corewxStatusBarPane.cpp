...
extern "C" {static void assign_wxStatusBarPane(void *, SIP_SSIZE_T, const void *);}
static void assign_wxStatusBarPane(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxStatusBarPane *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxStatusBarPane *>(sipSrc);
}
