...
static void release_wxStaticText(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxStaticText[] = {{84, 255, 1}};
...
static PyMethodDef methods_wxStaticText[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxStaticText_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxStaticText_SendDestroyEvent)},
