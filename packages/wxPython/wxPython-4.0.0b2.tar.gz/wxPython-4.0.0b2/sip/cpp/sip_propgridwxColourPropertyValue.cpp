...
static void release_wxColourPropertyValue(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxColourPropertyValue(void *, SIP_SSIZE_T, const void *);}
static void assign_wxColourPropertyValue(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxColourPropertyValue *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxColourPropertyValue *>(sipSrc);
}
