...
static void release_wxImageFileProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxImageFileProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxImageFileProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxImageFileProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxImageFileProperty *>(sipSrc);
}
