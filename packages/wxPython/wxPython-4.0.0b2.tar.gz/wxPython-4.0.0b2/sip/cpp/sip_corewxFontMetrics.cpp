...
extern "C" {static void assign_wxFontMetrics(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFontMetrics(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFontMetrics *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFontMetrics *>(sipSrc);
}
