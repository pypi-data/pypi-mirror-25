...
extern "C" {static void assign_wxRichTextAttrArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextAttrArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextAttrArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextAttrArray *>(sipSrc);
}
