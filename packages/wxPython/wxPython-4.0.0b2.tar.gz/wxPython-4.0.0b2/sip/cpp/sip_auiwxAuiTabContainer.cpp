...
static void release_wxAuiTabContainer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxAuiTabContainer(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiTabContainer(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiTabContainer *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiTabContainer *>(sipSrc);
}
