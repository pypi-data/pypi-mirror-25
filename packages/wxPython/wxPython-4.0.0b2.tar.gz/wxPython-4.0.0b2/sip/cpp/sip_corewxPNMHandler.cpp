...
static void release_wxPNMHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPNMHandler[] = {{251, 255, 1}};
...
static PyMethodDef methods_wxPNMHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetImageCount), (PyCFunction)meth_wxPNMHandler_DoGetImageCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPNMHandler_DoGetImageCount)},
