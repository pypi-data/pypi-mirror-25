...
static void release_wxPGTextCtrlEditor(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxPGTextCtrlEditor(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGTextCtrlEditor(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGTextCtrlEditor *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGTextCtrlEditor *>(sipSrc);
}
