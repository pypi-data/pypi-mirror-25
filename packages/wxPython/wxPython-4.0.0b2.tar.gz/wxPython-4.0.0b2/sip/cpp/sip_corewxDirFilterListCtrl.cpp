...
static void release_wxDirFilterListCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxDirFilterListCtrl[] = {{51, 255, 1}};
...
static PyMethodDef methods_wxDirFilterListCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxDirFilterListCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDirFilterListCtrl_SendDestroyEvent)},
