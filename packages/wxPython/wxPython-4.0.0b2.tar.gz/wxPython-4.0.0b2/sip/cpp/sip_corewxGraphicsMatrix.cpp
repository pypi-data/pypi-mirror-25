...
extern "C" {static void assign_wxGraphicsMatrix(void *, SIP_SSIZE_T, const void *);}
static void assign_wxGraphicsMatrix(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxGraphicsMatrix *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxGraphicsMatrix *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxGraphicsMatrix[] = {{216, 255, 1}};
