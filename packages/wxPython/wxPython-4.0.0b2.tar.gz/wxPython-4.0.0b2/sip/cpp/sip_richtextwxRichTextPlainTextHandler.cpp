...
static void release_wxRichTextPlainTextHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextPlainTextHandler(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextPlainTextHandler(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextPlainTextHandler *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextPlainTextHandler *>(sipSrc);
}
