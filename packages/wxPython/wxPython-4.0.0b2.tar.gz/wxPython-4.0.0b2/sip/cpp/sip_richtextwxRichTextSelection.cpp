...
extern "C" {static void assign_wxRichTextSelection(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextSelection(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextSelection *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextSelection *>(sipSrc);
}
