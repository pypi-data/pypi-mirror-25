...
static void release_wxFontProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxFontProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFontProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFontProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFontProperty *>(sipSrc);
}
