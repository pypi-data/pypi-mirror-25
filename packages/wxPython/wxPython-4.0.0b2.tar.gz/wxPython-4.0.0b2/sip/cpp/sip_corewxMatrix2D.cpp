...
extern "C" {static void assign_wxMatrix2D(void *, SIP_SSIZE_T, const void *);}
static void assign_wxMatrix2D(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxMatrix2D *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxMatrix2D *>(sipSrc);
}
