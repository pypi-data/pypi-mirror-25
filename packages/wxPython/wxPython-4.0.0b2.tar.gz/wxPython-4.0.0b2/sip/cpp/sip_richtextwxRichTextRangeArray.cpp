...
extern "C" {static void assign_wxRichTextRangeArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextRangeArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextRangeArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextRangeArray *>(sipSrc);
}
