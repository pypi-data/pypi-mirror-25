...
extern "C" {static void assign_wxNativeFontInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxNativeFontInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxNativeFontInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxNativeFontInfo *>(sipSrc);
}
