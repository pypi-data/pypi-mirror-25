...
extern "C" {static void assign_wxGraphicsObject(void *, SIP_SSIZE_T, const void *);}
static void assign_wxGraphicsObject(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxGraphicsObject *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxGraphicsObject *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxGraphicsObject[] = {{349, 255, 1}};
