...
extern "C" {static void assign_wxSystemOptions(void *, SIP_SSIZE_T, const void *);}
static void assign_wxSystemOptions(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxSystemOptions *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxSystemOptions *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxSystemOptions[] = {{349, 255, 1}};
