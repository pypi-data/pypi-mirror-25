...
extern "C" {static void assign_wxFileTypeInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFileTypeInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFileTypeInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFileTypeInfo *>(sipSrc);
}
