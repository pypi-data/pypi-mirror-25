 ...
 ::wxObject* sipwxValidator::Clone() const
{
    ...
    extern  ::wxObject* sipVH__core_114(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_114(sipGILState, 0, sipPySelf, sipMeth);
}
...
static void release_wxValidator(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxValidator[] = {{142, 255, 1}};
...
static PyMethodDef methods_wxValidator[] = {
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxValidator_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxValidator_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxValidator_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxValidator_TryBefore)},
