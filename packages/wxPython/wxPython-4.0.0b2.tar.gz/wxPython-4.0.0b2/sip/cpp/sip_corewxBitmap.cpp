...
extern "C" {static void assign_wxBitmap(void *, SIP_SSIZE_T, const void *);}
static void assign_wxBitmap(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxBitmap *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxBitmap *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxBitmap[] = {{199, 255, 1}};
