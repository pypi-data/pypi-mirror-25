...
extern "C" {static void assign_wxPGPaintData(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGPaintData(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGPaintData *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGPaintData *>(sipSrc);
}
