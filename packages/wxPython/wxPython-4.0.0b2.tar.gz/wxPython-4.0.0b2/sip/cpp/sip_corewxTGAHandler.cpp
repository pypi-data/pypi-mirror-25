...
static void release_wxTGAHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxTGAHandler[] = {{251, 255, 1}};
...
static PyMethodDef methods_wxTGAHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetImageCount), (PyCFunction)meth_wxTGAHandler_DoGetImageCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTGAHandler_DoGetImageCount)},
