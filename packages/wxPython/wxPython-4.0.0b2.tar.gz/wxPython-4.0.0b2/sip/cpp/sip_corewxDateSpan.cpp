...
extern "C" {static void assign_wxDateSpan(void *, SIP_SSIZE_T, const void *);}
static void assign_wxDateSpan(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxDateSpan *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxDateSpan *>(sipSrc);
}
