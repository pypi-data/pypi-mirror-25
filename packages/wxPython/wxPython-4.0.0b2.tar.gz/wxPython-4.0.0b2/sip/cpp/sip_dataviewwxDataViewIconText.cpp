...
extern "C" {static void assign_wxDataViewIconText(void *, SIP_SSIZE_T, const void *);}
static void assign_wxDataViewIconText(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxDataViewIconText *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxDataViewIconText *>(sipSrc);
}
