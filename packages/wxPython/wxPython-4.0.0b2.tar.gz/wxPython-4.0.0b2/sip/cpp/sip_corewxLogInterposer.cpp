...
static void release_wxLogInterposer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxLogInterposer[] = {{295, 255, 1}};


static PyMethodDef methods_wxLogInterposer[] = {
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogInterposer_DoLogRecord, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogInterposer_DoLogRecord)},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogInterposer_DoLogText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogInterposer_DoLogText)},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogInterposer_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogInterposer_DoLogTextAtLevel)}
};
