...
extern "C" {static void assign_wxAuiPaneInfoPtrArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiPaneInfoPtrArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiPaneInfoPtrArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiPaneInfoPtrArray *>(sipSrc);
}
