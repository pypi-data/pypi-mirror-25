...
extern "C" {static void assign_wxAuiNotebookPage(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiNotebookPage(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiNotebookPage *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiNotebookPage *>(sipSrc);
}
