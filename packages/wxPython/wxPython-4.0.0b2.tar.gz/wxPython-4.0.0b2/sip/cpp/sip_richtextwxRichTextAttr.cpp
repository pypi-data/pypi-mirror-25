...
extern "C" {static void assign_wxRichTextAttr(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextAttr(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextAttr *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextAttr *>(sipSrc);
}
