...
extern "C" {static void assign_wxPropertyGridIteratorBase(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPropertyGridIteratorBase(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPropertyGridIteratorBase *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPropertyGridIteratorBase *>(sipSrc);
}
