...
static void release_wxPGProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxPGProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGProperty *>(sipSrc);
}
