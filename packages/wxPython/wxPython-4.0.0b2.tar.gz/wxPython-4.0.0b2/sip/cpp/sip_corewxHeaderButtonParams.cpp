...
extern "C" {static void assign_wxHeaderButtonParams(void *, SIP_SSIZE_T, const void *);}
static void assign_wxHeaderButtonParams(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxHeaderButtonParams *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxHeaderButtonParams *>(sipSrc);
}
