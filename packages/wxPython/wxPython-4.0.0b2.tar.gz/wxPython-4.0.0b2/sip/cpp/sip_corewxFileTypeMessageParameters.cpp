 ...
 ::wxString sipwxFileType_MessageParameters::GetParamValue(const  ::wxString& name) const
{
    ...
    extern  ::wxString sipVH__core_204(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&);

    return sipVH__core_204(sipGILState, 0, sipPySelf, sipMeth, name);
}
...
static void release_wxFileType_MessageParameters(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxFileType_MessageParameters(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFileType_MessageParameters(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFileType::MessageParameters *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFileType::MessageParameters *>(sipSrc);
}
