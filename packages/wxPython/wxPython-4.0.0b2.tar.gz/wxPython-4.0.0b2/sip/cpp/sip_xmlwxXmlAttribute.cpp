...
static void release_wxXmlAttribute(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxXmlAttribute(void *, SIP_SSIZE_T, const void *);}
static void assign_wxXmlAttribute(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxXmlAttribute *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxXmlAttribute *>(sipSrc);
}
