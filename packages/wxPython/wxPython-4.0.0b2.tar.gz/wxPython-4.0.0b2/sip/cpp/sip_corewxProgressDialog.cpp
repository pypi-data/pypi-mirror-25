...
static void release_wxProgressDialog(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxProgressDialog[] = {{207, 255, 1}};
...
static PyMethodDef methods_wxProgressDialog[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxProgressDialog_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxProgressDialog_SendDestroyEvent)},
