...
extern "C" {static void assign_wxTimeSpan(void *, SIP_SSIZE_T, const void *);}
static void assign_wxTimeSpan(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxTimeSpan *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxTimeSpan *>(sipSrc);
}
