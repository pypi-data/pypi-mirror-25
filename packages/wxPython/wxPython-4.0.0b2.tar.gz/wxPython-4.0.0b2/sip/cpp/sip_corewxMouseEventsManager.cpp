...
void sipwxMouseEventsManager::MouseClickCancelled(int item)
{
    ...
    sipVH__core_89(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
void sipwxMouseEventsManager::MouseDragEnd(int item,const  ::wxPoint& pos)
{
    ...
    extern void sipVH__core_210(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxPoint&);

    sipVH__core_210(sipGILState, 0, sipPySelf, sipMeth, item, pos);
}
...
bool sipwxMouseEventsManager::MouseDragBegin(int item,const  ::wxPoint& pos)
{
    ...
    extern bool sipVH__core_209(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxPoint&);

    return sipVH__core_209(sipGILState, 0, sipPySelf, sipMeth, item, pos);
}
...
bool sipwxMouseEventsManager::MouseClicked(int item)
{
    ...
    return sipVH__core_123(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
int sipwxMouseEventsManager::MouseHitTest(const  ::wxPoint& pos)
{
    ...
    extern int sipVH__core_208(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&);
...
static void release_wxMouseEventsManager(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxMouseEventsManager[] = {{142, 255, 1}};
...
static PyMethodDef methods_wxMouseEventsManager[] = {
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxMouseEventsManager_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMouseEventsManager_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxMouseEventsManager_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMouseEventsManager_TryBefore)}
};
