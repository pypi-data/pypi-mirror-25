...
void sipwxHtmlWinTagHandler::SetParser( ::wxHtmlWinParser*parser)
{
    ...
    extern void sipVH__html_56(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxHtmlWinParser*);

    sipVH__html_56(sipGILState, 0, sipPySelf, sipMeth, parser);
}
...
static void release_wxHtmlWinTagHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxHtmlWinTagHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_ParseInner), (PyCFunction)meth_wxHtmlWinTagHandler_ParseInner, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlWinTagHandler_ParseInner)},
    {SIP_MLNAME_CAST(sipName_ParseInnerSource), (PyCFunction)meth_wxHtmlWinTagHandler_ParseInnerSource, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlWinTagHandler_ParseInnerSource)},
