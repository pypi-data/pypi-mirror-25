...
static void release_wxRichTextTable(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextTable(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextTable(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextTable *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextTable *>(sipSrc);
}
