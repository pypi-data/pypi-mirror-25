...
static void release_wxHtmlListBox(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxHtmlListBox[] = {
    ...
    {SIP_MLNAME_CAST(sipName_EstimateTotalHeight), (PyCFunction)meth_wxHtmlListBox_EstimateTotalHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlListBox_EstimateTotalHeight)},
    ...
    {SIP_MLNAME_CAST(sipName_OnDrawBackground), (PyCFunction)meth_wxHtmlListBox_OnDrawBackground, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlListBox_OnDrawBackground)},
    ...
    {SIP_MLNAME_CAST(sipName_OnDrawSeparator), (PyCFunction)meth_wxHtmlListBox_OnDrawSeparator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlListBox_OnDrawSeparator)},
    ...
    {SIP_MLNAME_CAST(sipName_OnGetRowsHeightHint), (PyCFunction)meth_wxHtmlListBox_OnGetRowsHeightHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlListBox_OnGetRowsHeightHint)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxHtmlListBox_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlListBox_SendDestroyEvent)},
