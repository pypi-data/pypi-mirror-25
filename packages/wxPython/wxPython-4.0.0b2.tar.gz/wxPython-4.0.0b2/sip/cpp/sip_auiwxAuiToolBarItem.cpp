...
extern "C" {static void assign_wxAuiToolBarItem(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiToolBarItem(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiToolBarItem *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiToolBarItem *>(sipSrc);
}
