...
extern "C" {static void assign_wxPGVIterator(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGVIterator(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGVIterator *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGVIterator *>(sipSrc);
}
