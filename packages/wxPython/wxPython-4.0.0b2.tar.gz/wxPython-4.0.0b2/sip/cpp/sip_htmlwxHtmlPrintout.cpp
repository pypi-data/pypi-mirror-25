...
void sipwxHtmlPrintout::GetPageInfo(int*minPage,int*maxPage,int*pageFrom,int*pageTo)
{
    ...
    extern void sipVH__html_55(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int*,int*,int*,int*);

    sipVH__html_55(sipGILState, 0, sipPySelf, sipMeth, minPage, maxPage, pageFrom, pageTo);
}
...
bool sipwxHtmlPrintout::HasPage(int pageNum)
{
    ...
    return sipVH__html_53(sipGILState, 0, sipPySelf, sipMeth, pageNum);
}
...
bool sipwxHtmlPrintout::OnBeginDocument(int startPage,int endPage)
{
    ...
    extern bool sipVH__html_54(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int);

    return sipVH__html_54(sipGILState, 0, sipPySelf, sipMeth, startPage, endPage);
}
