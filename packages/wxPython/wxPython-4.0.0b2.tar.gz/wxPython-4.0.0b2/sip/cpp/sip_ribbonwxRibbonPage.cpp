...
static void release_wxRibbonPage(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxRibbonPage[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetNextLargerSize), (PyCFunction)meth_wxRibbonPage_DoGetNextLargerSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonPage_DoGetNextLargerSize)},
    {SIP_MLNAME_CAST(sipName_DoGetNextSmallerSize), (PyCFunction)meth_wxRibbonPage_DoGetNextSmallerSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonPage_DoGetNextSmallerSize)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxRibbonPage_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonPage_SendDestroyEvent)},
