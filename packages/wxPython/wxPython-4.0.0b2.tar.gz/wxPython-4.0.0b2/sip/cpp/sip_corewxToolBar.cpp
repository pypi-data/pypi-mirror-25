...
static PyObject *meth_wxToolBar_SetDropdownMenu(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiJ8", &sipSelf, sipType_wxToolBar, &sipCpp, &id, sipType_wxMenu, &menu))
        {
            bool sipRes;
...
static void release_wxToolBar(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxToolBar[] = {{84, 255, 1}};
...
static PyMethodDef methods_wxToolBar[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxToolBar_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxToolBar_SendDestroyEvent)},
