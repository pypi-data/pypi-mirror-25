 ...
 ::wxWindow* sipwxStockPreferencesPage::CreateWindow( ::wxWindow*parent)
{
    ...
    extern  ::wxWindow* sipVH__core_219(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);
...
static PyObject *meth_wxStockPreferencesPage_GetKind(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxStockPreferencesPage, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxStockPreferencesPage_Kind);
        }
    }
...
static void release_wxStockPreferencesPage(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxStockPreferencesPage[] = {{388, 255, 1}};
...
static sipEnumMemberDef enummembers_wxStockPreferencesPage[] = {
    {sipName_Kind_Advanced, static_cast<int>( ::wxStockPreferencesPage::Kind_Advanced), 487},
    {sipName_Kind_General, static_cast<int>( ::wxStockPreferencesPage::Kind_General), 487},
};
