...
extern "C" {static void assign_wxFindReplaceData(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFindReplaceData(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFindReplaceData *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFindReplaceData *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxFindReplaceData[] = {{349, 255, 1}};
