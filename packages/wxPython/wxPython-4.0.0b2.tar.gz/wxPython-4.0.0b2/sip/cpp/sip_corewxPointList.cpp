...
extern "C" {static void assign_wxPointList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPointList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPointList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPointList *>(sipSrc);
}
