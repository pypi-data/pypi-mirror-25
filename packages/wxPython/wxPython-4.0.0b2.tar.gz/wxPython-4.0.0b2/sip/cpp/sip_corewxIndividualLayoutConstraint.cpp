...
static PyObject *meth_wxIndividualLayoutConstraint_GetMyEdge(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxIndividualLayoutConstraint, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxEdge);
        }
    }
...
static PyObject *meth_wxIndividualLayoutConstraint_GetRelationship(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxIndividualLayoutConstraint, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxRelationship);
        }
    }
...
static void release_wxIndividualLayoutConstraint(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxIndividualLayoutConstraint(void *, SIP_SSIZE_T, const void *);}
static void assign_wxIndividualLayoutConstraint(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxIndividualLayoutConstraint *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxIndividualLayoutConstraint *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxIndividualLayoutConstraint[] = {{349, 255, 1}};
