...
static void release_wxTopLevelWindow(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxTopLevelWindow[] = {{346, 255, 1}};
...
static PyMethodDef methods_wxTopLevelWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxTopLevelWindow_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTopLevelWindow_SendDestroyEvent)},
