...
extern "C" {static void assign_wxDateTime_TimeZone(void *, SIP_SSIZE_T, const void *);}
static void assign_wxDateTime_TimeZone(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxDateTime::TimeZone *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxDateTime::TimeZone *>(sipSrc);
}
