...
static void release_wxPickerBase(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPickerBase[] = {{84, 255, 1}};
...
static PyMethodDef methods_wxPickerBase[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxPickerBase_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPickerBase_SendDestroyEvent)},
