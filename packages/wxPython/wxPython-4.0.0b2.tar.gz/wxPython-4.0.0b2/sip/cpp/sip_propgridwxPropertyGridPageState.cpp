...
static void release_wxPropertyGridPageState(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxPropertyGridPageState(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPropertyGridPageState(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPropertyGridPageState *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPropertyGridPageState *>(sipSrc);
}
