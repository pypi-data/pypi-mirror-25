...
extern "C" {static void assign_wxHtmlLinkInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxHtmlLinkInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxHtmlLinkInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxHtmlLinkInfo *>(sipSrc);
}
