...
static void release_wxAffineMatrix2D(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxAffineMatrix2D(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAffineMatrix2D(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAffineMatrix2D *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAffineMatrix2D *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxAffineMatrix2D[] = {{8, 255, 1}};
