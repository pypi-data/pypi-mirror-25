...
extern "C" {static void assign_wxRichTextObjectAddress(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextObjectAddress(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextObjectAddress *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextObjectAddress *>(sipSrc);
}
