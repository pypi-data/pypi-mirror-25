...
static void release_wxMetafileDC(void *sipCppV, int)
{
    Py_BEGIN_ALLOW_THREADS
...
static void dealloc_wxMetafileDC(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_wxMetafileDC(sipGetAddress(sipSelf), 0);
    }
}


extern "C" {static void *init_type_wxMetafileDC(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_type_wxMetafileDC(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
     ::wxMetafileDC *sipCpp = 0;

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, sipKwdList, sipUnused, "|J1", sipType_wxString,&filename, &filenameState))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new  ::wxMetafileDC(*filename);
            Py_END_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxMetafileDC[] = {{1, 0, 1}};
...
PyDoc_STRVAR(doc_wxMetafileDC, "MetafileDC(filename=wx.EmptyString)\n"
    "\n"
...
sipClassTypeDef sipTypeDef__msw_wxMetafileDC = {
    {
        -1,
        0,
        0,
