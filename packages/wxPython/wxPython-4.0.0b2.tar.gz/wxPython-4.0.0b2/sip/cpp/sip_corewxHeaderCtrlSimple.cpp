...
int sipwxHeaderCtrlSimple::GetBestFittingWidth(uint idx) const
{
    ...
    extern int sipVH__core_148(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_148(sipGILState, 0, sipPySelf, sipMeth, idx);
}
...
const  ::wxHeaderColumn& sipwxHeaderCtrlSimple::GetColumn(uint idx) const
{
    ...
    extern const  ::wxHeaderColumn& sipVH__core_143(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_143(sipGILState, 0, sipPySelf, sipMeth, idx);
}
...
void sipwxHeaderCtrlSimple::UpdateColumnVisibility(uint idx,bool show)
{
    ...
    extern void sipVH__core_144(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,bool);

    sipVH__core_144(sipGILState, 0, sipPySelf, sipMeth, idx, show);
}
...
void sipwxHeaderCtrlSimple::UpdateColumnsOrder(const  ::wxArrayInt& order)
{
    ...
    extern void sipVH__core_145(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayInt&);

    sipVH__core_145(sipGILState, 0, sipPySelf, sipMeth, order);
}
...
bool sipwxHeaderCtrlSimple::UpdateColumnWidthToFit(uint idx,int widthTitle)
{
    ...
    extern bool sipVH__core_146(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,int);

    return sipVH__core_146(sipGILState, 0, sipPySelf, sipMeth, idx, widthTitle);
}
...
void sipwxHeaderCtrlSimple::OnColumnCountChanging(uint count)
{
    ...
    extern void sipVH__core_147(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    sipVH__core_147(sipGILState, 0, sipPySelf, sipMeth, count);
}
...
static void release_wxHeaderCtrlSimple(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxHeaderCtrlSimple[] = {{228, 255, 1}};
...
static PyMethodDef methods_wxHeaderCtrlSimple[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxHeaderCtrlSimple_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_SendDestroyEvent)},
