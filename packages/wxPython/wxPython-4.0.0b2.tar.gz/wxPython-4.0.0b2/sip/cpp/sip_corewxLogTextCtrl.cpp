...
static void release_wxLogTextCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxLogTextCtrl[] = {{293, 255, 1}};


static PyMethodDef methods_wxLogTextCtrl[] = {
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogTextCtrl_DoLogRecord, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogTextCtrl_DoLogRecord)},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogTextCtrl_DoLogText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogTextCtrl_DoLogText)},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogTextCtrl_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogTextCtrl_DoLogTextAtLevel)}
};
