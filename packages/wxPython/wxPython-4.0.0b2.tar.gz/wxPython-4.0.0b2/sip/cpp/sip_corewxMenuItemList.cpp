...
extern "C" {static void assign_wxMenuItemList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxMenuItemList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxMenuItemList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxMenuItemList *>(sipSrc);
}
