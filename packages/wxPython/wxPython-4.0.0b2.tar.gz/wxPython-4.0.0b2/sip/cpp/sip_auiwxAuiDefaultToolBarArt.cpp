...
static void release_wxAuiDefaultToolBarArt(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxAuiDefaultToolBarArt(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiDefaultToolBarArt(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiDefaultToolBarArt *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiDefaultToolBarArt *>(sipSrc);
}
