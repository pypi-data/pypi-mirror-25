...
extern "C" {static void assign_wxAlphaPixelData_Accessor(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAlphaPixelData_Accessor(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAlphaPixelData_Accessor *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAlphaPixelData_Accessor *>(sipSrc);
}
