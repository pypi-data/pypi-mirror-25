...
static void release_wxPrinterDC(void *sipCppV, int)
{
    Py_BEGIN_ALLOW_THREADS
...
static void dealloc_wxPrinterDC(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_wxPrinterDC(sipGetAddress(sipSelf), 0);
    }
}


extern "C" {static void *init_type_wxPrinterDC(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_type_wxPrinterDC(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
     ::wxPrinterDC *sipCpp = 0;

    {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new  ::wxPrinterDC(*printData);
            Py_END_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPrinterDC[] = {{88, 255, 1}};
