...
void sipwxRichTextStyleComboCtrl::Dismiss()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[39],sipPySelf,NULL,sipName_Dismiss);
...
bool sipwxRichTextStyleComboCtrl::IsKeyPopupToggle(const  ::wxKeyEvent& event) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[40]),sipPySelf,NULL,sipName_IsKeyPopupToggle);
...
void sipwxRichTextStyleComboCtrl::HidePopup(bool generateEvent)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[41],sipPySelf,NULL,sipName_HidePopup);
...
void sipwxRichTextStyleComboCtrl::OnButtonClick()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[42],sipPySelf,NULL,sipName_OnButtonClick);
...
bool sipwxRichTextStyleComboCtrl::AnimateShow(const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[44],sipPySelf,NULL,sipName_AnimateShow);
...
void sipwxRichTextStyleComboCtrl::DoSetPopupControl( ::wxComboPopup*popup)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[45],sipPySelf,NULL,sipName_DoSetPopupControl);
...
void sipwxRichTextStyleComboCtrl::DoShowPopup(const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[46],sipPySelf,NULL,sipName_DoShowPopup);
...
static void release_wxRichTextStyleComboCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxRichTextStyleComboCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AnimateShow), (PyCFunction)meth_wxRichTextStyleComboCtrl_AnimateShow, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextStyleComboCtrl_AnimateShow)},
    ...
    {SIP_MLNAME_CAST(sipName_DoSetPopupControl), (PyCFunction)meth_wxRichTextStyleComboCtrl_DoSetPopupControl, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextStyleComboCtrl_DoSetPopupControl)},
    ...
    {SIP_MLNAME_CAST(sipName_DoShowPopup), (PyCFunction)meth_wxRichTextStyleComboCtrl_DoShowPopup, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextStyleComboCtrl_DoShowPopup)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxRichTextStyleComboCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextStyleComboCtrl_SendDestroyEvent)},
