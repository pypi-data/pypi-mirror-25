 ...
 ::wxIconBundle sipwxArtProvider::CreateIconBundle(const  ::wxArtID& id,const  ::wxArtClient& client)
{
    ...
    extern  ::wxIconBundle sipVH__core_185(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArtID&,const  ::wxArtClient&);

    return sipVH__core_185(sipGILState, 0, sipPySelf, sipMeth, id, client);
}
 ...
 ::wxBitmap sipwxArtProvider::CreateBitmap(const  ::wxArtID& id,const  ::wxArtClient& client,const  ::wxSize& size)
{
    ...
    extern  ::wxBitmap sipVH__core_184(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArtID&,const  ::wxArtClient&,const  ::wxSize&);

    return sipVH__core_184(sipGILState, 0, sipPySelf, sipMeth, id, client, size);
}
...
static void release_wxArtProvider(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxArtProvider(void *, SIP_SSIZE_T, const void *);}
static void assign_wxArtProvider(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxArtProvider *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxArtProvider *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxArtProvider[] = {{349, 255, 1}};
