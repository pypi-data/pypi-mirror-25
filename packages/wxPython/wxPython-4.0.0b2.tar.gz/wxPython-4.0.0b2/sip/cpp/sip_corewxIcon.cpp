...
extern "C" {static void assign_wxIcon(void *, SIP_SSIZE_T, const void *);}
static void assign_wxIcon(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxIcon *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxIcon *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxIcon[] = {{199, 255, 1}};
