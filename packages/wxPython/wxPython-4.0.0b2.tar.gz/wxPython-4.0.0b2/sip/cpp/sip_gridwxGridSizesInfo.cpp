...
extern "C" {static void assign_wxGridSizesInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxGridSizesInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxGridSizesInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxGridSizesInfo *>(sipSrc);
}
