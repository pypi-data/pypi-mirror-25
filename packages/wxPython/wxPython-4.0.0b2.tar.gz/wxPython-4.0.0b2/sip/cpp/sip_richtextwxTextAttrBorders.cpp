...
extern "C" {static void assign_wxTextAttrBorders(void *, SIP_SSIZE_T, const void *);}
static void assign_wxTextAttrBorders(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxTextAttrBorders *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxTextAttrBorders *>(sipSrc);
}
