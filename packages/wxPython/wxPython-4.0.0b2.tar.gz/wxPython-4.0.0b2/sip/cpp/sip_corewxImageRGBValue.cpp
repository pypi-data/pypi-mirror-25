...
extern "C" {static void assign_wxImage_RGBValue(void *, SIP_SSIZE_T, const void *);}
static void assign_wxImage_RGBValue(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxImage::RGBValue *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxImage::RGBValue *>(sipSrc);
}
