...
extern "C" {static void assign_wxPageSetupDialogData(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPageSetupDialogData(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPageSetupDialogData *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPageSetupDialogData *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxPageSetupDialogData[] = {{349, 255, 1}};
