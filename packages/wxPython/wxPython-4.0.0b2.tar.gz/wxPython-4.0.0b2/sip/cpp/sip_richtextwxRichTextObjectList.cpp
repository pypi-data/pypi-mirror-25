...
extern "C" {static void assign_wxRichTextObjectList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextObjectList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextObjectList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextObjectList *>(sipSrc);
}
