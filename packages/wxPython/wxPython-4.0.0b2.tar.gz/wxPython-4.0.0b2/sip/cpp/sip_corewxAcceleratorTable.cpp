...
extern "C" {static void assign_wxAcceleratorTable(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAcceleratorTable(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAcceleratorTable *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAcceleratorTable *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxAcceleratorTable[] = {{349, 255, 1}};
