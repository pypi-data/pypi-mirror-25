...
static void release_wxHelpEvent(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxHelpEvent[] = {{72, 255, 1}};
...
static sipEnumMemberDef enummembers_wxHelpEvent[] = {
    {sipName_Origin_HelpButton, static_cast<int>( ::wxHelpEvent::Origin_HelpButton), 235},
    {sipName_Origin_Keyboard, static_cast<int>( ::wxHelpEvent::Origin_Keyboard), 235},
    {sipName_Origin_Unknown, static_cast<int>( ::wxHelpEvent::Origin_Unknown), 235},
};
