...
extern "C" {static void assign_wxAuiToolBarItemArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiToolBarItemArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiToolBarItemArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiToolBarItemArray *>(sipSrc);
}
