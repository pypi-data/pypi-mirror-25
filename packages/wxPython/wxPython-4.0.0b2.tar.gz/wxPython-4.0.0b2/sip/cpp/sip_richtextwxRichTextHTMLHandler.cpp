...
static void release_wxRichTextHTMLHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextHTMLHandler(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextHTMLHandler(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextHTMLHandler *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextHTMLHandler *>(sipSrc);
}
