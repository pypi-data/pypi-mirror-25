...
static void release_wxAuiSimpleTabArt(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxAuiSimpleTabArt(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiSimpleTabArt(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiSimpleTabArt *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiSimpleTabArt *>(sipSrc);
}
