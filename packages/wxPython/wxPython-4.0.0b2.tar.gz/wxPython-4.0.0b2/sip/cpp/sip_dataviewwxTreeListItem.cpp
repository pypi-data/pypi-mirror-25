...
extern "C" {static void assign_wxTreeListItem(void *, SIP_SSIZE_T, const void *);}
static void assign_wxTreeListItem(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxTreeListItem *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxTreeListItem *>(sipSrc);
}
