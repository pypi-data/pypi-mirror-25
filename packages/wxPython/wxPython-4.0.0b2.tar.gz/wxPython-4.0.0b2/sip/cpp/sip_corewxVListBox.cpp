 ...
 ::wxCoord sipwxVListBox::OnMeasureItem( ::size_t n) const
{
    ...
    return sipVH__core_121(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
void sipwxVListBox::OnDrawSeparator( ::wxDC& dc, ::wxRect& rect, ::size_t n) const
{
    ...
    extern void sipVH__core_164(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxRect&, ::size_t);

    sipVH__core_164(sipGILState, 0, sipPySelf, sipMeth, dc, rect, n);
}
...
void sipwxVListBox::OnDrawBackground( ::wxDC& dc,const  ::wxRect& rect, ::size_t n) const
{
    ...
    extern void sipVH__core_163(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRect&, ::size_t);

    sipVH__core_163(sipGILState, 0, sipPySelf, sipMeth, dc, rect, n);
}
...
static void release_wxVListBox(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxVListBox[] = {{550, 255, 1}};
...
static PyMethodDef methods_wxVListBox[] = {
    ...
    {SIP_MLNAME_CAST(sipName_EstimateTotalHeight), (PyCFunction)meth_wxVListBox_EstimateTotalHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVListBox_EstimateTotalHeight)},
    ...
    {SIP_MLNAME_CAST(sipName_OnGetRowsHeightHint), (PyCFunction)meth_wxVListBox_OnGetRowsHeightHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVListBox_OnGetRowsHeightHint)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxVListBox_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVListBox_SendDestroyEvent)},
