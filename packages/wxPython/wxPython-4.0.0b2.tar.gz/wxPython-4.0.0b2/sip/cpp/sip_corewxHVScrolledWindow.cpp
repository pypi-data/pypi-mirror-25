 ...
 ::wxCoord sipwxHVScrolledWindow::OnGetColumnWidth( ::size_t column) const
{
    ...
    return sipVH__core_121(sipGILState, 0, sipPySelf, sipMeth, column);
}
...
void sipwxHVScrolledWindow::OnGetColumnsWidthHint( ::size_t columnMin, ::size_t columnMax) const
{
    ...
    sipVH__core_120(sipGILState, 0, sipPySelf, sipMeth, columnMin, columnMax);
}
...
bool sipwxHVScrolledWindow::ScrollColumns(int columns)
{
    ...
    return sipVH__core_123(sipGILState, 0, sipPySelf, sipMeth, columns);
}
...
void sipwxHVScrolledWindow::RefreshColumn( ::size_t column)
{
    ...
    sipVH__core_122(sipGILState, 0, sipPySelf, sipMeth, column);
}
...
void sipwxHVScrolledWindow::RefreshRowColumn( ::size_t row, ::size_t column)
{
    ...
    sipVH__core_120(sipGILState, 0, sipPySelf, sipMeth, row, column);
}
...
void sipwxHVScrolledWindow::RefreshRowColumn(const  ::wxPosition& pos)
{
    ...
    extern void sipVH__core_124(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPosition&);

    sipVH__core_124(sipGILState, 0, sipPySelf, sipMeth, pos);
}
...
void sipwxHVScrolledWindow::RefreshRowsColumns( ::size_t fromRow, ::size_t toRow, ::size_t fromColumn, ::size_t toColumn)
{
    ...
    extern void sipVH__core_125(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t, ::size_t, ::size_t, ::size_t);

    sipVH__core_125(sipGILState, 0, sipPySelf, sipMeth, fromRow, toRow, fromColumn, toColumn);
}
...
void sipwxHVScrolledWindow::RefreshRowsColumns(const  ::wxPosition& from,const  ::wxPosition& to)
{
    ...
    extern void sipVH__core_126(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPosition&,const  ::wxPosition&);

    sipVH__core_126(sipGILState, 0, sipPySelf, sipMeth, from, to);
}
...
static void release_wxHVScrolledWindow(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxHVScrolledWindow[] = {{364, 255, 0}, {553, 255, 1}};
...
static PyMethodDef methods_wxHVScrolledWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_EstimateTotalHeight), (PyCFunction)meth_wxHVScrolledWindow_EstimateTotalHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHVScrolledWindow_EstimateTotalHeight)},
    {SIP_MLNAME_CAST(sipName_EstimateTotalWidth), (PyCFunction)meth_wxHVScrolledWindow_EstimateTotalWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHVScrolledWindow_EstimateTotalWidth)},
    ...
    {SIP_MLNAME_CAST(sipName_OnGetColumnWidth), (PyCFunction)meth_wxHVScrolledWindow_OnGetColumnWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHVScrolledWindow_OnGetColumnWidth)},
    {SIP_MLNAME_CAST(sipName_OnGetColumnsWidthHint), (PyCFunction)meth_wxHVScrolledWindow_OnGetColumnsWidthHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHVScrolledWindow_OnGetColumnsWidthHint)},
    {SIP_MLNAME_CAST(sipName_OnGetRowHeight), (PyCFunction)meth_wxHVScrolledWindow_OnGetRowHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHVScrolledWindow_OnGetRowHeight)},
    {SIP_MLNAME_CAST(sipName_OnGetRowsHeightHint), (PyCFunction)meth_wxHVScrolledWindow_OnGetRowsHeightHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHVScrolledWindow_OnGetRowsHeightHint)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxHVScrolledWindow_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHVScrolledWindow_SendDestroyEvent)},
