...
extern "C" {static void assign_wxLogRecordInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxLogRecordInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxLogRecordInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxLogRecordInfo *>(sipSrc);
}
