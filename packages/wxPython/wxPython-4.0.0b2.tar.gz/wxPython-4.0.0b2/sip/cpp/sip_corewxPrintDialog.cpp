 ...
 ::wxPrintData& sipwxPrintDialog::GetPrintData()
{
    ...
    extern  ::wxPrintData& sipVH__core_203(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxDC* sipwxPrintDialog::GetPrintDC()
{
    ...
    extern  ::wxDC* sipVH__core_202(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_202(sipGILState, 0, sipPySelf, sipMeth);
}
...
static void release_wxPrintDialog(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPrintDialog[] = {{349, 255, 1}};
