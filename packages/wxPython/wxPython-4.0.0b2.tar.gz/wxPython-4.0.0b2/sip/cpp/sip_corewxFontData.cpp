...
extern "C" {static void assign_wxFontData(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFontData(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFontData *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFontData *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxFontData[] = {{349, 255, 1}};
