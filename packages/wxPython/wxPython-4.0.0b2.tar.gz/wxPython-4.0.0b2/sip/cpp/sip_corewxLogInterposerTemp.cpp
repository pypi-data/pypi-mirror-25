...
static void release_wxLogInterposerTemp(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxLogInterposerTemp[] = {{295, 255, 1}};


static PyMethodDef methods_wxLogInterposerTemp[] = {
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogInterposerTemp_DoLogRecord, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogInterposerTemp_DoLogRecord)},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogInterposerTemp_DoLogText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogInterposerTemp_DoLogText)},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogInterposerTemp_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogInterposerTemp_DoLogTextAtLevel)}
};
