...
static void release_wxLayoutConstraints(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxLayoutConstraints(void *, SIP_SSIZE_T, const void *);}
static void assign_wxLayoutConstraints(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxLayoutConstraints *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxLayoutConstraints *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxLayoutConstraints[] = {{349, 255, 1}};
