...
extern "C" {static void assign_wxGraphicsGradientStops(void *, SIP_SSIZE_T, const void *);}
static void assign_wxGraphicsGradientStops(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxGraphicsGradientStops *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxGraphicsGradientStops *>(sipSrc);
}
