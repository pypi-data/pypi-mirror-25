...
static void release_wxPGChoiceEntry(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxPGChoiceEntry(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGChoiceEntry(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGChoiceEntry *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGChoiceEntry *>(sipSrc);
}
