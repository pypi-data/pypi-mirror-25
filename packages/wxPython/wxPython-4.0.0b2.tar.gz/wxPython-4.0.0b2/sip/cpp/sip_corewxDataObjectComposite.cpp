...
bool sipwxDataObjectComposite::SetData(const  ::wxDataFormat& format, ::size_t len,const void*buf)
{
    ...
    extern bool sipVH__core_57(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxDataFormat&, ::size_t,const void*);

    return sipVH__core_57(sipGILState, 0, sipPySelf, sipMeth, format, len, buf);
}
...
static void release_wxDataObjectComposite(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxDataObjectComposite[] = {{98, 255, 1}};
