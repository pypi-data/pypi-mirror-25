...
extern "C" {static void assign_wxRichTextDrawingHandlerList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextDrawingHandlerList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextDrawingHandlerList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextDrawingHandlerList *>(sipSrc);
}
