...
static PyObject *meth_wxSplitterWindow_GetSplitMode(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxSplitterWindow, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxSplitMode);
        }
    }
...
static void release_wxSplitterWindow(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxSplitterWindow[] = {{561, 255, 1}};
...
static PyMethodDef methods_wxSplitterWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxSplitterWindow_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSplitterWindow_SendDestroyEvent)},
