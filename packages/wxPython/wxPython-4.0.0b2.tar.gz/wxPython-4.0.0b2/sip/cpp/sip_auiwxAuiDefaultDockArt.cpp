...
static void release_wxAuiDefaultDockArt(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxAuiDefaultDockArt(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiDefaultDockArt(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiDefaultDockArt *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiDefaultDockArt *>(sipSrc);
}
