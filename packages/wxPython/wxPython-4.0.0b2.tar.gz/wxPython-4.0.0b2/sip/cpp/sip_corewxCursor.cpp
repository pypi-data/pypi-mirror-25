...
static void release_wxCursor(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxCursor(void *, SIP_SSIZE_T, const void *);}
static void assign_wxCursor(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxCursor *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxCursor *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxCursor[] = {{199, 255, 1}};
