...
extern "C" {static void assign_wxPropertyGridHitTestResult(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPropertyGridHitTestResult(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPropertyGridHitTestResult *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPropertyGridHitTestResult *>(sipSrc);
}
