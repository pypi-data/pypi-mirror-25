...
extern "C" {static void assign_wxHtmlBookRecArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxHtmlBookRecArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxHtmlBookRecArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxHtmlBookRecArray *>(sipSrc);
}
