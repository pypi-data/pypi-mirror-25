...
static void release_wxXmlDocument(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxXmlDocument(void *, SIP_SSIZE_T, const void *);}
static void assign_wxXmlDocument(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxXmlDocument *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxXmlDocument *>(sipSrc);
}
