...
static sipEncodedTypeDef supers_wxMetafile[] = {{4, 0, 1}};
...
PyDoc_STRVAR(doc_wxMetafile, "Metafile(filename=wx.EmptyString)\n"
    "\n"
    "A wxMetafile represents the MS Windows metafile object, so metafile\n"
    "operations have no effect in X.");


sipClassTypeDef sipTypeDef__msw_wxMetafile = {
    {
        -1,
        0,
        0,
