...
static void release_wxPGChoiceAndButtonEditor(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxPGChoiceAndButtonEditor(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGChoiceAndButtonEditor(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGChoiceAndButtonEditor *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGChoiceAndButtonEditor *>(sipSrc);
}
