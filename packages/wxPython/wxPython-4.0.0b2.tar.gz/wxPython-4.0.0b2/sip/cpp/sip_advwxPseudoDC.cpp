...
extern "C" {static void assign_wxPseudoDC(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPseudoDC(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPseudoDC *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPseudoDC *>(sipSrc);
}
