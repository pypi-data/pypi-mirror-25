...
int sipwxSimpleHtmlListBox::GetSelection() const
{
    ...
    extern int sipVH__html_76(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__html_76(sipGILState, 0, sipPySelf, sipMeth);
}
...
int sipwxSimpleHtmlListBox::FindString(const  ::wxString& string,bool caseSensitive) const
{
    ...
    extern int sipVH__html_85(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&,bool);

    return sipVH__html_85(sipGILState, 0, sipPySelf, sipMeth, string, caseSensitive);
}
...
void sipwxSimpleHtmlListBox::SetString(uint n,const  ::wxString& string)
{
    ...
    extern void sipVH__html_84(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,const  ::wxString&);

    sipVH__html_84(sipGILState, 0, sipPySelf, sipMeth, n, string);
}
 ...
 ::wxString sipwxSimpleHtmlListBox::GetString(uint n) const
{
    ...
    extern  ::wxString sipVH__html_83(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__html_83(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
uint sipwxSimpleHtmlListBox::GetCount() const
{
    ...
    extern uint sipVH__html_82(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxCoord sipwxSimpleHtmlListBox::OnMeasureItem( ::size_t n) const
{
    ...
    extern  ::wxCoord sipVH__html_73(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    return sipVH__html_73(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
void sipwxSimpleHtmlListBox::OnDrawSeparator( ::wxDC& dc, ::wxRect& rect, ::size_t n) const
{
    ...
    extern void sipVH__html_74(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxRect&, ::size_t);

    sipVH__html_74(sipGILState, 0, sipPySelf, sipMeth, dc, rect, n);
}
...
void sipwxSimpleHtmlListBox::OnDrawBackground( ::wxDC& dc,const  ::wxRect& rect, ::size_t n) const
{
    ...
    extern void sipVH__html_75(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRect&, ::size_t);
 ...
 ::wxCoord sipwxSimpleHtmlListBox::EstimateTotalHeight() const
{
    ...
    extern  ::wxCoord sipVH__html_76(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxSimpleHtmlListBox::OnGetRowsHeightHint( ::size_t rowMin, ::size_t rowMax) const
{
    ...
    extern void sipVH__html_77(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t, ::size_t);

    sipVH__html_77(sipGILState, 0, sipPySelf, sipMeth, rowMin, rowMax);
}
...
bool sipwxSimpleHtmlListBox::ScrollRows(int rows)
{
    ...
    extern bool sipVH__html_53(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__html_53(sipGILState, 0, sipPySelf, sipMeth, rows);
}
...
bool sipwxSimpleHtmlListBox::ScrollRowPages(int pages)
{
    ...
    return sipVH__html_53(sipGILState, 0, sipPySelf, sipMeth, pages);
}
...
void sipwxSimpleHtmlListBox::RefreshRows( ::size_t from_, ::size_t to_)
{
    ...
    sipVH__html_77(sipGILState, 0, sipPySelf, sipMeth, from_, to_);
}
...
void sipwxSimpleHtmlListBox::RefreshRow( ::size_t row)
{
    ...
    extern void sipVH__html_78(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    sipVH__html_78(sipGILState, 0, sipPySelf, sipMeth, row);
}
 ...
 ::wxOrientation sipwxSimpleHtmlListBox::GetOrientation() const
{
    ...
    extern  ::wxOrientation sipVH__html_79(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxSimpleHtmlListBox::OnGetUnitsSizeHint( ::size_t unitMin, ::size_t unitMax) const
{
    ...
    sipVH__html_77(sipGILState, 0, sipPySelf, sipMeth, unitMin, unitMax);
}
 ...
 ::wxCoord sipwxSimpleHtmlListBox::OnGetUnitSize( ::size_t unit) const
{
    ...
    return sipVH__html_73(sipGILState, 0, sipPySelf, sipMeth, unit);
}
...
void sipwxSimpleHtmlListBox::OnLinkClicked( ::size_t n,const  ::wxHtmlLinkInfo& link)
{
    ...
    extern void sipVH__html_80(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t,const  ::wxHtmlLinkInfo&);

    sipVH__html_80(sipGILState, 0, sipPySelf, sipMeth, n, link);
}
 ...
 ::wxString sipwxSimpleHtmlListBox::OnGetItemMarkup( ::size_t n) const
{
    ...
    extern  ::wxString sipVH__html_81(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    return sipVH__html_81(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
static PyObject *meth_wxSimpleHtmlListBox_GetOrientation(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxSimpleHtmlListBox, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxOrientation);
        }
    }
...
static void release_wxSimpleHtmlListBox(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxSimpleHtmlListBox[] = {
    ...
    {SIP_MLNAME_CAST(sipName_EstimateTotalHeight), (PyCFunction)meth_wxSimpleHtmlListBox_EstimateTotalHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_EstimateTotalHeight)},
    ...
    {SIP_MLNAME_CAST(sipName_GetSelectedTextBgColour), (PyCFunction)meth_wxSimpleHtmlListBox_GetSelectedTextBgColour, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_GetSelectedTextBgColour)},
    {SIP_MLNAME_CAST(sipName_GetSelectedTextColour), (PyCFunction)meth_wxSimpleHtmlListBox_GetSelectedTextColour, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_GetSelectedTextColour)},
    ...
    {SIP_MLNAME_CAST(sipName_OnDrawBackground), (PyCFunction)meth_wxSimpleHtmlListBox_OnDrawBackground, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_OnDrawBackground)},
    {SIP_MLNAME_CAST(sipName_OnDrawItem), (PyCFunction)meth_wxSimpleHtmlListBox_OnDrawItem, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_OnDrawSeparator), (PyCFunction)meth_wxSimpleHtmlListBox_OnDrawSeparator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_OnDrawSeparator)},
    ...
    {SIP_MLNAME_CAST(sipName_OnGetItemMarkup), (PyCFunction)meth_wxSimpleHtmlListBox_OnGetItemMarkup, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_OnGetItemMarkup)},
    ...
    {SIP_MLNAME_CAST(sipName_OnGetRowsHeightHint), (PyCFunction)meth_wxSimpleHtmlListBox_OnGetRowsHeightHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_OnGetRowsHeightHint)},
    ...
    {SIP_MLNAME_CAST(sipName_OnLinkClicked), (PyCFunction)meth_wxSimpleHtmlListBox_OnLinkClicked, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_OnLinkClicked)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxSimpleHtmlListBox_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSimpleHtmlListBox_SendDestroyEvent)},
