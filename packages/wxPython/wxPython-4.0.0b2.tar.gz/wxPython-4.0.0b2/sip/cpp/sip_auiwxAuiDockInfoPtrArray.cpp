...
extern "C" {static void assign_wxAuiDockInfoPtrArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiDockInfoPtrArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiDockInfoPtrArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiDockInfoPtrArray *>(sipSrc);
}
