...
extern "C" {static void assign_wxVideoMode(void *, SIP_SSIZE_T, const void *);}
static void assign_wxVideoMode(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxVideoMode *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxVideoMode *>(sipSrc);
}
