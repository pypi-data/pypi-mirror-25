...
static void release_wxLayoutAlgorithm(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxLayoutAlgorithm(void *, SIP_SSIZE_T, const void *);}
static void assign_wxLayoutAlgorithm(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxLayoutAlgorithm *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxLayoutAlgorithm *>(sipSrc);
}
