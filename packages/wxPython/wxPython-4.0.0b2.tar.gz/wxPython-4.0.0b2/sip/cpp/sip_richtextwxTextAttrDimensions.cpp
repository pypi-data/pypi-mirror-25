...
extern "C" {static void assign_wxTextAttrDimensions(void *, SIP_SSIZE_T, const void *);}
static void assign_wxTextAttrDimensions(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxTextAttrDimensions *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxTextAttrDimensions *>(sipSrc);
}
