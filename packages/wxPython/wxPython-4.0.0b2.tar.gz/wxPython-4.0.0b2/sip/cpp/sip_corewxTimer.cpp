...
bool sipwxTimer::Start(int milliseconds,bool oneShot)
{
    ...
    extern bool sipVH__core_100(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,bool);

    return sipVH__core_100(sipGILState, 0, sipPySelf, sipMeth, milliseconds, oneShot);
}
...
static void release_wxTimer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxTimer[] = {{142, 255, 1}};
...
static PyMethodDef methods_wxTimer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxTimer_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTimer_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxTimer_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTimer_TryBefore)}
};
