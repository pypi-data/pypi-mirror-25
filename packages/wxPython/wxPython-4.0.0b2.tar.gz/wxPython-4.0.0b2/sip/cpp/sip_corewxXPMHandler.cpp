...
static void release_wxXPMHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxXPMHandler[] = {{251, 255, 1}};
...
static PyMethodDef methods_wxXPMHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetImageCount), (PyCFunction)meth_wxXPMHandler_DoGetImageCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxXPMHandler_DoGetImageCount)},
