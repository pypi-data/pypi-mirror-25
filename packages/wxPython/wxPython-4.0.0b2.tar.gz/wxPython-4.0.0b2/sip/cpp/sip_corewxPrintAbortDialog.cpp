...
static void release_wxPrintAbortDialog(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPrintAbortDialog[] = {{115, 255, 1}};
...
static PyMethodDef methods_wxPrintAbortDialog[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxPrintAbortDialog_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPrintAbortDialog_SendDestroyEvent)},
