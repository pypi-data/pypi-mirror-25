...
static void release_wxTaskBarIcon(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxTaskBarIcon[] = {
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxTaskBarIcon_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTaskBarIcon_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxTaskBarIcon_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTaskBarIcon_TryBefore)}
};
