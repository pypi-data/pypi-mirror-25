...
extern "C" {static void assign_wxImageHistogram(void *, SIP_SSIZE_T, const void *);}
static void assign_wxImageHistogram(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxImageHistogram *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxImageHistogram *>(sipSrc);
}
