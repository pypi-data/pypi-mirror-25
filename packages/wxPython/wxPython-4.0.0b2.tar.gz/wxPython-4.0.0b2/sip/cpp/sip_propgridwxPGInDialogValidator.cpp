...
extern "C" {static void assign_wxPGInDialogValidator(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGInDialogValidator(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGInDialogValidator *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGInDialogValidator *>(sipSrc);
}
