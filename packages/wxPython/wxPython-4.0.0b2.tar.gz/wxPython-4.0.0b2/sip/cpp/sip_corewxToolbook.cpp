...
static void release_wxToolbook(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxToolbook[] = {{33, 255, 1}};
...
static PyMethodDef methods_wxToolbook[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxToolbook_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxToolbook_SendDestroyEvent)},
...
sipVariableDef variables_wxToolbook[] = {
    {PropertyVariable, sipName_ToolBar, &methods_wxToolbook[29], NULL, NULL, NULL},
};
