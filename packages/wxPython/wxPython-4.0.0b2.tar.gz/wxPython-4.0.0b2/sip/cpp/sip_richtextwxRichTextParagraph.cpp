...
static void release_wxRichTextParagraph(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextParagraph(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextParagraph(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextParagraph *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextParagraph *>(sipSrc);
}
