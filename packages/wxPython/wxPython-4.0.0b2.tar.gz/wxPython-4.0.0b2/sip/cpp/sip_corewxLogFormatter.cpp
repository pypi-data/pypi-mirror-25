 ...
 ::wxString sipwxLogFormatter::FormatTime( ::time_t time) const
{
    ...
    extern  ::wxString sipVH__core_42(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::time_t);

    return sipVH__core_42(sipGILState, 0, sipPySelf, sipMeth, time);
}
 ...
 ::wxString sipwxLogFormatter::Format( ::wxLogLevel level,const  ::wxString& msg,const  ::wxLogRecordInfo& info) const
{
    ...
    extern  ::wxString sipVH__core_41(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxLogLevel,const  ::wxString&,const  ::wxLogRecordInfo&);

    return sipVH__core_41(sipGILState, 0, sipPySelf, sipMeth, level, msg, info);
}
...
static void release_wxLogFormatter(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxLogFormatter(void *, SIP_SSIZE_T, const void *);}
static void assign_wxLogFormatter(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxLogFormatter *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxLogFormatter *>(sipSrc);
}
