...
extern "C" {static void assign_wxLinuxDistributionInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxLinuxDistributionInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxLinuxDistributionInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxLinuxDistributionInfo *>(sipSrc);
}
