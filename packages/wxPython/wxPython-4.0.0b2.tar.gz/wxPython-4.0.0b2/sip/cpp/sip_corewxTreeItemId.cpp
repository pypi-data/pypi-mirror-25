...
extern "C" {static void assign_wxTreeItemId(void *, SIP_SSIZE_T, const void *);}
static void assign_wxTreeItemId(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxTreeItemId *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxTreeItemId *>(sipSrc);
}
