...
static PyObject *meth_wxHtmlRenderingState_GetSelectionState(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxHtmlRenderingState, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxHtmlSelectionState);
        }
    }
...
extern "C" {static void assign_wxHtmlRenderingState(void *, SIP_SSIZE_T, const void *);}
static void assign_wxHtmlRenderingState(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxHtmlRenderingState *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxHtmlRenderingState *>(sipSrc);
}
