...
void sipwxComboPopup::SetStringValue(const  ::wxString& value)
{
    ...
    sipVH__core_38(sipGILState, 0, sipPySelf, sipMeth, value);
}
...
void sipwxComboPopup::PaintComboControl( ::wxDC& dc,const  ::wxRect& rect)
{
    ...
    extern void sipVH__core_158(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRect&);

    sipVH__core_158(sipGILState, 0, sipPySelf, sipMeth, dc, rect);
}
...
void sipwxComboPopup::OnComboKeyEvent( ::wxKeyEvent& event)
{
    ...
    extern void sipVH__core_157(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxKeyEvent&);

    sipVH__core_157(sipGILState, 0, sipPySelf, sipMeth, event);
}
 ...
 ::wxSize sipwxComboPopup::GetAdjustedSize(int minWidth,int prefHeight,int maxHeight)
{
    ...
    extern  ::wxSize sipVH__core_156(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int);

    return sipVH__core_156(sipGILState, 0, sipPySelf, sipMeth, minWidth, prefHeight, maxHeight);
}
...
bool sipwxComboPopup::FindItem(const  ::wxString& item, ::wxString*trueItem)
{
    ...
    extern bool sipVH__core_155(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&, ::wxString*);

    return sipVH__core_155(sipGILState, 0, sipPySelf, sipMeth, item, trueItem);
}
...
static void release_wxComboPopup(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
