...
bool sipwxPrintout::OnBeginDocument(int startPage,int endPage)
{
    ...
    return sipVH__core_68(sipGILState, 0, sipPySelf, sipMeth, startPage, endPage);
}
...
void sipwxPrintout::GetPageInfo(int*minPage,int*maxPage,int*pageFrom,int*pageTo)
{
    ...
    extern void sipVH__core_201(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int*,int*,int*,int*);

    sipVH__core_201(sipGILState, 0, sipPySelf, sipMeth, minPage, maxPage, pageFrom, pageTo);
}
...
static void release_wxPrintout(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPrintout[] = {{349, 255, 1}};
