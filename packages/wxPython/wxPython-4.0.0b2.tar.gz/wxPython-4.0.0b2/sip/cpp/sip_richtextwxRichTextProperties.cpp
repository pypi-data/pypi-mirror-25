...
extern "C" {static void assign_wxRichTextProperties(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextProperties(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextProperties *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextProperties *>(sipSrc);
}
