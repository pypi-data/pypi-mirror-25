...
static void release_wxRichTextField(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextField(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextField(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextField *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextField *>(sipSrc);
}
