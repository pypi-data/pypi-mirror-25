...
static void release_wxPGCell(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxPGCell(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGCell(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGCell *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGCell *>(sipSrc);
}
