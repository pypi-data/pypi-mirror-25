...
static void release_wxAuiManager(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxAuiManager[] = {
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxAuiManager_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiManager_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxAuiManager_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiManager_TryBefore)},
