...
bool sipwxWrapSizer::IsSpaceItem( ::wxSizerItem*item) const
{
    ...
    extern bool sipVH__core_85(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxSizerItem*);

    return sipVH__core_85(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
static void release_wxWrapSizer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxWrapSizer[] = {{36, 255, 1}};
