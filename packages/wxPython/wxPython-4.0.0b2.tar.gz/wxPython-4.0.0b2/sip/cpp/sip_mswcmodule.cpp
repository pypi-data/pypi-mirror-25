...
sipTypeDef *sipExportedTypes__msw[] = {
    &sipTypeDef__msw_wxMetafile.ctd_base,
    &sipTypeDef__msw_wxMetafileDC.ctd_base,
...
#if defined(SIP_USE_PYCAPSULE)
    sipAPI__msw = reinterpret_cast<const sipAPIDef *>(PyCapsule_GetPointer(sip_capiobj, SIP_MODULE_NAME "._C_API"));
#else
