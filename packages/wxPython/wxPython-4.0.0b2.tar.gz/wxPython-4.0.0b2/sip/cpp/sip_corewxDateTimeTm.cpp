...
extern "C" {static void assign_wxDateTime_Tm(void *, SIP_SSIZE_T, const void *);}
static void assign_wxDateTime_Tm(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxDateTime::Tm *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxDateTime::Tm *>(sipSrc);
}
...
static PyObject *varget_wxDateTime_Tm_mon(void *sipSelf, PyObject *, PyObject *)
{
    ...
    return sipConvertFromEnum(sipVal, sipType_wxDateTime_Month);
}
...
static int varset_wxDateTime_Tm_mon(void *sipSelf, PyObject *sipPy, PyObject *)
{
    ...
    sipVal = ( ::wxDateTime::Month)SIPLong_AsLong(sipPy);
