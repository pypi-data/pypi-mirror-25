...
void sipwxModalDialogHook::Exit( ::wxDialog*dialog)
{
    ...
    extern void sipVH__core_221(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    sipVH__core_221(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
...
int sipwxModalDialogHook::Enter( ::wxDialog*dialog)
{
    ...
    extern int sipVH__core_220(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    return sipVH__core_220(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
...
static void release_wxModalDialogHook(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
