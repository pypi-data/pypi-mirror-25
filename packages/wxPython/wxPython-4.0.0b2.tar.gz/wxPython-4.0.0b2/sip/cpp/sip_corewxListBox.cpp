...
void sipwxListBox::SetSelection(int n)
{
    ...
    extern void sipVH__core_89(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    sipVH__core_89(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
int sipwxListBox::FindString(const  ::wxString& string,bool caseSensitive) const
{
    ...
    extern int sipVH__core_130(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&,bool);

    return sipVH__core_130(sipGILState, 0, sipPySelf, sipMeth, string, caseSensitive);
}
...
void sipwxListBox::SetString(uint n,const  ::wxString& string)
{
    ...
    extern void sipVH__core_129(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,const  ::wxString&);

    sipVH__core_129(sipGILState, 0, sipPySelf, sipMeth, n, string);
}
 ...
 ::wxString sipwxListBox::GetString(uint n) const
{
    ...
    extern  ::wxString sipVH__core_128(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_128(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
uint sipwxListBox::GetCount() const
{
    ...
    extern uint sipVH__core_127(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
static void release_wxListBox(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxListBox[] = {{84, 255, 0}, {265, 255, 1}};
...
static PyMethodDef methods_wxListBox[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxListBox_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListBox_SendDestroyEvent)},
...
sipVariableDef variables_wxListBox[] = {
    ...
    {PropertyVariable, sipName_Selection, &methods_wxListBox[29], &methods_wxListBox[47], NULL, NULL},
