...
static void release_wxPNGHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPNGHandler[] = {{251, 255, 1}};
...
static PyMethodDef methods_wxPNGHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetImageCount), (PyCFunction)meth_wxPNGHandler_DoGetImageCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPNGHandler_DoGetImageCount)},
