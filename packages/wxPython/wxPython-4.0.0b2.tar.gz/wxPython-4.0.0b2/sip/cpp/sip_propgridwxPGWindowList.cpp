...
extern "C" {static void assign_wxPGWindowList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGWindowList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGWindowList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGWindowList *>(sipSrc);
}
