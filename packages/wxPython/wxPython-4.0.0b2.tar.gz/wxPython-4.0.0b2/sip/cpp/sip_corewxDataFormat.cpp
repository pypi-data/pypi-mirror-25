...
static PyObject *meth_wxDataFormat_GetType(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxDataFormat, &sipCpp))
        {
             ::wxDataFormatId sipRes = ( ::wxDataFormatId)0;
            int sipIsErr = 0;
        ...
        if (PyErr_Occurred()) sipIsErr = 1;
            ...
            return sipConvertFromEnum(sipRes,sipType_wxDataFormatId);
        }
    }
...
extern "C" {static void assign_wxDataFormat(void *, SIP_SSIZE_T, const void *);}
static void assign_wxDataFormat(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxDataFormat *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxDataFormat *>(sipSrc);
}
