...
static PyObject *meth_wxListItem_GetAlign(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxListItem, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxListColumnFormat);
        }
    }
...
extern "C" {static void assign_wxListItem(void *, SIP_SSIZE_T, const void *);}
static void assign_wxListItem(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxListItem *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxListItem *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxListItem[] = {{349, 255, 1}};
