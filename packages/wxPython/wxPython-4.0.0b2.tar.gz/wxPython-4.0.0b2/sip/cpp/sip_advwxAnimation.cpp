...
static void release_wxAnimation(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxAnimation(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAnimation(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAnimation *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAnimation *>(sipSrc);
}
