...
int sipwxTreeListItemComparator::Compare( ::wxTreeListCtrl*treelist,uint column, ::wxTreeListItem first, ::wxTreeListItem second)
{
    ...
    extern int sipVH__dataview_60(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxTreeListCtrl*,uint, ::wxTreeListItem, ::wxTreeListItem);

    return sipVH__dataview_60(sipGILState, 0, sipPySelf, sipMeth, treelist, column, first, second);
}
