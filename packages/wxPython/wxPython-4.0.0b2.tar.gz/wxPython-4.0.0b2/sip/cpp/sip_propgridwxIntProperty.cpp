...
PyDoc_STRVAR(doc_wxIntProperty_StringToValue, "StringToValue(variant, text, argFlags=0) -> bool\n"
    "\n"
...
static PyObject *meth_wxIntProperty_StringToValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1|i", &sipSelf, sipType_wxIntProperty, &sipCpp, sipType_wxPGVariant,&variant, &variantState, sipType_wxString,&text, &textState, &argFlags))
        {
            bool sipRes;
...
PyDoc_STRVAR(doc_wxIntProperty_IntToValue, "IntToValue(variant, number, argFlags=0) -> bool\n"
    "\n"
...
static PyObject *meth_wxIntProperty_IntToValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1i|i", &sipSelf, sipType_wxIntProperty, &sipCpp, sipType_wxPGVariant,&variant, &variantState, &number, &argFlags))
        {
            bool sipRes;
...
static void release_wxIntProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxIntProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxIntProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxIntProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxIntProperty *>(sipSrc);
}
