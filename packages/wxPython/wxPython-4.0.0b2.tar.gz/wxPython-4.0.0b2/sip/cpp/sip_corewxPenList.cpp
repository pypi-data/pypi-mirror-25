...
extern "C" {static void assign_wxPenList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPenList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPenList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPenList *>(sipSrc);
}
