...
static void release_wxRichTextFormattingDialogFactory(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextFormattingDialogFactory(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextFormattingDialogFactory(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextFormattingDialogFactory *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextFormattingDialogFactory *>(sipSrc);
}
