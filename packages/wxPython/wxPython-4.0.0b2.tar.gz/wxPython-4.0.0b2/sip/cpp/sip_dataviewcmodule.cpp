...
int sipVH__dataview_60(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxTreeListCtrl*treelist,uint column, ::wxTreeListItem first, ::wxTreeListItem second)
{
    int sipRes = 0;
...
bool sipVH__dataview_36(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxVariant& value)
{
    bool sipRes = 0;
