...
extern "C" {static void assign_wxAuiDockInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiDockInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiDockInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiDockInfo *>(sipSrc);
}
