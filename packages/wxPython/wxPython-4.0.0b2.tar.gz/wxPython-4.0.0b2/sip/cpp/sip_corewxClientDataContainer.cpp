...
static void release_wxClientDataContainer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxClientDataContainer(void *, SIP_SSIZE_T, const void *);}
static void assign_wxClientDataContainer(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxClientDataContainer *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxClientDataContainer *>(sipSrc);
}
