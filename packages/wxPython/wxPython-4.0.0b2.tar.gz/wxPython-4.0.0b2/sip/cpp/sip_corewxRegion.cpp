...
static PyObject *meth_wxRegion_Contains(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii", &sipSelf, sipType_wxRegion, &sipCpp, &x, &y))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxRegionContain);
        }
    }
...
extern "C" {static void assign_wxRegion(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRegion(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRegion *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRegion *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxRegion[] = {{199, 255, 1}};
