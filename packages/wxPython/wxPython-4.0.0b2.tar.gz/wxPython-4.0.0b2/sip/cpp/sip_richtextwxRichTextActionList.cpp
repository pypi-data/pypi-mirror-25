...
extern "C" {static void assign_wxRichTextActionList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextActionList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextActionList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextActionList *>(sipSrc);
}
