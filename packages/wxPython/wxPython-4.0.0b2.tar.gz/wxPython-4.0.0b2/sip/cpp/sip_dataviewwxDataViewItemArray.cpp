...
extern "C" {static void assign_wxDataViewItemArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxDataViewItemArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxDataViewItemArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxDataViewItemArray *>(sipSrc);
}
