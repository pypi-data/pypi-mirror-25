...
static void release_wxRichTextFieldTypeStandard(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextFieldTypeStandard(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextFieldTypeStandard(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextFieldTypeStandard *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextFieldTypeStandard *>(sipSrc);
}
