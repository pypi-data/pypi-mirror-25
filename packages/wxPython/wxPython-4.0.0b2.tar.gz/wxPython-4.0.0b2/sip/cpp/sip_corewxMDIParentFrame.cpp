 ...
 ::wxMDIClientWindow* sipwxMDIParentFrame::OnCreateClient()
{
    ...
    extern  ::wxMDIClientWindow* sipVH__core_171(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_171(sipGILState, 0, sipPySelf, sipMeth);
}
...
static void release_wxMDIParentFrame(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxMDIParentFrame[] = {{194, 255, 1}};
...
static PyMethodDef methods_wxMDIParentFrame[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxMDIParentFrame_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMDIParentFrame_SendDestroyEvent)},
