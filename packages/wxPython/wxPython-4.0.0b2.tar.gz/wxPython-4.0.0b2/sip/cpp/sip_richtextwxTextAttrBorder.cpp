...
extern "C" {static void assign_wxTextAttrBorder(void *, SIP_SSIZE_T, const void *);}
static void assign_wxTextAttrBorder(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxTextAttrBorder *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxTextAttrBorder *>(sipSrc);
}
