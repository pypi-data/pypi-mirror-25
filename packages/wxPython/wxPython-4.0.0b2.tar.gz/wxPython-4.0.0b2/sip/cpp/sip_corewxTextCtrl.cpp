...
static void release_wxTextCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxTextCtrl[] = {{84, 255, 0}, {516, 255, 1}};
...
static PyMethodDef methods_wxTextCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxTextCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextCtrl_SendDestroyEvent)},
