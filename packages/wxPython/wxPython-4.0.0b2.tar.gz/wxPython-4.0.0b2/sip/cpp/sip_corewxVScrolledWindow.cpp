...
static void release_wxVScrolledWindow(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxVScrolledWindow[] = {{364, 255, 0}, {555, 255, 1}};
...
static PyMethodDef methods_wxVScrolledWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_EstimateTotalHeight), (PyCFunction)meth_wxVScrolledWindow_EstimateTotalHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVScrolledWindow_EstimateTotalHeight)},
    ...
    {SIP_MLNAME_CAST(sipName_OnGetRowHeight), (PyCFunction)meth_wxVScrolledWindow_OnGetRowHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVScrolledWindow_OnGetRowHeight)},
    {SIP_MLNAME_CAST(sipName_OnGetRowsHeightHint), (PyCFunction)meth_wxVScrolledWindow_OnGetRowsHeightHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVScrolledWindow_OnGetRowsHeightHint)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxVScrolledWindow_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVScrolledWindow_SendDestroyEvent)},
