...
bool sipwxDropSource::GiveFeedback( ::wxDragResult effect)
{
    ...
    extern bool sipVH__core_66(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDragResult);

    return sipVH__core_66(sipGILState, 0, sipPySelf, sipMeth, effect);
}
 ...
 ::wxDragResult sipwxDropSource::DoDragDrop(int flags)
{
    ...
    extern  ::wxDragResult sipVH__core_65(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__core_65(sipGILState, 0, sipPySelf, sipMeth, flags);
}
...
static void release_wxDropSource(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
