...
void sipwxFileHistory::UseMenu( ::wxMenu*menu)
{
    ...
    extern void sipVH__core_211(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxMenu*);

    sipVH__core_211(sipGILState, 0, sipPySelf, sipMeth, menu);
}
...
void sipwxFileHistory::Save( ::wxConfigBase& config)
{
    ...
    extern void sipVH__core_213(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxConfigBase&);

    sipVH__core_213(sipGILState, 0, sipPySelf, sipMeth, config);
}
...
void sipwxFileHistory::RemoveFileFromHistory( ::size_t i)
{
    ...
    sipVH__core_122(sipGILState, 0, sipPySelf, sipMeth, i);
}
...
void sipwxFileHistory::Load(const  ::wxConfigBase& config)
{
    ...
    extern void sipVH__core_212(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxConfigBase&);

    sipVH__core_212(sipGILState, 0, sipPySelf, sipMeth, config);
}
 ...
 ::wxString sipwxFileHistory::GetHistoryFile( ::size_t index) const
{
    ...
    return sipVH__core_133(sipGILState, 0, sipPySelf, sipMeth, index);
}
...
static void release_wxFileHistory(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxFileHistory[] = {{349, 255, 1}};
