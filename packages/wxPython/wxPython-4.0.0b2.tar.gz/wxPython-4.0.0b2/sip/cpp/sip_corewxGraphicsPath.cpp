...
extern "C" {static void assign_wxGraphicsPath(void *, SIP_SSIZE_T, const void *);}
static void assign_wxGraphicsPath(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxGraphicsPath *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxGraphicsPath *>(sipSrc);
}
