...
void sipwxHtmlWinParser::SetDC( ::wxDC*dc,double pixel_scale)
{
    ...
    extern void sipVH__html_58(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC*,double);

    sipVH__html_58(sipGILState, 0, sipPySelf, sipMeth, dc, pixel_scale);
}
 ...
 ::wxFont* sipwxHtmlWinParser::CreateCurrentFont()
{
    ...
    extern  ::wxFont* sipVH__html_57(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__html_57(sipGILState, 0, sipPySelf, sipMeth);
}
...
static void release_wxHtmlWinParser(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxHtmlWinParser[] = {
    {SIP_MLNAME_CAST(sipName_AddTag), (PyCFunction)meth_wxHtmlWinParser_AddTag, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlWinParser_AddTag)},
