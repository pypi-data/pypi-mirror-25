...
static PyObject *meth_wxSashWindow_SashHitTest(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii|i", &sipSelf, sipType_wxSashWindow, &sipCpp, &x, &y, &tolerance))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxSashEdgePosition);
        }
    }
...
static void release_wxSashWindow(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxSashWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxSashWindow_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSashWindow_SendDestroyEvent)},
