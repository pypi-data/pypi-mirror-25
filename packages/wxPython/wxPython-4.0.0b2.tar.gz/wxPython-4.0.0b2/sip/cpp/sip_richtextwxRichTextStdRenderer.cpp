...
static void release_wxRichTextStdRenderer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextStdRenderer(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextStdRenderer(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextStdRenderer *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextStdRenderer *>(sipSrc);
}
