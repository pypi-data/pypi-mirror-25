...
static void release_wxPGLongStringDialogAdapter(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxPGLongStringDialogAdapter(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGLongStringDialogAdapter(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGLongStringDialogAdapter *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGLongStringDialogAdapter *>(sipSrc);
}
