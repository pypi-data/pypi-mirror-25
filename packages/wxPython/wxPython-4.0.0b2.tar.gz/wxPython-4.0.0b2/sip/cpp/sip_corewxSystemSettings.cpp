...
static PyObject *meth_wxSystemSettings_GetScreenType(PyObject *, PyObject *sipArgs)
{
...

    {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            return sipConvertFromEnum(sipRes,sipType_wxSystemScreenType);
        }
    }
...
extern "C" {static void assign_wxSystemSettings(void *, SIP_SSIZE_T, const void *);}
static void assign_wxSystemSettings(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxSystemSettings *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxSystemSettings *>(sipSrc);
}
