...
extern "C" {static void assign_wxPalette(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPalette(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPalette *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPalette *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxPalette[] = {{199, 255, 1}};
