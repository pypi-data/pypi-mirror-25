...
extern "C" {static void assign_wxImageArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxImageArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxImageArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxImageArray *>(sipSrc);
}
