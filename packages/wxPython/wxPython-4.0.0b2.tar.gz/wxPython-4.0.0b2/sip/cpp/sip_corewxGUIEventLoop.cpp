...
bool sipwxGUIEventLoop::YieldFor(long eventsToProcess)
{
    ...
    extern bool sipVH__core_92(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long);

    return sipVH__core_92(sipGILState, 0, sipPySelf, sipMeth, eventsToProcess);
}
...
void sipwxGUIEventLoop::Exit(int rc)
{
    ...
    sipVH__core_89(sipGILState, 0, sipPySelf, sipMeth, rc);
}
...
int sipwxGUIEventLoop::DispatchTimeout(unsigned long timeout)
{
    ...
    extern int sipVH__core_90(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, unsigned long);

    return sipVH__core_90(sipGILState, 0, sipPySelf, sipMeth, timeout);
}
...
bool sipwxGUIEventLoop::IsEventAllowedInsideYield( ::wxEventCategory cat) const
{
    ...
    extern bool sipVH__core_91(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxEventCategory);

    return sipVH__core_91(sipGILState, 0, sipPySelf, sipMeth, cat);
}
...
static void release_wxGUIEventLoop(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxGUIEventLoop[] = {{140, 255, 1}};
...
static PyMethodDef methods_wxGUIEventLoop[] = {
    ...
    {SIP_MLNAME_CAST(sipName_OnExit), (PyCFunction)meth_wxGUIEventLoop_OnExit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGUIEventLoop_OnExit)},
