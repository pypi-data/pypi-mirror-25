...
bool sipwxDialogLayoutAdapter::DoLayoutAdaptation( ::wxDialog*dialog)
{
    ...
    extern bool sipVH__core_165(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    return sipVH__core_165(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
...
static void release_wxDialogLayoutAdapter(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
