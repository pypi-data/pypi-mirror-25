...
extern "C" {static void assign_wxDataViewItemAttr(void *, SIP_SSIZE_T, const void *);}
static void assign_wxDataViewItemAttr(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxDataViewItemAttr *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxDataViewItemAttr *>(sipSrc);
}
