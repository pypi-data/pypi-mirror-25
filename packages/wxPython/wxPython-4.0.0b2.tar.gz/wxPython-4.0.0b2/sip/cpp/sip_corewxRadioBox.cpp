...
int sipwxRadioBox::FindString(const  ::wxString& string,bool bCase) const
{
    ...
    return sipVH__core_130(sipGILState, 0, sipPySelf, sipMeth, string, bCase);
}
...
static void release_wxRadioBox(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxRadioBox[] = {{84, 255, 0}, {266, 255, 1}};
...
static PyMethodDef methods_wxRadioBox[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxRadioBox_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_SendDestroyEvent)},
