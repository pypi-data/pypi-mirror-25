...
extern "C" {static void assign_wxAuiDockUIPartArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiDockUIPartArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiDockUIPartArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiDockUIPartArray *>(sipSrc);
}
