 ...
 ::wxPropertyGrid* sipwxPropertyGridManager::CreatePropertyGrid() const
{
    ...
    extern  ::wxPropertyGrid* sipVH__propgrid_81(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_81(sipGILState, 0, sipPySelf, sipMeth);
}
...
bool sipwxPropertyGridManager::RemovePage(int page)
{
    ...
    extern bool sipVH__propgrid_80(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__propgrid_80(sipGILState, 0, sipPySelf, sipMeth, page);
}
 ...
 ::wxPropertyGridPage* sipwxPropertyGridManager::InsertPage(int index,const  ::wxString& label,const  ::wxBitmap& bmp, ::wxPropertyGridPage*pageObj)
{
    ...
    extern  ::wxPropertyGridPage* sipVH__propgrid_79(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxString&,const  ::wxBitmap&, ::wxPropertyGridPage*);

    return sipVH__propgrid_79(sipGILState, 0, sipPySelf, sipMeth, index, label, bmp, pageObj);
}
...
static PyObject *meth_wxPropertyGridManager_AddPage(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|J1J9J8", &sipSelf, sipType_wxPropertyGridManager, &sipCpp, sipType_wxString,&label, &labelState, sipType_wxBitmap, &bmp, sipType_wxPropertyGridPage, &pageObj))
        {
...
static void release_wxPropertyGridManager(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxPropertyGridManager[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxPropertyGridManager_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGridManager_SendDestroyEvent)},
