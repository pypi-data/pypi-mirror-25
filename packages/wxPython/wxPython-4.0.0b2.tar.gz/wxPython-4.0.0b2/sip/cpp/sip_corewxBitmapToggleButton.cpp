...
static void release_wxBitmapToggleButton(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxBitmapToggleButton[] = {{525, 255, 1}};
...
static PyMethodDef methods_wxBitmapToggleButton[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxBitmapToggleButton_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBitmapToggleButton_SendDestroyEvent)},
