...
static PyObject *meth_wxMenu_Insert(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1iJ1J8|J1", &sipSelf, sipType_wxMenu, &sipCpp, sipType_size_t,&pos, &posState, &id, sipType_wxString,&text, &textState, sipType_wxMenu, &submenu, sipType_wxString,&help, &helpState))
        {
             ::wxMenuItem*sipRes;
...
static void release_wxMenu(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxMenu[] = {{142, 255, 1}};
...
static PyMethodDef methods_wxMenu[] = {
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxMenu_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMenu_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxMenu_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMenu_TryBefore)},
