...
static void release_wxMask(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxMask(void *, SIP_SSIZE_T, const void *);}
static void assign_wxMask(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxMask *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxMask *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxMask[] = {{349, 255, 1}};
