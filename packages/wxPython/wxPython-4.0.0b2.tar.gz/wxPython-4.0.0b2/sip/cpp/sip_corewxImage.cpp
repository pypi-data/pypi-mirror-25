...
static PyObject *meth_wxImage_GetType(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxImage, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxBitmapType);
        }
    }
...
static void release_wxImage(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxImage(void *, SIP_SSIZE_T, const void *);}
static void assign_wxImage(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxImage *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxImage *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxImage[] = {{349, 255, 1}};
