...
extern "C" {static void assign_wxFontList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFontList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFontList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFontList *>(sipSrc);
}
