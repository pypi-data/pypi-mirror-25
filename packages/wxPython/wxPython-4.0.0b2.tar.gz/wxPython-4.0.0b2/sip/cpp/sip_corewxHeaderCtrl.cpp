...
static void release_wxHeaderCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxHeaderCtrl[] = {{84, 255, 1}};
...
static PyMethodDef methods_wxHeaderCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxHeaderCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_SendDestroyEvent)},
