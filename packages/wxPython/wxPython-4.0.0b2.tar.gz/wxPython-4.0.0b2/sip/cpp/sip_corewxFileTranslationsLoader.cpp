...
static void release_wxFileTranslationsLoader(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxFileTranslationsLoader(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFileTranslationsLoader(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFileTranslationsLoader *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFileTranslationsLoader *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxFileTranslationsLoader[] = {{534, 255, 1}};
