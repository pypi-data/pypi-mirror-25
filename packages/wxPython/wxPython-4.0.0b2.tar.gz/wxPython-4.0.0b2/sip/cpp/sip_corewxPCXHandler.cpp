...
static void release_wxPCXHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPCXHandler[] = {{251, 255, 1}};
...
static PyMethodDef methods_wxPCXHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetImageCount), (PyCFunction)meth_wxPCXHandler_DoGetImageCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPCXHandler_DoGetImageCount)},
