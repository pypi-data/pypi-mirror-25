...
static void release_wxRichTextFontTable(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextFontTable(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextFontTable(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextFontTable *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextFontTable *>(sipSrc);
}
