...
static void release_wxPropertyCategory(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxPropertyCategory(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPropertyCategory(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPropertyCategory *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPropertyCategory *>(sipSrc);
}
