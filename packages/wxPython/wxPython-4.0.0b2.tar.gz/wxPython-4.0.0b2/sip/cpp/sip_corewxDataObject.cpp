...
bool sipwxDataObject::SetData(const  ::wxDataFormat& format, ::size_t len,const void*buf)
{
    ...
    extern bool sipVH__core_48(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxDataFormat&, ::size_t,const void*);

    return sipVH__core_48(sipGILState, 0, sipPySelf, sipMeth, format, len, buf);
}
 ...
 ::size_t sipwxDataObject::GetDataSize(const  ::wxDataFormat& format) const
{
    ...
    extern  ::size_t sipVH__core_45(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxDataFormat&);

    return sipVH__core_45(sipGILState, 0, sipPySelf, sipMeth, format);
}
...
bool sipwxDataObject::GetDataHere(const  ::wxDataFormat& format,void*buf) const
{
    ...
    extern bool sipVH__core_44(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxDataFormat&,void*);

    return sipVH__core_44(sipGILState, 0, sipPySelf, sipMeth, format, buf);
}
...
static void release_wxDataObject(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEnumMemberDef enummembers_wxDataObject[] = {
    {sipName_Both, static_cast<int>( ::wxDataObject::Both), 99},
    {sipName_Get, static_cast<int>( ::wxDataObject::Get), 99},
    {sipName_Set, static_cast<int>( ::wxDataObject::Set), 99},
};
