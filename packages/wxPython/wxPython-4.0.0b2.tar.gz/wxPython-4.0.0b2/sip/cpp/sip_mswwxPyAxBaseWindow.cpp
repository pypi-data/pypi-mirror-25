...
static void release_wxPyAxBaseWindow(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPyAxBaseWindow[] = {{10, 0, 1}};
...
static PyMethodDef methods_wxPyAxBaseWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxPyAxBaseWindow_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPyAxBaseWindow_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxPyAxBaseWindow_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPyAxBaseWindow_DoGetBestSize)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxPyAxBaseWindow_ProcessEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPyAxBaseWindow_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxPyAxBaseWindow_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPyAxBaseWindow_SendDestroyEvent)},
