 ...
 ::wxPoint sipwxHtmlWindowInterface::HTMLCoordsToWindow( ::wxHtmlCell*cell,const  ::wxPoint& pos) const
{
 ...
 ::wxHtmlOpeningStatus sipwxHtmlWindowInterface::OnHTMLOpeningURL( ::wxHtmlURLType type,const  ::wxString& url, ::wxString*redirect) const
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
PyDoc_STRVAR(doc_wxHtmlWindowInterface_OnHTMLOpeningURL, "OnHTMLOpeningURL(type, url, redirect) -> HtmlOpeningStatus\n"
    "\n"
...
static PyObject *meth_wxHtmlWindowInterface_OnHTMLOpeningURL(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BEJ1J0", &sipSelf, sipType_wxHtmlWindowInterface, &sipCpp, sipType_wxHtmlURLType, &type, sipType_wxString,&url, &urlState, sipType_wxString,&redirect, &redirectState))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = sipCpp->OnHTMLOpeningURL(type,*url,redirect);
            Py_END_ALLOW_THREADS
...
static void release_wxHtmlWindowInterface(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
