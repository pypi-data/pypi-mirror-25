...
static void release_wxNonOwnedWindow(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxNonOwnedWindow[] = {{561, 255, 1}};
...
static PyMethodDef methods_wxNonOwnedWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxNonOwnedWindow_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxNonOwnedWindow_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxNonOwnedWindow_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxNonOwnedWindow_DoGetBestSize)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxNonOwnedWindow_ProcessEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxNonOwnedWindow_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxNonOwnedWindow_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxNonOwnedWindow_SendDestroyEvent)},
