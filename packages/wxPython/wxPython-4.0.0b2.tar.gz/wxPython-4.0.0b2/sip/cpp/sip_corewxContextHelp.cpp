...
static void release_wxContextHelp(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxContextHelp(void *, SIP_SSIZE_T, const void *);}
static void assign_wxContextHelp(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxContextHelp *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxContextHelp *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxContextHelp[] = {{349, 255, 1}};
