...
PyDoc_STRVAR(doc_wxFloatProperty_StringToValue, "StringToValue(variant, text, argFlags=0) -> bool\n"
    "\n"
...
static PyObject *meth_wxFloatProperty_StringToValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1|i", &sipSelf, sipType_wxFloatProperty, &sipCpp, sipType_wxPGVariant,&variant, &variantState, sipType_wxString,&text, &textState, &argFlags))
        {
            bool sipRes;
...
static void release_wxFloatProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxFloatProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFloatProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFloatProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFloatProperty *>(sipSrc);
}
