...
static void release_wxHScrolledWindow(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxHScrolledWindow[] = {{364, 255, 0}, {552, 255, 1}};
...
static PyMethodDef methods_wxHScrolledWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_EstimateTotalWidth), (PyCFunction)meth_wxHScrolledWindow_EstimateTotalWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHScrolledWindow_EstimateTotalWidth)},
    ...
    {SIP_MLNAME_CAST(sipName_OnGetColumnWidth), (PyCFunction)meth_wxHScrolledWindow_OnGetColumnWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHScrolledWindow_OnGetColumnWidth)},
    {SIP_MLNAME_CAST(sipName_OnGetColumnsWidthHint), (PyCFunction)meth_wxHScrolledWindow_OnGetColumnsWidthHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHScrolledWindow_OnGetColumnsWidthHint)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxHScrolledWindow_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHScrolledWindow_SendDestroyEvent)},
