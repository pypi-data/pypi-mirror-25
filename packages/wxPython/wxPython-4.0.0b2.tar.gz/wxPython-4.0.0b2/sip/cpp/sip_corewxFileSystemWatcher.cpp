...
static void release_wxFileSystemWatcher(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxFileSystemWatcher[] = {{142, 255, 1}};
...
static PyMethodDef methods_wxFileSystemWatcher[] = {
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxFileSystemWatcher_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileSystemWatcher_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxFileSystemWatcher_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileSystemWatcher_TryBefore)}
};
