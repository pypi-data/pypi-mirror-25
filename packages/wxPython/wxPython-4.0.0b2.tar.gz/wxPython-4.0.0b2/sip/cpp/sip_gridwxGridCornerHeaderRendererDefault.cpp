...
static void release_wxGridCornerHeaderRendererDefault(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxGridCornerHeaderRendererDefault(void *, SIP_SSIZE_T, const void *);}
static void assign_wxGridCornerHeaderRendererDefault(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxGridCornerHeaderRendererDefault *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxGridCornerHeaderRendererDefault *>(sipSrc);
}
