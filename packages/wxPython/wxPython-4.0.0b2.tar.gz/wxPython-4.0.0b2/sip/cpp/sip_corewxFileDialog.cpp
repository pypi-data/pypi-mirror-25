...
static void release_wxFileDialog(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxFileDialog[] = {{115, 255, 1}};
...
static PyMethodDef methods_wxFileDialog[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxFileDialog_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileDialog_SendDestroyEvent)},
