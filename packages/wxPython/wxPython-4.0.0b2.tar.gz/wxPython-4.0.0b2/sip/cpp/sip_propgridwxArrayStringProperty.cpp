 ...
 ::wxPGArrayEditorDialog* sipwxArrayStringProperty::CreateEditorDialog()
{
    ...
    extern  ::wxPGArrayEditorDialog* sipVH__propgrid_67(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
bool sipwxArrayStringProperty::OnButtonClick( ::wxPropertyGrid*propgrid, ::wxWindow*primary,const  ::wxChar*cbt)
{
    ...
    extern bool sipVH__propgrid_66(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPropertyGrid*, ::wxWindow*,const  ::wxChar*);

    return sipVH__propgrid_66(sipGILState, 0, sipPySelf, sipMeth, propgrid, primary, cbt);
}
...
bool sipwxArrayStringProperty::OnCustomStringEdit( ::wxWindow*parent, ::wxString& value)
{
    ...
    extern bool sipVH__propgrid_65(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxString&);

    return sipVH__propgrid_65(sipGILState, 0, sipPySelf, sipMeth, parent, value);
}
...
void sipwxArrayStringProperty::ConvertArrayToString(const  ::wxArrayString& arr, ::wxString*pString,const  ::wxUniChar& delimiter) const
{
    ...
    extern void sipVH__propgrid_64(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayString&, ::wxString*,const  ::wxUniChar&);

    sipVH__propgrid_64(sipGILState, 0, sipPySelf, sipMeth, arr, pString, delimiter);
}
...
PyDoc_STRVAR(doc_wxArrayStringProperty_StringToValue, "StringToValue(variant, text, argFlags=0) -> bool\n"
    "\n"
...
static PyObject *meth_wxArrayStringProperty_StringToValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1|i", &sipSelf, sipType_wxArrayStringProperty, &sipCpp, sipType_wxPGVariant,&variant, &variantState, sipType_wxString,&text, &textState, &argFlags))
        {
            bool sipRes;
...
static void release_wxArrayStringProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxArrayStringProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxArrayStringProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxArrayStringProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxArrayStringProperty *>(sipSrc);
}
