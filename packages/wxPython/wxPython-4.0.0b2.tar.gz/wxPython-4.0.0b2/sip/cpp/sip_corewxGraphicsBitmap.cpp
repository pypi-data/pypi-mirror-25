...
extern "C" {static void assign_wxGraphicsBitmap(void *, SIP_SSIZE_T, const void *);}
static void assign_wxGraphicsBitmap(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxGraphicsBitmap *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxGraphicsBitmap *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxGraphicsBitmap[] = {{216, 255, 1}};
