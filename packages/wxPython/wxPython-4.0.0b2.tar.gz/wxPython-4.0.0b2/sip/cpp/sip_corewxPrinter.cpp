...
bool sipwxPrinter::Setup( ::wxWindow*parent)
{
    ...
    extern bool sipVH__core_115(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_115(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
void sipwxPrinter::ReportError( ::wxWindow*parent, ::wxPrintout*printout,const  ::wxString& message)
{
    ...
    extern void sipVH__core_200(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*,const  ::wxString&);

    sipVH__core_200(sipGILState, 0, sipPySelf, sipMeth, parent, printout, message);
}
 ...
 ::wxDC* sipwxPrinter::PrintDialog( ::wxWindow*parent)
{
    ...
    extern  ::wxDC* sipVH__core_199(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_199(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
bool sipwxPrinter::Print( ::wxWindow*parent, ::wxPrintout*printout,bool prompt)
{
    ...
    extern bool sipVH__core_198(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*,bool);

    return sipVH__core_198(sipGILState, 0, sipPySelf, sipMeth, parent, printout, prompt);
}
 ...
 ::wxPrintDialogData& sipwxPrinter::GetPrintDialogData() const
{
    ...
    extern  ::wxPrintDialogData& sipVH__core_197(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_197(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxPrintAbortDialog* sipwxPrinter::CreateAbortWindow( ::wxWindow*parent, ::wxPrintout*printout)
{
    ...
    extern  ::wxPrintAbortDialog* sipVH__core_196(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*);

    return sipVH__core_196(sipGILState, 0, sipPySelf, sipMeth, parent, printout);
}
...
static PyObject *meth_wxPrinter_GetLastError(PyObject *, PyObject *sipArgs)
{
...

    {
        if (sipParseArgs(&sipParseErr, sipArgs, ""))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxPrinterError);
        }
    }
...
static void release_wxPrinter(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPrinter[] = {{349, 255, 1}};
