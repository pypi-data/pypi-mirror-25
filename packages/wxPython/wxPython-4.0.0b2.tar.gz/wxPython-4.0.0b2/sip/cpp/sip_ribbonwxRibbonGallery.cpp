...
static PyObject *meth_wxRibbonGallery_GetUpButtonState(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxRibbonGallery, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxRibbonGalleryButtonState);
        }
    }
...
static void release_wxRibbonGallery(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxRibbonGallery[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetNextLargerSize), (PyCFunction)meth_wxRibbonGallery_DoGetNextLargerSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonGallery_DoGetNextLargerSize)},
    {SIP_MLNAME_CAST(sipName_DoGetNextSmallerSize), (PyCFunction)meth_wxRibbonGallery_DoGetNextSmallerSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonGallery_DoGetNextSmallerSize)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxRibbonGallery_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonGallery_SendDestroyEvent)},
