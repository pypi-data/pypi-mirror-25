...
extern "C" {static void assign_wxHtmlHelpDataItems(void *, SIP_SSIZE_T, const void *);}
static void assign_wxHtmlHelpDataItems(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxHtmlHelpDataItems *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxHtmlHelpDataItems *>(sipSrc);
}
