...
extern "C" {static void assign_wxVersionInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxVersionInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxVersionInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxVersionInfo *>(sipSrc);
}
