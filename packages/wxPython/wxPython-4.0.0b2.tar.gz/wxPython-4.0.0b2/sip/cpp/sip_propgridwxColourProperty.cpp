...
static void release_wxColourProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxColourProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxColourProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxColourProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxColourProperty *>(sipSrc);
}
