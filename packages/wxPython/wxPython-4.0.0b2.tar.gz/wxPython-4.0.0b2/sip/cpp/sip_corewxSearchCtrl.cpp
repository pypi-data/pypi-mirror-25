...
static void release_wxSearchCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxSearchCtrl[] = {{84, 255, 1}};
...
static PyMethodDef methods_wxSearchCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxSearchCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSearchCtrl_SendDestroyEvent)},
