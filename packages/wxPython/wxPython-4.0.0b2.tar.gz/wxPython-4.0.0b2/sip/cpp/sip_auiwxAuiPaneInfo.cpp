...
extern "C" {static void assign_wxAuiPaneInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiPaneInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiPaneInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiPaneInfo *>(sipSrc);
}
