...
static void release_wxListView(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxListView[] = {{284, 255, 1}};
...
static PyMethodDef methods_wxListView[] = {
    ...
    {SIP_MLNAME_CAST(sipName_OnGetItemAttr), (PyCFunction)meth_wxListView_OnGetItemAttr, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListView_OnGetItemAttr)},
    {SIP_MLNAME_CAST(sipName_OnGetItemColumnImage), (PyCFunction)meth_wxListView_OnGetItemColumnImage, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListView_OnGetItemColumnImage)},
    {SIP_MLNAME_CAST(sipName_OnGetItemImage), (PyCFunction)meth_wxListView_OnGetItemImage, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListView_OnGetItemImage)},
    {SIP_MLNAME_CAST(sipName_OnGetItemText), (PyCFunction)meth_wxListView_OnGetItemText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListView_OnGetItemText)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxListView_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxListView_SendDestroyEvent)},
