...
extern "C" {static void assign_wxFontInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFontInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFontInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFontInfo *>(sipSrc);
}
