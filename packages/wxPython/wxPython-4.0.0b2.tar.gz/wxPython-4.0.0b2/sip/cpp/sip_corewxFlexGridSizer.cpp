...
static PyObject *meth_wxFlexGridSizer_GetNonFlexibleGrowMode(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxFlexGridSizer, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxFlexSizerGrowMode);
        }
    }
...
static void release_wxFlexGridSizer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxFlexGridSizer[] = {{221, 255, 1}};
