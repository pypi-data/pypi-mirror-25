...
extern "C" {static void assign_wxWindowList(void *, SIP_SSIZE_T, const void *);}
static void assign_wxWindowList(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxWindowList *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxWindowList *>(sipSrc);
}
