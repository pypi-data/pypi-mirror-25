...
static void release_wxLogStderr(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxLogStderr[] = {{293, 255, 1}};


static PyMethodDef methods_wxLogStderr[] = {
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogStderr_DoLogRecord, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogStderr_DoLogRecord)},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogStderr_DoLogText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogStderr_DoLogText)},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogStderr_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogStderr_DoLogTextAtLevel)}
};
