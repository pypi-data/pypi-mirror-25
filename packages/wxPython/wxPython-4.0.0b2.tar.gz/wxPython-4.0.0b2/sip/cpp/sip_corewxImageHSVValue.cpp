...
extern "C" {static void assign_wxImage_HSVValue(void *, SIP_SSIZE_T, const void *);}
static void assign_wxImage_HSVValue(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxImage::HSVValue *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxImage::HSVValue *>(sipSrc);
}
