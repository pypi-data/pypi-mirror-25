...
static void release_wxRibbonAUIArtProvider(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRibbonAUIArtProvider(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRibbonAUIArtProvider(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRibbonAUIArtProvider *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRibbonAUIArtProvider *>(sipSrc);
}
