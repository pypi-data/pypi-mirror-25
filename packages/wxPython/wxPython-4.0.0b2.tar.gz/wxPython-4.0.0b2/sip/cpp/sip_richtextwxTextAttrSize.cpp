...
extern "C" {static void assign_wxTextAttrSize(void *, SIP_SSIZE_T, const void *);}
static void assign_wxTextAttrSize(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxTextAttrSize *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxTextAttrSize *>(sipSrc);
}
