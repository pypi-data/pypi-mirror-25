...
extern "C" {static void assign_wxRichTextContextMenuPropertiesInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextContextMenuPropertiesInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextContextMenuPropertiesInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextContextMenuPropertiesInfo *>(sipSrc);
}
