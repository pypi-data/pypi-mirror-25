...
static void release_wxIconBundle(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxIconBundle(void *, SIP_SSIZE_T, const void *);}
static void assign_wxIconBundle(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxIconBundle *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxIconBundle *>(sipSrc);
}
