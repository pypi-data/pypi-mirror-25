...
static PyObject *meth_wxTextAttrDimension_GetUnits(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxTextAttrDimension, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxTextAttrUnits);
        }
    }
...
static PyObject *meth_wxTextAttrDimension_GetPosition(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxTextAttrDimension, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxTextBoxAttrPosition);
        }
    }
...
extern "C" {static void assign_wxTextAttrDimension(void *, SIP_SSIZE_T, const void *);}
static void assign_wxTextAttrDimension(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxTextAttrDimension *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxTextAttrDimension *>(sipSrc);
}
