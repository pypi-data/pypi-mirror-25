...
void sipwxPrintPreview::SetZoom(int percent)
{
    ...
    sipVH__core_89(sipGILState, 0, sipPySelf, sipMeth, percent);
}
...
void sipwxPrintPreview::SetPrintout( ::wxPrintout*printout)
{
    ...
    extern void sipVH__core_195(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPrintout*);

    sipVH__core_195(sipGILState, 0, sipPySelf, sipMeth, printout);
}
...
void sipwxPrintPreview::SetFrame( ::wxFrame*frame)
{
    ...
    extern void sipVH__core_40(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxFrame*);

    sipVH__core_40(sipGILState, 0, sipPySelf, sipMeth, frame);
}
...
bool sipwxPrintPreview::SetCurrentPage(int pageNum)
{
    ...
    return sipVH__core_123(sipGILState, 0, sipPySelf, sipMeth, pageNum);
}
...
void sipwxPrintPreview::SetCanvas( ::wxPreviewCanvas*window)
{
    ...
    extern void sipVH__core_194(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPreviewCanvas*);

    sipVH__core_194(sipGILState, 0, sipPySelf, sipMeth, window);
}
...
bool sipwxPrintPreview::Print(bool prompt)
{
    ...
    return sipVH__core_78(sipGILState, 0, sipPySelf, sipMeth, prompt);
}
...
bool sipwxPrintPreview::PaintPage( ::wxPreviewCanvas*canvas, ::wxDC& dc)
{
    ...
    extern bool sipVH__core_193(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPreviewCanvas*, ::wxDC&);

    return sipVH__core_193(sipGILState, 0, sipPySelf, sipMeth, canvas, dc);
}
 ...
 ::wxPrintout* sipwxPrintPreview::GetPrintoutForPrinting() const
{
    ...
    extern  ::wxPrintout* sipVH__core_192(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_192(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxFrame* sipwxPrintPreview::GetFrame() const
{
    ...
    extern  ::wxFrame* sipVH__core_191(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxPreviewCanvas* sipwxPrintPreview::GetCanvas() const
{
    ...
    extern  ::wxPreviewCanvas* sipVH__core_190(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
static void release_wxPrintPreview(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPrintPreview[] = {{349, 255, 1}};
