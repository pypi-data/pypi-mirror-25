...
static PyObject *meth_wxMouseEvent_GetWheelAxis(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxMouseEvent, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxMouseWheelAxis);
        }
    }
...
static void release_wxMouseEvent(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxMouseEvent[] = {{135, 255, 0}, {336, 255, 1}};
