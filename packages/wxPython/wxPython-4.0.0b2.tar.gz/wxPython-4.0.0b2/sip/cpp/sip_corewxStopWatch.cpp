...
extern "C" {static void assign_wxStopWatch(void *, SIP_SSIZE_T, const void *);}
static void assign_wxStopWatch(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxStopWatch *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxStopWatch *>(sipSrc);
}
