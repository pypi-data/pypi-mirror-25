 ...
 ::wxObject* sipwxNumericPropertyValidator::Clone() const
{
    ...
    extern  ::wxObject* sipVH__propgrid_60(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_60(sipGILState, 0, sipPySelf, sipMeth);
}
...
static void release_wxNumericPropertyValidator(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxNumericPropertyValidator[] = {
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxNumericPropertyValidator_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxNumericPropertyValidator_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxNumericPropertyValidator_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxNumericPropertyValidator_TryBefore)},
