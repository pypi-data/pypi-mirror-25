...
extern "C" {static void assign_wxAuiDockUIPart(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiDockUIPart(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiDockUIPart *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiDockUIPart *>(sipSrc);
}
