...
static void release__ScrolledWindowBase(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers__ScrolledWindowBase[] = {{561, 255, 1}};
...
static PyMethodDef methods__ScrolledWindowBase[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth__ScrolledWindowBase_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc__ScrolledWindowBase_SendDestroyEvent)},
