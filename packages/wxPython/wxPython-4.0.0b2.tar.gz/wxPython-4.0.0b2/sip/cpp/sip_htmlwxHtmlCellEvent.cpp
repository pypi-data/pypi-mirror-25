 ...
 ::wxEventCategory sipwxHtmlCellEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__html_52(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__html_52(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxEvent* sipwxHtmlCellEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__html_51(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__html_51(sipGILState, 0, sipPySelf, sipMeth);
}
...
static void release_wxHtmlCellEvent(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
