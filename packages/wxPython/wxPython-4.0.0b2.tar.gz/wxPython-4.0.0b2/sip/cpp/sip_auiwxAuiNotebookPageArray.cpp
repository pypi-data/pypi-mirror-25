...
extern "C" {static void assign_wxAuiNotebookPageArray(void *, SIP_SSIZE_T, const void *);}
static void assign_wxAuiNotebookPageArray(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxAuiNotebookPageArray *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxAuiNotebookPageArray *>(sipSrc);
}
