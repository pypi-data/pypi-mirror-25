...
void sipwxSimpleHelpProvider::AddHelp( ::wxWindowBase*window,const  ::wxString& text)
{
    ...
    extern void sipVH__core_179(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindowBase*,const  ::wxString&);

    sipVH__core_179(sipGILState, 0, sipPySelf, sipMeth, window, text);
}
...
void sipwxSimpleHelpProvider::AddHelp( ::wxWindowID id,const  ::wxString& text)
{
    ...
    extern void sipVH__core_180(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindowID,const  ::wxString&);

    sipVH__core_180(sipGILState, 0, sipPySelf, sipMeth, id, text);
}
 ...
 ::wxString sipwxSimpleHelpProvider::GetHelp(const  ::wxWindowBase*window)
{
    ...
    extern  ::wxString sipVH__core_181(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxWindowBase*);

    return sipVH__core_181(sipGILState, 0, sipPySelf, sipMeth, window);
}
...
void sipwxSimpleHelpProvider::RemoveHelp( ::wxWindowBase*window)
{
    ...
    sipVH__core_101(sipGILState, 0, sipPySelf, sipMeth, window);
}
...
bool sipwxSimpleHelpProvider::ShowHelp( ::wxWindowBase*window)
{
    ...
    extern bool sipVH__core_182(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindowBase*);

    return sipVH__core_182(sipGILState, 0, sipPySelf, sipMeth, window);
}
...
bool sipwxSimpleHelpProvider::ShowHelpAtPoint( ::wxWindowBase*window,const  ::wxPoint& point, ::wxHelpEvent::Origin origin)
{
    ...
    extern bool sipVH__core_183(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindowBase*,const  ::wxPoint&, ::wxHelpEvent::Origin);

    return sipVH__core_183(sipGILState, 0, sipPySelf, sipMeth, window, point, origin);
}
...
static void release_wxSimpleHelpProvider(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxSimpleHelpProvider(void *, SIP_SSIZE_T, const void *);}
static void assign_wxSimpleHelpProvider(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxSimpleHelpProvider *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxSimpleHelpProvider *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxSimpleHelpProvider[] = {{236, 255, 1}};
