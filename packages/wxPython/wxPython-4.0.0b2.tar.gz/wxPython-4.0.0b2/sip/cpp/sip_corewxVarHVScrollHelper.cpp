...
static void release_wxVarHVScrollHelper(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxVarHVScrollHelper[] = {{555, 255, 0}, {552, 255, 1}};
...
static PyMethodDef methods_wxVarHVScrollHelper[] = {
    ...
    {SIP_MLNAME_CAST(sipName_EstimateTotalHeight), (PyCFunction)meth_wxVarHVScrollHelper_EstimateTotalHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVarHVScrollHelper_EstimateTotalHeight)},
    {SIP_MLNAME_CAST(sipName_EstimateTotalSize), meth_wxVarHVScrollHelper_EstimateTotalSize, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_EstimateTotalWidth), (PyCFunction)meth_wxVarHVScrollHelper_EstimateTotalWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVarHVScrollHelper_EstimateTotalWidth)},
    ...
    {SIP_MLNAME_CAST(sipName_OnGetColumnWidth), (PyCFunction)meth_wxVarHVScrollHelper_OnGetColumnWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVarHVScrollHelper_OnGetColumnWidth)},
    {SIP_MLNAME_CAST(sipName_OnGetColumnsWidthHint), (PyCFunction)meth_wxVarHVScrollHelper_OnGetColumnsWidthHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVarHVScrollHelper_OnGetColumnsWidthHint)},
    {SIP_MLNAME_CAST(sipName_OnGetRowHeight), (PyCFunction)meth_wxVarHVScrollHelper_OnGetRowHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVarHVScrollHelper_OnGetRowHeight)},
    {SIP_MLNAME_CAST(sipName_OnGetRowsHeightHint), (PyCFunction)meth_wxVarHVScrollHelper_OnGetRowsHeightHint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxVarHVScrollHelper_OnGetRowsHeightHint)},
