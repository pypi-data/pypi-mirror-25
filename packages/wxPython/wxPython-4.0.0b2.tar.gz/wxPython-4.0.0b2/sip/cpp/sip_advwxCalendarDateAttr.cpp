...
static PyObject *meth_wxCalendarDateAttr_GetBorder(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxCalendarDateAttr, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxCalendarDateBorder);
        }
    }
...
extern "C" {static void assign_wxCalendarDateAttr(void *, SIP_SSIZE_T, const void *);}
static void assign_wxCalendarDateAttr(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxCalendarDateAttr *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxCalendarDateAttr *>(sipSrc);
}
