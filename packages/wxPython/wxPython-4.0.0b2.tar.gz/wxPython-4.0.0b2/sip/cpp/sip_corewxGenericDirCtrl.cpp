...
static void release_wxGenericDirCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxGenericDirCtrl[] = {{84, 255, 1}};
...
static PyMethodDef methods_wxGenericDirCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxGenericDirCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SendDestroyEvent)},
