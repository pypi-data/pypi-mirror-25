...
extern "C" {static void assign_wxHtmlSelection(void *, SIP_SSIZE_T, const void *);}
static void assign_wxHtmlSelection(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxHtmlSelection *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxHtmlSelection *>(sipSrc);
}
