...
static void release_wxClipboard(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxClipboard(void *, SIP_SSIZE_T, const void *);}
static void assign_wxClipboard(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxClipboard *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxClipboard *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxClipboard[] = {{349, 255, 1}};
