...
extern "C" {static void assign_wxPGChoices(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGChoices(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGChoices *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGChoices *>(sipSrc);
}
