...
static PyObject *meth_wxAuiMDIParentFrame_SetArtProvider(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxAuiMDIParentFrame, &sipCpp, sipType_wxAuiTabArt, &provider))
        {
            PyErr_Clear();
...
static PyObject *meth_wxAuiMDIParentFrame_SetMenuBar(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxAuiMDIParentFrame, &sipCpp, sipType_wxMenuBar, &menuBar))
        {
            PyErr_Clear();
...
static void release_wxAuiMDIParentFrame(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxAuiMDIParentFrame[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxAuiMDIParentFrame_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiMDIParentFrame_SendDestroyEvent)},
