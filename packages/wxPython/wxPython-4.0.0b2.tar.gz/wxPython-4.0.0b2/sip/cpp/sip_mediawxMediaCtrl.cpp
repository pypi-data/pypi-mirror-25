...
static PyObject *meth_wxMediaCtrl_GetState(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxMediaCtrl, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxMediaState);
        }
    }
...
static void release_wxMediaCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxMediaCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxMediaCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMediaCtrl_SendDestroyEvent)},
