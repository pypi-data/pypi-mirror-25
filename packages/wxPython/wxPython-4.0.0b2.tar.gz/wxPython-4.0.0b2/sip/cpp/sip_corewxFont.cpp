...
extern "C" {static void assign_wxFont(void *, SIP_SSIZE_T, const void *);}
static void assign_wxFont(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxFont *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxFont *>(sipSrc);
}
