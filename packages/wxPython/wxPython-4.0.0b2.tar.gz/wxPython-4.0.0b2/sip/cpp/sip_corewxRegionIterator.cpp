...
extern "C" {static void assign_wxRegionIterator(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRegionIterator(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRegionIterator *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRegionIterator *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxRegionIterator[] = {{349, 255, 1}};
