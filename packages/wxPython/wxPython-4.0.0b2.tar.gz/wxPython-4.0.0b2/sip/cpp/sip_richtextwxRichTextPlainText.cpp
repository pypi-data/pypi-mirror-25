...
static void release_wxRichTextPlainText(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextPlainText(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextPlainText(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextPlainText *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextPlainText *>(sipSrc);
}
