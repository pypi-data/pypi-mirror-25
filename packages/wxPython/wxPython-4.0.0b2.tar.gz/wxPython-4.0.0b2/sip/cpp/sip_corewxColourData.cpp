...
static void release_wxColourData(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxColourData(void *, SIP_SSIZE_T, const void *);}
static void assign_wxColourData(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxColourData *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxColourData *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxColourData[] = {{349, 255, 1}};
