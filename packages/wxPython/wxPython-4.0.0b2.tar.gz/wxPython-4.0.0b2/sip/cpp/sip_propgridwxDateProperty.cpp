...
PyDoc_STRVAR(doc_wxDateProperty_StringToValue, "StringToValue(variant, text, argFlags=0) -> bool\n"
    "\n"
...
static PyObject *meth_wxDateProperty_StringToValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1|i", &sipSelf, sipType_wxDateProperty, &sipCpp, sipType_wxPGVariant,&variant, &variantState, sipType_wxString,&text, &textState, &argFlags))
        {
            bool sipRes;
...
static void release_wxDateProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxDateProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxDateProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxDateProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxDateProperty *>(sipSrc);
}
