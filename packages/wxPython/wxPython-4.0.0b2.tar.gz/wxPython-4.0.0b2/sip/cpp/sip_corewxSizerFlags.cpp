...
extern "C" {static void assign_wxSizerFlags(void *, SIP_SSIZE_T, const void *);}
static void assign_wxSizerFlags(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxSizerFlags *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxSizerFlags *>(sipSrc);
}
