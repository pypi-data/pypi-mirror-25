...
static sipEnumMemberDef enummembers_wxStandardPaths[] = {
    {sipName_ResourceCat_Messages, static_cast<int>( ::wxStandardPaths::ResourceCat_Messages), 473},
    {sipName_ResourceCat_None, static_cast<int>( ::wxStandardPaths::ResourceCat_None), 473},
};
