...
PyDoc_STRVAR(doc_wxBoolProperty_StringToValue, "StringToValue(variant, text, argFlags=0) -> bool\n"
    "\n"
...
static PyObject *meth_wxBoolProperty_StringToValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1|i", &sipSelf, sipType_wxBoolProperty, &sipCpp, sipType_wxPGVariant,&variant, &variantState, sipType_wxString,&text, &textState, &argFlags))
        {
            bool sipRes;
...
PyDoc_STRVAR(doc_wxBoolProperty_IntToValue, "IntToValue(variant, number, argFlags=0) -> bool\n"
    "\n"
...
static PyObject *meth_wxBoolProperty_IntToValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1i|i", &sipSelf, sipType_wxBoolProperty, &sipCpp, sipType_wxPGVariant,&variant, &variantState, &number, &argFlags))
        {
            bool sipRes;
...
static void release_wxBoolProperty(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxBoolProperty(void *, SIP_SSIZE_T, const void *);}
static void assign_wxBoolProperty(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxBoolProperty *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxBoolProperty *>(sipSrc);
}
