...
extern "C" {static void assign_wxComboCtrlFeatures(void *, SIP_SSIZE_T, const void *);}
static void assign_wxComboCtrlFeatures(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxComboCtrlFeatures *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxComboCtrlFeatures *>(sipSrc);
}
