...
static void release_wxRichTextImage(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxRichTextImage(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextImage(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextImage *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextImage *>(sipSrc);
}
