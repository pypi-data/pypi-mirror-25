...
void sipwxPreferencesEditor::Show( ::wxWindow*parent)
{
    ...
    extern void sipVH__core_177(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    sipVH__core_177(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
static void release_wxPreferencesEditor(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
