...
extern "C" {static void assign_wxRichTextHeaderFooterData(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextHeaderFooterData(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextHeaderFooterData *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextHeaderFooterData *>(sipSrc);
}
