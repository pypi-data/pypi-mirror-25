...
static PyObject *meth_wxAuiMDIChildFrame_SetMenuBar(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxAuiMDIChildFrame, &sipCpp, sipType_wxMenuBar, &menuBar))
        {
            PyErr_Clear();
...
static void release_wxAuiMDIChildFrame(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxAuiMDIChildFrame[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxAuiMDIChildFrame_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiMDIChildFrame_SendDestroyEvent)},
