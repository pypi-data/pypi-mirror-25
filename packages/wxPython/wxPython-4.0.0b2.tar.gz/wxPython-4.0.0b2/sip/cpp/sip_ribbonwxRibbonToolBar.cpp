...
static PyObject *meth_wxRibbonToolBar_GetToolKind(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxRibbonToolBar, &sipCpp, &tool_id))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxRibbonButtonKind);
        }
    }
...
static void release_wxRibbonToolBar(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxRibbonToolBar[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoGetNextLargerSize), (PyCFunction)meth_wxRibbonToolBar_DoGetNextLargerSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonToolBar_DoGetNextLargerSize)},
    {SIP_MLNAME_CAST(sipName_DoGetNextSmallerSize), (PyCFunction)meth_wxRibbonToolBar_DoGetNextSmallerSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonToolBar_DoGetNextSmallerSize)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxRibbonToolBar_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonToolBar_SendDestroyEvent)},
