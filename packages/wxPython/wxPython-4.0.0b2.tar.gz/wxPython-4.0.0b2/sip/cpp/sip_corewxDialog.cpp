...
static PyObject *meth_wxDialog_GetLayoutAdaptationMode(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxDialog, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxDialogLayoutAdaptationMode);
        }
    }
...
static void release_wxDialog(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxDialog[] = {{531, 255, 1}};
...
static PyMethodDef methods_wxDialog[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxDialog_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SendDestroyEvent)},
