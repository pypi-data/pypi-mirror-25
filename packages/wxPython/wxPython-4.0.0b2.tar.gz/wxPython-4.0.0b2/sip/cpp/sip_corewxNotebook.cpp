...
sipVariableDef variables_wxNotebook[] = {
    {PropertyVariable, sipName_ThemeBackgroundColour, &methods_wxNotebook[30], NULL, NULL, NULL},
    {PropertyVariable, sipName_Selection, &methods_wxNotebook[29], &methods_wxNotebook[46], NULL, NULL},
    {PropertyVariable, sipName_RowCount, &methods_wxNotebook[28], NULL, NULL, NULL},
};
