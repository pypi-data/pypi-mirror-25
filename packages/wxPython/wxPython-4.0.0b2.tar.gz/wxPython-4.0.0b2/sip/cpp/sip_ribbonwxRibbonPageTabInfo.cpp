...
extern "C" {static void assign_wxRibbonPageTabInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRibbonPageTabInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRibbonPageTabInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRibbonPageTabInfo *>(sipSrc);
}
