...
static void release_wxArchiveFSHandler(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxArchiveFSHandler[] = {{160, 255, 1}};
...
static PyMethodDef methods_wxArchiveFSHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetAnchor), (PyCFunction)meth_wxArchiveFSHandler_GetAnchor, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxArchiveFSHandler_GetAnchor)},
    {SIP_MLNAME_CAST(sipName_GetLeftLocation), (PyCFunction)meth_wxArchiveFSHandler_GetLeftLocation, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxArchiveFSHandler_GetLeftLocation)},
    {SIP_MLNAME_CAST(sipName_GetProtocol), (PyCFunction)meth_wxArchiveFSHandler_GetProtocol, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxArchiveFSHandler_GetProtocol)},
    {SIP_MLNAME_CAST(sipName_GetRightLocation), (PyCFunction)meth_wxArchiveFSHandler_GetRightLocation, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxArchiveFSHandler_GetRightLocation)},
