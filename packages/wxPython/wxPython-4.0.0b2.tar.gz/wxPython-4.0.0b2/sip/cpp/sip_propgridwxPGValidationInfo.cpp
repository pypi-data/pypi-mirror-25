...
extern "C" {static void assign_wxPGValidationInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPGValidationInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPGValidationInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPGValidationInfo *>(sipSrc);
}
