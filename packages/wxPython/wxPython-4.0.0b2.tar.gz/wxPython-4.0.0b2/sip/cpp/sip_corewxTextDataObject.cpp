...
void sipwxTextDataObject::SetText(const  ::wxString& strText)
{
    ...
    sipVH__core_38(sipGILState, 0, sipPySelf, sipMeth, strText);
}
...
static void release_wxTextDataObject(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxTextDataObject[] = {{101, 255, 1}};
