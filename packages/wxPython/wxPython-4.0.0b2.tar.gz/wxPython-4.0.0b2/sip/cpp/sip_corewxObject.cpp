...
sipVariableDef variables_wxObject[] = {
    {PropertyVariable, sipName_RefData, &methods_wxObject[2], &methods_wxObject[5], NULL, NULL},
    {PropertyVariable, sipName_ClassName, &methods_wxObject[1], NULL, NULL, NULL},
};
