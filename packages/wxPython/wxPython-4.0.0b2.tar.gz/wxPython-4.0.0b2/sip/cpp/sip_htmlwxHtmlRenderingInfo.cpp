...
extern "C" {static void assign_wxHtmlRenderingInfo(void *, SIP_SSIZE_T, const void *);}
static void assign_wxHtmlRenderingInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxHtmlRenderingInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxHtmlRenderingInfo *>(sipSrc);
}
