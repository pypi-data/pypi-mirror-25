...
static void release_wxNavigationKeyEvent(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxNavigationKeyEvent[] = {{135, 255, 1}};
...
static sipEnumMemberDef enummembers_wxNavigationKeyEvent[] = {
    {sipName_FromTab, static_cast<int>( ::wxNavigationKeyEvent::FromTab), 345},
    {sipName_IsBackward, static_cast<int>( ::wxNavigationKeyEvent::IsBackward), 345},
    {sipName_IsForward, static_cast<int>( ::wxNavigationKeyEvent::IsForward), 345},
    {sipName_WinChange, static_cast<int>( ::wxNavigationKeyEvent::WinChange), 345},
};
