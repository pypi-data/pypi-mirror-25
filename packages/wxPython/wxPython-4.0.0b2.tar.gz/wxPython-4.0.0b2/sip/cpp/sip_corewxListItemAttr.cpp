...
extern "C" {static void assign_wxListItemAttr(void *, SIP_SSIZE_T, const void *);}
static void assign_wxListItemAttr(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxListItemAttr *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxListItemAttr *>(sipSrc);
}
