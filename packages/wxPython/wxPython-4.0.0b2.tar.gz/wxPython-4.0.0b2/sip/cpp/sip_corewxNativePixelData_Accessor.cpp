...
extern "C" {static void assign_wxNativePixelData_Accessor(void *, SIP_SSIZE_T, const void *);}
static void assign_wxNativePixelData_Accessor(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxNativePixelData_Accessor *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxNativePixelData_Accessor *>(sipSrc);
}
