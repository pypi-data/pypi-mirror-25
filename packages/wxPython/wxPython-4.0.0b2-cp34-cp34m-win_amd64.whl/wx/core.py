...
def _ListCtrl_SetItemData(self, item, data):
    """
    Associates an application-defined data value with this item.
    """
...
ListCtrl.SetItemData = _ListCtrl_SetItemData
del _ListCtrl_SetItemData
