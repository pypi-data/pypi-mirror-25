...
class Vizualization:
    ...
    def draw_scatterplot_from_indexes(self, indexes):
        ...
        for i in indexes:
            if i in self.index_not_predicted:
                special_to_display.append(self.projected_input[i])
            elif i in self.index_good_predicted:
                good_to_display.append(self.projected_input[i])
            elif i in self.index_bad_predicted:
                bad_to_display.append(self.projected_input[i])
        ...
        self.draw_scatterplot(good_to_display, bad_to_display, special_to_display)
    ...
    def conciliate_filters(self, filters):
        ...
        self.draw_scatterplot_from_indexes(to_display)
        self.refresh_graph()
