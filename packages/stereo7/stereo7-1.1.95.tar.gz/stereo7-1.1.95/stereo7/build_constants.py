...
ios_cmd_build = 'xcodebuild -project @{ROOT}/proj.ios/@{XCODEPROJECT}.xcodeproj archive -archivePath @{XCODEPROJECT}.xcarchive -scheme @{SCHEME}'
ios_cmd_export = 'xcodebuild -exportArchive -archivePath ./@{XCODEPROJECT}.xcarchive -exportPath ./ipa -exportOptionsPlist export.plist'
