...
ios_cmd_build = 'xcodebuild -project @{ROOT}/proj.ios/Syndicate.xcodeproj archive -archivePath Syndicate.xcarchive -scheme @{SCHEME}'
ios_cmd_export = 'xcodebuild -exportArchive -archivePath ./Syndicate.xcarchive -exportPath ./ipa -exportOptionsPlist export.plist'
