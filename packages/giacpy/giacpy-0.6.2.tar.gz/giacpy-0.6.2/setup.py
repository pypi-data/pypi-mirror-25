...
package_data={'giacpy' : ['__init__.py', 'GPL-2']}
...
include_dirs2 = ['./qcas','/usr/include/qt5/QtCore','/usr/include/qt5/QtGui','/usr/include/qt5/QtWidgets','/usr/include/qt5/QtXml','/usr/include/qt5/QtSvg','/usr/include/qt5','./qcas/qt','.']
# with giac 1.2 -lao is not required anymore
libraries2=['qcas','dl','giac','gmp','Qt5Svg','Qt5Xml','Qt5Gui','Qt5Core','pthread']
library_dirs2=['./qcas']
