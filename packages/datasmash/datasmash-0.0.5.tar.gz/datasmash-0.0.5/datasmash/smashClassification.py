...
import pandas as pd
from datasmash.utils import preprocess_map, write_series, quantizer, condense
...
class SmashClassification(SupervisedLearnerPrimitiveBase):
    ...
    ### Main methods ###
    def set_training_data(self, lib_class_map):
        self.X, self.y = condense(lib_class_map)
