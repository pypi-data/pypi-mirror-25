...
class PipelineCli(object):
    ...
    def version(self):
        ...
        print('')
        print('capabilities_enabled: %s' % ['server', 'predictor', 'version'])
        print('capabilities_disabled: %s' % ['cluster', 'optimizer', 'router'])
        print('')
        print('Email upgrade@pipeline.ai to unlock the advanced capabilities.')
        print('')
    ...
    def predictor_loadtest(self,
        ...
        self._predictor_test(model_type=model_type,
                             model_name=model_name,
                             model_tag=model_tag,
