...
class PipelineCli(object):
    ...
    def version(self):
        ...
        print('')
        print('scopes_enabled: %s' % ['server'])
        print('scopes_disabled: %s' % ['cluster'])
        print('')
        print('capabilities_enabled: %s' % ['predict', 'registry', 'version'])
        print('capabilities_disabled: %s' % ['train', 'optimize'])
        print('')
        print('Email upgrade@pipeline.ai to unlock additional scopes and capabilities.')
        print('***********************************************************************')
    ...
    def cluster_proxy(self,
        ...
        self._cluster_wildcard_proxy(service_name,
                                     local_port,
                                     service_port,
                                     kube_namespace)


    def _cluster_wildcard_proxy(self,
                                service_name,
                                kube_namespace='default',
                                local_port=None,
                                service_port=None):
    ...
    def cluster_shell(self,
        ...
        self._cluster_wildcard_shell(service_name,
                                     kube_namespace)
    ...
    def cluster_logs(self,
        ...
        self._cluster_wildcard_logs(service_name,
                                    kube_namespace)
    ...
    def cluster_describe(self,
        ...
        self._cluster_wildcard_describe(service_name)
    ...
    def cluster_scale(self,
        ...
        self._cluster_wildcard_scale(service_name,
                                     replicas,
                                     kube_namespace)
    ...
    def cluster_route(self,
                      model_type,
                      model_name,
                      model_tag,
                      percentage_traffic):
        # TODO:  Route percentage_traffic accordingly.
        pass
...
#        print("")
    ...
    def cluster_stop(self,
        ...
        service_name = '%s-%s-%s-%s' % (build_prefix, model_type, model_name, model_tag)
        self._cluster_wildcard_stop(service_name, 
                                    kube_namespace)
