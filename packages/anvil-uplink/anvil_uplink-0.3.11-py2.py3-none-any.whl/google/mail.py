...
def send(to=[], subject=None, text=None, html=None, cc=[], bcc=[], from_address=None):
    ...
    return anvil.server.call("anvil.private.google.mail.send", from_address=from_address, to=to, cc=cc, bcc=bcc, subject=subject, text=text, html=html)
