...
from ._server import _register_exception_type, AnvilWrappedError, UplinkDisconnectedError, http_endpoint, api_request as request, HttpResponse
...
def get_api_origin():
    return call("anvil.private.get_app_origin") + "/_/api"
