...
class SingletonGenerator:
    ...
    def __init__(self, individuals, args):
        ...
        self.prob_pcr_copy = (args.prob_pcr_copy / 3.0) # specify pcr copy rate. 3.0 is a completely arbitrary value here
...
class HighlyRepetitiveLocusGenerator:
    ...
    def reads(self):
        ...
        prob_pcr_copy = self.args.prob_pcr_copy
        max_pcr_copy_nr = self.args.max_pcr_copy_nr
        target_cov = self.args.cov
