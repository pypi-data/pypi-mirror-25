...
class RADLocus:
    ...
    def _add_mutation_reads(self, template_read, coverage, args):
        ...
        if heterozygous:
            ...
            # if cov_allele_1 and cov_allele_2:
            #     self._id_templates = (reads_allele_1[0], reads_allele_2[0])
            # elif cov_allele_1:
            #     self._id_templates = (reads_allele_1[0], rmh.get_id_template(template_read, allele_2, self.mutation_model))
            # elif cov_allele_2:
            #     self._id_templates = (rmh.get_id_template(template_read, allele_1, self.mutation_model), reads_allele_2[0])
            # elif allele_1.has_dropout() and allele_2.has_dropout():
            #     self._id_templates = []
            # else:
            #     self._id_templates = (rmh.get_id_template(template_read, allele_1, self.mutation_model), rmh.get_id_template(template_read, allele_2, self.mutation_model))
