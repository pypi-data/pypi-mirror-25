...
class Data1D(Data):
    ...
    def cut(self, xmin, xmax):
        return _CosmoBolognaLib.Data1D_cut(self, xmin, xmax)
...
class FuncGrid(_object):
    ...
    def integrate_qag(self, a, b, prec=1.e-2, limit_size=6, rule=6):
        return _CosmoBolognaLib.FuncGrid_integrate_qag(self, a, b, prec, limit_size, rule)

    def integrate_qaws(self, a, b, alpha=0, beta=0, mu=0, nu=0, prec=1.e-2, limit_size=6):
...
class Cosmology(_object):
    ...
    def mass_function_vector(self, *args):
        return _CosmoBolognaLib.Cosmology_mass_function_vector(self, *args)
    ...
    def Pk_UnNorm(self, arg2, arg3, arg4, unit1=False):
        return _CosmoBolognaLib.Cosmology_Pk_UnNorm(self, arg2, arg3, arg4, unit1)
    ...
    def bias_eff_selection_function_2(self, *args):
        return _CosmoBolognaLib.Cosmology_bias_eff_selection_function_2(self, *args)
    ...
    def denominator(self, r1, r2, theta, rr, xi_DM):
        return _CosmoBolognaLib.Cosmology_denominator(self, r1, r2, theta, rr, xi_DM)

    def integrals_for_qu_NonLocal(self, xi_DM, Phi, rr, kk, Pk_DM, prec):
        return _CosmoBolognaLib.Cosmology_integrals_for_qu_NonLocal(self, xi_DM, Phi, rr, kk, Pk_DM, prec)

    def Gamma(self, r1, r2, theta, xi, dPhi):
        return _CosmoBolognaLib.Cosmology_Gamma(self, r1, r2, theta, xi, dPhi)

    def qu_NonLocal(self, *args):
        return _CosmoBolognaLib.Cosmology_qu_NonLocal(self, *args)

    def integrals_for_zeta_Slepian(self, xi_DM, xi_DM_m1, xi_DM_p1, xi_DM_2, rr, kk, Pk_DM):
        return _CosmoBolognaLib.Cosmology_integrals_for_zeta_Slepian(self, xi_DM, xi_DM_m1, xi_DM_p1, xi_DM_2, rr, kk, Pk_DM)
    ...
    def qu_DM_Slepian(self, r1, r2, theta, rr, xi_DM, xi_DM_m1, xi_DM_p1, xi_DM_2, kk, Pk_DM, norders=9, prec=1.e-3):
        return _CosmoBolognaLib.Cosmology_qu_DM_Slepian(self, r1, r2, theta, rr, xi_DM, xi_DM_m1, xi_DM_p1, xi_DM_2, kk, Pk_DM, norders, prec)

    def integrals_for_zeta_BarrigaGatzanaga(self, xi_DM, Phi, rr, kk, Pk_DM):
        return _CosmoBolognaLib.Cosmology_integrals_for_zeta_BarrigaGatzanaga(self, xi_DM, Phi, rr, kk, Pk_DM)
    ...
    def qu_DM_BarrigaGatzanaga(self, r1, r2, theta, rr, xi_DM, Phi, kk, Pk_DM):
        return _CosmoBolognaLib.Cosmology_qu_DM_BarrigaGatzanaga(self, r1, r2, theta, rr, xi_DM, Phi, kk, Pk_DM)

    def zeta_DM(self, r1, r2, theta, method, kk, Pk_DM):
        return _CosmoBolognaLib.Cosmology_zeta_DM(self, r1, r2, theta, method, kk, Pk_DM)

    def qu_DM(self, r1, r2, theta, method, kk, Pk_DM):
        return _CosmoBolognaLib.Cosmology_qu_DM(self, r1, r2, theta, method, kk, Pk_DM)

    def zeta_halo(self, r1, r2, theta, b1, b2, method, kk, Pk_DM):
        return _CosmoBolognaLib.Cosmology_zeta_halo(self, r1, r2, theta, b1, b2, method, kk, Pk_DM)

    def qu_halo(self, *args):
        return _CosmoBolognaLib.Cosmology_qu_halo(self, *args)

    def zeta_DM_eq(self, rr, method, kk, Pk_DM):
        return _CosmoBolognaLib.Cosmology_zeta_DM_eq(self, rr, method, kk, Pk_DM)

    def qu_DM_eq(self, rr, method, kk, Pk_DM):
        return _CosmoBolognaLib.Cosmology_qu_DM_eq(self, rr, method, kk, Pk_DM)
...
class STR_MF(_object):
    ...
    __swig_setmethods__["author_MF"] = _CosmoBolognaLib.STR_MF_author_MF_set
    __swig_getmethods__["author_MF"] = _CosmoBolognaLib.STR_MF_author_MF_get
    if _newclass:
        author_MF = _swig_property(_CosmoBolognaLib.STR_MF_author_MF_get, _CosmoBolognaLib.STR_MF_author_MF_set)
...
def VarCast(_out, arg2):
    return _CosmoBolognaLib.VarCast(_out, arg2)
...
class STR_data_HOD(_object):
    ...
    __swig_setmethods__["author_MF"] = _CosmoBolognaLib.STR_data_HOD_author_MF_set
    __swig_getmethods__["author_MF"] = _CosmoBolognaLib.STR_data_HOD_author_MF_get
    if _newclass:
        author_MF = _swig_property(_CosmoBolognaLib.STR_data_HOD_author_MF_get, _CosmoBolognaLib.STR_data_HOD_author_MF_set)
    __swig_setmethods__["author_bias"] = _CosmoBolognaLib.STR_data_HOD_author_bias_set
    __swig_getmethods__["author_bias"] = _CosmoBolognaLib.STR_data_HOD_author_bias_get
    if _newclass:
        author_bias = _swig_property(_CosmoBolognaLib.STR_data_HOD_author_bias_get, _CosmoBolognaLib.STR_data_HOD_author_bias_set)
    ...
    __swig_setmethods__["author_cM"] = _CosmoBolognaLib.STR_data_HOD_author_cM_set
    __swig_getmethods__["author_cM"] = _CosmoBolognaLib.STR_data_HOD_author_cM_get
    if _newclass:
        author_cM = _swig_property(_CosmoBolognaLib.STR_data_HOD_author_cM_get, _CosmoBolognaLib.STR_data_HOD_author_cM_set)
...
class STR_data_model(_object):
    ...
    __swig_setmethods__["method_MF"] = _CosmoBolognaLib.STR_data_model_method_MF_set
    __swig_getmethods__["method_MF"] = _CosmoBolognaLib.STR_data_model_method_MF_get
    if _newclass:
        method_MF = _swig_property(_CosmoBolognaLib.STR_data_model_method_MF_get, _CosmoBolognaLib.STR_data_model_method_MF_set)
    __swig_setmethods__["method_bias"] = _CosmoBolognaLib.STR_data_model_method_bias_set
    __swig_getmethods__["method_bias"] = _CosmoBolognaLib.STR_data_model_method_bias_get
    if _newclass:
        method_bias = _swig_property(_CosmoBolognaLib.STR_data_model_method_bias_get, _CosmoBolognaLib.STR_data_model_method_bias_set)
...
def Pkmu(kk, mu, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, Pk, Pk_NW):
    return _CosmoBolognaLib.Pkmu(kk, mu, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, Pk, Pk_NW)
Pkmu = _CosmoBolognaLib.Pkmu

def Pk_l(kk, l, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, Pk_lin, Pk_NW, prec):
    return _CosmoBolognaLib.Pk_l(kk, l, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, Pk_lin, Pk_NW, prec)
...
def Xi_wedges(rr, nwedges, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, kk, Pk_lin, Pk_NW, prec=1.e-5):
    return _CosmoBolognaLib.Xi_wedges(rr, nwedges, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, kk, Pk_lin, Pk_NW, prec)
Xi_wedges = _CosmoBolognaLib.Xi_wedges

def Xi_rppi(rp, pi, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, kk, Pk_lin, Pk_NW, prec):
    return _CosmoBolognaLib.Xi_rppi(rp, pi, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, kk, Pk_lin, Pk_NW, prec)
Xi_rppi = _CosmoBolognaLib.Xi_rppi

def wp_from_Xi_rppi(rp, pimax, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, kk, Pk_lin, Pk_NW, prec):
    return _CosmoBolognaLib.wp_from_Xi_rppi(rp, pimax, alpha_perp, alpha_par, sigmaNL_perp, sigmaNL_par, bias, linear_growth_rate, SigmaS, kk, Pk_lin, Pk_NW, prec)
...
class Modelling_TwoPointCorrelation1D_monopole(Modelling_TwoPointCorrelation1D):
    ...
    def set_bias_eff_grid(self, cosmoPars, min_pars, max_pars, nbins_pars, dir, file_grid_bias):
        return _CosmoBolognaLib.Modelling_TwoPointCorrelation1D_monopole_set_bias_eff_grid(self, cosmoPars, min_pars, max_pars, nbins_pars, dir, file_grid_bias)
