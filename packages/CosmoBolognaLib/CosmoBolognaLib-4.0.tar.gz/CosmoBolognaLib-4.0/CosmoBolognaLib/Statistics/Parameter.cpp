...
void cosmobl::statistics::Parameter::set_posterior (const int start, const int thin, const int seed)
{
...
void cosmobl::statistics::Parameter::set_posterior (const vector<double> chain_values, const int nwalkers, const int seed)
{
...
void cosmobl::statistics::Parameter::set_posterior (const vector<vector<double>> chain_values, const int seed)
{
