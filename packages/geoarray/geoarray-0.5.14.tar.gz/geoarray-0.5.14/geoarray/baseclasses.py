...
class GeoArray(object):
    ...
    def show_map(self, xlim=None, ylim=None, band=0, boundsMap=None, boundsMapPrj=None, ax=None, figsize=None,
        ...
        try:
            ...
            warnings.warn(
                'This function requires Basemap. You need to install basemap manually (see www./matplotlib.org/basemap) '
                'if you want to plot maps. It is not automatically installed.')
            raise
        try:
            import mpld3
            if zoomable:
