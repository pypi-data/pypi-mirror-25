...
#define CASADI_VERSION_STRING "3.3.0-rc1"
#define CASADI_GIT_REVISION "5d41c46df07306bcb20215486b1634604d174134"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.2.0-5.5d41c46df"  // NOLINT(whitespace/line_length)
...
#define CASADI_COMPILER_FLAGS "-DMS_WIN64 -std=c++11 -fno-ipa-cp-clone   "  // NOLINT(whitespace/line_length)
#define CASADI_MODULES "casadi;casadi_linsol_lapacklu;casadi_linsol_lapackqr;casadi_sundials_common;casadi_integrator_cvodes;casadi_integrator_idas;casadi_rootfinder_kinsol;casadi_nlpsol_ipopt;casadi_nlpsol_bonmin;casadi_conic_qpoases;casadi_conic_clp;casadi_linsol_csparse;casadi_linsol_csparsecholesky;casadi_importer_clang;casadi_linsol_ma27;casadi_xmlfile_tinyxml;casadi_nlpsol_blocksqp;casadi_conic_hpmpc;casadi_dple_slicot;casadi_expm_slicot;casadi_conic_nlpsol;casadi_integrator_rk;casadi_integrator_collocation;casadi_interpolant_linear;casadi_interpolant_bspline;casadi_linsol_symbolicqr;casadi_linsol_lsqr;casadi_nlpsol_sqpmethod;casadi_nlpsol_scpgen;casadi_rootfinder_newton;casadi_rootfinder_nlpsol"  // NOLINT(whitespace/line_length)
#define CASADI_PLUGINS "Linsol::lapacklu;Linsol::lapackqr;Integrator::cvodes;Integrator::idas;Rootfinder::kinsol;Nlpsol::ipopt;Nlpsol::bonmin;Conic::qpoases;Conic::clp;Linsol::csparse;Linsol::csparsecholesky;Importer::clang;Linsol::ma27;XmlFile::tinyxml;Nlpsol::blocksqp;Conic::hpmpc;Dple::slicot;Expm::slicot;Conic::nlpsol;Integrator::rk;Integrator::collocation;Interpolant::linear;Interpolant::bspline;Linsol::symbolicqr;Linsol::lsqr;Nlpsol::sqpmethod;Nlpsol::scpgen;Rootfinder::newton;Rootfinder::nlpsol"  // NOLINT(whitespace/line_length)
