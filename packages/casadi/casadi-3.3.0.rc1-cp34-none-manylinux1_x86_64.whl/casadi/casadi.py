...
class IM(MatrixCommon, GenericExpressionCommon, GenIM, PrintableCommon):
    ...
    def elements(self, *args) -> "std::vector< int,std::allocator< int > >":
        """
    ...
    def rand(*args) -> "casadi::Matrix< int >":
        """
...
def IM_rand(*args) -> "casadi::Matrix< int >":
    """
...
class MX(GenericExpressionCommon, PrintableCommon, GenMX, SharedObject):
    ...
    def which_output(self, *args) -> "int":
        """
...
class Function(SharedObject, PrintableCommon):
    ...
    def n_instructions(self, *args) -> "int":
        """
    ...
    def instruction_id(self, *args) -> "int":
        """
    ...
    def instruction_input(self, *args) -> "std::pair< int,int >":
        """
        Locations in the work vector for the inputs of the instruction ( SXFunction)

        instruction_input(self, int k) -> (int,int)
    ...
    def instruction_output(self, *args) -> "int":
        """
...
class OptiAdvanced(Opti):
    ...
    def instance_number(self, *args) -> "int":
        """
