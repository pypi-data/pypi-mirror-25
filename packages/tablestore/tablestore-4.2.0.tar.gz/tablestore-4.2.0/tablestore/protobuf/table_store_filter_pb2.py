...
_COMPARATORTYPE = _descriptor.EnumDescriptor(
  name='ComparatorType',
...
ComparatorType = enum_type_wrapper.EnumTypeWrapper(_COMPARATORTYPE)
...
_COMPOSITECOLUMNVALUEFILTER = _descriptor.Descriptor(
