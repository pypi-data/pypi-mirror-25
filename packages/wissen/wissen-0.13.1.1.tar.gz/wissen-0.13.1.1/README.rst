...
Note: Wissen doesn't check uniqueness checking by document ID, it means if you post multiple documents with same document ID, wissen will index all of them with regardless document ID. If you want to keep uniqueness, you SHOULD use 'patch' method NOT 'post'.
