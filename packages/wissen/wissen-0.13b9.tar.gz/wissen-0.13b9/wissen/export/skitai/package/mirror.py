...
from wissen.lib import pathtool, logger as loggerlib, flock
...
def mirror ():
	...
	while 1:
		...
		local_col = wissen.collection (indexdir = [normpath (d) for d in status ['indexdirs']], mode = wissen.MODIFY)		
