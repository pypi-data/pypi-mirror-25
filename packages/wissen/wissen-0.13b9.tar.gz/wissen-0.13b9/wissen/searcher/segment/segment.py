...
class Segment:
	...
	def close (self):		
		...
		os.fsync (self.fs_tis); os.close (self.fs_tis)
		os.fsync (self.fs_tii); os.close (self.fs_tii)
		os.fsync (self.fs_fdi); os.close (self.fs_fdi)
		os.fsync (self.fs_fda); os.close (self.fs_fda)
		os.fsync (self.fs_tfq); os.close (self.fs_tfq)
		os.fsync (self.fs_prx); os.close (self.fs_prx)
		os.fsync (self.fs_smp); os.close (self.fs_smp)
