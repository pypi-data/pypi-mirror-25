...
setup(
    name='chat_api',
    version=version,
    url='https://bitbucket.org/arabellatech/chat_api',
    license='Proprietary',
    description='Automated Chat & Surveys API',
    long_description=read_file('README.rst'),
    author='Pawel Krzyzaniak',
    author_email='pawelk@arabel.la',
    packages=get_packages('chat_api'),
    package_data=get_package_data('chat_api'),
    zip_safe=False,
