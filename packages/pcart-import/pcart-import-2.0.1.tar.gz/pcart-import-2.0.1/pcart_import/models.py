    ...
    def process(self):
        ...
        try:
            ...
            for item in result:
                ...
                images_links = []
                if 'product_image:1' in chunk:
                    images_links.append(chunk['product_image:1'])
                if 'product_image:2' in chunk:
                    images_links.append(chunk['product_image:2'])
                if 'product_image:3' in chunk:
                    images_links.append(chunk['product_image:3'])
