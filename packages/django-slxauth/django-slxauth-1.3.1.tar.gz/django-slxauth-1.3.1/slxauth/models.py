...
class AbstractSolarluxUser(AbstractBaseUser, PermissionsMixin):
    ...
    CUSTOMER_CATEGORY_CHOICES = (
        ('ACTIVE_PARTNER', _('active partner')),
        ('BI_FOLDING_DOOR_SPECIALIST', _('bi-folding-door specialist')),
        ('DEALER', _('dealer')),
    ...
    customer_category = models.CharField(_('customer category'), choices=CUSTOMER_CATEGORY_CHOICES, max_length=200, blank=True)
