...
from appy.pod.styles_manager import \
     Style, BulletedProperties, NumberedProperties, DEFAULT_CELL_PARA_STYLES
...
class HtmlElement:
    ...
    def __init__(self, elem, attrs=None, parent=None):
        ...
        self.odStyle = None
        # For cell tags, determine the default style to apply to their inner
        # paragraphs.
        self.innerStyle = None
        if elem in DEFAULT_CELL_PARA_STYLES:
            self.innerStyle = DEFAULT_CELL_PARA_STYLES[elem]
