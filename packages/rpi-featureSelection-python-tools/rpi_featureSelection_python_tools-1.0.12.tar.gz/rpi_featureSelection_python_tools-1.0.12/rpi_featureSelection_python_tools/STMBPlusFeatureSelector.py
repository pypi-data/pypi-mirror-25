...
from rpi_featureSelection_python_tools.stmbplus_tools import *
...
class STMBPlusFeatureSelector(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params]):
    ...
    def fit(self) -> None:
        ...
        index = Auto_JMIplusSTMB(self.training_inputs, self.training_outputs)
