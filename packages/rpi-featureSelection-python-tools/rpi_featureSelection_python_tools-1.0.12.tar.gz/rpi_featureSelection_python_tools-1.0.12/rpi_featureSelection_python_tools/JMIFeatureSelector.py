...
from rpi_featureSelection_python_tools.jmi_tools import *
...
class JMIFeatureSelector(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params]):
    ...
    def fit(self) -> None:
        ...
        index = JMI_BF(self.training_inputs, self.training_outputs)
        print(index.shape[0])
