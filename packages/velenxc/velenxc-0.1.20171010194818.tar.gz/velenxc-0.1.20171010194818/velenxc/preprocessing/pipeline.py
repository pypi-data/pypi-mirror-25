...
class DataFramePipe(object):
    ...
    def __init__(self, data, label_name=None, file_type='json'):
        ...
        self.missing_columns = []  # missing data columns
        self.zero_columns = []     # zero data columns
    ...
    def deleted_feature(self):
        return list(chain(*(self.missing_columns, self.zero_columns)))
    ...
    def drop_missing_data(self, null_criteria=0.25):
        ...
        self.missing_columns = null_percents[null_percents > null_criteria].index.tolist()

        self._df = self._df.drop(self.missing_columns, axis=1)
    ...
    def drop_high_zero_data(self, zero_criteria=0.75):
        ...
        self.zero_columns = high_zero_data.index.tolist()

        self._df = self._df.drop(self.zero_columns, axis=1)
        return self
