...
@Gooey(dump_build_config=True, required_cols=1, program_name="Widget Demo", group_by_type=False)
def main():
  ...
  my_cool_parser.add_argument('-u', '--textarea', default="I'm on \na new line", type=str, help='A multiline textarea', widget='Textarea')
