...
from gyun.cli.iaas_client.handler import IaasHandler
from gyun.cli.misc.utils import load_conf, send_request, get_expire_time
...
class BaseAction(object):
    ...
    def add_common_arguments(cls, parser):
        ...
        parser.add_argument('-f', '--config', dest='conf_file',
                action='store', type=str, default='~/.gyun/config.yaml',
