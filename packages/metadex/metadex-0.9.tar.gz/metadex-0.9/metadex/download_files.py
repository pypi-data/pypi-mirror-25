...
def get_all_async(study, metagenomeGroupDict, source, evalue=5, identity=60, length=15):
    """
    Summary: gets all metagenmic annotations for a study from the MG-RAST servers and stores as CSV
...
if __name__ == '__main__':
    get_all_async('lagoon study', {'mgm4739970.3':'nador_lagoon', 'mgm4739969.3':'oualidia_lagoon', 'mgm4739970.3': 'oualidia_lagoon', 'mgm4739971.3':'nador_lagoon'}, 'RefSeq', evalue=5, identity=60, length=15)
