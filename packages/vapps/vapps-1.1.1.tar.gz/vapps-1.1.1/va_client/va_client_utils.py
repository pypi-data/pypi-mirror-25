...
module_mappings = {
    ...
    'apps' : {
        ...
        'directory' : {
            'users' : {
                'list' : {"kwargs" : {'endpoint' : '/panels/action', 'data' : {'action' : 'list_users'}, 'keys' : ['users'], 'method' : 'post'}}, 
                'locked' : {"kwargs" : {'endpoint' : '/panels/action', 'data' : {'action' : 'list_users'}, 'keys' : ['users'], 'method' : 'post'}},
            }
        }
    },
    'services' : {
