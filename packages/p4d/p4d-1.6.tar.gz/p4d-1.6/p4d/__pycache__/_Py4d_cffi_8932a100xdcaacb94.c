...
PyMODINIT_FUNC
PyInit__Py4d_cffi_8932a100xdcaacb94(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_Py4d_cffi_8932a100xdcaacb94(void)
{
  PyObject *lib;
  lib = Py_InitModule("_Py4d_cffi_8932a100xdcaacb94", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
