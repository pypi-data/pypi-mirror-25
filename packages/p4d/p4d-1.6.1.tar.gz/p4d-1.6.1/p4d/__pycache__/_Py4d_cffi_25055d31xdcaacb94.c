...
_cffi_f_resultTypeFromString(PyObject *self, PyObject *arg0)
{
  ...
  (void)self; /* unused */
  return _cffi_from_c_deref((char *)&result, _cffi_type(12));
}
...
PyMODINIT_FUNC
PyInit__Py4d_cffi_25055d31xdcaacb94(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_Py4d_cffi_25055d31xdcaacb94(void)
{
  PyObject *lib;
  lib = Py_InitModule("_Py4d_cffi_25055d31xdcaacb94", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
