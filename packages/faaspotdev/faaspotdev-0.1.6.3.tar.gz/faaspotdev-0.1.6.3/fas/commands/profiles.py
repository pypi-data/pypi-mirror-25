...
class Profiles(Command):
    ...
    def create(self, name=None, username=None, password=None, application=None, token=None,
               host=None, port=None, protocol=None, certificate=None, update_if_exist=False,
               set_as_active_profile=False):
    ...
    def update(self, name, username=None, password=None, application=None, token=None, host=None,
               port=None, protocol=None, certificate=None):
        try:
    ...
    @staticmethod
    def _profile_dict(username=None, password=None, application=None, token=None, host=None,
                      port=None, protocol=None, certificate=None, trust_all=None, ssl_enabled=None,
                      current=None):
        if current:
            ...
            application = application or current.get('application')
        ...
        if application:
            profile_data['application'] = application
        if password:
