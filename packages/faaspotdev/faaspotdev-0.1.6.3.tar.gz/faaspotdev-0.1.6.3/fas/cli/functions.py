...
def add_functions_args(subparsers):
    ...
    get.add_argument('function_id',
                     action="store",
                     help='The function-id')
    ...
    create.add_argument('-s', '--source',
                        type=lambda x: is_valid_file(create, x),
                        help='The file code',
                        required=True)
    create.add_argument('-r', '--runtime',
                        help='The runtime executor',
                        dest="runtime",
                        required=True)
    create.add_argument('-c', '--context-file',
                        ...
                        dest="context_file",
                        required=False)
    create.add_argument('--public',
                        action='store_true',
                        help='Allow execution without a token')
    create.add_argument('--wait',
                        action='store_true',
                        help='Wait for creation')

    update = functions.add_parser('update', help='Update an existing function')
    update.add_argument('function_id',
                        action="store",
                        help='The function-id')
    ...
    update.add_argument('-c', '--context-file',
                        ...
                        dest="context_file",
                        required=False)
    update.add_argument('-r', '--runtime',
                        help='The runtime executor',
                        dest="runtime",
                        required=False)
    update.add_argument('-p', '--public',
                        action='store_true',
                        help='Allow execution without a token',
                        required=False)
    ...
    delete.add_argument('function_id',
                        action="store",
                        help='The function-id to delete')
    delete.add_argument('-w', '--wait',
                        action='store_true',
                        help='Wait for creation')

    run = functions.add_parser('run', help='Run an existing function')
    run.add_argument('function_id',
                     action="store",
                     help='The function-id to run')
    ...
    run_bulk.add_argument('function_id',
                          action="store",
                          help='The function-id to run in bulk')
