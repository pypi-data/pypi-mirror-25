...
setup(
    name = 'boltiot',
    packages = ['boltiot'],
    version = 1.0, #Specify a version here
    ...
    download = 'https://github.com/Inventrom/bolt-api-python/archive/1.3.tar.gz', #Download URL for github repository. Look at instructions...txt file for this part
