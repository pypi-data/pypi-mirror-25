...
class Menu_22Endpoint:
    ...
    def get(self, streamId, size, offset, menuScope=None, streamReadFilter=None, groupStreamOnly=None, applicationStreamOnly=None, returnFullResource=None, impersonate_user_id=None, accept_type=None):
        """
        Get menu.
