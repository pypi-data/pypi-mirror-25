...
#
# Generated Mon Mar 13 09:46:58 2017 by generateDS.py version 2.23a.
#
...
class DiscussionCard_22Sub(supermod.DiscussionCard_22):
    def __init__(self, PostListPage=None, MoreUnreadCount=None, TotalUnreadCount=None, FirstPost=None, PreviousPost=None, ShareList=None, VisibilityListCount=None, PinnedToList=None, Files=None, Author=None, ManagedByAssistant=None, RelatedCardCount=None, IsForward=None, CombinedCardId=None, TrashStatus=None):
        super(DiscussionCard_22Sub, self).__init__(PostListPage, MoreUnreadCount, TotalUnreadCount, FirstPost, PreviousPost, ShareList, VisibilityListCount, PinnedToList, Files, Author, ManagedByAssistant, RelatedCardCount, IsForward, CombinedCardId, TrashStatus, )
