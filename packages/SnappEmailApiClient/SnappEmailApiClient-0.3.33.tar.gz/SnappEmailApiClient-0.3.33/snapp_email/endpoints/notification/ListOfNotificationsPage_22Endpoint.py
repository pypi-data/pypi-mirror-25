...
class ListOfNotificationsPage_22Endpoint:
    ...
    def get(self, size, offset, sinceId=None, notificationType=None, sortDirection=None, returnFullResource=None, skipOlderThan=None, htmlFormat=None, impersonate_user_id=None, accept_type=None):
        """
