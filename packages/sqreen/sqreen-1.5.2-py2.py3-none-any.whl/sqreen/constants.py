...
CHANGELOG_URL = 'https://doc.sqreen.io/docs/python-changelog'
COMPATIBILITY_URL = 'https://doc.sqreen.io/docs/python-agent-compatibility'
INSTALLATION_URL = 'https://doc.sqreen.io/docs/installing-the-python-agent'
