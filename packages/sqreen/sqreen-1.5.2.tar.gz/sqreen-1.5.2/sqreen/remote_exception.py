...
class RemoteException(object):
    ...
    def __init__(self, exc_info, callback_payload=None, exception_payload=None,
                 request_payload=None, stack=None):
    ...
    def to_dict(self):
        ...
        # Base fields
        base_payload['rule_name'] = self.callback_payload.pop('rule_name', None)
        base_payload['rulespack_id'] = self.callback_payload.pop('rulespack_id', None)
        base_payload['rule_signature'] = self.callback_payload.pop('rule_signature', None)
