...
data_files = [
	('haiku/classifier/learner', ['haiku/classifier/learner/*.so.*', 'haiku/classifier/learner/*.dll']),
	('haiku/classifier/learner/liblinear', ['haiku/classifier/learner/liblinear/*.so.*']),
	('haiku/classifier/learner/liblinear/windows', ['haiku/classifier/learner/liblinear/windows/*.dll'])
]
...
setup(
	...
	package_data={		
		'haiku': [			
			...
			'classifier/learner/liblinear/*.dll',
			'classifier/learner/liblinear/*.so.*',
