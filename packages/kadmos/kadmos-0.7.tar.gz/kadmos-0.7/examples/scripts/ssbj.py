...
for mdao_definition in mdao_definitions:
    ...
    if mdao_architecture in ['IDF', 'MDF']:
        fpg.node['/data_schema/aircraft/other/objective']['problem_role'] = 'objective'
        fpg.node['/data_schema/aircraft/geometry/tc']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/reference/h']['problem_role'] = 'design variable'
        fpg.node['/data_schema/reference/M']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/geometry/AR']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/geometry/Lambda']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/geometry/Sref']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/geometry/lambda']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/geometry/section']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/other/Cf']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/other/T']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/geometry/Theta']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/other/L']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/weight/WE']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/weight/WT']['problem_role'] = 'design variable'
        fpg.node['/data_schema/reference/ESF']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/other/D']['problem_role'] = 'design variable'
        fpg.node['/data_schema/aircraft/other/DT']['problem_role'] = 'constraint'
        fpg.node['/data_schema/aircraft/other/sigma']['problem_role'] = 'constraint'
        fpg.node['/data_schema/aircraft/other/dpdx']['problem_role'] = 'constraint'
        fpg.node['/data_schema/reference/Temp']['problem_role'] = 'constraint'
    ...
    if mdao_architecture in ['IDF', 'MDF']:
        pass
        #mdg.edge['F1']['/data_schema/architectureNodes/finalOutputVariables/data_schemaCopy/analyses/f'][
        #    'equations'] = mdg.edge['F1']['/data_schema/analyses/f']['equations']
        #mdg.edge['G1']['/data_schema/architectureNodes/finalOutputVariables/data_schemaCopy/analyses/g1'][
        #    'equations'] = mdg.edge['G1']['/data_schema/analyses/g1']['equations']
        #mdg.edge['G2']['/data_schema/architectureNodes/finalOutputVariables/data_schemaCopy/analyses/g2'][
        #    'equations'] = mdg.edge['G2']['/data_schema/analyses/g2']['equations']#

    # Add some more problem roles to avoid undefined uIDs in the CMDOWS file
    if mdao_architecture == 'IDF':
        pass
        #mdg.node['/data_schema/architectureNodes/consistencyConstraintVariables/data_schemaCopy/analyses/gc_y1'][
        #    'problem_role'] = 'constraint'
        #mdg.node['/data_schema/architectureNodes/consistencyConstraintVariables/data_schemaCopy/analyses/gc_y2'][
        #    'problem_role'] = 'constraint'
