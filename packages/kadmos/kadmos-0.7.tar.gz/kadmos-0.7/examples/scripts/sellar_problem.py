...
rcg.edge['/data_schema/geometry/z1']['D1']['valid_ranges'] = {'limit_range': {'minimum': -5, 'maximum': 5.},
...
for mdao_definition in mdao_definitions:
    ...
    if mdao_architecture in ['IDF', 'MDF']:
        ...
        fpg.node['/data_schema/analyses/g1']['valid_ranges'] = {'limit_range': {'minimum': 0., 'maximum': 1e99}}
        fpg.node['/data_schema/analyses/g2']['problem_role'] = 'constraint'
        fpg.node['/data_schema/analyses/g2']['valid_ranges'] = {'limit_range': {'minimum': 0., 'maximum': 1e99}}
