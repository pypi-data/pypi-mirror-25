...
class EquationMixin(object):
    ...
    def add_equation_label(self, edge, label=None, language='Python'):
        ...
        self.edge[edge[0]][edge[1]]['equation_label'] = label
    ...
    def add_equation(self, edge_or_node, equation, language='Python'):
        ...
        if 'equations' not in self.edge[edge[0]][edge[1]]:
            self.edge[edge[0]][edge[1]]['equations'] = {}

        # Add equation to the equations attribute
        self.edge[edge[0]][edge[1]]['equations'][language] = equation
