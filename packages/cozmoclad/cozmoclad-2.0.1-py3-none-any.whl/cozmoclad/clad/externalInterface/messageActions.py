...
class TurnInPlace(object):
  ...
  def __init__(self, angle_rad=0.0, speed_rad_per_sec=0.0, accel_rad_per_sec2=0.0, tol_rad=0.0, isAbsolute=0, robotID=0):
    self.angle_rad = angle_rad
  ...
  def unpack_from(cls, reader):
    ...
    _robotID = reader.read('B')
    return cls(_angle_rad, _speed_rad_per_sec, _accel_rad_per_sec2, _tol_rad, _isAbsolute, _robotID)
  ...
  def __str__(self):
    return '{type}(angle_rad={angle_rad}, speed_rad_per_sec={speed_rad_per_sec}, accel_rad_per_sec2={accel_rad_per_sec2}, tol_rad={tol_rad}, isAbsolute={isAbsolute}, robotID={robotID})'.format(
      type=type(self).__name__,
      angle_rad=self._angle_rad,
