...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    SetDebugConsoleVarMessage               = 0xd5 # Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
    RunDebugConsoleFuncMessage              = 0xd6 # Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
    GetDebugConsoleVarMessage               = 0xd7 # Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
    GetAllDebugConsoleVarMessage            = 0xd8 # Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
    GetJsonDasLogsMessage                   = 0xd9 # Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
    SetEnableSpeedChooser                   = 0xda # Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
    LogRawCliffData                         = 0xdb # Anki.Cozmo.ExternalInterface.LogRawCliffData
    BlockPoolEnabledMessage                 = 0xdc # Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
    BlockSelectedMessage                    = 0xdd # Anki.Cozmo.ExternalInterface.BlockSelectedMessage
    GetBlockPoolMessage                     = 0xde # Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
    SendAvailableObjects                    = 0xdf # Anki.Cozmo.ExternalInterface.SendAvailableObjects
    BlockPoolResetMessage                   = 0xe0 # Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
    SaveCalibrationImage                    = 0xe1 # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xe2 # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xe3 # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xe4 # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xe5 # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xe6 # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xe7 # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xe8 # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xe9 # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    SetShouldAutoConnectToCubesAtStart      = 0xea # Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
    SetShouldAutoDisconnectFromCubesAtEnd   = 0xeb # Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
    TransferFile                            = 0xec # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xed # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xee # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xef # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xf0 # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xf1 # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xf2 # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xf3 # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  _tags_by_name = dict(
    ...
    SetDebugConsoleVarMessage=213,
    RunDebugConsoleFuncMessage=214,
    GetDebugConsoleVarMessage=215,
    GetAllDebugConsoleVarMessage=216,
    GetJsonDasLogsMessage=217,
    SetEnableSpeedChooser=218,
    LogRawCliffData=219,
    BlockPoolEnabledMessage=220,
    BlockSelectedMessage=221,
    GetBlockPoolMessage=222,
    SendAvailableObjects=223,
    BlockPoolResetMessage=224,
    SaveCalibrationImage=225,
    ClearCalibrationImages=226,
    ComputeCameraCalibration=227,
    ContinueFreeplayFromIdle=228,
    EnableDroneMode=229,
    EnterSdkMode=230,
    ExitSdkMode=231,
    SetStopRobotOnSdkDisconnect=232,
    StopRobotForSdk=233,
    SetShouldAutoConnectToCubesAtStart=234,
    SetShouldAutoDisconnectFromCubesAtEnd=235,
    TransferFile=236,
    NVStorageEraseEntry=237,
    NVStorageWipeAll=238,
    NVStorageWriteEntry=239,
    NVStorageClearPartialPendingWriteEntry=240,
    NVStorageReadEntry=241,
    SetCameraSettings=242,
    RequestRobotSettings=243,
  )
  ...
  _tags_by_value[213] = 'SetDebugConsoleVarMessage'
  _tags_by_value[214] = 'RunDebugConsoleFuncMessage'
  _tags_by_value[215] = 'GetDebugConsoleVarMessage'
  _tags_by_value[216] = 'GetAllDebugConsoleVarMessage'
  _tags_by_value[217] = 'GetJsonDasLogsMessage'
  _tags_by_value[218] = 'SetEnableSpeedChooser'
  _tags_by_value[219] = 'LogRawCliffData'
  _tags_by_value[220] = 'BlockPoolEnabledMessage'
  _tags_by_value[221] = 'BlockSelectedMessage'
  _tags_by_value[222] = 'GetBlockPoolMessage'
  _tags_by_value[223] = 'SendAvailableObjects'
  _tags_by_value[224] = 'BlockPoolResetMessage'
  _tags_by_value[225] = 'SaveCalibrationImage'
  _tags_by_value[226] = 'ClearCalibrationImages'
  _tags_by_value[227] = 'ComputeCameraCalibration'
  _tags_by_value[228] = 'ContinueFreeplayFromIdle'
  _tags_by_value[229] = 'EnableDroneMode'
  _tags_by_value[230] = 'EnterSdkMode'
  _tags_by_value[231] = 'ExitSdkMode'
  _tags_by_value[232] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[233] = 'StopRobotForSdk'
  _tags_by_value[234] = 'SetShouldAutoConnectToCubesAtStart'
  _tags_by_value[235] = 'SetShouldAutoDisconnectFromCubesAtEnd'
  _tags_by_value[236] = 'TransferFile'
  _tags_by_value[237] = 'NVStorageEraseEntry'
  _tags_by_value[238] = 'NVStorageWipeAll'
  _tags_by_value[239] = 'NVStorageWriteEntry'
  _tags_by_value[240] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[241] = 'NVStorageReadEntry'
  _tags_by_value[242] = 'SetCameraSettings'
  _tags_by_value[243] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[213] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[214] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[215] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[216] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[217] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage.unpack_from)
  _tag_unpack_methods[218] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser.unpack_from)
  _tag_unpack_methods[219] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LogRawCliffData.unpack_from)
  _tag_unpack_methods[220] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage.unpack_from)
  _tag_unpack_methods[221] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockSelectedMessage.unpack_from)
  _tag_unpack_methods[222] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockPoolMessage.unpack_from)
  _tag_unpack_methods[223] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SendAvailableObjects.unpack_from)
  _tag_unpack_methods[224] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolResetMessage.unpack_from)
  _tag_unpack_methods[225] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[226] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[227] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[228] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[229] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[230] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[231] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[232] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[233] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[234] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart.unpack_from)
  _tag_unpack_methods[235] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd.unpack_from)
  _tag_unpack_methods[236] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[237] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[238] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[239] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[240] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[241] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[242] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[243] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[213] = lambda : Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
  _type_by_tag_value[214] = lambda : Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
  _type_by_tag_value[215] = lambda : Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
  _type_by_tag_value[216] = lambda : Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
  _type_by_tag_value[217] = lambda : Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
  _type_by_tag_value[218] = lambda : Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
  _type_by_tag_value[219] = lambda : Anki.Cozmo.ExternalInterface.LogRawCliffData
  _type_by_tag_value[220] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
  _type_by_tag_value[221] = lambda : Anki.Cozmo.ExternalInterface.BlockSelectedMessage
  _type_by_tag_value[222] = lambda : Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
  _type_by_tag_value[223] = lambda : Anki.Cozmo.ExternalInterface.SendAvailableObjects
  _type_by_tag_value[224] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
  _type_by_tag_value[225] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[226] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[227] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[228] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[229] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[230] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[231] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[232] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[233] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[234] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
  _type_by_tag_value[235] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
  _type_by_tag_value[236] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[237] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[238] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[239] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[240] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[241] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[242] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[243] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings
