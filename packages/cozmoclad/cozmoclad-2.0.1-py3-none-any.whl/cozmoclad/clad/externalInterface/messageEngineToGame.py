...
class NeedsState(object):
  ...
  __slots__ = (
    ...
    '_unconnectedDecayTestVariation', # string[uint_8]
  )
  ...
  @property
  def unconnectedDecayTestVariation(self):
    "string[uint_8] unconnectedDecayTestVariation struct property."
    return self._unconnectedDecayTestVariation

  @unconnectedDecayTestVariation.setter
  def unconnectedDecayTestVariation(self, value):
    self._unconnectedDecayTestVariation = msgbuffers.validate_string(
      'NeedsState.unconnectedDecayTestVariation', value, 255)

  def __init__(self, curNeedLevel=(), curNeedBracket=(), partIsDamaged=(), curNeedsUnlockLevel=0, numStarsAwarded=0, numStarsForNextUnlock=0, actionCausingTheUpdate=Anki.Cozmo.NeedsActionId.NoAction, unconnectedDecayTestVariation=''):
    ...
    self.unconnectedDecayTestVariation = unconnectedDecayTestVariation
  ...
  def unpack_from(cls, reader):
    ...
    _unconnectedDecayTestVariation = reader.read_string('B')
    return cls(_curNeedLevel, _curNeedBracket, _partIsDamaged, _curNeedsUnlockLevel, _numStarsAwarded, _numStarsForNextUnlock, _actionCausingTheUpdate, _unconnectedDecayTestVariation)
  ...
  def pack_to(self, writer):
    ...
    writer.write_string(self._unconnectedDecayTestVariation, 'B')
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._curNeedLevel == other._curNeedLevel and
        ...
        self._unconnectedDecayTestVariation == other._unconnectedDecayTestVariation)
    else:
      return NotImplemented
  ...
  def __len__(self):
    return (msgbuffers.size_varray(self._curNeedLevel, 'f', 'B') +
      ...
      msgbuffers.size_string(self._unconnectedDecayTestVariation, 'B'))

  def __str__(self):
    return '{type}(curNeedLevel={curNeedLevel}, curNeedBracket={curNeedBracket}, partIsDamaged={partIsDamaged}, curNeedsUnlockLevel={curNeedsUnlockLevel}, numStarsAwarded={numStarsAwarded}, numStarsForNextUnlock={numStarsForNextUnlock}, actionCausingTheUpdate={actionCausingTheUpdate}, unconnectedDecayTestVariation={unconnectedDecayTestVariation})'.format(
      type=type(self).__name__,
      ...
      unconnectedDecayTestVariation=msgbuffers.shorten_string(self._unconnectedDecayTestVariation))
  ...
  def __repr__(self):
    return '{type}(curNeedLevel={curNeedLevel}, curNeedBracket={curNeedBracket}, partIsDamaged={partIsDamaged}, curNeedsUnlockLevel={curNeedsUnlockLevel}, numStarsAwarded={numStarsAwarded}, numStarsForNextUnlock={numStarsForNextUnlock}, actionCausingTheUpdate={actionCausingTheUpdate}, unconnectedDecayTestVariation={unconnectedDecayTestVariation})'.format(
      ...
      unconnectedDecayTestVariation=repr(self._unconnectedDecayTestVariation))
...
class MessageEngineToGame(object):
  ...
  class Tag(object):
    ...
    EndOfMessage                    = 0x8f # Anki.Cozmo.ExternalInterface.EndOfMessage
  ...
  _tags_by_value[143] = 'EndOfMessage'
  ...
  _tag_unpack_methods[143] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EndOfMessage.unpack_from)
  ...
  _type_by_tag_value[143] = lambda : Anki.Cozmo.ExternalInterface.EndOfMessage
