...
class PostAudioSwitchState(object):
  ...
  def __init__(self, switchStateGroup=Anki.AudioMetaData.SwitchState.SwitchGroupType.Cozmo_Sings_100Bpm, switchStateValue=Anki.AudioMetaData.SwitchState.GenericSwitch.Invalid, gameObject=Anki.AudioMetaData.GameObjectType.Invalid):
