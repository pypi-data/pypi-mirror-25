...
class MessageViz(object):
  ...
  class Tag(object):
    ...
    CarryStateUpdate              = 2  # Anki.Cozmo.CarryStateUpdate
    SetBodyRadioMode              = 3  # Anki.Cozmo.SetBodyRadioMode
    AnimationState                = 4  # Anki.Cozmo.RobotInterface.AnimationState
    ImageChunk                    = 5  # Anki.Cozmo.ImageChunk
    ImageImuData                  = 6  # Anki.Cozmo.ImageImuData
    CameraCalibration             = 7  # Anki.Cozmo.CameraCalibration
    SetVizOrigin                  = 8  # Anki.Cozmo.SetVizOrigin
    RobotStateMessage             = 9  # Anki.Cozmo.VizInterface.RobotStateMessage
    Object                        = 10 # Anki.Cozmo.VizInterface.Object
    SegmentPrimitive              = 11 # Anki.Cozmo.VizInterface.SegmentPrimitive
    Quad                          = 12 # Anki.Cozmo.VizInterface.Quad
    SimpleQuadVectorMessageBegin  = 13 # Anki.Cozmo.VizInterface.SimpleQuadVectorMessageBegin
    SimpleQuadVectorMessage       = 14 # Anki.Cozmo.VizInterface.SimpleQuadVectorMessage
    SimpleQuadVectorMessageEnd    = 15 # Anki.Cozmo.VizInterface.SimpleQuadVectorMessageEnd
    MemoryMapMessageDebugVizBegin = 16 # Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizBegin
    MemoryMapMessageDebugViz      = 17 # Anki.Cozmo.VizInterface.MemoryMapMessageDebugViz
    MemoryMapMessageDebugVizEnd   = 18 # Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizEnd
    CameraQuad                    = 19 # Anki.Cozmo.VizInterface.CameraQuad
    CameraRect                    = 20 # Anki.Cozmo.VizInterface.CameraRect
    CameraLine                    = 21 # Anki.Cozmo.VizInterface.CameraLine
    CameraOval                    = 22 # Anki.Cozmo.VizInterface.CameraOval
    CameraText                    = 23 # Anki.Cozmo.VizInterface.CameraText
    EraseObject                   = 24 # Anki.Cozmo.VizInterface.EraseObject
    EraseSegmentPrimitives        = 25 # Anki.Cozmo.VizInterface.EraseSegmentPrimitives
    EraseQuad                     = 26 # Anki.Cozmo.VizInterface.EraseQuad
    SetRobot                      = 27 # Anki.Cozmo.VizInterface.SetRobot
    AppendPathSegmentLine         = 28 # Anki.Cozmo.VizInterface.AppendPathSegmentLine
    AppendPathSegmentArc          = 29 # Anki.Cozmo.VizInterface.AppendPathSegmentArc
    SetPathColor                  = 30 # Anki.Cozmo.VizInterface.SetPathColor
    ErasePath                     = 31 # Anki.Cozmo.VizInterface.ErasePath
    DefineColor                   = 32 # Anki.Cozmo.VizInterface.DefineColor
    SetLabel                      = 33 # Anki.Cozmo.VizInterface.SetLabel
    DockingErrorSignal            = 34 # Anki.Cozmo.VizInterface.DockingErrorSignal
    CameraInfo                    = 35 # Anki.Cozmo.VizInterface.CameraInfo
    VisionMarker                  = 36 # Anki.Cozmo.VizInterface.VisionMarker
    ShowObjects                   = 37 # Anki.Cozmo.VizInterface.ShowObjects
    TrackerQuad                   = 38 # Anki.Cozmo.VizInterface.TrackerQuad
    FaceDetection                 = 39 # Anki.Cozmo.VizInterface.FaceDetection
    RobotMood                     = 40 # Anki.Cozmo.VizInterface.RobotMood
    RobotBehaviorSelectData       = 41 # Anki.Cozmo.VizInterface.RobotBehaviorSelectData
    NewBehaviorSelected           = 42 # Anki.Cozmo.VizInterface.NewBehaviorSelected
    NewReactionTriggered          = 43 # Anki.Cozmo.VizInterface.NewReactionTriggered
    StartRobotUpdate              = 44 # Anki.Cozmo.VizInterface.StartRobotUpdate
    EndRobotUpdate                = 45 # Anki.Cozmo.VizInterface.EndRobotUpdate
    DisplayImage                  = 46 # Anki.Cozmo.VizInterface.DisplayImage
    SaveImages                    = 47 # Anki.Cozmo.VizInterface.SaveImages
    SaveState                     = 48 # Anki.Cozmo.VizInterface.SaveState
    ObjectConnectionState         = 49 # Anki.Cozmo.VizInterface.ObjectConnectionState
    ObjectMovingState             = 50 # Anki.Cozmo.VizInterface.ObjectMovingState
    ObjectUpAxisState             = 51 # Anki.Cozmo.VizInterface.ObjectUpAxisState
    ObjectAccelState              = 52 # Anki.Cozmo.VizInterface.ObjectAccelState
  ...
  _tags_by_name = dict(
    ...
    SegmentPrimitive=11,
    Quad=12,
    SimpleQuadVectorMessageBegin=13,
    SimpleQuadVectorMessage=14,
    SimpleQuadVectorMessageEnd=15,
    MemoryMapMessageDebugVizBegin=16,
    MemoryMapMessageDebugViz=17,
    MemoryMapMessageDebugVizEnd=18,
    CameraQuad=19,
    CameraRect=20,
    CameraLine=21,
    CameraOval=22,
    CameraText=23,
    EraseObject=24,
    EraseSegmentPrimitives=25,
    EraseQuad=26,
    SetRobot=27,
    AppendPathSegmentLine=28,
    AppendPathSegmentArc=29,
    SetPathColor=30,
    ErasePath=31,
    DefineColor=32,
    SetLabel=33,
    DockingErrorSignal=34,
    CameraInfo=35,
    VisionMarker=36,
    ShowObjects=37,
    TrackerQuad=38,
    FaceDetection=39,
    RobotMood=40,
    RobotBehaviorSelectData=41,
    NewBehaviorSelected=42,
    NewReactionTriggered=43,
    StartRobotUpdate=44,
    EndRobotUpdate=45,
    DisplayImage=46,
    SaveImages=47,
    SaveState=48,
    ObjectConnectionState=49,
    ObjectMovingState=50,
    ObjectUpAxisState=51,
    ObjectAccelState=52,
  )
  ...
  _tags_by_value[2] = 'CarryStateUpdate'
  _tags_by_value[3] = 'SetBodyRadioMode'
  _tags_by_value[4] = 'AnimationState'
  _tags_by_value[5] = 'ImageChunk'
  _tags_by_value[6] = 'ImageImuData'
  _tags_by_value[7] = 'CameraCalibration'
  _tags_by_value[8] = 'SetVizOrigin'
  _tags_by_value[9] = 'RobotStateMessage'
  _tags_by_value[10] = 'Object'
  _tags_by_value[11] = 'SegmentPrimitive'
  _tags_by_value[12] = 'Quad'
  _tags_by_value[13] = 'SimpleQuadVectorMessageBegin'
  _tags_by_value[14] = 'SimpleQuadVectorMessage'
  _tags_by_value[15] = 'SimpleQuadVectorMessageEnd'
  _tags_by_value[16] = 'MemoryMapMessageDebugVizBegin'
  _tags_by_value[17] = 'MemoryMapMessageDebugViz'
  _tags_by_value[18] = 'MemoryMapMessageDebugVizEnd'
  _tags_by_value[19] = 'CameraQuad'
  _tags_by_value[20] = 'CameraRect'
  _tags_by_value[21] = 'CameraLine'
  _tags_by_value[22] = 'CameraOval'
  _tags_by_value[23] = 'CameraText'
  _tags_by_value[24] = 'EraseObject'
  _tags_by_value[25] = 'EraseSegmentPrimitives'
  _tags_by_value[26] = 'EraseQuad'
  _tags_by_value[27] = 'SetRobot'
  _tags_by_value[28] = 'AppendPathSegmentLine'
  _tags_by_value[29] = 'AppendPathSegmentArc'
  _tags_by_value[30] = 'SetPathColor'
  _tags_by_value[31] = 'ErasePath'
  _tags_by_value[32] = 'DefineColor'
  _tags_by_value[33] = 'SetLabel'
  _tags_by_value[34] = 'DockingErrorSignal'
  _tags_by_value[35] = 'CameraInfo'
  _tags_by_value[36] = 'VisionMarker'
  _tags_by_value[37] = 'ShowObjects'
  _tags_by_value[38] = 'TrackerQuad'
  _tags_by_value[39] = 'FaceDetection'
  _tags_by_value[40] = 'RobotMood'
  _tags_by_value[41] = 'RobotBehaviorSelectData'
  _tags_by_value[42] = 'NewBehaviorSelected'
  _tags_by_value[43] = 'NewReactionTriggered'
  _tags_by_value[44] = 'StartRobotUpdate'
  _tags_by_value[45] = 'EndRobotUpdate'
  _tags_by_value[46] = 'DisplayImage'
  _tags_by_value[47] = 'SaveImages'
  _tags_by_value[48] = 'SaveState'
  _tags_by_value[49] = 'ObjectConnectionState'
  _tags_by_value[50] = 'ObjectMovingState'
  _tags_by_value[51] = 'ObjectUpAxisState'
  _tags_by_value[52] = 'ObjectAccelState'
  ...
  _tag_unpack_methods[2] = lambda reader: reader.read_object(Anki.Cozmo.CarryStateUpdate.unpack_from)
  _tag_unpack_methods[3] = lambda reader: reader.read_object(Anki.Cozmo.SetBodyRadioMode.unpack_from)
  _tag_unpack_methods[4] = lambda reader: reader.read_object(Anki.Cozmo.RobotInterface.AnimationState.unpack_from)
  _tag_unpack_methods[5] = lambda reader: reader.read_object(Anki.Cozmo.ImageChunk.unpack_from)
  _tag_unpack_methods[6] = lambda reader: reader.read_object(Anki.Cozmo.ImageImuData.unpack_from)
  _tag_unpack_methods[7] = lambda reader: reader.read_object(Anki.Cozmo.CameraCalibration.unpack_from)
  _tag_unpack_methods[8] = lambda reader: reader.read_object(Anki.Cozmo.SetVizOrigin.unpack_from)
  _tag_unpack_methods[9] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotStateMessage.unpack_from)
  _tag_unpack_methods[10] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.Object.unpack_from)
  _tag_unpack_methods[11] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SegmentPrimitive.unpack_from)
  _tag_unpack_methods[12] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.Quad.unpack_from)
  _tag_unpack_methods[13] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SimpleQuadVectorMessageBegin.unpack_from)
  _tag_unpack_methods[14] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SimpleQuadVectorMessage.unpack_from)
  _tag_unpack_methods[15] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SimpleQuadVectorMessageEnd.unpack_from)
  _tag_unpack_methods[16] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizBegin.unpack_from)
  _tag_unpack_methods[17] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.MemoryMapMessageDebugViz.unpack_from)
  _tag_unpack_methods[18] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizEnd.unpack_from)
  _tag_unpack_methods[19] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraQuad.unpack_from)
  _tag_unpack_methods[20] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraRect.unpack_from)
  _tag_unpack_methods[21] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraLine.unpack_from)
  _tag_unpack_methods[22] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraOval.unpack_from)
  _tag_unpack_methods[23] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraText.unpack_from)
  _tag_unpack_methods[24] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseObject.unpack_from)
  _tag_unpack_methods[25] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseSegmentPrimitives.unpack_from)
  _tag_unpack_methods[26] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[27] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetRobot.unpack_from)
  _tag_unpack_methods[28] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.AppendPathSegmentLine.unpack_from)
  _tag_unpack_methods[29] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.AppendPathSegmentArc.unpack_from)
  _tag_unpack_methods[30] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetPathColor.unpack_from)
  _tag_unpack_methods[31] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ErasePath.unpack_from)
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DefineColor.unpack_from)
  _tag_unpack_methods[33] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetLabel.unpack_from)
  _tag_unpack_methods[34] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DockingErrorSignal.unpack_from)
  _tag_unpack_methods[35] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraInfo.unpack_from)
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.VisionMarker.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ShowObjects.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.TrackerQuad.unpack_from)
  _tag_unpack_methods[39] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.FaceDetection.unpack_from)
  _tag_unpack_methods[40] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotMood.unpack_from)
  _tag_unpack_methods[41] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotBehaviorSelectData.unpack_from)
  _tag_unpack_methods[42] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.NewBehaviorSelected.unpack_from)
  _tag_unpack_methods[43] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.NewReactionTriggered.unpack_from)
  _tag_unpack_methods[44] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.StartRobotUpdate.unpack_from)
  _tag_unpack_methods[45] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EndRobotUpdate.unpack_from)
  _tag_unpack_methods[46] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DisplayImage.unpack_from)
  _tag_unpack_methods[47] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveImages.unpack_from)
  _tag_unpack_methods[48] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveState.unpack_from)
  _tag_unpack_methods[49] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectConnectionState.unpack_from)
  _tag_unpack_methods[50] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectMovingState.unpack_from)
  _tag_unpack_methods[51] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectUpAxisState.unpack_from)
  _tag_unpack_methods[52] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectAccelState.unpack_from)
  ...
  _type_by_tag_value[2] = lambda : Anki.Cozmo.CarryStateUpdate
  _type_by_tag_value[3] = lambda : Anki.Cozmo.SetBodyRadioMode
  _type_by_tag_value[4] = lambda : Anki.Cozmo.RobotInterface.AnimationState
  _type_by_tag_value[5] = lambda : Anki.Cozmo.ImageChunk
  _type_by_tag_value[6] = lambda : Anki.Cozmo.ImageImuData
  _type_by_tag_value[7] = lambda : Anki.Cozmo.CameraCalibration
  _type_by_tag_value[8] = lambda : Anki.Cozmo.SetVizOrigin
  _type_by_tag_value[9] = lambda : Anki.Cozmo.VizInterface.RobotStateMessage
  _type_by_tag_value[10] = lambda : Anki.Cozmo.VizInterface.Object
  _type_by_tag_value[11] = lambda : Anki.Cozmo.VizInterface.SegmentPrimitive
  _type_by_tag_value[12] = lambda : Anki.Cozmo.VizInterface.Quad
  _type_by_tag_value[13] = lambda : Anki.Cozmo.VizInterface.SimpleQuadVectorMessageBegin
  _type_by_tag_value[14] = lambda : Anki.Cozmo.VizInterface.SimpleQuadVectorMessage
  _type_by_tag_value[15] = lambda : Anki.Cozmo.VizInterface.SimpleQuadVectorMessageEnd
  _type_by_tag_value[16] = lambda : Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizBegin
  _type_by_tag_value[17] = lambda : Anki.Cozmo.VizInterface.MemoryMapMessageDebugViz
  _type_by_tag_value[18] = lambda : Anki.Cozmo.VizInterface.MemoryMapMessageDebugVizEnd
  _type_by_tag_value[19] = lambda : Anki.Cozmo.VizInterface.CameraQuad
  _type_by_tag_value[20] = lambda : Anki.Cozmo.VizInterface.CameraRect
  _type_by_tag_value[21] = lambda : Anki.Cozmo.VizInterface.CameraLine
  _type_by_tag_value[22] = lambda : Anki.Cozmo.VizInterface.CameraOval
  _type_by_tag_value[23] = lambda : Anki.Cozmo.VizInterface.CameraText
  _type_by_tag_value[24] = lambda : Anki.Cozmo.VizInterface.EraseObject
  _type_by_tag_value[25] = lambda : Anki.Cozmo.VizInterface.EraseSegmentPrimitives
  _type_by_tag_value[26] = lambda : Anki.Cozmo.VizInterface.EraseQuad
  _type_by_tag_value[27] = lambda : Anki.Cozmo.VizInterface.SetRobot
  _type_by_tag_value[28] = lambda : Anki.Cozmo.VizInterface.AppendPathSegmentLine
  _type_by_tag_value[29] = lambda : Anki.Cozmo.VizInterface.AppendPathSegmentArc
  _type_by_tag_value[30] = lambda : Anki.Cozmo.VizInterface.SetPathColor
  _type_by_tag_value[31] = lambda : Anki.Cozmo.VizInterface.ErasePath
  _type_by_tag_value[32] = lambda : Anki.Cozmo.VizInterface.DefineColor
  _type_by_tag_value[33] = lambda : Anki.Cozmo.VizInterface.SetLabel
  _type_by_tag_value[34] = lambda : Anki.Cozmo.VizInterface.DockingErrorSignal
  _type_by_tag_value[35] = lambda : Anki.Cozmo.VizInterface.CameraInfo
  _type_by_tag_value[36] = lambda : Anki.Cozmo.VizInterface.VisionMarker
  _type_by_tag_value[37] = lambda : Anki.Cozmo.VizInterface.ShowObjects
  _type_by_tag_value[38] = lambda : Anki.Cozmo.VizInterface.TrackerQuad
  _type_by_tag_value[39] = lambda : Anki.Cozmo.VizInterface.FaceDetection
  _type_by_tag_value[40] = lambda : Anki.Cozmo.VizInterface.RobotMood
  _type_by_tag_value[41] = lambda : Anki.Cozmo.VizInterface.RobotBehaviorSelectData
  _type_by_tag_value[42] = lambda : Anki.Cozmo.VizInterface.NewBehaviorSelected
  _type_by_tag_value[43] = lambda : Anki.Cozmo.VizInterface.NewReactionTriggered
  _type_by_tag_value[44] = lambda : Anki.Cozmo.VizInterface.StartRobotUpdate
  _type_by_tag_value[45] = lambda : Anki.Cozmo.VizInterface.EndRobotUpdate
  _type_by_tag_value[46] = lambda : Anki.Cozmo.VizInterface.DisplayImage
  _type_by_tag_value[47] = lambda : Anki.Cozmo.VizInterface.SaveImages
  _type_by_tag_value[48] = lambda : Anki.Cozmo.VizInterface.SaveState
  _type_by_tag_value[49] = lambda : Anki.Cozmo.VizInterface.ObjectConnectionState
  _type_by_tag_value[50] = lambda : Anki.Cozmo.VizInterface.ObjectMovingState
  _type_by_tag_value[51] = lambda : Anki.Cozmo.VizInterface.ObjectUpAxisState
  _type_by_tag_value[52] = lambda : Anki.Cozmo.VizInterface.ObjectAccelState
