...
class AllTriggersConsidered(object):
  ...
  def __init__(self, cliffDetected, cubeMoved, facePositionUpdated, fistBump, frustration, hiccup, motorCalibration, noPreDockPoses, objectPositionUpdated, placedOnCharger, petInitialDetection, robotPickedUp, robotPlacedOnSlope, returnedToTreads, robotOnBack, robotOnFace, robotOnSide, robotShaken, sparked, unexpectedMovement, vc):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_cliffDetected, _cubeMoved, _facePositionUpdated, _fistBump, _frustration, _hiccup, _motorCalibration, _noPreDockPoses, _objectPositionUpdated, _placedOnCharger, _petInitialDetection, _robotPickedUp, _robotPlacedOnSlope, _returnedToTreads, _robotOnBack, _robotOnFace, _robotOnSide, _robotShaken, _sparked, _unexpectedMovement, _vc)
  ...
  def __str__(self):
    return '{type}(cliffDetected={cliffDetected}, cubeMoved={cubeMoved}, facePositionUpdated={facePositionUpdated}, fistBump={fistBump}, frustration={frustration}, hiccup={hiccup}, motorCalibration={motorCalibration}, noPreDockPoses={noPreDockPoses}, objectPositionUpdated={objectPositionUpdated}, placedOnCharger={placedOnCharger}, petInitialDetection={petInitialDetection}, robotPickedUp={robotPickedUp}, robotPlacedOnSlope={robotPlacedOnSlope}, returnedToTreads={returnedToTreads}, robotOnBack={robotOnBack}, robotOnFace={robotOnFace}, robotOnSide={robotOnSide}, robotShaken={robotShaken}, sparked={sparked}, unexpectedMovement={unexpectedMovement}, vc={vc})'.format(
