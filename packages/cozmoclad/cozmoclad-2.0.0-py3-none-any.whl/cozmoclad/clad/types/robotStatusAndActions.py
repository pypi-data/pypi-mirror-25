...
class RobotState(object):
  ...
  @property
  def distanceSensor_mm(self):
    "uint_16 distanceSensor_mm struct property."
    return self._distanceSensor_mm

  @distanceSensor_mm.setter
  def distanceSensor_mm(self, value):
    self._distanceSensor_mm = msgbuffers.validate_integer(
      'RobotState.distanceSensor_mm', value, 0, 65535)
  ...
  def __init__(self, timestamp=0, pose_frame_id=0, pose_origin_id=0, pose=Anki.Cozmo.RobotPose(), lwheel_speed_mmps=0.0, rwheel_speed_mmps=0.0, headAngle=0.0, liftAngle=0.0, accel=Anki.Cozmo.AccelData(), gyro=Anki.Cozmo.GyroData(), batteryVoltage=0.0, status=0, cliffDataRaw=(0,) * 4, distanceSensor_mm=0, currPathSegment=0):
    ...
    self.distanceSensor_mm = distanceSensor_mm
  ...
  def unpack_from(cls, reader):
    ...
    _distanceSensor_mm = reader.read('H')
    _currPathSegment = reader.read('b')
    return cls(_timestamp, _pose_frame_id, _pose_origin_id, _pose, _lwheel_speed_mmps, _rwheel_speed_mmps, _headAngle, _liftAngle, _accel, _gyro, _batteryVoltage, _status, _cliffDataRaw, _distanceSensor_mm, _currPathSegment)
  ...
  def pack_to(self, writer):
    ...
    writer.write(self._distanceSensor_mm, 'H')
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._timestamp == other._timestamp and
        ...
        self._distanceSensor_mm == other._distanceSensor_mm and
  ...
  def __str__(self):
    return '{type}(timestamp={timestamp}, pose_frame_id={pose_frame_id}, pose_origin_id={pose_origin_id}, pose={pose}, lwheel_speed_mmps={lwheel_speed_mmps}, rwheel_speed_mmps={rwheel_speed_mmps}, headAngle={headAngle}, liftAngle={liftAngle}, accel={accel}, gyro={gyro}, batteryVoltage={batteryVoltage}, status={status}, cliffDataRaw={cliffDataRaw}, distanceSensor_mm={distanceSensor_mm}, currPathSegment={currPathSegment})'.format(
      ...
      distanceSensor_mm=self._distanceSensor_mm,
  ...
  def __repr__(self):
    return '{type}(timestamp={timestamp}, pose_frame_id={pose_frame_id}, pose_origin_id={pose_origin_id}, pose={pose}, lwheel_speed_mmps={lwheel_speed_mmps}, rwheel_speed_mmps={rwheel_speed_mmps}, headAngle={headAngle}, liftAngle={liftAngle}, accel={accel}, gyro={gyro}, batteryVoltage={batteryVoltage}, status={status}, cliffDataRaw={cliffDataRaw}, distanceSensor_mm={distanceSensor_mm}, currPathSegment={currPathSegment})'.format(
      ...
      distanceSensor_mm=repr(self._distanceSensor_mm),
