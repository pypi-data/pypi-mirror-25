...
class LocalNotificationItem(object):
  ...
  def __init__(self, notificationMainUnion=Anki.Cozmo.NotificationUnion(), connection=Anki.Cozmo.Connection.Either, textKeys=(), whenType=Anki.Cozmo.WhenType.NotApplicable, whenParam=0.0, rangeEarly=0.0, rangeLate=0.0, minimumDuration=0.0):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_notificationMainUnion, _connection, _textKeys, _whenType, _whenParam, _rangeEarly, _rangeLate, _minimumDuration)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._notificationMainUnion == other._notificationMainUnion and
        ...
        self._minimumDuration == other._minimumDuration)
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(notificationMainUnion={notificationMainUnion}, connection={connection}, textKeys={textKeys}, whenType={whenType}, whenParam={whenParam}, rangeEarly={rangeEarly}, rangeLate={rangeLate}, minimumDuration={minimumDuration})'.format(
      type=type(self).__name__,
