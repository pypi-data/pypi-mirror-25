...
class RobotActionType(object):
  ...
  TRACK_OBJECT                      = 33
  TRACK_FACE                        = 34
  TRACK_GROUND_POINT                = 35
  TRACK_MOTION                      = 36
  TRACK_PET_FACE                    = 37
  TRAVERSE_OBJECT                   = 38
  TURN_IN_PLACE                     = 39
  TURN_TOWARDS_FACE                 = 40
  TURN_TOWARDS_IMAGE_POINT          = 41
  TURN_TOWARDS_LAST_FACE_POSE       = 42
  TURN_TOWARDS_OBJECT               = 43
  TURN_TOWARDS_POSE                 = 44
  VISUALLY_VERIFY_OBJECT            = 45
  VISUALLY_VERIFY_FACE              = 46
  VISUALLY_VERIFY_NO_OBJECT_AT_POSE = 47
  WAIT                              = 48
  WAIT_FOR_IMAGES                   = 49
  WAIT_FOR_LAMBDA                   = 50
