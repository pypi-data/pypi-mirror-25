...
class SetOverrideGameRequestWeights(object):
  ...
  def __init__(self, useDefaults=False, unlockIDs=(), weights=()):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_useDefaults, _unlockIDs, _weights)
  ...
  def __str__(self):
    return '{type}(useDefaults={useDefaults}, unlockIDs={unlockIDs}, weights={weights})'.format(
      type=type(self).__name__,
...
class RegisterOnboardingComplete(object):
  ...
  def __init__(self, onboardingStage=0, finalStage=False):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_onboardingStage, _finalStage)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._onboardingStage == other._onboardingStage and
        self._finalStage == other._finalStage)
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(onboardingStage={onboardingStage}, finalStage={finalStage})'.format(
      type=type(self).__name__,
...
class StoredLabAssignments(object):
  "Generated message-passing message."

  __slots__ = (
    '_assignments', # AssignmentDef[uint_16]
  )

  @property
  def assignments(self):
    "AssignmentDef[uint_16] assignments struct property."
    return self._assignments

  @assignments.setter
  def assignments(self, value):
    self._assignments = msgbuffers.validate_varray(
      'StoredLabAssignments.assignments', value, 65535,
      lambda name, value_inner: msgbuffers.validate_object(
        name, value_inner, Anki.Util.AnkiLab.AssignmentDef))
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new StoredLabAssignments from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('StoredLabAssignments.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new StoredLabAssignments from the given BinaryReader."
    _assignments = reader.read_object_varray(Anki.Util.AnkiLab.AssignmentDef.unpack_from, 'H')
    return cls(_assignments)

  def pack(self):
    "Writes the current StoredLabAssignments, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current StoredLabAssignments to the given BinaryWriter."
    writer.write_object_varray(self._assignments, 'H')
  ...
  def __len__(self):
    return (msgbuffers.size_object_varray(self._assignments, 'H'))

  def __str__(self):
    return '{type}(assignments={assignments})'.format(
      type=type(self).__name__,
      assignments=msgbuffers.shorten_sequence(self._assignments))

  def __repr__(self):
    return '{type}(assignments={assignments})'.format(
      type=type(self).__name__,
      assignments=repr(self._assignments))

Anki.Cozmo.ExternalInterface.StoredLabAssignments = StoredLabAssignments
del StoredLabAssignments
...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    StartControllerTestMode                 = 0x47 # Anki.Cozmo.StartControllerTestMode
    RawPWM                                  = 0x48 # Anki.Cozmo.RawPWM
    ActivateExperimentRequest               = 0x49 # Anki.Util.AnkiLab.ActivateExperimentRequest
    ActivateExperimentResponse              = 0x4a # Anki.Util.AnkiLab.ActivateExperimentResponse
    ...
    UpdateFirmware                          = 0x58 # Anki.Cozmo.ExternalInterface.UpdateFirmware
    ResetFirmware                           = 0x59 # Anki.Cozmo.ExternalInterface.ResetFirmware
    DriveWheels                             = 0x5a # Anki.Cozmo.ExternalInterface.DriveWheels
    DriveArc                                = 0x5b # Anki.Cozmo.ExternalInterface.DriveArc
    MoveHead                                = 0x5c # Anki.Cozmo.ExternalInterface.MoveHead
    MoveLift                                = 0x5d # Anki.Cozmo.ExternalInterface.MoveLift
    EnableLiftPower                         = 0x5e # Anki.Cozmo.ExternalInterface.EnableLiftPower
    EnableCliffSensor                       = 0x5f # Anki.Cozmo.ExternalInterface.EnableCliffSensor
    EnableStopOnCliff                       = 0x60 # Anki.Cozmo.ExternalInterface.EnableStopOnCliff
    EnableBlockTapFilter                    = 0x61 # Anki.Cozmo.ExternalInterface.EnableBlockTapFilter
    GetBlockTapFilterStatus                 = 0x62 # Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus
    StopAllMotors                           = 0x63 # Anki.Cozmo.ExternalInterface.StopAllMotors
    ControllerGains                         = 0x64 # Anki.Cozmo.ExternalInterface.ControllerGains
    RollActionParams                        = 0x65 # Anki.Cozmo.ExternalInterface.RollActionParams
    SetMotionModelParams                    = 0x66 # Anki.Cozmo.ExternalInterface.SetMotionModelParams
    SetRobotVolume                          = 0x67 # Anki.Cozmo.ExternalInterface.SetRobotVolume
    SetRobotAudioOutputSource               = 0x68 # Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource
    ForceDelocalizeRobot                    = 0x69 # Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot
    RestoreRobotFromBackup                  = 0x6a # Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup
    RequestRobotRestoreData                 = 0x6b # Anki.Cozmo.ExternalInterface.RequestRobotRestoreData
    WipeRobotGameData                       = 0x6c # Anki.Cozmo.ExternalInterface.WipeRobotGameData
    RequestUnlockDataFromBackup             = 0x6d # Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup
    CancelAction                            = 0x6e # Anki.Cozmo.ExternalInterface.CancelAction
    CancelActionByIdTag                     = 0x6f # Anki.Cozmo.ExternalInterface.CancelActionByIdTag
    QueueSingleAction                       = 0x70 # Anki.Cozmo.ExternalInterface.QueueSingleAction
    QueueCompoundAction                     = 0x71 # Anki.Cozmo.ExternalInterface.QueueCompoundAction
    RedirectViz                             = 0x72 # Anki.Cozmo.ExternalInterface.RedirectViz
    ImageRequest                            = 0x73 # Anki.Cozmo.ExternalInterface.ImageRequest
    SetRobotImageSendMode                   = 0x74 # Anki.Cozmo.ExternalInterface.SetRobotImageSendMode
    SaveImages                              = 0x75 # Anki.Cozmo.ExternalInterface.SaveImages
    EnableColorImages                       = 0x76 # Anki.Cozmo.ExternalInterface.EnableColorImages
    SaveRobotState                          = 0x77 # Anki.Cozmo.ExternalInterface.SaveRobotState
    EnableDisplay                           = 0x78 # Anki.Cozmo.ExternalInterface.EnableDisplay
    ExecuteTestPlan                         = 0x79 # Anki.Cozmo.ExternalInterface.ExecuteTestPlan
    PlannerRunMode                          = 0x7a # Anki.Cozmo.ExternalInterface.PlannerRunMode
    SelectNextObject                        = 0x7b # Anki.Cozmo.ExternalInterface.SelectNextObject
    SetRobotCarryingObject                  = 0x7c # Anki.Cozmo.ExternalInterface.SetRobotCarryingObject
    DeleteAllCustomObjects                  = 0x7d # Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects
    DeleteCustomMarkerObjects               = 0x7e # Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects
    DeleteFixedCustomObjects                = 0x7f # Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects
    UndefineAllCustomMarkerObjects          = 0x80 # Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects
    CreateFixedCustomObject                 = 0x81 # Anki.Cozmo.ExternalInterface.CreateFixedCustomObject
    DefineCustomBox                         = 0x82 # Anki.Cozmo.ExternalInterface.DefineCustomBox
    DefineCustomCube                        = 0x83 # Anki.Cozmo.ExternalInterface.DefineCustomCube
    DefineCustomWall                        = 0x84 # Anki.Cozmo.ExternalInterface.DefineCustomWall
    VisionWhileMoving                       = 0x85 # Anki.Cozmo.ExternalInterface.VisionWhileMoving
    SetFaceToEnroll                         = 0x86 # Anki.Cozmo.ExternalInterface.SetFaceToEnroll
    CancelFaceEnrollment                    = 0x87 # Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
    EraseEnrolledFaceByID                   = 0x88 # Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
    EraseAllEnrolledFaces                   = 0x89 # Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
    EnableVisionMode                        = 0x8a # Anki.Cozmo.ExternalInterface.EnableVisionMode
    UpdateEnrolledFaceByID                  = 0x8b # Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
    VisionRunMode                           = 0x8c # Anki.Cozmo.ExternalInterface.VisionRunMode
    SaveFaceAlbumToFile                     = 0x8d # Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
    LoadFaceAlbumFromFile                   = 0x8e # Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
    SetMemoryMapRenderEnabled               = 0x8f # Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
    SetMemoryMapBroadcastFrequency_sec      = 0x90 # Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
    ActivateHighLevelActivity               = 0x91 # Anki.Cozmo.ExternalInterface.ActivateHighLevelActivity
    ExecuteBehaviorByExecutableType         = 0x92 # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
    ExecuteBehaviorByID                     = 0x93 # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByID
    SetLiftLoadTestAsRunnable               = 0x94 # Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
    BehaviorManagerMessage                  = 0x95 # Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
    CanCozmoRequestGame                     = 0x96 # Anki.Cozmo.ExternalInterface.CanCozmoRequestGame
    SetOverrideGameRequestWeights           = 0x97 # Anki.Cozmo.ExternalInterface.SetOverrideGameRequestWeights
    AbortPath                               = 0x98 # Anki.Cozmo.ExternalInterface.AbortPath
    AbortAll                                = 0x99 # Anki.Cozmo.ExternalInterface.AbortAll
    StartTestMode                           = 0x9a # Anki.Cozmo.ExternalInterface.StartTestMode
    RequestAllBehaviorsList                 = 0x9b # Anki.Cozmo.ExternalInterface.RequestAllBehaviorsList
    RequestReactionTriggerMap               = 0x9c # Anki.Cozmo.ExternalInterface.RequestReactionTriggerMap
    ExecuteReactionTrigger                  = 0x9d # Anki.Cozmo.ExternalInterface.ExecuteReactionTrigger
    DisableReactionsWithLock                = 0x9e # Anki.Cozmo.ExternalInterface.DisableReactionsWithLock
    RemoveDisableReactionsLock              = 0x9f # Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock
    DisableAllReactionsWithLock             = 0xa0 # Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock
    SetDefaultHeadAndLiftState              = 0xa1 # Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
    SetSparkedMusicState                    = 0xa2 # Anki.Cozmo.ExternalInterface.SetSparkedMusicState
    NotifyOverfeedingShouldTriggerHiccups   = 0xa3 # Anki.Cozmo.ExternalInterface.NotifyOverfeedingShouldTriggerHiccups
    RequestPyramidPreReqState               = 0xa4 # Anki.Cozmo.ExternalInterface.RequestPyramidPreReqState
    NotifyCozmoWakeup                       = 0xa5 # Anki.Cozmo.ExternalInterface.NotifyCozmoWakeup
    RequestLocatedObjectStates              = 0xa6 # Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates
    RequestConnectedObjects                 = 0xa7 # Anki.Cozmo.ExternalInterface.RequestConnectedObjects
    DrawPoseMarker                          = 0xa8 # Anki.Cozmo.ExternalInterface.DrawPoseMarker
    ErasePoseMarker                         = 0xa9 # Anki.Cozmo.ExternalInterface.ErasePoseMarker
    VisualizeQuad                           = 0xaa # Anki.Cozmo.ExternalInterface.VisualizeQuad
    EraseQuad                               = 0xab # Anki.Cozmo.ExternalInterface.EraseQuad
    ReplayLastAnimation                     = 0xac # Anki.Cozmo.ExternalInterface.ReplayLastAnimation
    PushIdleAnimation                       = 0xad # Anki.Cozmo.ExternalInterface.PushIdleAnimation
    RemoveIdleAnimation                     = 0xae # Anki.Cozmo.ExternalInterface.RemoveIdleAnimation
    ReadFaceAnimationDir                    = 0xaf # Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
    ReadAnimationFile                       = 0xb0 # Anki.Cozmo.ExternalInterface.ReadAnimationFile
    RequestAvailableAnimations              = 0xb1 # Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
    RequestAvailableAnimationGroups         = 0xb2 # Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
    SetLiveIdleAnimationParameters          = 0xb3 # Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
    PushDrivingAnimations                   = 0xb4 # Anki.Cozmo.ExternalInterface.PushDrivingAnimations
    RemoveDrivingAnimations                 = 0xb5 # Anki.Cozmo.ExternalInterface.RemoveDrivingAnimations
    SetHeadlight                            = 0xb6 # Anki.Cozmo.ExternalInterface.SetHeadlight
    SetActiveObjectLEDs                     = 0xb7 # Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
    SetAllActiveObjectLEDs                  = 0xb8 # Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
    SetBackpackLEDs                         = 0xb9 # Anki.Cozmo.ExternalInterface.SetBackpackLEDs
    EnableLightStates                       = 0xba # Anki.Cozmo.ExternalInterface.EnableLightStates
    EnableCubeSleep                         = 0xbb # Anki.Cozmo.ExternalInterface.EnableCubeSleep
    EnableCubeLightsStateTransitionMessages = 0xbc # Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
    FlashCurrentLightsState                 = 0xbd # Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
    PlayCubeAnim                            = 0xbe # Anki.Cozmo.ExternalInterface.PlayCubeAnim
    StopCubeAnim                            = 0xbf # Anki.Cozmo.ExternalInterface.StopCubeAnim
    StreamObjectAccel                       = 0xc0 # Anki.Cozmo.ExternalInterface.StreamObjectAccel
    TransitionToNextOnboardingState         = 0xc1 # Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
    MoodMessage                             = 0xc2 # Anki.Cozmo.ExternalInterface.MoodMessage
    GetNeedsState                           = 0xc3 # Anki.Cozmo.ExternalInterface.GetNeedsState
    ForceSetNeedsLevels                     = 0xc4 # Anki.Cozmo.ExternalInterface.ForceSetNeedsLevels
    ForceSetDamagedParts                    = 0xc5 # Anki.Cozmo.ExternalInterface.ForceSetDamagedParts
    RegisterOnboardingComplete              = 0xc6 # Anki.Cozmo.ExternalInterface.RegisterOnboardingComplete
    SetNeedsPauseState                      = 0xc7 # Anki.Cozmo.ExternalInterface.SetNeedsPauseState
    GetNeedsPauseState                      = 0xc8 # Anki.Cozmo.ExternalInterface.GetNeedsPauseState
    SetNeedsPauseStates                     = 0xc9 # Anki.Cozmo.ExternalInterface.SetNeedsPauseStates
    GetNeedsPauseStates                     = 0xca # Anki.Cozmo.ExternalInterface.GetNeedsPauseStates
    SetNeedsActionWhitelist                 = 0xcb # Anki.Cozmo.ExternalInterface.SetNeedsActionWhitelist
    RegisterNeedsActionCompleted            = 0xcc # Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted
    GetWantsNeedsOnboarding                 = 0xcd # Anki.Cozmo.ExternalInterface.GetWantsNeedsOnboarding
    WipeRobotNeedsData                      = 0xce # Anki.Cozmo.ExternalInterface.WipeRobotNeedsData
    WipeDeviceNeedsData                     = 0xcf # Anki.Cozmo.ExternalInterface.WipeDeviceNeedsData
    RequestSetUnlock                        = 0xd0 # Anki.Cozmo.ExternalInterface.RequestSetUnlock
    InventoryRequestAdd                     = 0xd1 # Anki.Cozmo.ExternalInterface.InventoryRequestAdd
    InventoryRequestSet                     = 0xd2 # Anki.Cozmo.ExternalInterface.InventoryRequestSet
    InventoryRequestGet                     = 0xd3 # Anki.Cozmo.ExternalInterface.InventoryRequestGet
    RequestDeviceData                       = 0xd4 # Anki.Cozmo.ExternalInterface.RequestDeviceData
    StoredLabAssignments                    = 0xd5 # Anki.Cozmo.ExternalInterface.StoredLabAssignments
    SetDebugConsoleVarMessage               = 0xd6 # Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
    RunDebugConsoleFuncMessage              = 0xd7 # Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
    GetDebugConsoleVarMessage               = 0xd8 # Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
    GetAllDebugConsoleVarMessage            = 0xd9 # Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
    GetJsonDasLogsMessage                   = 0xda # Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
    SetEnableSpeedChooser                   = 0xdb # Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
    LogRawCliffData                         = 0xdc # Anki.Cozmo.ExternalInterface.LogRawCliffData
    BlockPoolEnabledMessage                 = 0xdd # Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
    BlockSelectedMessage                    = 0xde # Anki.Cozmo.ExternalInterface.BlockSelectedMessage
    GetBlockPoolMessage                     = 0xdf # Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
    SendAvailableObjects                    = 0xe0 # Anki.Cozmo.ExternalInterface.SendAvailableObjects
    BlockPoolResetMessage                   = 0xe1 # Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
    SaveCalibrationImage                    = 0xe2 # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xe3 # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xe4 # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xe5 # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xe6 # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xe7 # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xe8 # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xe9 # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xea # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    SetShouldAutoConnectToCubesAtStart      = 0xeb # Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
    SetShouldAutoDisconnectFromCubesAtEnd   = 0xec # Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
    TransferFile                            = 0xed # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xee # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xef # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xf0 # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xf1 # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xf2 # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xf3 # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xf4 # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  @property
  def StoredLabAssignments(self):
    "Anki.Cozmo.ExternalInterface.StoredLabAssignments StoredLabAssignments union property."
    msgbuffers.safety_check_tag('StoredLabAssignments', self._tag, self.Tag.StoredLabAssignments, self._tags_by_value)
    return self._data

  @StoredLabAssignments.setter
  def StoredLabAssignments(self, value):
    self._data = msgbuffers.validate_object(
      'MessageGameToEngine.StoredLabAssignments', value, Anki.Cozmo.ExternalInterface.StoredLabAssignments)
    self._tag = self.Tag.StoredLabAssignments
  ...
  _tags_by_name = dict(
    ...
    IMURequest=69,
    IMUTemperature=70,
    StartControllerTestMode=71,
    RawPWM=72,
    ActivateExperimentRequest=73,
    ActivateExperimentResponse=74,
    ...
    MoveLift=93,
    EnableLiftPower=94,
    EnableCliffSensor=95,
    EnableStopOnCliff=96,
    EnableBlockTapFilter=97,
    GetBlockTapFilterStatus=98,
    StopAllMotors=99,
    ControllerGains=100,
    RollActionParams=101,
    SetMotionModelParams=102,
    SetRobotVolume=103,
    SetRobotAudioOutputSource=104,
    ForceDelocalizeRobot=105,
    RestoreRobotFromBackup=106,
    RequestRobotRestoreData=107,
    WipeRobotGameData=108,
    RequestUnlockDataFromBackup=109,
    CancelAction=110,
    CancelActionByIdTag=111,
    QueueSingleAction=112,
    QueueCompoundAction=113,
    RedirectViz=114,
    ImageRequest=115,
    SetRobotImageSendMode=116,
    SaveImages=117,
    EnableColorImages=118,
    SaveRobotState=119,
    EnableDisplay=120,
    ExecuteTestPlan=121,
    PlannerRunMode=122,
    SelectNextObject=123,
    SetRobotCarryingObject=124,
    DeleteAllCustomObjects=125,
    DeleteCustomMarkerObjects=126,
    DeleteFixedCustomObjects=127,
    UndefineAllCustomMarkerObjects=128,
    CreateFixedCustomObject=129,
    DefineCustomBox=130,
    DefineCustomCube=131,
    DefineCustomWall=132,
    VisionWhileMoving=133,
    SetFaceToEnroll=134,
    CancelFaceEnrollment=135,
    EraseEnrolledFaceByID=136,
    EraseAllEnrolledFaces=137,
    EnableVisionMode=138,
    UpdateEnrolledFaceByID=139,
    VisionRunMode=140,
    SaveFaceAlbumToFile=141,
    LoadFaceAlbumFromFile=142,
    SetMemoryMapRenderEnabled=143,
    SetMemoryMapBroadcastFrequency_sec=144,
    ActivateHighLevelActivity=145,
    ExecuteBehaviorByExecutableType=146,
    ExecuteBehaviorByID=147,
    SetLiftLoadTestAsRunnable=148,
    BehaviorManagerMessage=149,
    CanCozmoRequestGame=150,
    SetOverrideGameRequestWeights=151,
    AbortPath=152,
    AbortAll=153,
    StartTestMode=154,
    RequestAllBehaviorsList=155,
    RequestReactionTriggerMap=156,
    ExecuteReactionTrigger=157,
    DisableReactionsWithLock=158,
    RemoveDisableReactionsLock=159,
    DisableAllReactionsWithLock=160,
    SetDefaultHeadAndLiftState=161,
    SetSparkedMusicState=162,
    NotifyOverfeedingShouldTriggerHiccups=163,
    RequestPyramidPreReqState=164,
    NotifyCozmoWakeup=165,
    RequestLocatedObjectStates=166,
    RequestConnectedObjects=167,
    DrawPoseMarker=168,
    ErasePoseMarker=169,
    VisualizeQuad=170,
    EraseQuad=171,
    ReplayLastAnimation=172,
    PushIdleAnimation=173,
    RemoveIdleAnimation=174,
    ReadFaceAnimationDir=175,
    ReadAnimationFile=176,
    RequestAvailableAnimations=177,
    RequestAvailableAnimationGroups=178,
    SetLiveIdleAnimationParameters=179,
    PushDrivingAnimations=180,
    RemoveDrivingAnimations=181,
    SetHeadlight=182,
    SetActiveObjectLEDs=183,
    SetAllActiveObjectLEDs=184,
    SetBackpackLEDs=185,
    EnableLightStates=186,
    EnableCubeSleep=187,
    EnableCubeLightsStateTransitionMessages=188,
    FlashCurrentLightsState=189,
    PlayCubeAnim=190,
    StopCubeAnim=191,
    StreamObjectAccel=192,
    TransitionToNextOnboardingState=193,
    MoodMessage=194,
    GetNeedsState=195,
    ForceSetNeedsLevels=196,
    ForceSetDamagedParts=197,
    RegisterOnboardingComplete=198,
    SetNeedsPauseState=199,
    GetNeedsPauseState=200,
    SetNeedsPauseStates=201,
    GetNeedsPauseStates=202,
    SetNeedsActionWhitelist=203,
    RegisterNeedsActionCompleted=204,
    GetWantsNeedsOnboarding=205,
    WipeRobotNeedsData=206,
    WipeDeviceNeedsData=207,
    RequestSetUnlock=208,
    InventoryRequestAdd=209,
    InventoryRequestSet=210,
    InventoryRequestGet=211,
    RequestDeviceData=212,
    StoredLabAssignments=213,
    SetDebugConsoleVarMessage=214,
    RunDebugConsoleFuncMessage=215,
    GetDebugConsoleVarMessage=216,
    GetAllDebugConsoleVarMessage=217,
    GetJsonDasLogsMessage=218,
    SetEnableSpeedChooser=219,
    LogRawCliffData=220,
    BlockPoolEnabledMessage=221,
    BlockSelectedMessage=222,
    GetBlockPoolMessage=223,
    SendAvailableObjects=224,
    BlockPoolResetMessage=225,
    SaveCalibrationImage=226,
    ClearCalibrationImages=227,
    ComputeCameraCalibration=228,
    ContinueFreeplayFromIdle=229,
    EnableDroneMode=230,
    EnterSdkMode=231,
    ExitSdkMode=232,
    SetStopRobotOnSdkDisconnect=233,
    StopRobotForSdk=234,
    SetShouldAutoConnectToCubesAtStart=235,
    SetShouldAutoDisconnectFromCubesAtEnd=236,
    TransferFile=237,
    NVStorageEraseEntry=238,
    NVStorageWipeAll=239,
    NVStorageWriteEntry=240,
    NVStorageClearPartialPendingWriteEntry=241,
    NVStorageReadEntry=242,
    SetCameraSettings=243,
    RequestRobotSettings=244,
  )
  ...
  _tags_by_value[71] = 'StartControllerTestMode'
  _tags_by_value[72] = 'RawPWM'
  _tags_by_value[73] = 'ActivateExperimentRequest'
  _tags_by_value[74] = 'ActivateExperimentResponse'
  ...
  _tags_by_value[88] = 'UpdateFirmware'
  _tags_by_value[89] = 'ResetFirmware'
  _tags_by_value[90] = 'DriveWheels'
  _tags_by_value[91] = 'DriveArc'
  _tags_by_value[92] = 'MoveHead'
  _tags_by_value[93] = 'MoveLift'
  _tags_by_value[94] = 'EnableLiftPower'
  _tags_by_value[95] = 'EnableCliffSensor'
  _tags_by_value[96] = 'EnableStopOnCliff'
  _tags_by_value[97] = 'EnableBlockTapFilter'
  _tags_by_value[98] = 'GetBlockTapFilterStatus'
  _tags_by_value[99] = 'StopAllMotors'
  _tags_by_value[100] = 'ControllerGains'
  _tags_by_value[101] = 'RollActionParams'
  _tags_by_value[102] = 'SetMotionModelParams'
  _tags_by_value[103] = 'SetRobotVolume'
  _tags_by_value[104] = 'SetRobotAudioOutputSource'
  _tags_by_value[105] = 'ForceDelocalizeRobot'
  _tags_by_value[106] = 'RestoreRobotFromBackup'
  _tags_by_value[107] = 'RequestRobotRestoreData'
  _tags_by_value[108] = 'WipeRobotGameData'
  _tags_by_value[109] = 'RequestUnlockDataFromBackup'
  _tags_by_value[110] = 'CancelAction'
  _tags_by_value[111] = 'CancelActionByIdTag'
  _tags_by_value[112] = 'QueueSingleAction'
  _tags_by_value[113] = 'QueueCompoundAction'
  _tags_by_value[114] = 'RedirectViz'
  _tags_by_value[115] = 'ImageRequest'
  _tags_by_value[116] = 'SetRobotImageSendMode'
  _tags_by_value[117] = 'SaveImages'
  _tags_by_value[118] = 'EnableColorImages'
  _tags_by_value[119] = 'SaveRobotState'
  _tags_by_value[120] = 'EnableDisplay'
  _tags_by_value[121] = 'ExecuteTestPlan'
  _tags_by_value[122] = 'PlannerRunMode'
  _tags_by_value[123] = 'SelectNextObject'
  _tags_by_value[124] = 'SetRobotCarryingObject'
  _tags_by_value[125] = 'DeleteAllCustomObjects'
  _tags_by_value[126] = 'DeleteCustomMarkerObjects'
  _tags_by_value[127] = 'DeleteFixedCustomObjects'
  _tags_by_value[128] = 'UndefineAllCustomMarkerObjects'
  _tags_by_value[129] = 'CreateFixedCustomObject'
  _tags_by_value[130] = 'DefineCustomBox'
  _tags_by_value[131] = 'DefineCustomCube'
  _tags_by_value[132] = 'DefineCustomWall'
  _tags_by_value[133] = 'VisionWhileMoving'
  _tags_by_value[134] = 'SetFaceToEnroll'
  _tags_by_value[135] = 'CancelFaceEnrollment'
  _tags_by_value[136] = 'EraseEnrolledFaceByID'
  _tags_by_value[137] = 'EraseAllEnrolledFaces'
  _tags_by_value[138] = 'EnableVisionMode'
  _tags_by_value[139] = 'UpdateEnrolledFaceByID'
  _tags_by_value[140] = 'VisionRunMode'
  _tags_by_value[141] = 'SaveFaceAlbumToFile'
  _tags_by_value[142] = 'LoadFaceAlbumFromFile'
  _tags_by_value[143] = 'SetMemoryMapRenderEnabled'
  _tags_by_value[144] = 'SetMemoryMapBroadcastFrequency_sec'
  _tags_by_value[145] = 'ActivateHighLevelActivity'
  _tags_by_value[146] = 'ExecuteBehaviorByExecutableType'
  _tags_by_value[147] = 'ExecuteBehaviorByID'
  _tags_by_value[148] = 'SetLiftLoadTestAsRunnable'
  _tags_by_value[149] = 'BehaviorManagerMessage'
  _tags_by_value[150] = 'CanCozmoRequestGame'
  _tags_by_value[151] = 'SetOverrideGameRequestWeights'
  _tags_by_value[152] = 'AbortPath'
  _tags_by_value[153] = 'AbortAll'
  _tags_by_value[154] = 'StartTestMode'
  _tags_by_value[155] = 'RequestAllBehaviorsList'
  _tags_by_value[156] = 'RequestReactionTriggerMap'
  _tags_by_value[157] = 'ExecuteReactionTrigger'
  _tags_by_value[158] = 'DisableReactionsWithLock'
  _tags_by_value[159] = 'RemoveDisableReactionsLock'
  _tags_by_value[160] = 'DisableAllReactionsWithLock'
  _tags_by_value[161] = 'SetDefaultHeadAndLiftState'
  _tags_by_value[162] = 'SetSparkedMusicState'
  _tags_by_value[163] = 'NotifyOverfeedingShouldTriggerHiccups'
  _tags_by_value[164] = 'RequestPyramidPreReqState'
  _tags_by_value[165] = 'NotifyCozmoWakeup'
  _tags_by_value[166] = 'RequestLocatedObjectStates'
  _tags_by_value[167] = 'RequestConnectedObjects'
  _tags_by_value[168] = 'DrawPoseMarker'
  _tags_by_value[169] = 'ErasePoseMarker'
  _tags_by_value[170] = 'VisualizeQuad'
  _tags_by_value[171] = 'EraseQuad'
  _tags_by_value[172] = 'ReplayLastAnimation'
  _tags_by_value[173] = 'PushIdleAnimation'
  _tags_by_value[174] = 'RemoveIdleAnimation'
  _tags_by_value[175] = 'ReadFaceAnimationDir'
  _tags_by_value[176] = 'ReadAnimationFile'
  _tags_by_value[177] = 'RequestAvailableAnimations'
  _tags_by_value[178] = 'RequestAvailableAnimationGroups'
  _tags_by_value[179] = 'SetLiveIdleAnimationParameters'
  _tags_by_value[180] = 'PushDrivingAnimations'
  _tags_by_value[181] = 'RemoveDrivingAnimations'
  _tags_by_value[182] = 'SetHeadlight'
  _tags_by_value[183] = 'SetActiveObjectLEDs'
  _tags_by_value[184] = 'SetAllActiveObjectLEDs'
  _tags_by_value[185] = 'SetBackpackLEDs'
  _tags_by_value[186] = 'EnableLightStates'
  _tags_by_value[187] = 'EnableCubeSleep'
  _tags_by_value[188] = 'EnableCubeLightsStateTransitionMessages'
  _tags_by_value[189] = 'FlashCurrentLightsState'
  _tags_by_value[190] = 'PlayCubeAnim'
  _tags_by_value[191] = 'StopCubeAnim'
  _tags_by_value[192] = 'StreamObjectAccel'
  _tags_by_value[193] = 'TransitionToNextOnboardingState'
  _tags_by_value[194] = 'MoodMessage'
  _tags_by_value[195] = 'GetNeedsState'
  _tags_by_value[196] = 'ForceSetNeedsLevels'
  _tags_by_value[197] = 'ForceSetDamagedParts'
  _tags_by_value[198] = 'RegisterOnboardingComplete'
  _tags_by_value[199] = 'SetNeedsPauseState'
  _tags_by_value[200] = 'GetNeedsPauseState'
  _tags_by_value[201] = 'SetNeedsPauseStates'
  _tags_by_value[202] = 'GetNeedsPauseStates'
  _tags_by_value[203] = 'SetNeedsActionWhitelist'
  _tags_by_value[204] = 'RegisterNeedsActionCompleted'
  _tags_by_value[205] = 'GetWantsNeedsOnboarding'
  _tags_by_value[206] = 'WipeRobotNeedsData'
  _tags_by_value[207] = 'WipeDeviceNeedsData'
  _tags_by_value[208] = 'RequestSetUnlock'
  _tags_by_value[209] = 'InventoryRequestAdd'
  _tags_by_value[210] = 'InventoryRequestSet'
  _tags_by_value[211] = 'InventoryRequestGet'
  _tags_by_value[212] = 'RequestDeviceData'
  _tags_by_value[213] = 'StoredLabAssignments'
  _tags_by_value[214] = 'SetDebugConsoleVarMessage'
  _tags_by_value[215] = 'RunDebugConsoleFuncMessage'
  _tags_by_value[216] = 'GetDebugConsoleVarMessage'
  _tags_by_value[217] = 'GetAllDebugConsoleVarMessage'
  _tags_by_value[218] = 'GetJsonDasLogsMessage'
  _tags_by_value[219] = 'SetEnableSpeedChooser'
  _tags_by_value[220] = 'LogRawCliffData'
  _tags_by_value[221] = 'BlockPoolEnabledMessage'
  _tags_by_value[222] = 'BlockSelectedMessage'
  _tags_by_value[223] = 'GetBlockPoolMessage'
  _tags_by_value[224] = 'SendAvailableObjects'
  _tags_by_value[225] = 'BlockPoolResetMessage'
  _tags_by_value[226] = 'SaveCalibrationImage'
  _tags_by_value[227] = 'ClearCalibrationImages'
  _tags_by_value[228] = 'ComputeCameraCalibration'
  _tags_by_value[229] = 'ContinueFreeplayFromIdle'
  _tags_by_value[230] = 'EnableDroneMode'
  _tags_by_value[231] = 'EnterSdkMode'
  _tags_by_value[232] = 'ExitSdkMode'
  _tags_by_value[233] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[234] = 'StopRobotForSdk'
  _tags_by_value[235] = 'SetShouldAutoConnectToCubesAtStart'
  _tags_by_value[236] = 'SetShouldAutoDisconnectFromCubesAtEnd'
  _tags_by_value[237] = 'TransferFile'
  _tags_by_value[238] = 'NVStorageEraseEntry'
  _tags_by_value[239] = 'NVStorageWipeAll'
  _tags_by_value[240] = 'NVStorageWriteEntry'
  _tags_by_value[241] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[242] = 'NVStorageReadEntry'
  _tags_by_value[243] = 'SetCameraSettings'
  _tags_by_value[244] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.StartControllerTestMode.unpack_from)
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.RawPWM.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Util.AnkiLab.ActivateExperimentRequest.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Util.AnkiLab.ActivateExperimentResponse.unpack_from)
  ...
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateFirmware.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ResetFirmware.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DriveWheels.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DriveArc.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoveHead.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoveLift.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableLiftPower.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCliffSensor.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableStopOnCliff.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableBlockTapFilter.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopAllMotors.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ControllerGains.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RollActionParams.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMotionModelParams.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotVolume.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotRestoreData.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WipeRobotGameData.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelAction.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelActionByIdTag.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.QueueSingleAction.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.QueueCompoundAction.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RedirectViz.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ImageRequest.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotImageSendMode.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveImages.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableColorImages.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveRobotState.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDisplay.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteTestPlan.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlannerRunMode.unpack_from)
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SelectNextObject.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotCarryingObject.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects.unpack_from)
  _tag_unpack_methods[127] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects.unpack_from)
  _tag_unpack_methods[128] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects.unpack_from)
  _tag_unpack_methods[129] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreateFixedCustomObject.unpack_from)
  _tag_unpack_methods[130] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomBox.unpack_from)
  _tag_unpack_methods[131] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomCube.unpack_from)
  _tag_unpack_methods[132] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomWall.unpack_from)
  _tag_unpack_methods[133] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionWhileMoving.unpack_from)
  _tag_unpack_methods[134] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetFaceToEnroll.unpack_from)
  _tag_unpack_methods[135] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelFaceEnrollment.unpack_from)
  _tag_unpack_methods[136] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[137] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[138] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableVisionMode.unpack_from)
  _tag_unpack_methods[139] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[140] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionRunMode.unpack_from)
  _tag_unpack_methods[141] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile.unpack_from)
  _tag_unpack_methods[142] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile.unpack_from)
  _tag_unpack_methods[143] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled.unpack_from)
  _tag_unpack_methods[144] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec.unpack_from)
  _tag_unpack_methods[145] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ActivateHighLevelActivity.unpack_from)
  _tag_unpack_methods[146] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType.unpack_from)
  _tag_unpack_methods[147] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByID.unpack_from)
  _tag_unpack_methods[148] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable.unpack_from)
  _tag_unpack_methods[149] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorManagerMessage.unpack_from)
  _tag_unpack_methods[150] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CanCozmoRequestGame.unpack_from)
  _tag_unpack_methods[151] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetOverrideGameRequestWeights.unpack_from)
  _tag_unpack_methods[152] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortPath.unpack_from)
  _tag_unpack_methods[153] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortAll.unpack_from)
  _tag_unpack_methods[154] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartTestMode.unpack_from)
  _tag_unpack_methods[155] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAllBehaviorsList.unpack_from)
  _tag_unpack_methods[156] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestReactionTriggerMap.unpack_from)
  _tag_unpack_methods[157] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteReactionTrigger.unpack_from)
  _tag_unpack_methods[158] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisableReactionsWithLock.unpack_from)
  _tag_unpack_methods[159] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock.unpack_from)
  _tag_unpack_methods[160] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock.unpack_from)
  _tag_unpack_methods[161] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState.unpack_from)
  _tag_unpack_methods[162] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetSparkedMusicState.unpack_from)
  _tag_unpack_methods[163] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NotifyOverfeedingShouldTriggerHiccups.unpack_from)
  _tag_unpack_methods[164] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestPyramidPreReqState.unpack_from)
  _tag_unpack_methods[165] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NotifyCozmoWakeup.unpack_from)
  _tag_unpack_methods[166] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates.unpack_from)
  _tag_unpack_methods[167] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestConnectedObjects.unpack_from)
  _tag_unpack_methods[168] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DrawPoseMarker.unpack_from)
  _tag_unpack_methods[169] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ErasePoseMarker.unpack_from)
  _tag_unpack_methods[170] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisualizeQuad.unpack_from)
  _tag_unpack_methods[171] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[172] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReplayLastAnimation.unpack_from)
  _tag_unpack_methods[173] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushIdleAnimation.unpack_from)
  _tag_unpack_methods[174] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RemoveIdleAnimation.unpack_from)
  _tag_unpack_methods[175] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir.unpack_from)
  _tag_unpack_methods[176] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadAnimationFile.unpack_from)
  _tag_unpack_methods[177] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimations.unpack_from)
  _tag_unpack_methods[178] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups.unpack_from)
  _tag_unpack_methods[179] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters.unpack_from)
  _tag_unpack_methods[180] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushDrivingAnimations.unpack_from)
  _tag_unpack_methods[181] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RemoveDrivingAnimations.unpack_from)
  _tag_unpack_methods[182] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetHeadlight.unpack_from)
  _tag_unpack_methods[183] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[184] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[185] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetBackpackLEDs.unpack_from)
  _tag_unpack_methods[186] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableLightStates.unpack_from)
  _tag_unpack_methods[187] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeSleep.unpack_from)
  _tag_unpack_methods[188] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages.unpack_from)
  _tag_unpack_methods[189] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FlashCurrentLightsState.unpack_from)
  _tag_unpack_methods[190] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlayCubeAnim.unpack_from)
  _tag_unpack_methods[191] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopCubeAnim.unpack_from)
  _tag_unpack_methods[192] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StreamObjectAccel.unpack_from)
  _tag_unpack_methods[193] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState.unpack_from)
  _tag_unpack_methods[194] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodMessage.unpack_from)
  _tag_unpack_methods[195] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsState.unpack_from)
  _tag_unpack_methods[196] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ForceSetNeedsLevels.unpack_from)
  _tag_unpack_methods[197] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ForceSetDamagedParts.unpack_from)
  _tag_unpack_methods[198] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RegisterOnboardingComplete.unpack_from)
  _tag_unpack_methods[199] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsPauseState.unpack_from)
  _tag_unpack_methods[200] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsPauseState.unpack_from)
  _tag_unpack_methods[201] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsPauseStates.unpack_from)
  _tag_unpack_methods[202] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsPauseStates.unpack_from)
  _tag_unpack_methods[203] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsActionWhitelist.unpack_from)
  _tag_unpack_methods[204] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted.unpack_from)
  _tag_unpack_methods[205] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetWantsNeedsOnboarding.unpack_from)
  _tag_unpack_methods[206] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WipeRobotNeedsData.unpack_from)
  _tag_unpack_methods[207] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WipeDeviceNeedsData.unpack_from)
  _tag_unpack_methods[208] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlock.unpack_from)
  _tag_unpack_methods[209] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InventoryRequestAdd.unpack_from)
  _tag_unpack_methods[210] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InventoryRequestSet.unpack_from)
  _tag_unpack_methods[211] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InventoryRequestGet.unpack_from)
  _tag_unpack_methods[212] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestDeviceData.unpack_from)
  _tag_unpack_methods[213] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StoredLabAssignments.unpack_from)
  _tag_unpack_methods[214] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[215] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[216] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[217] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[218] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage.unpack_from)
  _tag_unpack_methods[219] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser.unpack_from)
  _tag_unpack_methods[220] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LogRawCliffData.unpack_from)
  _tag_unpack_methods[221] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage.unpack_from)
  _tag_unpack_methods[222] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockSelectedMessage.unpack_from)
  _tag_unpack_methods[223] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockPoolMessage.unpack_from)
  _tag_unpack_methods[224] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SendAvailableObjects.unpack_from)
  _tag_unpack_methods[225] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolResetMessage.unpack_from)
  _tag_unpack_methods[226] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[227] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[228] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[229] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[230] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[231] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[232] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[233] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[234] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[235] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart.unpack_from)
  _tag_unpack_methods[236] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd.unpack_from)
  _tag_unpack_methods[237] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[238] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[239] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[240] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[241] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[242] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[243] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[244] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[71] = lambda : Anki.Cozmo.StartControllerTestMode
  _type_by_tag_value[72] = lambda : Anki.Cozmo.RawPWM
  _type_by_tag_value[73] = lambda : Anki.Util.AnkiLab.ActivateExperimentRequest
  _type_by_tag_value[74] = lambda : Anki.Util.AnkiLab.ActivateExperimentResponse
  ...
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.UpdateFirmware
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.ResetFirmware
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.DriveWheels
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.DriveArc
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.MoveHead
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.MoveLift
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.EnableLiftPower
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.EnableCliffSensor
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.EnableStopOnCliff
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.EnableBlockTapFilter
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.StopAllMotors
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.ControllerGains
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.RollActionParams
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.SetMotionModelParams
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.SetRobotVolume
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotRestoreData
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.WipeRobotGameData
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.CancelAction
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.CancelActionByIdTag
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.QueueSingleAction
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.QueueCompoundAction
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.RedirectViz
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.ImageRequest
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.SetRobotImageSendMode
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.SaveImages
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.EnableColorImages
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.SaveRobotState
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.EnableDisplay
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.ExecuteTestPlan
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.PlannerRunMode
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.SelectNextObject
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.SetRobotCarryingObject
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects
  _type_by_tag_value[127] = lambda : Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects
  _type_by_tag_value[128] = lambda : Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects
  _type_by_tag_value[129] = lambda : Anki.Cozmo.ExternalInterface.CreateFixedCustomObject
  _type_by_tag_value[130] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomBox
  _type_by_tag_value[131] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomCube
  _type_by_tag_value[132] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomWall
  _type_by_tag_value[133] = lambda : Anki.Cozmo.ExternalInterface.VisionWhileMoving
  _type_by_tag_value[134] = lambda : Anki.Cozmo.ExternalInterface.SetFaceToEnroll
  _type_by_tag_value[135] = lambda : Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
  _type_by_tag_value[136] = lambda : Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
  _type_by_tag_value[137] = lambda : Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
  _type_by_tag_value[138] = lambda : Anki.Cozmo.ExternalInterface.EnableVisionMode
  _type_by_tag_value[139] = lambda : Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
  _type_by_tag_value[140] = lambda : Anki.Cozmo.ExternalInterface.VisionRunMode
  _type_by_tag_value[141] = lambda : Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
  _type_by_tag_value[142] = lambda : Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
  _type_by_tag_value[143] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
  _type_by_tag_value[144] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
  _type_by_tag_value[145] = lambda : Anki.Cozmo.ExternalInterface.ActivateHighLevelActivity
  _type_by_tag_value[146] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
  _type_by_tag_value[147] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByID
  _type_by_tag_value[148] = lambda : Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
  _type_by_tag_value[149] = lambda : Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
  _type_by_tag_value[150] = lambda : Anki.Cozmo.ExternalInterface.CanCozmoRequestGame
  _type_by_tag_value[151] = lambda : Anki.Cozmo.ExternalInterface.SetOverrideGameRequestWeights
  _type_by_tag_value[152] = lambda : Anki.Cozmo.ExternalInterface.AbortPath
  _type_by_tag_value[153] = lambda : Anki.Cozmo.ExternalInterface.AbortAll
  _type_by_tag_value[154] = lambda : Anki.Cozmo.ExternalInterface.StartTestMode
  _type_by_tag_value[155] = lambda : Anki.Cozmo.ExternalInterface.RequestAllBehaviorsList
  _type_by_tag_value[156] = lambda : Anki.Cozmo.ExternalInterface.RequestReactionTriggerMap
  _type_by_tag_value[157] = lambda : Anki.Cozmo.ExternalInterface.ExecuteReactionTrigger
  _type_by_tag_value[158] = lambda : Anki.Cozmo.ExternalInterface.DisableReactionsWithLock
  _type_by_tag_value[159] = lambda : Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock
  _type_by_tag_value[160] = lambda : Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock
  _type_by_tag_value[161] = lambda : Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
  _type_by_tag_value[162] = lambda : Anki.Cozmo.ExternalInterface.SetSparkedMusicState
  _type_by_tag_value[163] = lambda : Anki.Cozmo.ExternalInterface.NotifyOverfeedingShouldTriggerHiccups
  _type_by_tag_value[164] = lambda : Anki.Cozmo.ExternalInterface.RequestPyramidPreReqState
  _type_by_tag_value[165] = lambda : Anki.Cozmo.ExternalInterface.NotifyCozmoWakeup
  _type_by_tag_value[166] = lambda : Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates
  _type_by_tag_value[167] = lambda : Anki.Cozmo.ExternalInterface.RequestConnectedObjects
  _type_by_tag_value[168] = lambda : Anki.Cozmo.ExternalInterface.DrawPoseMarker
  _type_by_tag_value[169] = lambda : Anki.Cozmo.ExternalInterface.ErasePoseMarker
  _type_by_tag_value[170] = lambda : Anki.Cozmo.ExternalInterface.VisualizeQuad
  _type_by_tag_value[171] = lambda : Anki.Cozmo.ExternalInterface.EraseQuad
  _type_by_tag_value[172] = lambda : Anki.Cozmo.ExternalInterface.ReplayLastAnimation
  _type_by_tag_value[173] = lambda : Anki.Cozmo.ExternalInterface.PushIdleAnimation
  _type_by_tag_value[174] = lambda : Anki.Cozmo.ExternalInterface.RemoveIdleAnimation
  _type_by_tag_value[175] = lambda : Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
  _type_by_tag_value[176] = lambda : Anki.Cozmo.ExternalInterface.ReadAnimationFile
  _type_by_tag_value[177] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
  _type_by_tag_value[178] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
  _type_by_tag_value[179] = lambda : Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
  _type_by_tag_value[180] = lambda : Anki.Cozmo.ExternalInterface.PushDrivingAnimations
  _type_by_tag_value[181] = lambda : Anki.Cozmo.ExternalInterface.RemoveDrivingAnimations
  _type_by_tag_value[182] = lambda : Anki.Cozmo.ExternalInterface.SetHeadlight
  _type_by_tag_value[183] = lambda : Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
  _type_by_tag_value[184] = lambda : Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
  _type_by_tag_value[185] = lambda : Anki.Cozmo.ExternalInterface.SetBackpackLEDs
  _type_by_tag_value[186] = lambda : Anki.Cozmo.ExternalInterface.EnableLightStates
  _type_by_tag_value[187] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeSleep
  _type_by_tag_value[188] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
  _type_by_tag_value[189] = lambda : Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
  _type_by_tag_value[190] = lambda : Anki.Cozmo.ExternalInterface.PlayCubeAnim
  _type_by_tag_value[191] = lambda : Anki.Cozmo.ExternalInterface.StopCubeAnim
  _type_by_tag_value[192] = lambda : Anki.Cozmo.ExternalInterface.StreamObjectAccel
  _type_by_tag_value[193] = lambda : Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
  _type_by_tag_value[194] = lambda : Anki.Cozmo.ExternalInterface.MoodMessage
  _type_by_tag_value[195] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsState
  _type_by_tag_value[196] = lambda : Anki.Cozmo.ExternalInterface.ForceSetNeedsLevels
  _type_by_tag_value[197] = lambda : Anki.Cozmo.ExternalInterface.ForceSetDamagedParts
  _type_by_tag_value[198] = lambda : Anki.Cozmo.ExternalInterface.RegisterOnboardingComplete
  _type_by_tag_value[199] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsPauseState
  _type_by_tag_value[200] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsPauseState
  _type_by_tag_value[201] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsPauseStates
  _type_by_tag_value[202] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsPauseStates
  _type_by_tag_value[203] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsActionWhitelist
  _type_by_tag_value[204] = lambda : Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted
  _type_by_tag_value[205] = lambda : Anki.Cozmo.ExternalInterface.GetWantsNeedsOnboarding
  _type_by_tag_value[206] = lambda : Anki.Cozmo.ExternalInterface.WipeRobotNeedsData
  _type_by_tag_value[207] = lambda : Anki.Cozmo.ExternalInterface.WipeDeviceNeedsData
  _type_by_tag_value[208] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlock
  _type_by_tag_value[209] = lambda : Anki.Cozmo.ExternalInterface.InventoryRequestAdd
  _type_by_tag_value[210] = lambda : Anki.Cozmo.ExternalInterface.InventoryRequestSet
  _type_by_tag_value[211] = lambda : Anki.Cozmo.ExternalInterface.InventoryRequestGet
  _type_by_tag_value[212] = lambda : Anki.Cozmo.ExternalInterface.RequestDeviceData
  _type_by_tag_value[213] = lambda : Anki.Cozmo.ExternalInterface.StoredLabAssignments
  _type_by_tag_value[214] = lambda : Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
  _type_by_tag_value[215] = lambda : Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
  _type_by_tag_value[216] = lambda : Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
  _type_by_tag_value[217] = lambda : Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
  _type_by_tag_value[218] = lambda : Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
  _type_by_tag_value[219] = lambda : Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
  _type_by_tag_value[220] = lambda : Anki.Cozmo.ExternalInterface.LogRawCliffData
  _type_by_tag_value[221] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
  _type_by_tag_value[222] = lambda : Anki.Cozmo.ExternalInterface.BlockSelectedMessage
  _type_by_tag_value[223] = lambda : Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
  _type_by_tag_value[224] = lambda : Anki.Cozmo.ExternalInterface.SendAvailableObjects
  _type_by_tag_value[225] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
  _type_by_tag_value[226] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[227] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[228] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[229] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[230] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[231] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[232] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[233] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[234] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[235] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
  _type_by_tag_value[236] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
  _type_by_tag_value[237] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[238] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[239] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[240] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[241] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[242] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[243] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[244] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings
