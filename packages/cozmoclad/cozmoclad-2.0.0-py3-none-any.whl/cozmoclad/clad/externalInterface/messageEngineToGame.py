...
class RobotConnectionResponse(object):
  ...
  def __init__(self, robotID=0, result=Anki.Cozmo.RobotConnectionResult.Success, fwVersion=0, serialNumber=0, bodyHWVersion=0, bodyColor=Anki.Cozmo.BodyColor.UNKNOWN):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_robotID, _result, _fwVersion, _serialNumber, _bodyHWVersion, _bodyColor)
  ...
  def __str__(self):
    return '{type}(robotID={robotID}, result={result}, fwVersion={fwVersion}, serialNumber={serialNumber}, bodyHWVersion={bodyHWVersion}, bodyColor={bodyColor})'.format(
      type=type(self).__name__,
...
class PerRobotSettings(object):
  ...
  def __init__(self, robotID=0, serialNumberHead=0, serialNumberBody=0, modelNumber=0, hwVersion=0, cameraConfig=Anki.Cozmo.ExternalInterface.CameraConfig(), color=Anki.Cozmo.BodyColor.UNKNOWN):
    self.robotID = robotID
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_robotID, _serialNumberHead, _serialNumberBody, _modelNumber, _hwVersion, _cameraConfig, _color)
  ...
  def __str__(self):
    return '{type}(robotID={robotID}, serialNumberHead={serialNumberHead}, serialNumberBody={serialNumberBody}, modelNumber={modelNumber}, hwVersion={hwVersion}, cameraConfig={cameraConfig}, color={color})'.format(
      type=type(self).__name__,
      robotID=self._robotID,
...
class RobotDeletedFixedCustomObjects(object):
  ...
  def robotID(self, value):
    self._robotID = msgbuffers.validate_integer(
      'RobotDeletedFixedCustomObjects.robotID', value, 0, 4294967295)
...
class RobotDeletedCustomMarkerObjects(object):
  ...
  def robotID(self, value):
    self._robotID = msgbuffers.validate_integer(
      'RobotDeletedCustomMarkerObjects.robotID', value, 0, 4294967295)
...
class NeedsState(object):
  ...
  def __init__(self, curNeedLevel=(), curNeedBracket=(), partIsDamaged=(), curNeedsUnlockLevel=0, numStarsAwarded=0, numStarsForNextUnlock=0, actionCausingTheUpdate=Anki.Cozmo.NeedsActionId.NoAction):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_curNeedLevel, _curNeedBracket, _partIsDamaged, _curNeedsUnlockLevel, _numStarsAwarded, _numStarsForNextUnlock, _actionCausingTheUpdate)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._curNeedLevel == other._curNeedLevel and
        ...
        self._actionCausingTheUpdate == other._actionCausingTheUpdate)
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(curNeedLevel={curNeedLevel}, curNeedBracket={curNeedBracket}, partIsDamaged={partIsDamaged}, curNeedsUnlockLevel={curNeedsUnlockLevel}, numStarsAwarded={numStarsAwarded}, numStarsForNextUnlock={numStarsForNextUnlock}, actionCausingTheUpdate={actionCausingTheUpdate})'.format(
      type=type(self).__name__,
...
class ConnectedToDifferentRobot(object):
  "Generated message-passing message."
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new ConnectedToDifferentRobot from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('ConnectedToDifferentRobot.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new ConnectedToDifferentRobot from the given BinaryReader."
    return cls()

  def pack(self):
    "Writes the current ConnectedToDifferentRobot, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current ConnectedToDifferentRobot to the given BinaryWriter."
...
Anki.Cozmo.ExternalInterface.ConnectedToDifferentRobot = ConnectedToDifferentRobot
del ConnectedToDifferentRobot
...
class UpdatedAssignments(object):
  "Generated message-passing message."
  ...
  def assignments(self, value):
    self._assignments = msgbuffers.validate_varray(
      'UpdatedAssignments.assignments', value, 65535,
      lambda name, value_inner: msgbuffers.validate_object(
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new UpdatedAssignments from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('UpdatedAssignments.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new UpdatedAssignments from the given BinaryReader."
    _assignments = reader.read_object_varray(Anki.Util.AnkiLab.AssignmentDef.unpack_from, 'H')
    return cls(_assignments)

  def pack(self):
    "Writes the current UpdatedAssignments, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current UpdatedAssignments to the given BinaryWriter."
...
Anki.Cozmo.ExternalInterface.UpdatedAssignments = UpdatedAssignments
del UpdatedAssignments
...
class MessageEngineToGame(object):
  ...
  class Tag(object):
    ...
    CliffEvent                      = 0x20 # Anki.Cozmo.CliffEvent
    PotentialCliff                  = 0x21 # Anki.Cozmo.PotentialCliff
    CarryStateUpdate                = 0x22 # Anki.Cozmo.CarryStateUpdate
    SetBodyRadioMode                = 0x23 # Anki.Cozmo.SetBodyRadioMode
    AnimationState                  = 0x24 # Anki.Cozmo.RobotInterface.AnimationState
    ActivateExperimentRequest       = 0x25 # Anki.Util.AnkiLab.ActivateExperimentRequest
    ActivateExperimentResponse      = 0x26 # Anki.Util.AnkiLab.ActivateExperimentResponse
    ...
    UnexpectedMovement              = 0x3a # Anki.Cozmo.ExternalInterface.UnexpectedMovement
    RestoreRobotStatus              = 0x3b # Anki.Cozmo.ExternalInterface.RestoreRobotStatus
    RestoreRobotOptions             = 0x3c # Anki.Cozmo.ExternalInterface.RestoreRobotOptions
    DebugString                     = 0x3d # Anki.Cozmo.ExternalInterface.DebugString
    DebugAnimationString            = 0x3e # Anki.Cozmo.ExternalInterface.DebugAnimationString
    RobotProcessedImage             = 0x3f # Anki.Cozmo.ExternalInterface.RobotProcessedImage
    RobotObservedObject             = 0x40 # Anki.Cozmo.ExternalInterface.RobotObservedObject
    RobotObservedPossibleObject     = 0x41 # Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
    RobotObservedFace               = 0x42 # Anki.Cozmo.ExternalInterface.RobotObservedFace
    RobotChangedObservedFaceID      = 0x43 # Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
    RobotObservedPet                = 0x44 # Anki.Cozmo.ExternalInterface.RobotObservedPet
    RobotObservedMotion             = 0x45 # Anki.Cozmo.ExternalInterface.RobotObservedMotion
    RobotObservedLaserPoint         = 0x46 # Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint
    RobotDeletedFace                = 0x47 # Anki.Cozmo.ExternalInterface.RobotDeletedFace
    RobotDeletedLocatedObject       = 0x48 # Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject
    RobotDeletedAllCustomObjects    = 0x49 # Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
    RobotDeletedFixedCustomObjects  = 0x4a # Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects
    RobotDeletedCustomMarkerObjects = 0x4b # Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects
    CreatedFixedCustomObject        = 0x4c # Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
    DefinedCustomObject             = 0x4d # Anki.Cozmo.ExternalInterface.DefinedCustomObject
    RobotMarkedObjectPoseUnknown    = 0x4e # Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
    LocatedObjectStates             = 0x4f # Anki.Cozmo.ExternalInterface.LocatedObjectStates
    ConnectedObjectStates           = 0x50 # Anki.Cozmo.ExternalInterface.ConnectedObjectStates
    RobotReadToolCode               = 0x51 # Anki.Cozmo.ExternalInterface.RobotReadToolCode
    FaceEnrollmentCompleted         = 0x52 # Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
    RobotErasedEnrolledFace         = 0x53 # Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
    RobotErasedAllEnrolledFaces     = 0x54 # Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
    RobotCompletedFactoryDotTest    = 0x55 # Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
    RobotCompletedAction            = 0x56 # Anki.Cozmo.ExternalInterface.RobotCompletedAction
    BlockPickedUp                   = 0x57 # Anki.Cozmo.ExternalInterface.BlockPickedUp
    BlockPlaced                     = 0x58 # Anki.Cozmo.ExternalInterface.BlockPlaced
    AnimationAvailable              = 0x59 # Anki.Cozmo.ExternalInterface.AnimationAvailable
    AnimationGroupAvailable         = 0x5a # Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
    AnimationAborted                = 0x5b # Anki.Cozmo.ExternalInterface.AnimationAborted
    AnimationEvent                  = 0x5c # Anki.Cozmo.ExternalInterface.AnimationEvent
    MoodState                       = 0x5d # Anki.Cozmo.ExternalInterface.MoodState
    NeedsState                      = 0x5e # Anki.Cozmo.ExternalInterface.NeedsState
    NeedsPauseState                 = 0x5f # Anki.Cozmo.ExternalInterface.NeedsPauseState
    NeedsPauseStates                = 0x60 # Anki.Cozmo.ExternalInterface.NeedsPauseStates
    FreeplaySparksAwarded           = 0x61 # Anki.Cozmo.ExternalInterface.FreeplaySparksAwarded
    StarLevelCompleted              = 0x62 # Anki.Cozmo.ExternalInterface.StarLevelCompleted
    StarUnlocked                    = 0x63 # Anki.Cozmo.ExternalInterface.StarUnlocked
    WantsNeedsOnboarding            = 0x64 # Anki.Cozmo.ExternalInterface.WantsNeedsOnboarding
    ConnectedToDifferentRobot       = 0x65 # Anki.Cozmo.ExternalInterface.ConnectedToDifferentRobot
    RequestSetUnlockResult          = 0x66 # Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
    UnlockStatus                    = 0x67 # Anki.Cozmo.ExternalInterface.UnlockStatus
    UnlockedDefaults                = 0x68 # Anki.Cozmo.ExternalInterface.UnlockedDefaults
    InventoryStatus                 = 0x69 # Anki.Cozmo.ExternalInterface.InventoryStatus
    RequestDefaultSparks            = 0x6a # Anki.Cozmo.ExternalInterface.RequestDefaultSparks
    InitDebugConsoleVarMessage      = 0x6b # Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
    JsonDasLogMessage               = 0x6c # Anki.Cozmo.ExternalInterface.JsonDasLogMessage
    JsonDasLogAllSentMessage        = 0x6d # Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
    VerifyDebugConsoleFuncMessage   = 0x6e # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
    VerifyDebugConsoleVarMessage    = 0x6f # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
    DebugAppendConsoleLogLine       = 0x70 # Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
    LatencyMessage                  = 0x71 # Anki.Cozmo.ExternalInterface.LatencyMessage
    DeviceDataMessage               = 0x72 # Anki.Cozmo.ExternalInterface.DeviceDataMessage
    BlockTapFilterStatus            = 0x73 # Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
    UpdateEngineState               = 0x74 # Anki.Cozmo.ExternalInterface.UpdateEngineState
    EngineErrorCodeMessage          = 0x75 # Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
    CubeLightsStateTransition       = 0x76 # Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
    BlockPoolDataMessage            = 0x77 # Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
    NVStorageOpResult               = 0x78 # Anki.Cozmo.ExternalInterface.NVStorageOpResult
    FirmwareUpdateProgress          = 0x79 # Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
    FirmwareUpdateComplete          = 0x7a # Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
    RequestGameStart                = 0x7b # Anki.Cozmo.ExternalInterface.RequestGameStart
    HardSparkStartedByEngine        = 0x7c # Anki.Cozmo.ExternalInterface.HardSparkStartedByEngine
    HardSparkEndedByEngine          = 0x7d # Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
    SdkConnectionStatus             = 0x7e # Anki.Cozmo.ExternalInterface.SdkConnectionStatus
    SdkStatus                       = 0x7f # Anki.Cozmo.ExternalInterface.SdkStatus
    BehaviorTransition              = 0x80 # Anki.Cozmo.ExternalInterface.BehaviorTransition
    ReactionTriggerTransition       = 0x81 # Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
    RespondAllBehaviorsList         = 0x82 # Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList
    RespondReactionTriggerMap       = 0x83 # Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap
    BehaviorObjectiveAchieved       = 0x84 # Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
    PyramidPreReqState              = 0x85 # Anki.Cozmo.ExternalInterface.PyramidPreReqState
    GuardDogStart                   = 0x86 # Anki.Cozmo.ExternalInterface.GuardDogStart
    GuardDogEnd                     = 0x87 # Anki.Cozmo.ExternalInterface.GuardDogEnd
    OnboardingState                 = 0x88 # Anki.Cozmo.ExternalInterface.OnboardingState
    MemoryMapMessageBegin           = 0x89 # Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
    MemoryMapMessage                = 0x8a # Anki.Cozmo.ExternalInterface.MemoryMapMessage
    MemoryMapMessageEnd             = 0x8b # Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
    SupportInfo                     = 0x8c # Anki.Cozmo.ExternalInterface.SupportInfo
    FeedingSFXStageUpdate           = 0x8d # Anki.Cozmo.ExternalInterface.FeedingSFXStageUpdate
    ResponseLocale                  = 0x8e # Anki.Cozmo.ExternalInterface.ResponseLocale
    UpdatedAssignments              = 0x8f # Anki.Cozmo.ExternalInterface.UpdatedAssignments
    EndOfMessage                    = 0x90 # Anki.Cozmo.ExternalInterface.EndOfMessage
  ...
  @property
  def ConnectedToDifferentRobot(self):
    "Anki.Cozmo.ExternalInterface.ConnectedToDifferentRobot ConnectedToDifferentRobot union property."
    msgbuffers.safety_check_tag('ConnectedToDifferentRobot', self._tag, self.Tag.ConnectedToDifferentRobot, self._tags_by_value)
    return self._data

  @ConnectedToDifferentRobot.setter
  def ConnectedToDifferentRobot(self, value):
    self._data = msgbuffers.validate_object(
      'MessageEngineToGame.ConnectedToDifferentRobot', value, Anki.Cozmo.ExternalInterface.ConnectedToDifferentRobot)
    self._tag = self.Tag.ConnectedToDifferentRobot
  ...
  @property
  def UpdatedAssignments(self):
    "Anki.Cozmo.ExternalInterface.UpdatedAssignments UpdatedAssignments union property."
    msgbuffers.safety_check_tag('UpdatedAssignments', self._tag, self.Tag.UpdatedAssignments, self._tags_by_value)
    return self._data

  @UpdatedAssignments.setter
  def UpdatedAssignments(self, value):
    self._data = msgbuffers.validate_object(
      'MessageEngineToGame.UpdatedAssignments', value, Anki.Cozmo.ExternalInterface.UpdatedAssignments)
    self._tag = self.Tag.UpdatedAssignments
  ...
  _tags_by_name = dict(
    ...
    SetBodyRadioMode=35,
    AnimationState=36,
    ActivateExperimentRequest=37,
    ActivateExperimentResponse=38,
    ...
    ChargerEvent=57,
    UnexpectedMovement=58,
    RestoreRobotStatus=59,
    RestoreRobotOptions=60,
    DebugString=61,
    DebugAnimationString=62,
    RobotProcessedImage=63,
    RobotObservedObject=64,
    RobotObservedPossibleObject=65,
    RobotObservedFace=66,
    RobotChangedObservedFaceID=67,
    RobotObservedPet=68,
    RobotObservedMotion=69,
    RobotObservedLaserPoint=70,
    RobotDeletedFace=71,
    RobotDeletedLocatedObject=72,
    RobotDeletedAllCustomObjects=73,
    RobotDeletedFixedCustomObjects=74,
    RobotDeletedCustomMarkerObjects=75,
    CreatedFixedCustomObject=76,
    DefinedCustomObject=77,
    RobotMarkedObjectPoseUnknown=78,
    LocatedObjectStates=79,
    ConnectedObjectStates=80,
    RobotReadToolCode=81,
    FaceEnrollmentCompleted=82,
    RobotErasedEnrolledFace=83,
    RobotErasedAllEnrolledFaces=84,
    RobotCompletedFactoryDotTest=85,
    RobotCompletedAction=86,
    BlockPickedUp=87,
    BlockPlaced=88,
    AnimationAvailable=89,
    AnimationGroupAvailable=90,
    AnimationAborted=91,
    AnimationEvent=92,
    MoodState=93,
    NeedsState=94,
    NeedsPauseState=95,
    NeedsPauseStates=96,
    FreeplaySparksAwarded=97,
    StarLevelCompleted=98,
    StarUnlocked=99,
    WantsNeedsOnboarding=100,
    ConnectedToDifferentRobot=101,
    RequestSetUnlockResult=102,
    UnlockStatus=103,
    UnlockedDefaults=104,
    InventoryStatus=105,
    RequestDefaultSparks=106,
    InitDebugConsoleVarMessage=107,
    JsonDasLogMessage=108,
    JsonDasLogAllSentMessage=109,
    VerifyDebugConsoleFuncMessage=110,
    VerifyDebugConsoleVarMessage=111,
    DebugAppendConsoleLogLine=112,
    LatencyMessage=113,
    DeviceDataMessage=114,
    BlockTapFilterStatus=115,
    UpdateEngineState=116,
    EngineErrorCodeMessage=117,
    CubeLightsStateTransition=118,
    BlockPoolDataMessage=119,
    NVStorageOpResult=120,
    FirmwareUpdateProgress=121,
    FirmwareUpdateComplete=122,
    RequestGameStart=123,
    HardSparkStartedByEngine=124,
    HardSparkEndedByEngine=125,
    SdkConnectionStatus=126,
    SdkStatus=127,
    BehaviorTransition=128,
    ReactionTriggerTransition=129,
    RespondAllBehaviorsList=130,
    RespondReactionTriggerMap=131,
    BehaviorObjectiveAchieved=132,
    PyramidPreReqState=133,
    GuardDogStart=134,
    GuardDogEnd=135,
    OnboardingState=136,
    MemoryMapMessageBegin=137,
    MemoryMapMessage=138,
    MemoryMapMessageEnd=139,
    SupportInfo=140,
    FeedingSFXStageUpdate=141,
    ResponseLocale=142,
    UpdatedAssignments=143,
    EndOfMessage=144,
  )
  ...
  _tags_by_value[34] = 'CarryStateUpdate'
  _tags_by_value[35] = 'SetBodyRadioMode'
  _tags_by_value[36] = 'AnimationState'
  _tags_by_value[37] = 'ActivateExperimentRequest'
  _tags_by_value[38] = 'ActivateExperimentResponse'
  ...
  _tags_by_value[58] = 'UnexpectedMovement'
  _tags_by_value[59] = 'RestoreRobotStatus'
  _tags_by_value[60] = 'RestoreRobotOptions'
  _tags_by_value[61] = 'DebugString'
  _tags_by_value[62] = 'DebugAnimationString'
  _tags_by_value[63] = 'RobotProcessedImage'
  _tags_by_value[64] = 'RobotObservedObject'
  _tags_by_value[65] = 'RobotObservedPossibleObject'
  _tags_by_value[66] = 'RobotObservedFace'
  _tags_by_value[67] = 'RobotChangedObservedFaceID'
  _tags_by_value[68] = 'RobotObservedPet'
  _tags_by_value[69] = 'RobotObservedMotion'
  _tags_by_value[70] = 'RobotObservedLaserPoint'
  _tags_by_value[71] = 'RobotDeletedFace'
  _tags_by_value[72] = 'RobotDeletedLocatedObject'
  _tags_by_value[73] = 'RobotDeletedAllCustomObjects'
  _tags_by_value[74] = 'RobotDeletedFixedCustomObjects'
  _tags_by_value[75] = 'RobotDeletedCustomMarkerObjects'
  _tags_by_value[76] = 'CreatedFixedCustomObject'
  _tags_by_value[77] = 'DefinedCustomObject'
  _tags_by_value[78] = 'RobotMarkedObjectPoseUnknown'
  _tags_by_value[79] = 'LocatedObjectStates'
  _tags_by_value[80] = 'ConnectedObjectStates'
  _tags_by_value[81] = 'RobotReadToolCode'
  _tags_by_value[82] = 'FaceEnrollmentCompleted'
  ...
  _tags_by_value[86] = 'RobotCompletedAction'
  _tags_by_value[87] = 'BlockPickedUp'
  _tags_by_value[88] = 'BlockPlaced'
  _tags_by_value[89] = 'AnimationAvailable'
  _tags_by_value[90] = 'AnimationGroupAvailable'
  _tags_by_value[91] = 'AnimationAborted'
  _tags_by_value[92] = 'AnimationEvent'
  _tags_by_value[93] = 'MoodState'
  _tags_by_value[94] = 'NeedsState'
  _tags_by_value[95] = 'NeedsPauseState'
  _tags_by_value[96] = 'NeedsPauseStates'
  _tags_by_value[97] = 'FreeplaySparksAwarded'
  _tags_by_value[98] = 'StarLevelCompleted'
  _tags_by_value[99] = 'StarUnlocked'
  _tags_by_value[100] = 'WantsNeedsOnboarding'
  _tags_by_value[101] = 'ConnectedToDifferentRobot'
  _tags_by_value[102] = 'RequestSetUnlockResult'
  _tags_by_value[103] = 'UnlockStatus'
  _tags_by_value[104] = 'UnlockedDefaults'
  _tags_by_value[105] = 'InventoryStatus'
  _tags_by_value[106] = 'RequestDefaultSparks'
  _tags_by_value[107] = 'InitDebugConsoleVarMessage'
  _tags_by_value[108] = 'JsonDasLogMessage'
  _tags_by_value[109] = 'JsonDasLogAllSentMessage'
  _tags_by_value[110] = 'VerifyDebugConsoleFuncMessage'
  _tags_by_value[111] = 'VerifyDebugConsoleVarMessage'
  _tags_by_value[112] = 'DebugAppendConsoleLogLine'
  _tags_by_value[113] = 'LatencyMessage'
  _tags_by_value[114] = 'DeviceDataMessage'
  _tags_by_value[115] = 'BlockTapFilterStatus'
  _tags_by_value[116] = 'UpdateEngineState'
  _tags_by_value[117] = 'EngineErrorCodeMessage'
  _tags_by_value[118] = 'CubeLightsStateTransition'
  _tags_by_value[119] = 'BlockPoolDataMessage'
  _tags_by_value[120] = 'NVStorageOpResult'
  _tags_by_value[121] = 'FirmwareUpdateProgress'
  _tags_by_value[122] = 'FirmwareUpdateComplete'
  _tags_by_value[123] = 'RequestGameStart'
  _tags_by_value[124] = 'HardSparkStartedByEngine'
  _tags_by_value[125] = 'HardSparkEndedByEngine'
  _tags_by_value[126] = 'SdkConnectionStatus'
  _tags_by_value[127] = 'SdkStatus'
  _tags_by_value[128] = 'BehaviorTransition'
  _tags_by_value[129] = 'ReactionTriggerTransition'
  _tags_by_value[130] = 'RespondAllBehaviorsList'
  _tags_by_value[131] = 'RespondReactionTriggerMap'
  _tags_by_value[132] = 'BehaviorObjectiveAchieved'
  _tags_by_value[133] = 'PyramidPreReqState'
  _tags_by_value[134] = 'GuardDogStart'
  _tags_by_value[135] = 'GuardDogEnd'
  _tags_by_value[136] = 'OnboardingState'
  _tags_by_value[137] = 'MemoryMapMessageBegin'
  _tags_by_value[138] = 'MemoryMapMessage'
  _tags_by_value[139] = 'MemoryMapMessageEnd'
  _tags_by_value[140] = 'SupportInfo'
  _tags_by_value[141] = 'FeedingSFXStageUpdate'
  _tags_by_value[142] = 'ResponseLocale'
  _tags_by_value[143] = 'UpdatedAssignments'
  _tags_by_value[144] = 'EndOfMessage'
  ...
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.CliffEvent.unpack_from)
  _tag_unpack_methods[33] = lambda reader: reader.read_object(Anki.Cozmo.PotentialCliff.unpack_from)
  _tag_unpack_methods[34] = lambda reader: reader.read_object(Anki.Cozmo.CarryStateUpdate.unpack_from)
  _tag_unpack_methods[35] = lambda reader: reader.read_object(Anki.Cozmo.SetBodyRadioMode.unpack_from)
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.RobotInterface.AnimationState.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Util.AnkiLab.ActivateExperimentRequest.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Util.AnkiLab.ActivateExperimentResponse.unpack_from)
  ...
  _tag_unpack_methods[58] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnexpectedMovement.unpack_from)
  _tag_unpack_methods[59] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotStatus.unpack_from)
  _tag_unpack_methods[60] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotOptions.unpack_from)
  _tag_unpack_methods[61] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugString.unpack_from)
  _tag_unpack_methods[62] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAnimationString.unpack_from)
  _tag_unpack_methods[63] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotProcessedImage.unpack_from)
  _tag_unpack_methods[64] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedObject.unpack_from)
  _tag_unpack_methods[65] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject.unpack_from)
  _tag_unpack_methods[66] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedFace.unpack_from)
  _tag_unpack_methods[67] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID.unpack_from)
  _tag_unpack_methods[68] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPet.unpack_from)
  _tag_unpack_methods[69] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedMotion.unpack_from)
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint.unpack_from)
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFace.unpack_from)
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects.unpack_from)
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefinedCustomObject.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LocatedObjectStates.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectedObjectStates.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotReadToolCode.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedAction.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPickedUp.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPlaced.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAvailable.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationGroupAvailable.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAborted.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationEvent.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodState.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsState.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsPauseState.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsPauseStates.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FreeplaySparksAwarded.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StarLevelCompleted.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StarUnlocked.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WantsNeedsOnboarding.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectedToDifferentRobot.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlockResult.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockStatus.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockedDefaults.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InventoryStatus.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestDefaultSparks.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogMessage.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LatencyMessage.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceDataMessage.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEngineState.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CubeLightsStateTransition.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolDataMessage.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageOpResult.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete.unpack_from)
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestGameStart.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.HardSparkStartedByEngine.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkConnectionStatus.unpack_from)
  _tag_unpack_methods[127] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkStatus.unpack_from)
  _tag_unpack_methods[128] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorTransition.unpack_from)
  _tag_unpack_methods[129] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReactionTriggerTransition.unpack_from)
  _tag_unpack_methods[130] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList.unpack_from)
  _tag_unpack_methods[131] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap.unpack_from)
  _tag_unpack_methods[132] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved.unpack_from)
  _tag_unpack_methods[133] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PyramidPreReqState.unpack_from)
  _tag_unpack_methods[134] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GuardDogStart.unpack_from)
  _tag_unpack_methods[135] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GuardDogEnd.unpack_from)
  _tag_unpack_methods[136] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.OnboardingState.unpack_from)
  _tag_unpack_methods[137] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin.unpack_from)
  _tag_unpack_methods[138] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessage.unpack_from)
  _tag_unpack_methods[139] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd.unpack_from)
  _tag_unpack_methods[140] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SupportInfo.unpack_from)
  _tag_unpack_methods[141] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FeedingSFXStageUpdate.unpack_from)
  _tag_unpack_methods[142] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ResponseLocale.unpack_from)
  _tag_unpack_methods[143] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdatedAssignments.unpack_from)
  _tag_unpack_methods[144] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EndOfMessage.unpack_from)
  ...
  _type_by_tag_value[32] = lambda : Anki.Cozmo.CliffEvent
  _type_by_tag_value[33] = lambda : Anki.Cozmo.PotentialCliff
  _type_by_tag_value[34] = lambda : Anki.Cozmo.CarryStateUpdate
  _type_by_tag_value[35] = lambda : Anki.Cozmo.SetBodyRadioMode
  _type_by_tag_value[36] = lambda : Anki.Cozmo.RobotInterface.AnimationState
  _type_by_tag_value[37] = lambda : Anki.Util.AnkiLab.ActivateExperimentRequest
  _type_by_tag_value[38] = lambda : Anki.Util.AnkiLab.ActivateExperimentResponse
  ...
  _type_by_tag_value[58] = lambda : Anki.Cozmo.ExternalInterface.UnexpectedMovement
  _type_by_tag_value[59] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotStatus
  _type_by_tag_value[60] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotOptions
  _type_by_tag_value[61] = lambda : Anki.Cozmo.ExternalInterface.DebugString
  _type_by_tag_value[62] = lambda : Anki.Cozmo.ExternalInterface.DebugAnimationString
  _type_by_tag_value[63] = lambda : Anki.Cozmo.ExternalInterface.RobotProcessedImage
  _type_by_tag_value[64] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedObject
  _type_by_tag_value[65] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
  _type_by_tag_value[66] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedFace
  _type_by_tag_value[67] = lambda : Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
  _type_by_tag_value[68] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPet
  _type_by_tag_value[69] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedMotion
  _type_by_tag_value[70] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFace
  _type_by_tag_value[72] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject
  _type_by_tag_value[73] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
  _type_by_tag_value[74] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.DefinedCustomObject
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.LocatedObjectStates
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.ConnectedObjectStates
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.RobotReadToolCode
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedAction
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.BlockPickedUp
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.BlockPlaced
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.AnimationAvailable
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.AnimationAborted
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.AnimationEvent
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.MoodState
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.NeedsState
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.NeedsPauseState
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.NeedsPauseStates
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.FreeplaySparksAwarded
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.StarLevelCompleted
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.StarUnlocked
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.WantsNeedsOnboarding
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.ConnectedToDifferentRobot
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.UnlockStatus
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.UnlockedDefaults
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.InventoryStatus
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.RequestDefaultSparks
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogMessage
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.LatencyMessage
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.DeviceDataMessage
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.UpdateEngineState
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.NVStorageOpResult
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.RequestGameStart
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.HardSparkStartedByEngine
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.SdkConnectionStatus
  _type_by_tag_value[127] = lambda : Anki.Cozmo.ExternalInterface.SdkStatus
  _type_by_tag_value[128] = lambda : Anki.Cozmo.ExternalInterface.BehaviorTransition
  _type_by_tag_value[129] = lambda : Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
  _type_by_tag_value[130] = lambda : Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList
  _type_by_tag_value[131] = lambda : Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap
  _type_by_tag_value[132] = lambda : Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
  _type_by_tag_value[133] = lambda : Anki.Cozmo.ExternalInterface.PyramidPreReqState
  _type_by_tag_value[134] = lambda : Anki.Cozmo.ExternalInterface.GuardDogStart
  _type_by_tag_value[135] = lambda : Anki.Cozmo.ExternalInterface.GuardDogEnd
  _type_by_tag_value[136] = lambda : Anki.Cozmo.ExternalInterface.OnboardingState
  _type_by_tag_value[137] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
  _type_by_tag_value[138] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessage
  _type_by_tag_value[139] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
  _type_by_tag_value[140] = lambda : Anki.Cozmo.ExternalInterface.SupportInfo
  _type_by_tag_value[141] = lambda : Anki.Cozmo.ExternalInterface.FeedingSFXStageUpdate
  _type_by_tag_value[142] = lambda : Anki.Cozmo.ExternalInterface.ResponseLocale
  _type_by_tag_value[143] = lambda : Anki.Cozmo.ExternalInterface.UpdatedAssignments
  _type_by_tag_value[144] = lambda : Anki.Cozmo.ExternalInterface.EndOfMessage
