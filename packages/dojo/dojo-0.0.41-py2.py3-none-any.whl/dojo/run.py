...
class Entrypoint(object):
    ...
    def run(self, name, runner, config, env):
        ...
        # Build secrets by decrypting available JSONs
        env_json_secrets_path = os.path.join(base_config_path, 'secrets.%s.json.enc' % (env, ))
        secrets = Secrets.decrypt(env_json_secrets_path)
