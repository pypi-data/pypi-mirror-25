...
from clubhouse.forms.forms import EntriesForm
from clubhouse.forms.models import (
    Form, Field, FormEntry, FieldEntry, FormBlock
)
...
class FormAdmin(admin.ModelAdmin):
    ...
    """
    inlines = (FieldAdmin,)
    list_display = ("title", "email_copies",)
    list_display_links = ("title",)
    list_editable = ("email_copies",)
    search_fields = ("title", "response", "email_from",
                     "email_copies")
    fieldsets = (
        (None, {
            "fields": ["title","button_text","response"],
        }),
        (_("Email"), {
...
admin.site.register(FormBlock,admin.BlockAdmin)
