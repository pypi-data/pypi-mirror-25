    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.ForeignKey(to='clubhouse_forms.Form')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.ForeignKey(related_name='entries', to='clubhouse_forms.Form')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='entry',
            field=models.ForeignKey(related_name='fields', to='clubhouse_forms.FormEntry'),
        ),
        migrations.AddField(
            model_name='field',
            name='form',
            field=models.ForeignKey(related_name='fields', to='clubhouse_forms.Form'),
        ),
    ]
