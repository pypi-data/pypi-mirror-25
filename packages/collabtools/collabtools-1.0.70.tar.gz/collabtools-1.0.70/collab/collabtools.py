...
def upload_rule(args):
    ...
    # first, parse it locally to make sure it has the right format before bothering the server about it
    parse_rule(rule_dictionary)
