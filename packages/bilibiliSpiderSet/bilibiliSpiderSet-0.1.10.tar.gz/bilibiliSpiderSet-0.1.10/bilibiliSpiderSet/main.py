...
# @Last Modified time: 2017-09-28 22:03:50
...
def get_live_background():
	...
	parser.add_argument('-s', '--save', type=int, help='input save path to save\
						background (default : desktop)', action='store_true', \
						choices=[1, 0])
	args = parser.parse_args()

	spider = Xspider()
	link = spider.main(args.room_url, args.save)
	if link != None:
		print(link)
