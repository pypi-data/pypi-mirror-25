...
from gm.enum import OrderSide_Unknown, OrderType_Unknown, \
    PositionEffect_Unknown, PositionSide_Unknown
...
def order_volume(symbol, volume, price=0, side=OrderSide_Unknown,
                 order_type=OrderType_Unknown,
                 position_effect=PositionEffect_Unknown, account=''):
    """
    按指定量委托
    """
...
def order_value(symbol, value, price=0, side=OrderSide_Unknown,
                order_type=OrderType_Unknown,
                position_effect=PositionEffect_Unknown, account=''):
    """
    按指定价值委托
...
def order_percent(symbol, percent, price=0, side=OrderSide_Unknown,
                  order_type=OrderType_Unknown,
                  position_effect=PositionEffect_Unknown, account=''):
    """
    按指定比例委托
...
def order_target_volume(symbol, volume, price=0, side=PositionSide_Unknown,
                        order_type=OrderType_Unknown, account=''):
    """
    调仓到目标持仓量
    """
    ...
    return _place_order(symbol=symbol, target_volume=volume, price=price,
                        position_side=side, order_type=order_type,
                        order_style=order_style, account_id=account_id)


def order_target_value(symbol, value, price=0, side=PositionSide_Unknown,
                       order_type=OrderType_Unknown, account=''):
    """
    调仓到目标持仓额
    """
...
def order_target_percent(symbol, percent, price=0, side=PositionSide_Unknown,
                         order_type=OrderType_Unknown, account=''):
    """
    调仓到目标持仓比例
    """
