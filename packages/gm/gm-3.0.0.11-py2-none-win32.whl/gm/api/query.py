...
from gm.model.fundmental import FundmentalApi
from gm.model.history import HistoryApi
from gm.utils import load_to_datetime_str

fundmentalapi = FundmentalApi()
historyapi = HistoryApi()

def get_fundmentals(table, end_date, symbols=None, fields=None, filter=None, order_by=None, count=1000):
    """
    查询基本面财务数据
    """
    return fundmentalapi.get_fundmentals(table, end_date, symbols, fields, filter, order_by, count)
...
def get_instruments(symbols=None, exchanges=None, sec_types=None, names=None, skip_suspended=True, skip_st=True, fields=None):
    ...
    """
    return fundmentalapi.get_instruments(symbols, exchanges, sec_types, names, skip_suspended,skip_st, fields)
...
def get_history_instruments(symbols, fields=None, start_date=None, end_date=None):
    ...
    """
    return fundmentalapi.get_history_instruments(symbols, fields, start_date, end_date)
...
def get_instrumentinfos(symbols=None, exchanges=None, sec_types=None, names=None, fields=None):
    ...
    """
    return fundmentalapi.get_instrumentinfos(symbols, exchanges, sec_types, names, fields)
...
def get_constituents(index, fields=None):
    ...
    weight 权重
    """
    return fundmentalapi.get_constituents(index, fields)
...
def get_history_constituents(index, start_date=None, end_date=None):
    ...
    """
    return fundmentalapi.get_history_constituents(index, start_date, end_date)
...
def get_sector(code):
    ...
    查询板块股票列表
    """
    return fundmentalapi.get_sector(code)
...
def get_industry(code):
    ...
    查询行业股票列表
    """
    return fundmentalapi.get_industry(code)
...
def get_concept(code):
    ...
    return fundmentalapi.get_concept(code)
...
def get_trading_dates(exchange, start_date, end_date):
    ...
    """
    return fundmentalapi.get_trading_dates(exchange, start_date, end_date)
...
def get_previous_trading_date(exchange, date):
    ...
    """
    return fundmentalapi.get_previous_trading_date(exchange, date)
...
def get_next_trading_date(exchange, date):
    ...
    @:return 返回下一交易日, 为 yyyy-mm-dd 格式的字符串, 如果不存在则返回None
    """
    return fundmentalapi.get_next_trading_date(exchange, date)
...
def get_dividend(symbol, start_date, end_date=None):
    ...
    查询分红送配
    """
    return fundmentalapi.get_dividend(symbol, start_date, end_date)
...
def get_continuous_contracts(csymbol, start_date=None, end_date=None):
    ...
    获取连续合约
    """
    return fundmentalapi.get_continuous_contracts(csymbol, start_date, end_date)
