...
import gm.pb.fundamental_pb2 as fundamental__pb2
...
class FundamentalServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetFundamentals = channel.unary_unary(
        ...
        request_serializer=fundamental__pb2.GetFundamentalsReq.SerializeToString,
        response_deserializer=fundamental__pb2.GetFundamentalsRsp.FromString,
        )
    self.GetInstrumentInfos = channel.unary_unary(
        '/fundamental.api.FundamentalService/GetInstrumentInfos',
        request_serializer=fundamental__pb2.GetInstrumentInfosReq.SerializeToString,
    ...
    self.GetInstruments = channel.unary_unary(
        ...
        request_serializer=fundamental__pb2.GetInstrumentsReq.SerializeToString,
    ...
    self.GetHistoryInstruments = channel.unary_unary(
        ...
        request_serializer=fundamental__pb2.GetHistoryInstrumentsReq.SerializeToString,
        response_deserializer=data__pb2.Instruments.FromString,
        )
    self.GetConstituents = channel.unary_unary(
        '/fundamental.api.FundamentalService/GetConstituents',
        request_serializer=fundamental__pb2.GetConstituentsReq.SerializeToString,
    ...
    self.GetSector = channel.unary_unary(
        ...
        request_serializer=fundamental__pb2.GetSectorReq.SerializeToString,
        response_deserializer=fundamental__pb2.GetSectorRsp.FromString,
        )
    self.GetIndustry = channel.unary_unary(
        '/fundamental.api.FundamentalService/GetIndustry',
        request_serializer=fundamental__pb2.GetIndustryReq.SerializeToString,
        response_deserializer=fundamental__pb2.GetIndustryRsp.FromString,
        )
    self.GetConcept = channel.unary_unary(
        '/fundamental.api.FundamentalService/GetConcept',
        request_serializer=fundamental__pb2.GetConceptReq.SerializeToString,
        response_deserializer=fundamental__pb2.GetConceptRsp.FromString,
        )
    self.GetTradingDates = channel.unary_unary(
        '/fundamental.api.FundamentalService/GetTradingDates',
        request_serializer=fundamental__pb2.GetTradingDatesReq.SerializeToString,
        response_deserializer=fundamental__pb2.GetTradingDatesRsp.FromString,
        )
    self.GetPreviousTradingDate = channel.unary_unary(
        '/fundamental.api.FundamentalService/GetPreviousTradingDate',
        request_serializer=fundamental__pb2.GetPreviousTradingDateReq.SerializeToString,
        response_deserializer=fundamental__pb2.GetPreviousTradingDateRsp.FromString,
        )
    self.GetNextTradingDate = channel.unary_unary(
        '/fundamental.api.FundamentalService/GetNextTradingDate',
        request_serializer=fundamental__pb2.GetNextTradingDateReq.SerializeToString,
        response_deserializer=fundamental__pb2.GetNextTradingDateRsp.FromString,
        )
    self.GetDividends = channel.unary_unary(
        '/fundamental.api.FundamentalService/GetDividends',
        request_serializer=fundamental__pb2.GetDividendsReq.SerializeToString,
    ...
    self.GetContinuousContracts = channel.unary_unary(
        ...
        request_serializer=fundamental__pb2.GetContinuousContractsReq.SerializeToString,
...
def add_FundamentalServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetFundamentals': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=fundamental__pb2.GetFundamentalsReq.FromString,
          response_serializer=fundamental__pb2.GetFundamentalsRsp.SerializeToString,
      ),
      'GetInstrumentInfos': grpc.unary_unary_rpc_method_handler(
          servicer.GetInstrumentInfos,
          request_deserializer=fundamental__pb2.GetInstrumentInfosReq.FromString,
      ...
      'GetInstruments': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=fundamental__pb2.GetInstrumentsReq.FromString,
      ...
      'GetHistoryInstruments': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=fundamental__pb2.GetHistoryInstrumentsReq.FromString,
          response_serializer=data__pb2.Instruments.SerializeToString,
      ),
      'GetConstituents': grpc.unary_unary_rpc_method_handler(
          servicer.GetConstituents,
          request_deserializer=fundamental__pb2.GetConstituentsReq.FromString,
          response_serializer=data__pb2.Constituents.SerializeToString,
      ),
      'GetSector': grpc.unary_unary_rpc_method_handler(
          servicer.GetSector,
          request_deserializer=fundamental__pb2.GetSectorReq.FromString,
          response_serializer=fundamental__pb2.GetSectorRsp.SerializeToString,
      ),
      'GetIndustry': grpc.unary_unary_rpc_method_handler(
          servicer.GetIndustry,
          request_deserializer=fundamental__pb2.GetIndustryReq.FromString,
          response_serializer=fundamental__pb2.GetIndustryRsp.SerializeToString,
      ),
      'GetConcept': grpc.unary_unary_rpc_method_handler(
          servicer.GetConcept,
          request_deserializer=fundamental__pb2.GetConceptReq.FromString,
          response_serializer=fundamental__pb2.GetConceptRsp.SerializeToString,
      ),
      'GetTradingDates': grpc.unary_unary_rpc_method_handler(
          servicer.GetTradingDates,
          request_deserializer=fundamental__pb2.GetTradingDatesReq.FromString,
          response_serializer=fundamental__pb2.GetTradingDatesRsp.SerializeToString,
      ),
      'GetPreviousTradingDate': grpc.unary_unary_rpc_method_handler(
          servicer.GetPreviousTradingDate,
          request_deserializer=fundamental__pb2.GetPreviousTradingDateReq.FromString,
          response_serializer=fundamental__pb2.GetPreviousTradingDateRsp.SerializeToString,
      ),
      'GetNextTradingDate': grpc.unary_unary_rpc_method_handler(
          servicer.GetNextTradingDate,
          request_deserializer=fundamental__pb2.GetNextTradingDateReq.FromString,
          response_serializer=fundamental__pb2.GetNextTradingDateRsp.SerializeToString,
      ),
      'GetDividends': grpc.unary_unary_rpc_method_handler(
          servicer.GetDividends,
          request_deserializer=fundamental__pb2.GetDividendsReq.FromString,
      ...
      'GetContinuousContracts': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=fundamental__pb2.GetContinuousContractsReq.FromString,
