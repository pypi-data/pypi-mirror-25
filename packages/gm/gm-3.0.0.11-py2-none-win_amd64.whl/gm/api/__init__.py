...
from .trade import (
    ...
    cancel_all_orders, order_cancel, close_all_positions,
    get_orders, get_unfinished_orders)

# 数据查询api
from .query import (
    history_n, history, get_fundmentals, get_dividend, get_continuous_contracts, get_next_trading_date,
...
__all__ = [
    ...
    'history_n', 'history', 'get_fundmentals', 'get_dividend',
