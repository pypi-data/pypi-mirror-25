...
def get_fundamentals(table, end_date, symbols=None, fields=None, filter=None, order_by=None, count=1000):
    """
    查询基本面财务数据
    """
    return fundamentalapi.get_fundamentals(table, end_date, symbols, fields, filter, order_by, count)
