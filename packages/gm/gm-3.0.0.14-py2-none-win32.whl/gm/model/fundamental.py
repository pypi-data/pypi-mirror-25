...
from gm.pb.fundamental_pb2 import FundamentalServiceStub, GetFundamentalsReq, \
    ...
    GetContinuousContractsReq, GetFundamentalsRsp
...
class FundamentalApi(object):
    ...
    def get_fundamentals(self, table, end_date, symbols=None, fields=None, filter=None, order_by=None, count=1000):
        ...
        req = GetFundamentalsReq(table=table, end_date=end_date, fields=fields, symbols=','.join(symbols), filter=filter,
                                order_by=order_by, count=count)
        resp = self.stub.GetFundamentals(req)
        result = []
