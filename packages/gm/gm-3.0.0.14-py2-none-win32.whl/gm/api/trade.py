...
def order_target_volume(symbol, volume, price=0, position_side=PositionSide_Unknown,
...
def order_target_value(symbol, value, price=0, position_side=PositionSide_Unknown,
                       order_type=OrderType_Unknown, account=''):
    """
    调仓到目标持仓额
    """
...
def order_target_percent(symbol, percent, price=0, position_side=PositionSide_Unknown,
                         order_type=OrderType_Unknown, account=''):
    """
    调仓到目标持仓比例
    """
