...
class NumpyUtil(BaseUtil):
    ...
    def extract_schema(cls, array):
        ...
        swagger_schema['example'] = SwaggerUtil.get_swagger_sample(array, items_count, swagger_schema['items'])
    ...
    def get_input_object(cls, raw_input_value, schema):
        ...
        for i in range(len(raw_input_value)):
            raw_input_value[i] = NumpyUtil._numpify_json_object(raw_input_value[i], schema.internal.data_type)
