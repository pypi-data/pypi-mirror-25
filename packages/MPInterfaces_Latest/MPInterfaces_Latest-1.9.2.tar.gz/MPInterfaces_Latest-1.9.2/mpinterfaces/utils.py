...
from mpinterfaces import set_config, SETTINGS_FILE, PACKAGE_PATH
...
def load_config_vars(config_dict):
    ...
    MPINT_CONFIG, MP_API, VASP_PSP, QUEUE_TEMPLATE, USERNAME,\
    VASP_STD_BIN, VASP_TWOD_BIN, VASP_NCL_BIN, VASP_SOL_BIN,\
    VASP_CUSTOM_BIN, VDW_KERNEL, QUEUE_SYSTEM = set_config()
