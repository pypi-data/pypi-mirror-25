...
#from mpinterfaces import SETTINGS_FILE
#config_template = os.path.join(MPINT_DIR, "config_files", "mpint_config.yaml")
#os.system('cp {} ~/.mpint_config.yaml'.format(config_template))
