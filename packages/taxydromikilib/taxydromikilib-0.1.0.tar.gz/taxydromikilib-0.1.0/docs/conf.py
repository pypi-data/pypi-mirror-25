...
# -*- coding: utf-8 -*-
#
# taxydromikilib documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''taxydromikilib''')])
...
version = taxydromikilib.__version__
# The full version, including alpha/beta/rc tags.
release = taxydromikilib.__version__
...
htmlhelp_basename = '''taxydromikilibdoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''taxydromikilib.tex''',
     u'''taxydromikilib Documentation''',
