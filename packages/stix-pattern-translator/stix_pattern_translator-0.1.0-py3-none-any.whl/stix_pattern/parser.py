...
from stix_pattern.grammar import STIXPatternListener, STIXPatternParser, STIXPatternLexer
from stix_pattern.pattern_objects import ObservationExpression, CombinedComparisonExpression, ObservationOperators, \
