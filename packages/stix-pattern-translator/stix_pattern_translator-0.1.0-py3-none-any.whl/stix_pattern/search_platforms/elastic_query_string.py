...
from stix_pattern.pattern_objects import ObservationExpression, ComparisonExpression, \
    ComparisonExpressionOperators, ComparisonComparators, Pattern, \
    CombinedComparisonExpression, CombinedObservationExpression, ObservationOperators
from stix_pattern.errors import SearchFeatureNotSupportedError
...
class ElasticQueryStringPatternTranslator:
    ...
    def _format_match(value) -> str:
        return "/{}/".format(ElasticQueryStringPatternTranslator._escape_value(value))
