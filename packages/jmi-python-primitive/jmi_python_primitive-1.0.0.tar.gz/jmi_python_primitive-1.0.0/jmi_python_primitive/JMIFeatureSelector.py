...
from jmi_python_primitive.jmi_tools import *

class JMIFeatureSelector():
    """
    ...
    def fit(self):
        ...
        FeatureSize = 5
        index = JMI(FeatureSize, self.training_inputs.shape[0], self.training_inputs.shape[1], self.training_inputs, self.training_outputs)
        print (index.shape[0])
