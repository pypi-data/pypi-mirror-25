...
# -*- coding: utf-8 -*-
#
# notifierlib documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''notifierlib''')])
...
version = notifierlib.__version__
# The full version, including alpha/beta/rc tags.
release = notifierlib.__version__
...
htmlhelp_basename = '''notifierlibdoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''notifierlib.tex''',
     u'''notifierlib Documentation''',
