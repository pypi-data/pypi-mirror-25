...
class IPCMBSelector(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params]):
    ...
    def fit(self) -> None:
        ...
        ipcmb = rpi_featureSelection_matlab_tools.initialize()
        index = np.array(ipcmb.IPCMB_binsearch())
