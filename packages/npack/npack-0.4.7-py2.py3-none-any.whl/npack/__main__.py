...
def main():
    ...
    | \| | __|_   _| __| |  |_ _\ \/ /    
    | .` | _|  | | | _|| |__ | | >  <     
    |_|\_|___| |_| |_| |____|___/_/\_\    npack.py version 0.4.7
    ...
    checksum_parser.add_argument('-cpu', '--cpu_cores', help='hint for utilizing specific # of cpu cores for checksum',required=False)
    ...
    zip_parser.add_argument('-cpu', '--cpu_cores', help='hint for utilizing specific # of cpu cores for checksum', required=False)
