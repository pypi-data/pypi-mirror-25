...
CLSCNT_VALIDITA_WRONG = 5396                                   #: E' necessario specificare una data di fine per le classi di sconto promozionale!
...
CLOUD_BACKUP_ERROR_EMAIL_SUBJECT = 9100                        #: [konga] Errore di backup nel cloud
