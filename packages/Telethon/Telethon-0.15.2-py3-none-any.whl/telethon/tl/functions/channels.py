...
class GetAdminLogRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            b'' if not self.events_filter else (self.events_filter.to_bytes()),
            b'' if not self.admins else b''.join((b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.admins)),b''.join(x.to_bytes() for x in self.admins))),
