...
class AllStickers(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.sets)),b''.join(x.to_bytes() for x in self.sets),
        ))
...
class BotResults(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            b'' if not self.switch_pm else (self.switch_pm.to_bytes()),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.results)),b''.join(x.to_bytes() for x in self.results),
            struct.pack('<i', self.cache_time),
        ))
...
class Dialogs(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            b'@l\xba\x15',
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.dialogs)),b''.join(x.to_bytes() for x in self.dialogs),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.messages)),b''.join(x.to_bytes() for x in self.messages),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),
        ))
...
class FavedStickers(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            b'\x16/\x7f\xf3',
            struct.pack('<i', self.hash),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.packs)),b''.join(x.to_bytes() for x in self.packs),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.stickers)),b''.join(x.to_bytes() for x in self.stickers),
        ))
...
class HighScores(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            b'\x99\xfd;\x9a',
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.scores)),b''.join(x.to_bytes() for x in self.scores),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),
        ))
...
class SavedGifs(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            b'\xa5\t\x07.',
            struct.pack('<i', self.hash),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.gifs)),b''.join(x.to_bytes() for x in self.gifs),
        ))
