...
class ChannelDifference(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            b'Ngd ',
            struct.pack('<I', (1 if self.final else 0) | (2 if self.timeout else 0)),
            struct.pack('<i', self.pts),
            b'' if not self.timeout else (struct.pack('<i', self.timeout)),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.new_messages)),b''.join(x.to_bytes() for x in self.new_messages),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.other_updates)),b''.join(x.to_bytes() for x in self.other_updates),
...
class ChannelDifferenceTooLong(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.messages)),b''.join(x.to_bytes() for x in self.messages),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),
        ))
...
class Difference(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            b'\xa0\x9c\xf4\x00',
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.new_messages)),b''.join(x.to_bytes() for x in self.new_messages),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.new_encrypted_messages)),b''.join(x.to_bytes() for x in self.new_encrypted_messages),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.other_updates)),b''.join(x.to_bytes() for x in self.other_updates),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),
            self.state.to_bytes(),
...
class DifferenceSlice(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),
            self.intermediate_state.to_bytes(),
        ))
