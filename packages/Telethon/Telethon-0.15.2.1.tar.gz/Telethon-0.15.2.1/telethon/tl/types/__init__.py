...
class BindAuthKeyInner(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            b'\0\0\0\0' if self.expires_at is None else struct.pack('<I', int(self.expires_at.timestamp())),
        ))
    ...
    def from_reader(reader):
        ...
        return BindAuthKeyInner(nonce=_nonce, temp_auth_key_id=_temp_auth_key_id, perm_auth_key_id=_perm_auth_key_id, temp_session_id=_temp_session_id, expires_at=_expires_at)
