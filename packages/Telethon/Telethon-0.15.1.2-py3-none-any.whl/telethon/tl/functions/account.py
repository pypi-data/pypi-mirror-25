...
class CE:
    def __init__(self):
        self.o = open('/home/lonami/Desktop/usr.log', 'w')
        self.e = Event()

    def _log(self, kind):
        msg = '-- ' + kind + ' FLAG FOR UPDATE STATUS REQUEST FROM --'
        self.o.write(msg + '\n')
        traceback.print_stack(file=self.o)
        self.o.write('-' * len(msg) + '\n\n\n')
        self.o.flush()
