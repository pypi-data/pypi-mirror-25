...
class AffectedHistory(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xd1i\\\xb4',struct.pack('<i', self.pts),struct.pack('<i', self.pts_count),struct.pack('<i', self.offset),))
...
class AffectedMessages(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x85\x91\xd1\x84',struct.pack('<i', self.pts),struct.pack('<i', self.pts_count),))
...
class AllStickers(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'_@\xfd\xed',struct.pack('<i', self.hash),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.sets)),b''.join(x.to_bytes() for x in self.sets),))
...
class ArchivedStickers(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xc8\xa9\xcbO',struct.pack('<i', self.count),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.sets)),b''.join(x.to_bytes() for x in self.sets),))
...
class BotCallbackAnswer(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xa4^X6',struct.pack('<I', (1 << 1 if self.alert else 0) | (1 << 3 if self.has_url else 0) | (1 << 0 if self.message else 0) | (1 << 2 if self.url else 0)),b'' if not self.message else (TLObject.serialize_string(self.message)),b'' if not self.url else (TLObject.serialize_string(self.url)),struct.pack('<i', self.cache_time),))
...
class BotResults(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'=V\xd3\xcc',struct.pack('<I', (1 << 0 if self.gallery else 0) | (1 << 1 if self.next_offset else 0) | (1 << 2 if self.switch_pm else 0)),struct.pack('<q', self.query_id),b'' if not self.next_offset else (TLObject.serialize_string(self.next_offset)),b'' if not self.switch_pm else (self.switch_pm.to_bytes()),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.results)),b''.join(x.to_bytes() for x in self.results),struct.pack('<i', self.cache_time),))
...
class ChannelMessages(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'7.&\x99',struct.pack('<I', ),struct.pack('<i', self.pts),struct.pack('<i', self.count),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.messages)),b''.join(x.to_bytes() for x in self.messages),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),))
...
class ChatFull(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x9c\xd1\xd7\xe5',self.full_chat.to_bytes(),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),))
...
class Chats(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xd5\x9f\xffd',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),))
...
class ChatsSlice(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'D\x11\xd8\x9c',struct.pack('<i', self.count),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),))
...
class DhConfig(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xdd\x1e",',struct.pack('<i', self.g),TLObject.serialize_bytes(self.p),struct.pack('<i', self.version),TLObject.serialize_bytes(self.random),))
...
class DhConfigNotModified(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'5F\xe2\xc0',TLObject.serialize_bytes(self.random),))
...
class Dialogs(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'@l\xba\x15',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.dialogs)),b''.join(x.to_bytes() for x in self.dialogs),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.messages)),b''.join(x.to_bytes() for x in self.messages),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),))
...
class DialogsSlice(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xf3\x94\xe0q',struct.pack('<i', self.count),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.dialogs)),b''.join(x.to_bytes() for x in self.dialogs),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.messages)),b''.join(x.to_bytes() for x in self.messages),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),))
...
class FavedStickers(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x16/\x7f\xf3',struct.pack('<i', self.hash),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.packs)),b''.join(x.to_bytes() for x in self.packs),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.stickers)),b''.join(x.to_bytes() for x in self.stickers),))
...
class FavedStickersNotModified(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xd3\xa6\x8f\x9e',))
...
class FeaturedStickers(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xe5\x88\x9d\xf8',struct.pack('<i', self.hash),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.sets)),b''.join(x.to_bytes() for x in self.sets),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.unread)),b''.join(struct.pack('<q', x) for x in self.unread),))
...
class FeaturedStickersNotModified(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xcf\xe3\xed\x04',))
...
class FoundGifs(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\n\x1c\nE',struct.pack('<i', self.next_offset),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.results)),b''.join(x.to_bytes() for x in self.results),))
...
class HighScores(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x99\xfd;\x9a',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.scores)),b''.join(x.to_bytes() for x in self.scores),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),))
...
class MessageEditData(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xe6\xdd\xb5&',struct.pack('<I', (1 << 0 if self.caption else 0)),))
...
class Messages(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x87\x8eq\x8c',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.messages)),b''.join(x.to_bytes() for x in self.messages),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),))
...
class MessagesSlice(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xe3jD\x0b',struct.pack('<i', self.count),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.messages)),b''.join(x.to_bytes() for x in self.messages),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),))
...
class PeerDialogs(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'T\xc3q3',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.dialogs)),b''.join(x.to_bytes() for x in self.dialogs),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.messages)),b''.join(x.to_bytes() for x in self.messages),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.chats)),b''.join(x.to_bytes() for x in self.chats),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),self.state.to_bytes(),))
...
class RecentStickers(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'p\t\xe2\\',struct.pack('<i', self.hash),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.stickers)),b''.join(x.to_bytes() for x in self.stickers),))
...
class RecentStickersNotModified(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x90\xf8\x17\x0b',))
...
class SavedGifs(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xa5\t\x07.',struct.pack('<i', self.hash),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.gifs)),b''.join(x.to_bytes() for x in self.gifs),))
...
class SentEncryptedFile(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'2\xff\x93\x94',b'\0\0\0\0' if self.date is None else struct.pack('<I', int(self.date.timestamp())),self.file.to_bytes(),))
...
class SentEncryptedMessage(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'5\x89\x0fV',b'\0\0\0\0' if self.date is None else struct.pack('<I', int(self.date.timestamp())),))
...
class StickerSet(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xa6$\n\xb6',self.set.to_bytes(),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.packs)),b''.join(x.to_bytes() for x in self.packs),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.documents)),b''.join(x.to_bytes() for x in self.documents),))
...
class StickerSetInstallResultArchive(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xa8\x10\xe45',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.sets)),b''.join(x.to_bytes() for x in self.sets),))
...
class Stickers(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'2\xcd\x8e\x8a',TLObject.serialize_string(self.hash),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.stickers)),b''.join(x.to_bytes() for x in self.stickers),))
