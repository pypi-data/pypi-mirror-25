...
class ChangePhoneRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xdb.\xc3p',TLObject.serialize_string(self.phone_number),TLObject.serialize_string(self.phone_code_hash),TLObject.serialize_string(self.phone_code),))
...
class CheckUsernameRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b"l\xd8\x14'",TLObject.serialize_string(self.username),))
...
class ConfirmPhoneRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xc3x!_',TLObject.serialize_string(self.phone_code_hash),TLObject.serialize_string(self.phone_code),))
...
class DeleteAccountRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x0bN\x8dA',TLObject.serialize_string(self.reason),))
...
class GetNotifySettingsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'1\xad\xb3\x12',self.peer.to_bytes(),))
...
class GetPasswordSettingsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xbb\x11\x8d\xbc',TLObject.serialize_bytes(self.current_password_hash),))
...
class GetPrivacyRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'P\xc9\xdb\xda',self.key.to_bytes(),))
...
class GetTmpPasswordRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'~2\x82J',TLObject.serialize_bytes(self.password_hash),struct.pack('<i', self.period),))
...
class RegisterDeviceRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'x\xa8~c',struct.pack('<i', self.token_type),TLObject.serialize_string(self.token),))
...
class ReportPeerRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'_\x9d\x18\xae',self.peer.to_bytes(),self.reason.to_bytes(),))
...
class ResetAuthorizationRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xbc\xf3w\xdf',struct.pack('<q', self.hash),))
...
class SendChangePhoneCodeRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xeb}\xe5\x08',struct.pack('<I', (1 << 0 if self.allow_flashcall else 0) | (1 << 0 if self.current_number else 0)),TLObject.serialize_string(self.phone_number),b'' if not self.current_number else (b'\xb5ur\x99' if {} else b'7\x97y\xbc'),))
...
class SendConfirmPhoneCodeRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xbd\xd7\x16\x15',struct.pack('<I', (1 << 0 if self.allow_flashcall else 0) | (1 << 0 if self.current_number else 0)),TLObject.serialize_string(self.hash),b'' if not self.current_number else (b'\xb5ur\x99' if {} else b'7\x97y\xbc'),))
...
class SetAccountTTLRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'^HB$',self.ttl.to_bytes(),))
...
class SetPrivacyRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xe8\x1c\xf8\xc9',self.key.to_bytes(),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.rules)),b''.join(x.to_bytes() for x in self.rules),))
...
class UnregisterDeviceRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'@[\xc5e',struct.pack('<i', self.token_type),TLObject.serialize_string(self.token),))
...
class UpdateDeviceLockedRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'25\xdf8',struct.pack('<i', self.period),))
...
class UpdateNotifySettingsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x93[\xbe\x84',self.peer.to_bytes(),self.settings.to_bytes(),))
...
class UpdatePasswordSettingsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x86K|\xfa',TLObject.serialize_bytes(self.current_password_hash),self.new_settings.to_bytes(),))
...
class UpdateProfileRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'uWQx',struct.pack('<I', (1 << 0 if self.first_name else 0) | (1 << 1 if self.last_name else 0) | (1 << 2 if self.about else 0)),b'' if not self.first_name else (TLObject.serialize_string(self.first_name)),b'' if not self.last_name else (TLObject.serialize_string(self.last_name)),b'' if not self.about else (TLObject.serialize_string(self.about)),))
...
class UpdateStatusRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b',V(f',b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class UpdateUsernameRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'|\xdd\x0b>',TLObject.serialize_string(self.username),))
