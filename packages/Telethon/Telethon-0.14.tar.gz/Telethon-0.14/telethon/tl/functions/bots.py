...
class AnswerWebhookJSONQueryRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'M?!\xe6',struct.pack('<q', self.query_id),self.data.to_bytes(),))
...
class SendCustomRequestRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b"\xedi'\xaa",TLObject.serialize_string(self.custom_method),self.params.to_bytes(),))
