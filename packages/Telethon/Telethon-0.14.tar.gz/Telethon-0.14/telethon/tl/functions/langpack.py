...
class GetDifferenceRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'}M.\x0b',struct.pack('<i', self.from_version),))
...
class GetLangPackRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x8e\xc5\xb5\x9a',TLObject.serialize_string(self.lang_code),))
...
class GetStringsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x18\xe3\x1e.',TLObject.serialize_string(self.lang_code),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.keys)),b''.join(TLObject.serialize_string(x) for x in self.keys),))
