...
class BindTempAuthKeyRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x05*\xd4\xcd',struct.pack('<q', self.perm_auth_key_id),struct.pack('<q', self.nonce),b'\0\0\0\0' if self.expires_at is None else struct.pack('<I', int(self.expires_at.timestamp())),TLObject.serialize_bytes(self.encrypted_message),))
...
class CancelCodeRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'x\x05\x04\x1f',TLObject.serialize_string(self.phone_number),TLObject.serialize_string(self.phone_code_hash),))
...
class CheckPhoneRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xfb\x1d\xe5o',TLObject.serialize_string(self.phone_number),))
...
class DropTempAuthKeysRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x88\xa1H\x8e',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.except_auth_keys)),b''.join(struct.pack('<q', x) for x in self.except_auth_keys),))
...
class ExportAuthorizationRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xcd\xff\xbf\xe5',struct.pack('<i', self.dc_id),))
...
class ImportAuthorizationRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x13\x96\xef\xe3',struct.pack('<i', self.id),TLObject.serialize_bytes(self.bytes),))
...
class ImportBotAuthorizationRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b',\xff\xa3g',struct.pack('<i', self.flags),struct.pack('<i', self.api_id),TLObject.serialize_string(self.api_hash),TLObject.serialize_string(self.bot_auth_token),))
...
class RecoverPasswordRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x92n\xa5N',TLObject.serialize_string(self.code),))
...
class ResendCodeRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xbf\xa9\xf1>',TLObject.serialize_string(self.phone_number),TLObject.serialize_string(self.phone_code_hash),))
...
class SendCodeRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xec\xf0\xae\x86',struct.pack('<I', (1 << 0 if self.allow_flashcall else 0) | (1 << 0 if self.current_number else 0)),TLObject.serialize_string(self.phone_number),b'' if not self.current_number else (b'\xb5ur\x99' if {} else b'7\x97y\xbc'),struct.pack('<i', self.api_id),TLObject.serialize_string(self.api_hash),))
...
class SendInvitesRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x97\x1d\x1cw',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.phone_numbers)),b''.join(TLObject.serialize_string(x) for x in self.phone_numbers),TLObject.serialize_string(self.message),))
...
class SignInRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x81\x15\xd5\xbc',TLObject.serialize_string(self.phone_number),TLObject.serialize_string(self.phone_code_hash),TLObject.serialize_string(self.phone_code),))
...
class SignUpRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'4v\x06\x1b',TLObject.serialize_string(self.phone_number),TLObject.serialize_string(self.phone_code_hash),TLObject.serialize_string(self.phone_code),TLObject.serialize_string(self.first_name),TLObject.serialize_string(self.last_name),))
