...
class AcceptEncryptionRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x15\x04\xbc=',self.peer.to_bytes(),TLObject.serialize_bytes(self.g_b),struct.pack('<q', self.key_fingerprint),))
...
class AddChatUserRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\t\xaa\xa0\xf9',struct.pack('<i', self.chat_id),self.user_id.to_bytes(),struct.pack('<i', self.fwd_limit),))
...
class CheckChatInviteRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xbb\xb1\xad>',TLObject.serialize_string(self.hash),))
...
class ClearRecentStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'-`\x99\x89',struct.pack('<I', (1 << 0 if self.attached else 0)),))
...
class CreateChatRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'n\x12\xcb\t',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.users)),b''.join(x.to_bytes() for x in self.users),TLObject.serialize_string(self.title),))
...
class DeleteChatUserRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x16\x1fa\xe0',struct.pack('<i', self.chat_id),self.user_id.to_bytes(),))
...
class DeleteHistoryRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\t[\x01\x1c',struct.pack('<I', (1 << 0 if self.just_clear else 0)),self.peer.to_bytes(),struct.pack('<i', self.max_id),))
...
class DeleteMessagesRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xd2\x95\x8e\xe5',struct.pack('<I', (1 << 0 if self.revoke else 0)),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(struct.pack('<i', x) for x in self.id),))
...
class DiscardEncryptionRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xc5#\xd9\xed',struct.pack('<i', self.chat_id),))
...
class EditChatAdminRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'.\x9f\xe6\xa9',struct.pack('<i', self.chat_id),self.user_id.to_bytes(),b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class EditChatPhotoRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xd8yL\xca',struct.pack('<i', self.chat_id),self.photo.to_bytes(),))
...
class EditChatTitleRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'U(E\xdc',struct.pack('<i', self.chat_id),TLObject.serialize_string(self.title),))
...
class EditInlineBotMessageRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x85,\x0c\x13',struct.pack('<I', (1 << 1 if self.no_webpage else 0) | (1 << 11 if self.message else 0) | (1 << 2 if self.reply_markup else 0) | (1 << 3 if self.entities else 0)),self.id.to_bytes(),b'' if not self.message else (TLObject.serialize_string(self.message)),b'' if not self.reply_markup else (self.reply_markup.to_bytes()),b'' if not self.entities else b''.join((b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.entities)),b''.join(x.to_bytes() for x in self.entities))),))
...
class EditMessageRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xca\xe4\x91\xce',struct.pack('<I', (1 << 1 if self.no_webpage else 0) | (1 << 11 if self.message else 0) | (1 << 2 if self.reply_markup else 0) | (1 << 3 if self.entities else 0)),self.peer.to_bytes(),struct.pack('<i', self.id),b'' if not self.message else (TLObject.serialize_string(self.message)),b'' if not self.reply_markup else (self.reply_markup.to_bytes()),b'' if not self.entities else b''.join((b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.entities)),b''.join(x.to_bytes() for x in self.entities))),))
...
class ExportChatInviteRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x89R\x88}',struct.pack('<i', self.chat_id),))
...
class FaveStickerRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'[\xc5\xff\xb9',self.id.to_bytes(),b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class ForwardMessageRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xf9;\x963',self.peer.to_bytes(),struct.pack('<i', self.id),struct.pack('<q', self.random_id),))
...
class ForwardMessagesRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x95\x01\x8ep',struct.pack('<I', (1 << 5 if self.silent else 0) | (1 << 6 if self.background else 0) | (1 << 8 if self.with_my_score else 0)),self.from_peer.to_bytes(),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(struct.pack('<i', x) for x in self.id),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.random_id)),b''.join(struct.pack('<q', x) for x in self.random_id),self.to_peer.to_bytes(),))
...
class GetAllChatsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xf0\x0f\xa8\xeb',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.except_ids)),b''.join(struct.pack('<i', x) for x in self.except_ids),))
...
class GetAllStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xb1\x18\x96\x1c',struct.pack('<i', self.hash),))
...
class GetArchivedStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x92v\xf1W',struct.pack('<I', (1 << 0 if self.masks else 0)),struct.pack('<q', self.offset_id),struct.pack('<i', self.limit),))
...
class GetAttachedStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xccg[\xcc',self.media.to_bytes(),))
...
class GetBotCallbackAnswerRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xec\x9f\n\x81',struct.pack('<I', (1 << 1 if self.game else 0) | (1 << 0 if self.data else 0)),self.peer.to_bytes(),struct.pack('<i', self.msg_id),b'' if not self.data else (TLObject.serialize_bytes(self.data)),))
...
class GetChatsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x87\xa1j<',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(struct.pack('<i', x) for x in self.id),))
...
class GetCommonChatsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xc4H\n\r',self.user_id.to_bytes(),struct.pack('<i', self.max_id),struct.pack('<i', self.limit),))
...
class GetDhConfigRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'P\x89\xcf&',struct.pack('<i', self.version),struct.pack('<i', self.random_length),))
...
class GetDialogsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xc5\xa9\x1b\x19',struct.pack('<I', (1 << 0 if self.exclude_pinned else 0)),b'\0\0\0\0' if self.offset_date is None else struct.pack('<I', int(self.offset_date.timestamp())),struct.pack('<i', self.offset_id),self.offset_peer.to_bytes(),struct.pack('<i', self.limit),))
...
class GetDocumentByHashRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'd$\x8e3',TLObject.serialize_bytes(self.sha256),struct.pack('<i', self.size),TLObject.serialize_string(self.mime_type),))
...
class GetFavedStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x0e\x0b\xce!',struct.pack('<i', self.hash),))
...
class GetFeaturedStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'O\xca\xac-',struct.pack('<i', self.hash),))
...
class GetFullChatRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'f\x1c\x83;',struct.pack('<i', self.chat_id),))
...
class GetGameHighScoresRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x9dd"\xe8',self.peer.to_bytes(),struct.pack('<i', self.id),self.user_id.to_bytes(),))
...
class GetHistoryRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'F(\xa9\xaf',self.peer.to_bytes(),struct.pack('<i', self.offset_id),b'\0\0\0\0' if self.offset_date is None else struct.pack('<I', int(self.offset_date.timestamp())),struct.pack('<i', self.add_offset),struct.pack('<i', self.limit),struct.pack('<i', self.max_id),struct.pack('<i', self.min_id),))
...
class GetInlineBotResultsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x9d\x99NQ',struct.pack('<I', (1 << 0 if self.geo_point else 0)),self.bot.to_bytes(),self.peer.to_bytes(),b'' if not self.geo_point else (self.geo_point.to_bytes()),TLObject.serialize_string(self.query),TLObject.serialize_string(self.offset),))
...
class GetInlineGameHighScoresRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x1b^c\x0f',self.id.to_bytes(),self.user_id.to_bytes(),))
...
class GetMaskStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x9f\xc7\xb8e',struct.pack('<i', self.hash),))
...
class GetMessageEditDataRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'6\x8d\xa6\xfd',self.peer.to_bytes(),struct.pack('<i', self.id),))
...
class GetMessagesRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b't\xfa"B',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(struct.pack('<i', x) for x in self.id),))
...
class GetMessagesViewsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b']\xa5\xc8\xc4',self.peer.to_bytes(),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(struct.pack('<i', x) for x in self.id),b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class GetPeerDialogsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xb9v\x97-',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.peers)),b''.join(x.to_bytes() for x in self.peers),))
...
class GetPeerSettingsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x9c\xe0r6',self.peer.to_bytes(),))
...
class GetRecentStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xc9\x92\xa1^',struct.pack('<I', (1 << 0 if self.attached else 0)),struct.pack('<i', self.hash),))
...
class GetSavedGifsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'R=\xbf\x83',struct.pack('<i', self.hash),))
...
class GetStickerSetRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x0e\xa9\x19&',self.stickerset.to_bytes(),))
...
class GetUnreadMentionsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'r\x84WF',self.peer.to_bytes(),struct.pack('<i', self.offset_id),struct.pack('<i', self.add_offset),struct.pack('<i', self.limit),struct.pack('<i', self.max_id),struct.pack('<i', self.min_id),))
...
class GetWebPageRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x91\x8f\xca2',TLObject.serialize_string(self.url),struct.pack('<i', self.hash),))
...
class GetWebPagePreviewRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'$>"%',TLObject.serialize_string(self.message),))
...
class HideReportSpamRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x9bp\xf1\xa8',self.peer.to_bytes(),))
...
class ImportChatInviteRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x1c\x05Pl',TLObject.serialize_string(self.hash),))
...
class InstallStickerSetRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'`\xe4\x8f\xc7',self.stickerset.to_bytes(),b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class MigrateChatRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xe3\xb8\xa3\x15',struct.pack('<i', self.chat_id),))
...
class ReadEncryptedHistoryRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\niK\x7f',self.peer.to_bytes(),b'\0\0\0\0' if self.max_date is None else struct.pack('<I', int(self.max_date.timestamp())),))
...
class ReadFeaturedStickersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'&\x81\x11[',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(struct.pack('<q', x) for x in self.id),))
...
class ReadHistoryRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b':m0\x0e',self.peer.to_bytes(),struct.pack('<i', self.max_id),))
...
class ReadMessageContentsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'w?\xa76',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(struct.pack('<i', x) for x in self.id),))
...
class ReceivedMessagesRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xc0T\xa9\x05',struct.pack('<i', self.max_id),))
...
class ReceivedQueueRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'f\xbb\xa5U',struct.pack('<i', self.max_qts),))
...
class ReorderPinnedDialogsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'D\xf6\x9f\x95',struct.pack('<I', (1 << 0 if self.force else 0)),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.order)),b''.join(x.to_bytes() for x in self.order),))
...
class ReorderStickerSetsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'9w3x',struct.pack('<I', (1 << 0 if self.masks else 0)),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.order)),b''.join(struct.pack('<q', x) for x in self.order),))
...
class ReportEncryptedSpamRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x0f\x8c\x0cK',self.peer.to_bytes(),))
...
class ReportSpamRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xdb\x92\x15\xcf',self.peer.to_bytes(),))
...
class RequestEncryptionRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'C\xafM\xf6',self.user_id.to_bytes(),struct.pack('<i', self.random_id),TLObject.serialize_bytes(self.g_a),))
...
class SaveDraftRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'K\xe19\xbc',struct.pack('<I', (1 << 1 if self.no_webpage else 0) | (1 << 0 if self.reply_to_msg_id else 0) | (1 << 3 if self.entities else 0)),b'' if not self.reply_to_msg_id else (struct.pack('<i', self.reply_to_msg_id)),self.peer.to_bytes(),TLObject.serialize_string(self.message),b'' if not self.entities else b''.join((b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.entities)),b''.join(x.to_bytes() for x in self.entities))),))
...
class SaveGifRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xcb0z2',self.id.to_bytes(),b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class SaveRecentStickerRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b"\xf8\x18'9",struct.pack('<I', (1 << 0 if self.attached else 0)),self.id.to_bytes(),b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class SearchRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xa0\x9e\x9e\x03',struct.pack('<I', (1 << 0 if self.from_id else 0)),self.peer.to_bytes(),TLObject.serialize_string(self.q),b'' if not self.from_id else (self.from_id.to_bytes()),self.filter.to_bytes(),b'\0\0\0\0' if self.min_date is None else struct.pack('<I', int(self.min_date.timestamp())),b'\0\0\0\0' if self.max_date is None else struct.pack('<I', int(self.max_date.timestamp())),struct.pack('<i', self.offset_id),struct.pack('<i', self.add_offset),struct.pack('<i', self.limit),struct.pack('<i', self.max_id),struct.pack('<i', self.min_id),))
...
class SearchGifsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'kw\x9a\xbf',TLObject.serialize_string(self.q),struct.pack('<i', self.offset),))
...
class SearchGlobalRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xb0\xac<\x9e',TLObject.serialize_string(self.q),b'\0\0\0\0' if self.offset_date is None else struct.pack('<I', int(self.offset_date.timestamp())),self.offset_peer.to_bytes(),struct.pack('<i', self.offset_id),struct.pack('<i', self.limit),))
...
class SendEncryptedRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'sgw\xa9',self.peer.to_bytes(),struct.pack('<q', self.random_id),TLObject.serialize_bytes(self.data),))
...
class SendEncryptedFileRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'f\x1b\x90\x9a',self.peer.to_bytes(),struct.pack('<q', self.random_id),TLObject.serialize_bytes(self.data),self.file.to_bytes(),))
...
class SendEncryptedServiceRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xa49\xd42',self.peer.to_bytes(),struct.pack('<q', self.random_id),TLObject.serialize_bytes(self.data),))
...
class SendInlineBotResultRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xfe\x06n\xb1',struct.pack('<I', (1 << 5 if self.silent else 0) | (1 << 6 if self.background else 0) | (1 << 7 if self.clear_draft else 0) | (1 << 0 if self.reply_to_msg_id else 0)),self.peer.to_bytes(),b'' if not self.reply_to_msg_id else (struct.pack('<i', self.reply_to_msg_id)),struct.pack('<q', self.random_id),struct.pack('<q', self.query_id),TLObject.serialize_string(self.id),))
...
class SendMediaRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x91g\xf1\xc8',struct.pack('<I', (1 << 5 if self.silent else 0) | (1 << 6 if self.background else 0) | (1 << 7 if self.clear_draft else 0) | (1 << 0 if self.reply_to_msg_id else 0) | (1 << 2 if self.reply_markup else 0)),self.peer.to_bytes(),b'' if not self.reply_to_msg_id else (struct.pack('<i', self.reply_to_msg_id)),self.media.to_bytes(),struct.pack('<q', self.random_id),b'' if not self.reply_markup else (self.reply_markup.to_bytes()),))
...
class SendMessageRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'zB\x88\xfa',struct.pack('<I', (1 << 1 if self.no_webpage else 0) | (1 << 5 if self.silent else 0) | (1 << 6 if self.background else 0) | (1 << 7 if self.clear_draft else 0) | (1 << 0 if self.reply_to_msg_id else 0) | (1 << 2 if self.reply_markup else 0) | (1 << 3 if self.entities else 0)),self.peer.to_bytes(),b'' if not self.reply_to_msg_id else (struct.pack('<i', self.reply_to_msg_id)),TLObject.serialize_string(self.message),struct.pack('<q', self.random_id),b'' if not self.reply_markup else (self.reply_markup.to_bytes()),b'' if not self.entities else b''.join((b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.entities)),b''.join(x.to_bytes() for x in self.entities))),))
...
class SendScreenshotNotificationRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b' \xf0}\xc9',self.peer.to_bytes(),struct.pack('<i', self.reply_to_msg_id),struct.pack('<q', self.random_id),))
...
class SetBotCallbackAnswerRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\n\x13\x8f\xd5',struct.pack('<I', (1 << 1 if self.alert else 0) | (1 << 0 if self.message else 0) | (1 << 2 if self.url else 0)),struct.pack('<q', self.query_id),b'' if not self.message else (TLObject.serialize_string(self.message)),b'' if not self.url else (TLObject.serialize_string(self.url)),struct.pack('<i', self.cache_time),))
...
class SetBotPrecheckoutResultsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x95\xdd\xc2\t',struct.pack('<I', (1 << 1 if self.success else 0) | (1 << 0 if self.error else 0)),struct.pack('<q', self.query_id),b'' if not self.error else (TLObject.serialize_string(self.error)),))
...
class SetBotShippingResultsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xfar\xf6\xe5',struct.pack('<I', (1 << 0 if self.error else 0) | (1 << 1 if self.shipping_options else 0)),struct.pack('<q', self.query_id),b'' if not self.error else (TLObject.serialize_string(self.error)),b'' if not self.shipping_options else b''.join((b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.shipping_options)),b''.join(x.to_bytes() for x in self.shipping_options))),))
...
class SetEncryptedTypingRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xedQ\x14y',self.peer.to_bytes(),b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class SetGameScoreRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xc0\xec\xf8\x8e',struct.pack('<I', (1 << 0 if self.edit_message else 0) | (1 << 1 if self.force else 0)),self.peer.to_bytes(),struct.pack('<i', self.id),self.user_id.to_bytes(),struct.pack('<i', self.score),))
...
class SetInlineBotResultsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x06\xa2^\xeb',struct.pack('<I', (1 << 0 if self.gallery else 0) | (1 << 1 if self.private else 0) | (1 << 2 if self.next_offset else 0) | (1 << 3 if self.switch_pm else 0)),struct.pack('<q', self.query_id),b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.results)),b''.join(x.to_bytes() for x in self.results),struct.pack('<i', self.cache_time),b'' if not self.next_offset else (TLObject.serialize_string(self.next_offset)),b'' if not self.switch_pm else (self.switch_pm.to_bytes()),))
...
class SetInlineGameScoreRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'd\x9f\xad\x15',struct.pack('<I', (1 << 0 if self.edit_message else 0) | (1 << 1 if self.force else 0)),self.id.to_bytes(),self.user_id.to_bytes(),struct.pack('<i', self.score),))
...
class SetTypingRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'P^\x82\xa3',self.peer.to_bytes(),self.action.to_bytes(),))
...
class StartBotRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'xs\xdf\xe6',self.bot.to_bytes(),self.peer.to_bytes(),struct.pack('<q', self.random_id),TLObject.serialize_string(self.start_param),))
...
class ToggleChatAdminsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xe1\xd9\x8b\xec',struct.pack('<i', self.chat_id),b'\xb5ur\x99' if {} else b'7\x97y\xbc',))
...
class ToggleDialogPinRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'j\xbe\x892',struct.pack('<I', (1 << 0 if self.pinned else 0)),self.peer.to_bytes(),))
...
class UninstallStickerSetRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xdeUn\xf9',self.stickerset.to_bytes(),))
...
class UploadMediaRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xb1\xc2\x9bQ',self.peer.to_bytes(),self.media.to_bytes(),))
