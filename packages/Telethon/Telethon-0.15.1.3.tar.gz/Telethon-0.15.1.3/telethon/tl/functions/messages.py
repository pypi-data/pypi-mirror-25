...
class GetInlineBotResultsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            self.bot.to_bytes(),
            self.peer.to_bytes(),
            b'' if not self.geo_point else (self.geo_point.to_bytes()),
...
class ReorderPinnedDialogsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.order)),b''.join(x.to_bytes() for x in self.order),
        ))
...
class SearchRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            b'' if not self.from_id else (self.from_id.to_bytes()),
...
class SetBotShippingResultsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((
            ...
            struct.pack('<q', self.query_id),
            b'' if not self.error else (TLObject.serialize_bytes(self.error)),
            b'' if not self.shipping_options else b''.join((b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.shipping_options)),b''.join(x.to_bytes() for x in self.shipping_options))),
        ))
