...
class DeletePhotosRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'/\x7f\xcf\x87',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(x.to_bytes() for x in self.id),))
...
class GetUserPhotosRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xa82\xcd\x91',self.user_id.to_bytes(),struct.pack('<i', self.offset),struct.pack('<q', self.max_id),struct.pack('<i', self.limit),))
...
class UpdateProfilePhotoRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'RQ\xbb\xf0',self.id.to_bytes(),))
...
class UploadProfilePhotoRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x98\xc02O',self.file.to_bytes(),))
