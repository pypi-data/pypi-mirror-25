...
class BlockRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xfcI+3',self.id.to_bytes(),))
...
class DeleteContactRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'D7\x95\x8e',self.id.to_bytes(),))
...
class DeleteContactsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x9e8\xabY',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.id)),b''.join(x.to_bytes() for x in self.id),))
...
class GetBlockedRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x0f5|\xf5',struct.pack('<i', self.offset),struct.pack('<i', self.limit),))
...
class GetContactsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\x9f\x84#\xc0',struct.pack('<i', self.hash),))
...
class GetTopPeersRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xb5-\x98\xd4',struct.pack('<I', (1 << 0 if self.correspondents else 0) | (1 << 1 if self.bots_pm else 0) | (1 << 2 if self.bots_inline else 0) | (1 << 3 if self.phone_calls else 0) | (1 << 10 if self.groups else 0) | (1 << 15 if self.channels else 0)),struct.pack('<i', self.offset),struct.pack('<i', self.limit),struct.pack('<i', self.hash),))
...
class ImportCardRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xfe\x96\xe1O',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.export_card)),b''.join(struct.pack('<i', x) for x in self.export_card),))
...
class ImportContactsRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xe5\x0b\x80,',b'\x15\xc4\xb5\x1c',struct.pack('<i', len(self.contacts)),b''.join(x.to_bytes() for x in self.contacts),))
...
class ResetTopPeerRatingRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xacs\xe3\x1a',self.category.to_bytes(),self.peer.to_bytes(),))
...
class ResolveUsernameRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xa3\xcb<\xf9',TLObject.serialize_string(self.username),))
...
class SearchRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xd8\x12\xf8\x11',TLObject.serialize_string(self.q),struct.pack('<i', self.limit),))
...
class UnblockRequest(TLObject):
    ...
    def to_bytes(self):
        return b''.join((b'\xbd\x00A\xe5',self.id.to_bytes(),))
