...
class ApiMeta(object):
    def __init__(self, app, name, f, args, kwargs):
        ...
        :param app:  the archerv2 app instance
...
class Archer(object):
    ...
    def __init__(self, service_name, thrift_file=None, root_path=None,
        ...
        """
        initialize an archerv2 application

        :param name:  app name
        :param thrift_file:  the thrift file to load by thriftpy, if not set
                             ,archerv2 will automatically find a .thrift file
                             under root path
    ...
    def after_api_call(self, f):
        ...
        of :class:`~archerv2.app.ApiResultMeta`, same for :meth:`tear_down_api_call`.
    ...
    def process(self, iprot, oprot):
        ...
        """
        return self.app.process(iprot, oprot)

    @property
    def test_client(self):
        """
        :return: an :class:`~archerv2.test.TestClient` instance
    ...
    def fake_client(self):
        """
        :return: an :class:`~archerv2.test.FakeClient` instance
