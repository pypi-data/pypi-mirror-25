...
class Configuration(object):
   ...
   def __init__(self, argv):
      ...
      self.is_location_reconstruction= args.index_location
      ...
      if sum(1 for o in(self.is_backup, self.is_restore, self.is_init, self.is_location_reconstruction) if o)>1:
   ...
   def _get_command_line_options(self, argv):
      ...
      parser.add_argument('--index-location',
         action='store_true',
         help="reconstructs the location index by scanning the archive for backup files")
