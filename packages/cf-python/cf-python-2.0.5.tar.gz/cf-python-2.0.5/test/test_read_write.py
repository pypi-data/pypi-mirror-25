...
#        print cf.read(filename)
        self.assertTrue(len(cf.read(filename, field=['dimension'])) == 4)
        self.assertTrue(len(cf.read(filename, field=['auxiliary'])) == 4)
        self.assertTrue(len(cf.read(filename, field='measure')) == 2)
        self.assertTrue(len(cf.read(filename, field=['field_ancillary'])) == 5)
        self.assertTrue(len(cf.read(filename, field='domain_ancillary')) == 4)
        self.assertTrue(len(cf.read(filename, field=['field_ancillary', 'auxiliary'])) == 8)
        self.assertTrue(len(cf.read(filename, field=['domain_ancillary', 'auxiliary'])) == 7)
        self.assertTrue(len(cf.read(filename, field=['domain_ancillary', 'measure', 'auxiliary'])) == 8)
        self.assertTrue(len(cf.read(filename, field='all')) == 15)
        self.assertTrue(len(cf.read(filename, field=('field_ancillary', 'dimension', 'measure', 'auxiliary', 'domain_ancillary'))) == 15)
    #--- End: def
