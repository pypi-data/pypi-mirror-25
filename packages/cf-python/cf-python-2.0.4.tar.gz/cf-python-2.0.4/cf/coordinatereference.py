...
'''
#        self._conversion_term_type.pop(term, None)
        self._parameters.remove(term)
        self._ancillaries.remove(term)
...
#        '''
#
#x.__setitem__(key) <==> x[key] = value
#
#'''
#        super(CoordinateReference, self).__setitem__(key, value)
#    #--- End: def
