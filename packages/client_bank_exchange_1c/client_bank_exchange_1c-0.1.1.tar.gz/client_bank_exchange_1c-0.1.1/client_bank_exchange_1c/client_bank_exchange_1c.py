...
class Document(Section):
    ...
    # noinspection PyShadowingNames
    def __init__(self, document_type: str = None, number: str = None, date: str = None, amount: str = None,
                 receipt: Receipt = None, payer: Payer = None, receiver: Receiver = None, payment: Payment = None,
                 tax: Tax = None, special: Special = None):
