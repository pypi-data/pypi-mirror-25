...
class KcpWrapper(_object):
    ...
    def setBindData(self, bindData):
        return _kcp.KcpWrapper_setBindData(self, bindData)

    def getBindData(self):
        return _kcp.KcpWrapper_getBindData(self)

    def setOutputListener(self, outputListener):
    ...
    def setWndSize(self, sndwnd, rcvwnd):
        return _kcp.KcpWrapper_setWndSize(self, sndwnd, rcvwnd)

    def setNoDelay(self, nodelay, interval, resend, nc):
