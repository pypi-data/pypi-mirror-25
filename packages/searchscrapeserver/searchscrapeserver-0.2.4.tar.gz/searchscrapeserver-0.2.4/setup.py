...
setup(name='searchscrapeserver',
      ...
      license='GPL-3.0',
      packages=['searchscrapeserver', 'searchscrapeserver.server', 'searchscrapeserver.scraping', 'searchscrapeserver.parsing', 
      'searchscrapeserver.common', 'searchscrapeserver.schemas'],
      install_requires=[
      	'aiohttp',
      	'lxml',
      	'bs4',
