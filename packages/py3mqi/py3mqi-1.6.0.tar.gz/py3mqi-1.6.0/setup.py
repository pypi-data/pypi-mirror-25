...
setup(name = 'py3mqi',
    ...
    long_description= 'Python 3.5 compatible version of PyMQI. PyMQI is a Python library for working with WebSphere MQ (formerly known as MQSeries) implementing MQI and PCF protocols.',
    author='Reinhard Pilz',
    author_email='reinhard.pilz@gmail.com',
    url='https://pythonhosted.org/pymqi/',
    download_url='https://github.com/Dynatrace-Reinhard-Pilz/pymqi3',
    platforms='Linux',
