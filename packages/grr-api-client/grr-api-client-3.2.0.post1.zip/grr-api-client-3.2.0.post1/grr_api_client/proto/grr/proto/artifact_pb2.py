...
_ARTIFACTDESCRIPTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='artifact_source', full_name='ArtifactDescriptor.artifact_source', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\374\343\304\001\031\022\027Artifact\'s JSON source.'))),
    _descriptor.FieldDescriptor(
      name='processors', full_name='ArtifactDescriptor.processors', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='is_custom', full_name='ArtifactDescriptor.is_custom', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='error_message', full_name='ArtifactDescriptor.error_message', index=6,
...
_ARTIFACTSOURCE.fields_by_name['attributes'].message_type = grr_dot_proto_dot_jobs__pb2._DICT
...
ArtifactSource = _reflection.GeneratedProtocolMessageType('ArtifactSource', (_message.Message,), dict(
  ...
  __module__ = 'grr.proto.artifact_pb2'
...
_ARTIFACTDESCRIPTOR.fields_by_name['artifact_source'].has_options = True
_ARTIFACTDESCRIPTOR.fields_by_name['artifact_source']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\374\343\304\001\031\022\027Artifact\'s JSON source.'))
