...
def enumerateDistantSDRsBruteForce(n, w, threshold):
    """enumerateDistantSDRsBruteForce(n, w, threshold) -> PyObject *"""
    return _experimental.enumerateDistantSDRsBruteForce(n, w, threshold)
...
class ApicalTiebreakTemporalMemory(object):
    ...
    def __init__(self, *args):
        ...
        __init__(self, columnCount, basalInputSize, apicalInputSize, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, connectedPermanence=0.50, minThreshold=10, sampleSize=20, permanenceIncrement=0.10, permanenceDecrement=0.10, basalPredictedSegmentDecrement=0.0, apicalPredictedSegmentDecrement=0.0, learnOnOneCell=False, seed=42, maxSegmentsPerCell=255, maxSynapsesPerSegment=255, checkInputs=True) -> ApicalTiebreakTemporalMemory
        """
    ...
    def seed(self, seed):
        """seed(self, seed)"""
        return _experimental.ApicalTiebreakTemporalMemory_seed(self, seed)
    ...
    def createBasalSegment(self, cell):
        """createBasalSegment(self, cell) -> nupic::algorithms::connections::Segment"""
        return _experimental.ApicalTiebreakTemporalMemory_createBasalSegment(self, cell)


    def createApicalSegment(self, cell):
        """createApicalSegment(self, cell) -> nupic::algorithms::connections::Segment"""
        return _experimental.ApicalTiebreakTemporalMemory_createApicalSegment(self, cell)
    ...
    def setActivationThreshold(self, arg2):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_setActivationThreshold(self, arg2)
    ...
    def setInitialPermanence(self, arg2):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_setInitialPermanence(self, arg2)
    ...
    def setConnectedPermanence(self, arg2):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_setConnectedPermanence(self, arg2)
    ...
    def setMinThreshold(self, arg2):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_setMinThreshold(self, arg2)
    ...
    def setSampleSize(self, arg2):
        """setSampleSize(self, arg2)"""
        return _experimental.ApicalTiebreakTemporalMemory_setSampleSize(self, arg2)
    ...
    def setLearnOnOneCell(self, learnOnOneCell):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_setLearnOnOneCell(self, learnOnOneCell)
    ...
    def setPermanenceIncrement(self, arg2):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_setPermanenceIncrement(self, arg2)
    ...
    def setPermanenceDecrement(self, arg2):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_setPermanenceDecrement(self, arg2)
    ...
    def setBasalPredictedSegmentDecrement(self, arg2):
        """setBasalPredictedSegmentDecrement(self, arg2)"""
        return _experimental.ApicalTiebreakTemporalMemory_setBasalPredictedSegmentDecrement(self, arg2)
    ...
    def setApicalPredictedSegmentDecrement(self, arg2):
        """setApicalPredictedSegmentDecrement(self, arg2)"""
        return _experimental.ApicalTiebreakTemporalMemory_setApicalPredictedSegmentDecrement(self, arg2)
    ...
    def setCheckInputs(self, checkInputs):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_setCheckInputs(self, checkInputs)


    def _validateCell(self, cell):
        """_validateCell(self, cell) -> bool"""
        return _experimental.ApicalTiebreakTemporalMemory__validateCell(self, cell)


    def write(self, proto):
        """write(self, proto)"""
        return _experimental.ApicalTiebreakTemporalMemory_write(self, proto)


    def read(self, proto):
        """read(self, proto)"""
        return _experimental.ApicalTiebreakTemporalMemory_read(self, proto)


    def __eq__(self, other):
        """__eq__(self, other) -> bool"""
        return _experimental.ApicalTiebreakTemporalMemory___eq__(self, other)


    def __ne__(self, other):
        """__ne__(self, other) -> bool"""
        return _experimental.ApicalTiebreakTemporalMemory___ne__(self, other)
    ...
    def columnForCell(self, cell):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_columnForCell(self, cell)


    def activateCells(self, activeColumnsBegin, activeColumnsEnd, basalReinforceCandidatesBegin, basalReinforceCandidatesEnd, apicalReinforceCandidatesBegin, apicalReinforceCandidatesEnd, basalGrowthCandidatesBegin, basalGrowthCandidatesEnd, apicalGrowthCandidatesBegin, apicalGrowthCandidatesEnd, learn):
        """activateCells(self, activeColumnsBegin, activeColumnsEnd, basalReinforceCandidatesBegin, basalReinforceCandidatesEnd, apicalReinforceCandidatesBegin, apicalReinforceCandidatesEnd, basalGrowthCandidatesBegin, basalGrowthCandidatesEnd, apicalGrowthCandidatesBegin, apicalGrowthCandidatesEnd, learn)"""
        return _experimental.ApicalTiebreakTemporalMemory_activateCells(self, activeColumnsBegin, activeColumnsEnd, basalReinforceCandidatesBegin, basalReinforceCandidatesEnd, apicalReinforceCandidatesBegin, apicalReinforceCandidatesEnd, basalGrowthCandidatesBegin, basalGrowthCandidatesEnd, apicalGrowthCandidatesBegin, apicalGrowthCandidatesEnd, learn)


    def depolarizeCells(self, basalInputBegin, basalInputEnd, apicalInputBegin, apicalInputEnd, learn=True):
        """depolarizeCells(self, basalInputBegin, basalInputEnd, apicalInputBegin, apicalInputEnd, learn=True)"""
        return _experimental.ApicalTiebreakTemporalMemory_depolarizeCells(self, basalInputBegin, basalInputEnd, apicalInputBegin, apicalInputEnd, learn)
    ...
    def cellsForColumn(self, columnIdx):
        ...
        return _experimental.ApicalTiebreakTemporalMemory_cellsForColumn(self, columnIdx)
...
class ApicalTiebreakPairMemory(ApicalTiebreakTemporalMemory):
    ...
    def __init__(self, columnCount, basalInputSize, apicalInputSize, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, connectedPermanence=0.50, minThreshold=10, sampleSize=20, permanenceIncrement=0.10, permanenceDecrement=0.10, basalPredictedSegmentDecrement=0.0, apicalPredictedSegmentDecrement=0.0, learnOnOneCell=False, seed=42, maxSegmentsPerCell=255, maxSynapsesPerSegment=255, checkInputs=True):
        """__init__(self, columnCount, basalInputSize, apicalInputSize, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, connectedPermanence=0.50, minThreshold=10, sampleSize=20, permanenceIncrement=0.10, permanenceDecrement=0.10, basalPredictedSegmentDecrement=0.0, apicalPredictedSegmentDecrement=0.0, learnOnOneCell=False, seed=42, maxSegmentsPerCell=255, maxSynapsesPerSegment=255, checkInputs=True) -> ApicalTiebreakPairMemory"""
        this = _experimental.new_ApicalTiebreakPairMemory(columnCount, basalInputSize, apicalInputSize, cellsPerColumn, activationThreshold, initialPermanence, connectedPermanence, minThreshold, sampleSize, permanenceIncrement, permanenceDecrement, basalPredictedSegmentDecrement, apicalPredictedSegmentDecrement, learnOnOneCell, seed, maxSegmentsPerCell, maxSynapsesPerSegment, checkInputs)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def compute(self, *args):
        """
        compute(self, activeColumnsBegin, activeColumnsEnd, basalInputBegin, basalInputEnd, apicalInputBegin, apicalInputEnd, basalGrowthCandidatesBegin, basalGrowthCandidatesEnd, apicalGrowthCandidatesBegin, apicalGrowthCandidatesEnd, learn=True)
        compute(self, activeColumns, basalInput, apicalInput, basalGrowthCandidates, apicalGrowthCandidates, learn=True)
        """
    ...
    def _initFromCapnpPyBytes(self, pyBytes):
        ...
        return _experimental.ApicalTiebreakPairMemory__initFromCapnpPyBytes(self, pyBytes)


    def convertedCompute(self, py_activeColumns, py_basalInput, py_apicalInput, py_basalGrowthCandidates, py_apicalGrowthCandidates, learn):
        """convertedCompute(self, py_activeColumns, py_basalInput, py_apicalInput, py_basalGrowthCandidates, py_apicalGrowthCandidates, learn)"""
        return _experimental.ApicalTiebreakPairMemory_convertedCompute(self, py_activeColumns, py_basalInput, py_apicalInput, py_basalGrowthCandidates, py_apicalGrowthCandidates, learn)
...
class ApicalTiebreakSequenceMemory(ApicalTiebreakTemporalMemory):
    ...
    def __init__(self, *args):
        ...
        __init__(self, columnCount, apicalInputSize=0, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, connectedPermanence=0.50, minThreshold=10, sampleSize=20, permanenceIncrement=0.10, permanenceDecrement=0.10, basalPredictedSegmentDecrement=0.0, apicalPredictedSegmentDecrement=0.0, learnOnOneCell=False, seed=42, maxSegmentsPerCell=255, maxSynapsesPerSegment=255, checkInputs=True) -> ApicalTiebreakSequenceMemory
        """
    ...
    def compute(self, *args):
        """
        compute(self, activeColumnsBegin, activeColumnsEnd, apicalInputBegin=None, apicalInputEnd=None, apicalGrowthCandidatesBegin=None, apicalGrowthCandidatesEnd=None, learn=True)
    ...
    def _initFromCapnpPyBytes(self, pyBytes):
        """_initFromCapnpPyBytes(self, pyBytes)"""
        return _experimental.ApicalTiebreakSequenceMemory__initFromCapnpPyBytes(self, pyBytes)


    def convertedCompute(self, py_activeColumns, py_apicalInput, py_apicalGrowthCandidates, learn):
        """convertedCompute(self, py_activeColumns, py_apicalInput, py_apicalGrowthCandidates, learn)"""
        return _experimental.ApicalTiebreakSequenceMemory_convertedCompute(self, py_activeColumns, py_apicalInput, py_apicalGrowthCandidates, learn)
