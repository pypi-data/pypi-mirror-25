...
class VPPUtil(object):
    ...
    def _install_vpp_pkg(self, node, pkg):
        """
    ...
    def install_vpp_ubuntu(self, node, fdio_release='1707',
        ...
        self._install_vpp_pkg(node, 'vpp-lib')
        self._install_vpp_pkg(node, 'vpp')
        self._install_vpp_pkg(node, 'vpp-plugins')
        self._install_vpp_pkg(node, 'vpp-dpdk-dkms')
        self._install_vpp_pkg(node, 'vpp-dpdk-dev')
        self._install_vpp_pkg(node, 'vpp-api-python')
        self._install_vpp_pkg(node, 'vpp-api-java')
        self._install_vpp_pkg(node, 'vpp-api-lua')
        self._install_vpp_pkg(node, 'vpp-nsh-plugin-dbg')
        self._install_vpp_pkg(node, 'vpp-nsh-plugin-dev')
        self._install_vpp_pkg(node, 'vpp-nsh-plugin')
        self._install_vpp_pkg(node, 'vpp-dev')
        self._install_vpp_pkg(node, 'vpp-dbg')

    def _uninstall_vpp_pkg(self, node, pkg):
        """
    ...
    def uninstall_vpp_ubuntu(self, node):
        ...
        :type node: dict
        """
        self._uninstall_vpp_pkg(node, 'vpp-api-python')
        self._uninstall_vpp_pkg(node, 'vpp-api-java')
        self._uninstall_vpp_pkg(node, 'vpp-api-lua')
        self._uninstall_vpp_pkg(node, 'vpp-nsh-plugin-dbg')
        self._uninstall_vpp_pkg(node, 'vpp-nsh-plugin-dev')
        self._uninstall_vpp_pkg(node, 'vpp-nsh-plugin')
        self._uninstall_vpp_pkg(node, 'vpp-plugins')
        self._uninstall_vpp_pkg(node, 'vpp-dpdk-dev')
        self._uninstall_vpp_pkg(node, 'vpp-dpdk-dkms')
        self._uninstall_vpp_pkg(node, 'vpp-dev')
        self._uninstall_vpp_pkg(node, 'vpp-dbg')
        self._uninstall_vpp_pkg(node, 'vpp')
        self._uninstall_vpp_pkg(node, 'vpp-lib')
    ...
    def status(node):
        ...
        errors = re.findall(r'EAL:[\w \(\)-]+', stdout)
