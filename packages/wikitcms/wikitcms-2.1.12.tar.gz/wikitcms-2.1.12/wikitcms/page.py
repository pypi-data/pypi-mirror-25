...
class DownloadPage(Page):
    ...
    def seedtext(self):
        ...
        arches = set()
        imagedict = dict()
        for img in self.event.ff_release.all_images:
            if img['arch']:
                arches.add(img['arch'])
        ...
        # calculated earlier...for our purposes we can just use the
            ...
            for arch in arches:
                ...
                for img in imgs:
                    if img['arch'] == arch:
                        ...
                        url = '/'.join((self.event.ff_release.location,
                                        img['path']))
