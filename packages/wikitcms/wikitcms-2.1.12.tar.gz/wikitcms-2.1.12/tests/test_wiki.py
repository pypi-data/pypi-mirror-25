...
class TestWiki:
    ...
    def test_get_validation_event(self, fakecompose, fakenightly, faketext, fakeinit):
        ...
        fakecompose.assert_called_with(self.site, '24', 'Alpha', '1.1')
        # old-school TC/RC
        ret = self.site.get_validation_event(23, 'Final', 'TC9')
        fakecompose.assert_called_with(self.site, 23, 'Final', 'TC9')
        ret = self.site.get_validation_event(23, 'Beta', 'RC1')
        fakecompose.assert_called_with(self.site, 23, 'Beta', 'RC1')
        # old-school nightly
        ret = self.site.get_validation_event(23, 'Rawhide', '20151112')
        fakenightly.assert_called_with(self.site, release=23, milestone='Rawhide', compose='20151112')
        ret = self.site.get_validation_event(23, 'Branched', '20151211')
        fakenightly.assert_called_with(self.site, release=23, milestone='Branched', compose='20151211')
        ...
        fakecompose.assert_called_with(self.site, 25, 'RC', '1.1')
        # Pungi 4 nightly
        ret = self.site.get_validation_event(24, 'Rawhide', '20160222.n.0')
        fakenightly.assert_called_with(self.site, release=24, milestone='Rawhide', compose='20160222.n.0')
        ret = self.site.get_validation_event(24, 'Branched', '20160315.n.1')
        fakenightly.assert_called_with(self.site, release=24, milestone='Branched', compose='20160315.n.1')
    ...
    def test_get_validation_page(self, fakecompose, fakenightly, faketext, fakeinit):
        ...
        fakecompose.assert_called_with(self.site, '24', 'Installation', 'Alpha', '1.1')
        # old-school TC/RC
        ret = self.site.get_validation_page('Installation', 23, 'Final', 'TC9')
        fakecompose.assert_called_with(self.site, 23, 'Installation', 'Final', 'TC9')
        ret = self.site.get_validation_page('Installation', 23, 'Beta', 'RC1')
        fakecompose.assert_called_with(self.site, 23, 'Installation', 'Beta', 'RC1')
        # old-school nightly
        ret = self.site.get_validation_page('Installation', 23, 'Rawhide', '20151112')
        fakenightly.assert_called_with(self.site, 23, 'Installation', 'Rawhide', '20151112')
        ret = self.site.get_validation_page('Installation', 23, 'Branched', '20151211')
        fakenightly.assert_called_with(self.site, 23, 'Installation', 'Branched', '20151211')
        # Pungi 4 production/candidate
        ret = self.site.get_validation_page('Installation', 24, 'Alpha', '1.1')
        fakecompose.assert_called_with(self.site, 24, 'Installation', 'Alpha', '1.1')
        # Past 23, 'Final' milestone should be converted to 'RC'
        ret = self.site.get_validation_page('Installation', 25, 'Final', '1.1')
        fakecompose.assert_called_with(self.site, 25, 'Installation', 'RC', '1.1')
        # Pungi 4 nightly
        ret = self.site.get_validation_page('Installation', 24, 'Rawhide', '20160222.n.0')
        fakenightly.assert_called_with(self.site, 24, 'Installation', 'Rawhide', '20160222.n.0')
        ret = self.site.get_validation_page('Installation', 24, 'Branched', '20160315.n.1')
        fakenightly.assert_called_with(self.site, 24, 'Installation', 'Branched', '20160315.n.1')
