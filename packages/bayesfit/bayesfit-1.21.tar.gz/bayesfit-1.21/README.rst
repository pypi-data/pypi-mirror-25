...
**IMPORTANT** : **Version 1.2** has been released!  This version fixes issues with using decimal values in stimulus intensities, along with some of the plotting functions. Please upgrade from 1.15 release if you have not already!
