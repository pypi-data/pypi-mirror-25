...
class ChessUI(ChessException):
    ...
    def set_game_change_notifications(self, widget, callback=None):
        ...
        This is a convenience function to get game_games and
        partial_games updated after editing a game selected from one of the
        three grids displaying lists of games.
        """
    ...
    def set_partial_change_notifications(self, widget, callback=None):
        ...
        This is a convenience function to get partial_games updated after
        editing a partial position selected from base_partials.
        """
        self.set_data_change_notifications(
            widget,
            (self.base_partials,),
