...
from rmappsup.api import callthreadqueue

from rmappsup.gui.tasklog import LogText
...
class ChessDeferredUpdate(ChessException):
    ...
    # Code in the rmappsup.gui.tasklog module already dealt with this problem,
    # so the minimum necessary was copied to here.  The classes in tasklog are
    # modified versions of code present in this module before this change.
