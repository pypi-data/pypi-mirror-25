...
from rmappsup.api import modulequery
from rmappsup.api import callthreadqueue
from rmappsup.gui.textentry import get_text_modal
...
class Chess(ChessException):
    ...
    def new_index_selection(self):
        ...
        #position.partial.extract_position('')
        #position.partial.process_partial_position()
