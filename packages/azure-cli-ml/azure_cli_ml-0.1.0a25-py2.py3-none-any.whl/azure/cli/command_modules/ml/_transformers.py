...
def transform_mlc_resource(result_tuple):
    ...
    to_print = {
        ...
        'Cluster Size': result['container_service']['agentCount'] if result['container_service'] else 'N/A'
    }
    if result['provisioning_errors'] and result['provisioning_state'] == 'Failed':
