...
class UpdateSystemServicesResponse(Model):
    ...
    :ivar update_status: Update status. Possible values include: 'InProgress',
     'Completed'
    :vartype update_status: str or :class:`UpdateStatus
     <azure.mgmt.machinelearningcompute.models.UpdateStatus>`
