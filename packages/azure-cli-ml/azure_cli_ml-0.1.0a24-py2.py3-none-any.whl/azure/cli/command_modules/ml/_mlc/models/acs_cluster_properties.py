...
class AcsClusterProperties(Model):
    ...
    :param agent_vm_size: The Azure VM size of the agent VM nodes. This cannot
     be changed once the cluster is created. Possible values include:
     ...
     'Standard_GS5'. Default value: "Standard_D2_v2" .
    ...
    def __init__(self, orchestrator_type, orchestrator_properties, system_services=None, master_count=1, agent_count=2, agent_vm_size="Standard_D2_v2"):
