...
def gcal_events_to_xlsx(desired_month_string, calendar_title):
    """
...
if __name__ == '__main__':
    month_year = input("Please input month and year. Example: September 2017\n")
    calendar_name = input("Calendar name (blank if you want Arthur Murray Vernon): ")
    if not calendar_name:
        calendar_name = "Arthur Murray Vernon"
    
    book = gcal_events_to_xlsx(month_year, calendar_name)
    book.close()
