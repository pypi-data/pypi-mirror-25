...
|Version: 1.6.0| |Release: 1.4.0| |License: GPL v3| |Python 3.3+| |All
Platforms!| |Open Source Love| |Lines of Code: 1567| |Lines of Docs:
...
Python? Most of the other options out there are not web crawlers
themselves, simply frameworks and libraries through which one can create
and deploy a web spider. With spidy, everything runs right out of the
box.
...
.. |Version: 1.6.0| image:: https://img.shields.io/badge/version-1.5.1-brightgreen.svg
...
.. |Lines of Code: 1567| image:: https://img.shields.io/badge/lines%20of%20code-1567-brightgreen.svg
