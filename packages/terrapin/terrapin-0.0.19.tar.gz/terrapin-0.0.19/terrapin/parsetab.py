...
_lr_productions = [
  ...
  ('output_list -> output','output_list',1,'p_output_list_1','parser.py',27),
  ('output_list -> output_list output','output_list',2,'p_output_list_2','parser.py',32),
  ('output -> block','output',1,'p_output','parser.py',37),
  ('output -> WS','output',1,'p_output','parser.py',38),
  ('output -> STRING','output',1,'p_output','parser.py',39),
  ('output -> WORD','output',1,'p_output','parser.py',40),
  ('output -> QUOTEDSTRING','output',1,'p_output','parser.py',41),
  ('output -> INT','output',1,'p_output','parser.py',42),
  ('output -> GT','output',1,'p_output','parser.py',43),
  ('output -> LT','output',1,'p_output','parser.py',44),
  ('output -> EQ','output',1,'p_output','parser.py',45),
  ('output -> variable','output',1,'p_output','parser.py',46),
  ('variable -> LVARDELIM WORD RVARDELIM','variable',3,'p_variable','parser.py',51),
  ('block -> if_result output_list else output_list end_if','block',5,'p_if_else_statement','parser.py',55),
  ('block -> if_result else output_list end_if','block',4,'p_empty_if_else_statement','parser.py',60),
  ('block -> if_result output_list end_if','block',3,'p_if_statement','parser.py',65),
  ('if_result -> LCODEDELIM WS IF WS WORD WS RCODEDELIM','if_result',7,'p_truthy_if','parser.py',70),
  ('if_result -> LCODEDELIM WS IF WS WORD WS EQ WS QUOTEDSTRING WS RCODEDELIM','if_result',11,'p_equality_if','parser.py',75),
  ('if_result -> LCODEDELIM WS IF WS WORD WS NE WS QUOTEDSTRING WS RCODEDELIM','if_result',11,'p_non_equality_if','parser.py',81),
  ('if_result -> LCODEDELIM WS IF WS word_len WS GT WS cast_int WS RCODEDELIM','if_result',11,'p_len_gt_if','parser.py',87),
  ('if_result -> LCODEDELIM WS IF WS word_len WS LT WS cast_int WS RCODEDELIM','if_result',11,'p_len_lt_if','parser.py',92),
  ('if_result -> LCODEDELIM WS IF WS word_len WS EQ WS cast_int WS RCODEDELIM','if_result',11,'p_len_equality_if','parser.py',97),
  ('if_result -> LCODEDELIM WS IF WS word_len WS NE WS cast_int WS RCODEDELIM','if_result',11,'p_len_non_equality_if','parser.py',102),
  ('else -> LCODEDELIM WS ELSE WS RCODEDELIM','else',5,'p_else','parser.py',107),
  ('end_if -> LCODEDELIM WS ENDIF WS RCODEDELIM','end_if',5,'p_end_if','parser.py',112),
  ('word_len -> WORD LEN','word_len',2,'p_word_len','parser.py',117),
  ('cast_int -> INT','cast_int',1,'p_cast_int','parser.py',121),
]
