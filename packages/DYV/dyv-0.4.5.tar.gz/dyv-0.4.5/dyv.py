...
@click.option('--version', '-v', type=click.INT, default=False, help="The version of Odoo")
@click.option('--no-addon', '-na', type=click.BOOL, default=False, is_flag=True, help="No addon by default")
@click.version_option(__VERSION__, is_flag=True, expose_value=False, is_eager=True)
@click.pass_context
def cli(ctx, user, addon, project, version, no_addon):
    """CLI for DYV"""
    ...
    for repo_section in config_repo_obj.sections:
        repos[repo_section] = {
            'path': config_repo_obj[repo_section].get('path', ''),
            'branch_8': config_repo_obj[repo_section].get('branch_8', ''),
            'branch_9': config_repo_obj[repo_section].get('branch_9', ''),
            'branch_10': config_repo_obj[repo_section].get('branch_10', ''),
            'branch_11': config_repo_obj[repo_section].get('branch_11', ''),
            'branch_12': config_repo_obj[repo_section].get('branch_12', ''),
            'branch_dev': config_repo_obj[repo_section].get('branch_dev', ''),
            'branch_master': config_repo_obj[repo_section].get('branch_master', ''),
        }
    chemins = {}
