...
def catalog_get_measurements(catalog_number=None, norad_catalog_number=None, start_time=None, end_time=None, **kwargs):
    ...
    resource = '/catalog/objects/{0}/measurements?startTime={start_time}&endTime={end_time}'.format(catalog_number, start_time=start_time, end_time=end_time)
    response = api_request(resource)
    return response
...
def catalog_list_states(catalog_number=None, norad_catalog_number=None, start_time=None, end_time=None, **kwargs):
    require_timespan(start_time, end_time)
    catalog_number = get_catalog_number(catalog_number, norad_catalog_number, 'all')

    resource = '/catalog/objects/{0}/states?startTime={start_time}&endTime={end_time}'.format(catalog_number, start_time=start_time, end_time=end_time)
    response = api_request(resource)
    return response
