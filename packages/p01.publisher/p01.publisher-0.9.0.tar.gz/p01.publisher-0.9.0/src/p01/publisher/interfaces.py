...
##############################################################################
"""
$Id: interfaces.py 4614 2017-05-26 13:43:01Z roger.ineichen $
"""
...
class IApplicationCreatedEvent(zope.component.interfaces.IObjectEvent):
    ...
    app = zope.interface.Attribute(u"IApplication")
...
class IWSGIApplicationCreatedEvent(zope.component.interfaces.IObjectEvent):

    app = zope.interface.Attribute(u"IWSGIApplication")


class WSGIApplicationCreatedEvent(object):

    zope.interface.implements(IWSGIApplicationCreatedEvent)
