...
# -*- coding: utf-8 -*-
'''
wallall by Yves Vanlerberghe - A quickly thrown togheter WallAll Python library
...
class WallAll(object):
    ...
    def soundsensor(self):
        """ Gets the value of the soundsensor, in I don't know what, it jumps orders of magnitude between devices """
