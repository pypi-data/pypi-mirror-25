...
##############################################################################
"""
$Id: simple.py 4642 2017-09-17 22:11:21Z roger.ineichen $
"""
...
class SimpleScroller(object):
    ...
    but with optinal search widget support
    ...
    NOTE: Register a j01ScrollerItemsTemplate or implement your own
          j01ScrollerItems roperty and return the scroller html result
