...
def sentiment(sentence):
    ...
    nlp = DSCoreNLP('http://127.0.0.1:9000')
    ...
    sentimentWord = str(output['sentences'][0]['sentiment'])
    sentimentValue = int(output['sentences'][0]['sentimentValue'])
    return sentimentWord, sentimentValue
