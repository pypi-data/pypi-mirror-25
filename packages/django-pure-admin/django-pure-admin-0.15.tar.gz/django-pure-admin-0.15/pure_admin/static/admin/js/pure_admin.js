(function ($) {
    ...
    $('input[type="file"]').before('<div class="upload-ico"><i class="fa fa-upload" /></div>');
    ...
    $('.vLargeTextField, .vTextField, .vIntegerField').focus(function () {
...
//Not blank form
    ...
    $('select[multiple="multiple"]').each(function (i, elem) {
        ...
        if ($(elem).attr('class') != 'selectfilter' && $(elem).attr('class') != 'selectfilterstacked') {
