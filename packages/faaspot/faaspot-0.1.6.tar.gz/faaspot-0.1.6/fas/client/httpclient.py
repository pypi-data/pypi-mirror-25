...
class HTTPClient(object):
    ...
    def __init__(self, host, port=DEFAULT_PORT,
                 protocol=DEFAULT_PROTOCOL, api_prefix=DEFAULT_API_PREFIX,
                 headers=None, query_params=None, cert=None, trust_all=False,
                 username=None, password=None, token=None):
        self.port = port
        self.host = host
        self.protocol = protocol
        self.api_prefix = api_prefix or DEFAULT_API_PREFIX  # in case None was passed..
    ...
    @property
    def url(self):
        url = '{0}://{1}:{2}/{3}/'.format(self.protocol, self.host,
