...
tag name. This can be very handy to *load every items corresponding with a naming convention*

.. code-block:: python

    >>> flags=server.flags.searchAndDeclare('timeout')
    >>> registers=server.registers.searchAndDeclare('sonde')
