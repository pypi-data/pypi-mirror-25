...
class SAIAItemTimers(SAIAAnalogItem):
    def onInit(self):
        pass
...
class SAIAItemCounters(SAIAAnalogItem):
    def onInit(self):
        pass
...
class SAIATimers(SAIAAnalogItems):
    def __init__(self, memory, maxsize=65535):
        super(SAIATimers, self).__init__(memory, SAIAItemTimers, maxsize)
...
class SAIACounters(SAIAAnalogItems):
    def __init__(self, memory, maxsize=65535):
        super(SAIACounters, self).__init__(memory, SAIAItemCounters, maxsize)
