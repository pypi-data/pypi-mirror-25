...
class Line(object):
    ...
    def asQgsFeature(self):
        ...
        lineFeature.setGeometry(qgis.core.QgsGeometry.fromPolyline(self.pointsList))
        return lineFeature
    ...
    def asShapes(self):
        ...
        lineShape = Shapes()
        lineShape.setShapeType(qgis.core.QGis.WKBLineString)
...
class polygon(object):
    ...
    def asQgsPolygonFeature(self):
        ...
        polygonFeature.setGeometry(qgis.core.QgsGeometry.fromPolygon([self.pointsList]))
    ...
    def asPolygonShapes(self):
        ...
        polygonShape = Shapes()
        polygonShape.setShapeType(qgis.core.QGis.WKBPolygon)
