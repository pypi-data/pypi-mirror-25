...
from botlib.utils import to_time, today, elapsed, locked
from botlib.clock import Repeater
from botlib.object import Object
from botlib.event import Event

from botlib.space import cfg, kernel
...
source = "https://bitbucket.org/bthate/evrm2"

def init(event):
    args = event._parsed.args
    for name, obj in wanted.items():
        if cfg.all or name in cfg.init.split(",") or args and name in args:
            for key, val in obj.items():
                e = Event(event)
                e.txt = "stats %s" % key
                e.parse()
                sec = seconds(val, period.get(key, "jaar"))
                repeater = Repeater(sec, stats, e, name="stats.%s" % key)
...
def stats(event, **kwargs):
    n = kwargs.get("name", event._parsed.rest)
    n = n.split(".")[-1]
    for name, obj in wanted.items():
        for key, val in obj.items():
            needed = seconds(nr(key), period.get(key, "jaar"))
            if not needed:
                continue
            if n and n not in key:
                continue
            delta = time.time() - starttime
            nrtimes = int(delta/needed)
            txt = "\n%s #%s" % (n.upper(), nrtimes)
            if key in omschrijving:
                txt += " (%s)" % omschrijving.get(key)
            if key in soort:
                txt += " door %s" % soort.get(key)
            txt += " in bijv. %s" % random.choice(gemeenten) 
            if key in urls:
                txt += " - %s" % urls.get(key)
            if key in tags:
                txt += " %s" % tags.get(key)
...
#:
suicide = Object()
suicide.suicide = cijfers.suicide - suicidecel["2015"]
suicide.celsuicide = suicidecel["2015"]
...
tags.crisis = "#oordeelgeencrisis"
tags.alarm = "#telaat"
tags.oordeel = "#geencrisis"
tags.vergiftigingen = "#acuut"
tags.neurotoxisch = "#hersenaantasting" 
tags.schizofrenie = "#chronisch"
tags.angst = "#overdosis"
tags.depressie = "#redenvoormanie"
tags.meds = "#giftoediening"
tags.ibs = "#overlast"
tags.rm = "#benadeling"
tags.vwm = "#maatregel"
tags.vm = "#nogeven"
...
omschrijving.keten = "besluit tot crisisbeoordeling"
omschrijving.politie = "vraagt om crisisbeoordeling"
omschrijving.hap = 'vraagt om crisisbeoordeeling'
omschrijving.verwijs = "maakt vervolg afspraak"
omschrijving.uitstroom = "maakt geen vervolgafspraak"
omschrijving.opname = 'besluit tot opname'
omschrijving.suicide = "zelfdoding"
...
omschrijving.oordeel = "crisisdient beoordeling"
...
omschrijving.celsuicide = "sterven in een isoleercel"
...
period.hap = 'jaar'
period.verwijs = "jaar"
period.uitstroom = "jaar"
period.opname = 'jaar'
period.suicide = "jaar"
period.pogingen = "jaar"
period.incidenten = "jaar"
period.acuut = "jaar"
period.zorgmijder = "jaar"
period.inwoners = "dag"
period.crisis = "jaar"
period.alarm = "jaar"
period.oordeel = "jaar"
period.vergiftigingen = "jaar"
period.neurotoxisch = "jaar"
period.speed = "dag"
period.cocaine = "dag"
period.alcohol = "dag"
period.wiet = "dag"
period.antipsychotica = "dag"
period.antidepresiva = "dag"
period.slaapmiddel = "dag"
period.ambulant = "dag"
period.verslaving = "dag"
period.schizofrenie = "dag"
period.depressie = "dag"
period.amitriptyline = "dag"
period.paroxetine = "dag"
period.citalopram = "dag"
period.oxazepam = "dag"
period.venlafaxine = "dag"
period.mirtazapine = "dag"
period.quetiapine = "dag"
period.diazepam = "dag"
period.sertraline = "dag"
period.haloperidol = "dag"
period.verslaafden = "dag"
period.inwoners = "dag"
period.arbeidshandicap = "dag"
period.huisartsen = "dag"
period.opnames = "jaar"
period.zorgmijder = "jaar"
period.middelgebondenstoornissen = "dag"
period.somatoformestoornissen = "dag"
period.cognitievestoornissen = "dag"
period.angststoornissen = "dag"
period.aanpassingsstoornissen = "dag"
period.depressievestoornissen = "dag"
period.eetstoornissen = "dag"
period.restgroepdiagnose = "dag"
period.ontbrekendeprimairediagnose = "dag"
period.andereproblemenredenvoorzorg = "dag"
period.schizofrenieenanderepsychotischestoornissen = "dag"
period.bipolairestoornissen = "dag"
period.posttraumatischestressstoornis = "dag"
period.persoonlijkheidsstoornissen = "dag"
period.adhd = "dag"
period.gedrag = "dag"
period.kindertijdoverig = "dag"
period.autismespectrum = "dag"
period.seh = "jaar"
period.celsuicide = "jaar"
...
periode.keten = "na besluit burgemeester"
periode.politie = "na arrestattie politie"
periode.hap = 'buiten kantooruren en in het weekend'
periode.verwijs = "maandag weer"
periode.avond = "'s avonds"
periode.uitstroom = "niet meer gezien"
periode.opname = 'voor 6 maanden'
periode.suicide = "nooit meer"
periode.pogingen = "vandaag"
periode.weekend = "in het weekend"
periode.incidenten = "vandaag"
periode.acuut = "vandaag"
periode.zorgmijder = "niet meer gezien"
periode.inwoners = "dagelijks"
periode.crisis = "vandaag"
periode.alarm = "vandaag"
periode.oordeel = "vandaag"
periode.vergiftigingen = "vandaag"
periode.neurotoxisch = "vandaag"

#:
soort = Object()
soort.alarm = "patient"
soort.oordeel = "crisisdienst"
...
soort.politie = "doorverwijzende agent"
soort.hap = "triage afnemende HAP assistent"
soort.keten  = "tot opnane beslissende burgemeester"
soort.verwijs = "naar eigen behandelaart verwijsende crisisdienst"
soort.uitstroom = "geen vervolgbehandeling krijgende patient"
soort.suicide = "slachtoffer"
soort.crisis = "crisis beoordelende crisisdienst"
soort.pogingen = "wanhopige patient"
soort.incidenten = "112 beller"
soort.acuut = "spoedeisende psychiatrische hulp"
soort.meds = "medicijnen nemende patient"
soort.amitriptyline = "slachtoffer"
soort.paroxetine = "slachtoffer"
soort.citalopram = "slachtoffer"
soort.oxazepam = "slachtoffer"
soort.venlafaxine = "slachtoffer"
soort.mirtazapine = "slachoffer"
soort.quetiapine = "slachtoffer"
soort.diazepam = "slachtoffer"
soort.sertrali = "slachtoffer"
soort.haloperidol = "slachtoffer"
soort.insluiting = "slachtoffer"
soort.ambulant = "casemanager"
soort.verslaafden = "gebruiker"
soort.slaapmiddel = "insomnia patient"
soort.celsuicide = "slachtoffer"
...
urls.suicide = "https://www.cbs.nl/nl-nl/nieuws/2017/26/1-894-zelfdodingen-in-2016"
...
urls.echa = "https://echa.europa.eu/search-for-chemicals"
urls.vergiftigingen = "https://vergiftigingen.info"
urls.celsuicide = "https://www.tweedekamer.nl/kamerstukken/detail?id=2016D32125&did=2016D32125"
