...
from bingads.v10.bulk.entities.common import _ProductConditionHelper
...
class BulkCampaignProductScope(_SingleRecordBulkEntity):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self._campaign_criterion = _CAMPAIGN_OBJECT_FACTORY_V10.create('CampaignCriterion')
        self._campaign_criterion.Type = 'CampaignCriterion'
        self._campaign_criterion.Criterion = _CAMPAIGN_OBJECT_FACTORY_V10.create('ProductScope')
