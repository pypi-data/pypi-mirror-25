...
class RSABase64Field(serializers.CharField):
    ...
    def __init__(self, base4_key=False, base64_data=True, cipher_type=1, **kwargs):
        self.base64_key = base4_key
...
class RSABase64MethodField(serializers.SerializerMethodField):
    ...
    def __init__(self, base4_key=False, base64_data=True, cipher_type=1, method_name=None, **kwargs):
        self.base64_key = base4_key
        self.base64_data = base64_data
        self.cipher_type = cipher_type
