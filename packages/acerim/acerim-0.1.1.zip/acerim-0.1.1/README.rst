ACERIM (**depr**) |TravisBadge|_ |AppveyorBadge|_ |RtdBadge|_ |PyPiBadge|_ |CodecovBadge|_ |ZenodoBadge|_
=========================================================================================================
...
**Warning**: As of Oct 12, 2017, ACERIM has been deprecated. Please see `craterpy <github.com/cjtu/craterpy>`_ for info & tutorials, or install it from the CheeseShop `here <https://pypi.python.org/pypi/acerim>`_.
