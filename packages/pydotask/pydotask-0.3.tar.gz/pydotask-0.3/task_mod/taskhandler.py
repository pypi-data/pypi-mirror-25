...
def update_program(taskobj):
    with open('task_mod/tasks.csv','r') as task_data:
...
def addTask():
    ...
    with open('task_mod/tasks.csv','a') as tasks_data:
    ...
    for task in taskobj:
        ...
        if str(det) != str(taskindex):
            ...
            if ask == 'Y' or ask == 'y':
                ...
                with open('task_mod/tasks.csv','r') as tasks_read, open('task_mod/new_tasks.csv','w') as tasks_del:
                ...
                os.remove('task_mod/tasks.csv')
                os.rename('task_mod/new_tasks.csv','task_mod/tasks.csv')
                tasks_read.close()
                tasks_del.close()
