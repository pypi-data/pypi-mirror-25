...
def Main():
    ...
    while True:
        ...
        try:
            command = input(termcolor.colors.fg.lightcyan + 'PyDo $ ' + resetc).lower()
            ...
            print(termcolor.colors.fg.lightred + 'Oops something went wrong :/\n' + resetc)
