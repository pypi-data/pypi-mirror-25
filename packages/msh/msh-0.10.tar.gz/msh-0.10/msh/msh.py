...
'''
p=PexpectClient('20.0.0.110', 'root', '1123456')
...
try:
    ...
    print '密码错误'
    os._exit(1)
    # os.system("echo PasswordErrorException > ~/Desktop/a.txt")
'''
...
if __name__ == "__main__":
    ...
    # f = open('/etc/zshrc')
    # print f.readline()
    # a = {'a':None, 'b':None, 'c':'aa', 'd':'axx'}
    # print len(a.values()), a.values().count(None)


    # print iflist, ifadd, host, '==='
    # if option.iflist:
    #     print 'list'
    #
    # if option.ifadd:
