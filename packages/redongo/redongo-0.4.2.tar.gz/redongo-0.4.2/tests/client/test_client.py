...
class TestClient:
    ...
    def test__add_to_transaction__OK1(self):
        global test_redongo
        obj = {
            '_id': 9999999,
            'int_field': 1,
        ...
        test_redongo.add_to_transaction(APPNAME_PICKLE, [obj]*100)

    def test__end_transaction__OK1(self):
        global test_redongo
        obj = {
            '_id': 9999999,
        }
        test_redongo.end_transaction(APPNAME_PICKLE, [obj])
