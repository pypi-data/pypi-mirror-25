...
class Dashboard:
    ...
    def check(self, verbose=False):
        ...
        isMarkdownDiv = (isinstance(self.markdown_div, list) and
                         all([isinstance(d, Div) for d in self.markdown_div])) \
        ...
        isDashboard = isTitle and isTabs and isMisc and isExactlyOneActiveTab \
            and isHeader and isMarkdownDiv and isLatex
        if verbose:
