...
* The `DotDict`  class- make it possible to access dictionary attributes with dot-notation
(`dict.attribute` instead of `dict['attribute']`)
...
Publish a build with: `twine upload dist/*`
