...
class LTIValidator(object):
    ...
    def validate_request(self, launch_uri, http_method, payload):
        ...
        @raise MissingAppKeyException if the response code was 401
        @raise NotFoundException if the response code was 404
        @raise MissingDataException if the response code was 422
        """
