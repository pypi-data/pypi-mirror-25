...
setup(
  ...
  url='https://github.com/j00bar/ansilbe',
  install_requires=['ansible']
)

print('*** WARNING ***')
print('You mistyped "ansible" and instead typed "ansilbe". I have ')
print('installed Ansible anyway, but you really should uninstall ansilbe ')
