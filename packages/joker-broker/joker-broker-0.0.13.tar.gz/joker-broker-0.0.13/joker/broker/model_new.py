...
class _Molecule(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        _Molecule.__dict__['_changed'].__set__(self, dict())
        _Molecule.__dict__['_initial'].__set__(self, data)
        _Molecule.__dict__['_permanent'].__set__(self, False)
...
class AbstractModel(object):
    ...
    def __init__(self, *args, **kwargs):
        self.data = _Molecule(*args, **kwargs)
