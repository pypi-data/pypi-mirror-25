...
def qsub(script_name, work_path=None, stderr_path=None, join='n',job_name=None, resource_list=None,queue=None, stdout_path=None, env=False,
...
def _gen_task_desc():
    ...
    return {
        ...
        "AutoCluster": {
            'ReserveOnFail': False,
            'Configs': {
                'Mounts': m['AutoCluster']['Configs']['Mounts'] if m else {}
            }
        },
        "MaxRetryCount": 0,
        "Parameters": {
