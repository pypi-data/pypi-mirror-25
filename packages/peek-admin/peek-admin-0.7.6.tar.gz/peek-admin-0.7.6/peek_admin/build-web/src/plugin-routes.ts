...
export const pluginRoutes = [
    ...
    {
        path: 'peek_plugin_pof_field_assessments',
        loadChildren: "peek_plugin_pof_field_assessments/field-assessments-admin.module#PofFieldAssessmentsModule"
    },
    {
    ...
    {
        path: 'peek_plugin_pof_gis_location_loader',
        loadChildren: "peek_plugin_pof_gis_location_loader/pofGisLocationLoader.module#PofGisLocationLoaderModule"
    },
    {
