...
from schul_cloud_resources_api_v1.models.jsonapi_meta import JsonapiMeta


class TestJsonapiMeta(unittest.TestCase):
    """ JsonapiMeta unit test stubs """
    ...
    def testJsonapiMeta(self):
        """
        Test JsonapiMeta
        """
        model = schul_cloud_resources_api_v1.models.jsonapi_meta.JsonapiMeta()
