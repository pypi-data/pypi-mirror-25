...
from schul_cloud_resources_api_v1.models.resource_post import ResourcePost


class TestResourcePost(unittest.TestCase):
    """ ResourcePost unit test stubs """
    ...
    def testResourcePost(self):
        """
        Test ResourcePost
        """
        model = schul_cloud_resources_api_v1.models.resource_post.ResourcePost()
