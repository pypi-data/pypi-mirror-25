...
def get_logger(name='aiohttp_sample', logpath='main.log',
    ...
    fmt = '%(asctime)s; LEVEL=%(levelname)s; uuid=%(uuid)s; type=%(type)s; %(message)s'
    formatter = logging.Formatter(log_format or fmt)
