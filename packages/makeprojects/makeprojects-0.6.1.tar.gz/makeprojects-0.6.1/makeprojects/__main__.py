...
#
# \param workingDir String containing the current working directory
...
def main(workingDir):
	...
	parser.add_argument('-vs2012', dest='vs2012', action='store_true',
		default=False,
		help='Build for Visual Studio 2012.')
	parser.add_argument('-vs2013', dest='vs2013', action='store_true',
		default=False,
		help='Build for Visual Studio 2013.')
	...
	parser.add_argument('-vs2017', dest='vs2017', action='store_true',
		default=False,
		help='Build for Visual Studio 2017.')
		
	parser.add_argument('-codeblocks', dest='codeblocks', action='store_true',
		default=False,
		help='Build for CodeBlocks 16.01')
