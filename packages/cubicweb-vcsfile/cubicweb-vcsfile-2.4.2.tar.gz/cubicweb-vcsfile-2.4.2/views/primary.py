...
from logilab.mtconverter import TransformError, xml_escape, TransformData
...
class RevisionPrimaryView(primary.PrimaryView):
    ...
    def render_entity_relations(self, rev):
        ...
        if versioned:
            ...
            subst = lambda obj: (domid(obj.decode('utf-8', 'replace')), xml_escape(obj.decode('utf-8', 'replace')))
