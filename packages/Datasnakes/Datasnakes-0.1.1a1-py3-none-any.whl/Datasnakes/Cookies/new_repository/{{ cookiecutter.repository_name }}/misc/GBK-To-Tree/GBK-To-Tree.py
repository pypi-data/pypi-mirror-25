...
Part C: Use PhyML to produce phylogenetic trees.

Part D: PAML integration.
...
# -----------------------------------------------------------------------------
        ...
        # Part C: Use PhyML to produce phylogenetic trees and distance matrices.
        ...
        # Convert the files to relaxed-phylip format
        # Convert the nuclotide file
        print("Convert the nucleotide fasta aligned file to relaxed-phylip format.")
        AlignIO.convert(Gene[0] + "_cds_nucl_aligned.fasta", "fasta", Gene[0] + "_cds_nucl_aligned.phy", "phylip-relaxed")
        os.system("cp " + Gene[0] + "_cds_nucl_aligned.phy " + )
...
# -----------------------------------------------------------------------------
# -----------------------------------------------------------------------------
        # Part D: Use PAML to analyze divergence and other relevant phylogenetic
        # measures


        # Change to the PAML executables directory
        PAML = # To do - [] Fill in the directories in this file
        os.chdir(PAML)
