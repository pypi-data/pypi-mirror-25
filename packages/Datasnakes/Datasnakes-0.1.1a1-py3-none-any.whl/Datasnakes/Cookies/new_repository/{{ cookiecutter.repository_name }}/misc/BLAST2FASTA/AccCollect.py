...
Should be located in '/work2/vallender/Projects/GPCR-Orthologs/Scripts' and used
with the blast2fasta.sh bash script.
"""
...
# Home Directory
home = '/work2/vallender/Projects/GPCR-Orthologs/Scripts'
h = home

# Location of .csv files
docs = '/work2/vallender/Projects/GPCR-Orthologs/DocsAndFiles'

# Output Directory
output = '/work2/vallender/Projects/GPCR-Orthologs/BlastOutput'
out = output
os.chdir(docs)  # Directory Change: Home directory
os.listdir(docs)  # Make a list of all the documents
...
for org in file2:    # Format a list of organisms
    ...
    org = org.replace(" ", "_")
    org_list.append(org)
print("These are the organisms: " + org_list)
...
# retrieved and stored in the above directory.
    for Organism, TID in zip(org_list, ID_list):
        ...
        maximum = 0
        os.chdir(out + x) # Change the directory
...
#------------------------------------------------------------------------------
    # Copy output files to DocsAndFiles Directory
    os.system('cp {Master_Accession_File.csv,Master_GI_File.csv,Time_Record_ExistingFiles.csv,Time_Record_BLASTingFiles.csv} '
              + docs + "/")


    o.close()  # File Handling

    os.chdir(h)  # Directory Change: Home directory
