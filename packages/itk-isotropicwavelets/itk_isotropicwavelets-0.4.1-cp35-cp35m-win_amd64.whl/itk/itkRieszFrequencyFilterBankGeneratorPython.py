...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkRieszFrequencyFilterBankGeneratorPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkRieszFrequencyFilterBankGeneratorPython')
...
class itkRieszFrequencyFilterBankGeneratorICF2(itkGenerateImageSourcePython.itkGenerateImageSourceICF2):
    ...
    def GetPointer(self) -> "itkRieszFrequencyFilterBankGeneratorICF2 *":
        """GetPointer(itkRieszFrequencyFilterBankGeneratorICF2 self) -> itkRieszFrequencyFilterBankGeneratorICF2"""
        return _itkRieszFrequencyFilterBankGeneratorPython.itkRieszFrequencyFilterBankGeneratorICF2_GetPointer(self)
...
itkRieszFrequencyFilterBankGeneratorICF2.GetPointer = new_instancemethod(_itkRieszFrequencyFilterBankGeneratorPython.itkRieszFrequencyFilterBankGeneratorICF2_GetPointer, None, itkRieszFrequencyFilterBankGeneratorICF2)
...
class itkRieszFrequencyFilterBankGeneratorICF3(itkGenerateImageSourcePython.itkGenerateImageSourceICF3):
    ...
    def GetPointer(self) -> "itkRieszFrequencyFilterBankGeneratorICF3 *":
        """GetPointer(itkRieszFrequencyFilterBankGeneratorICF3 self) -> itkRieszFrequencyFilterBankGeneratorICF3"""
        return _itkRieszFrequencyFilterBankGeneratorPython.itkRieszFrequencyFilterBankGeneratorICF3_GetPointer(self)
...
itkRieszFrequencyFilterBankGeneratorICF3.GetPointer = new_instancemethod(_itkRieszFrequencyFilterBankGeneratorPython.itkRieszFrequencyFilterBankGeneratorICF3_GetPointer, None, itkRieszFrequencyFilterBankGeneratorICF3)
