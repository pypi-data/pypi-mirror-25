...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkShannonIsotropicWaveletPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkShannonIsotropicWaveletPython')
...
class itkShannonIsotropicWaveletF2PD2(itkIsotropicWaveletFrequencyFunctionPython.itkIsotropicWaveletFrequencyFunctionF2PD2):
    ...
    def GetPointer(self) -> "itkShannonIsotropicWaveletF2PD2 *":
        """GetPointer(itkShannonIsotropicWaveletF2PD2 self) -> itkShannonIsotropicWaveletF2PD2"""
        return _itkShannonIsotropicWaveletPython.itkShannonIsotropicWaveletF2PD2_GetPointer(self)
...
itkShannonIsotropicWaveletF2PD2.GetPointer = new_instancemethod(_itkShannonIsotropicWaveletPython.itkShannonIsotropicWaveletF2PD2_GetPointer, None, itkShannonIsotropicWaveletF2PD2)
...
class itkShannonIsotropicWaveletF3PD3(itkIsotropicWaveletFrequencyFunctionPython.itkIsotropicWaveletFrequencyFunctionF3PD3):
    ...
    def GetPointer(self) -> "itkShannonIsotropicWaveletF3PD3 *":
        """GetPointer(itkShannonIsotropicWaveletF3PD3 self) -> itkShannonIsotropicWaveletF3PD3"""
        return _itkShannonIsotropicWaveletPython.itkShannonIsotropicWaveletF3PD3_GetPointer(self)
...
itkShannonIsotropicWaveletF3PD3.GetPointer = new_instancemethod(_itkShannonIsotropicWaveletPython.itkShannonIsotropicWaveletF3PD3_GetPointer, None, itkShannonIsotropicWaveletF3PD3)
