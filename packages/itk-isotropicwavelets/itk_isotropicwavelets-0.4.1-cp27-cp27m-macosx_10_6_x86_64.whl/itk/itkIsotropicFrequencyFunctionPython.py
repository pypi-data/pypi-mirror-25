...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkIsotropicFrequencyFunctionPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkIsotropicFrequencyFunctionPython')
...
class itkIsotropicFrequencyFunctionF2PD2(itkFrequencyFunctionPython.itkFrequencyFunctionF2PD2):
    ...
    def EvaluateMagnitude(self, freq_norm_in_hz):
    ...
    def GetPointer(self):
        """GetPointer(itkIsotropicFrequencyFunctionF2PD2 self) -> itkIsotropicFrequencyFunctionF2PD2"""
        return _itkIsotropicFrequencyFunctionPython.itkIsotropicFrequencyFunctionF2PD2_GetPointer(self)
...
itkIsotropicFrequencyFunctionF2PD2.GetPointer = new_instancemethod(_itkIsotropicFrequencyFunctionPython.itkIsotropicFrequencyFunctionF2PD2_GetPointer, None, itkIsotropicFrequencyFunctionF2PD2)
...
def itkIsotropicFrequencyFunctionF2PD2_cast(obj):
...
class itkIsotropicFrequencyFunctionF3PD3(itkFrequencyFunctionPython.itkFrequencyFunctionF3PD3):
    ...
    def GetPointer(self):
        """GetPointer(itkIsotropicFrequencyFunctionF3PD3 self) -> itkIsotropicFrequencyFunctionF3PD3"""
        return _itkIsotropicFrequencyFunctionPython.itkIsotropicFrequencyFunctionF3PD3_GetPointer(self)
...
itkIsotropicFrequencyFunctionF3PD3.GetPointer = new_instancemethod(_itkIsotropicFrequencyFunctionPython.itkIsotropicFrequencyFunctionF3PD3_GetPointer, None, itkIsotropicFrequencyFunctionF3PD3)
...
def itkIsotropicFrequencyFunctionF3PD3_cast(obj):
