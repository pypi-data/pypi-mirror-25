...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkVowIsotropicWaveletPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkVowIsotropicWaveletPython')
...
class itkVowIsotropicWaveletF2PD2(itkIsotropicWaveletFrequencyFunctionPython.itkIsotropicWaveletFrequencyFunctionF2PD2):
    ...
    def GetPointer(self) -> "itkVowIsotropicWaveletF2PD2 *":
        """GetPointer(itkVowIsotropicWaveletF2PD2 self) -> itkVowIsotropicWaveletF2PD2"""
        return _itkVowIsotropicWaveletPython.itkVowIsotropicWaveletF2PD2_GetPointer(self)
...
itkVowIsotropicWaveletF2PD2.GetPointer = new_instancemethod(_itkVowIsotropicWaveletPython.itkVowIsotropicWaveletF2PD2_GetPointer, None, itkVowIsotropicWaveletF2PD2)
...
class itkVowIsotropicWaveletF3PD3(itkIsotropicWaveletFrequencyFunctionPython.itkIsotropicWaveletFrequencyFunctionF3PD3):
    ...
    def GetPointer(self) -> "itkVowIsotropicWaveletF3PD3 *":
        """GetPointer(itkVowIsotropicWaveletF3PD3 self) -> itkVowIsotropicWaveletF3PD3"""
        return _itkVowIsotropicWaveletPython.itkVowIsotropicWaveletF3PD3_GetPointer(self)
...
itkVowIsotropicWaveletF3PD3.GetPointer = new_instancemethod(_itkVowIsotropicWaveletPython.itkVowIsotropicWaveletF3PD3_GetPointer, None, itkVowIsotropicWaveletF3PD3)
