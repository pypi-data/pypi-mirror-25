...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkFrequencyShrinkImageFilterPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkFrequencyShrinkImageFilterPython')
...
class itkFrequencyShrinkImageFilterICF2(itkImageToImageFilterBPython.itkImageToImageFilterICF2ICF2):
    ...
    def GetPointer(self) -> "itkFrequencyShrinkImageFilterICF2 *":
        """GetPointer(itkFrequencyShrinkImageFilterICF2 self) -> itkFrequencyShrinkImageFilterICF2"""
        return _itkFrequencyShrinkImageFilterPython.itkFrequencyShrinkImageFilterICF2_GetPointer(self)
...
itkFrequencyShrinkImageFilterICF2.GetPointer = new_instancemethod(_itkFrequencyShrinkImageFilterPython.itkFrequencyShrinkImageFilterICF2_GetPointer, None, itkFrequencyShrinkImageFilterICF2)
...
class itkFrequencyShrinkImageFilterICF3(itkImageToImageFilterBPython.itkImageToImageFilterICF3ICF3):
    ...
    def GetPointer(self) -> "itkFrequencyShrinkImageFilterICF3 *":
        """GetPointer(itkFrequencyShrinkImageFilterICF3 self) -> itkFrequencyShrinkImageFilterICF3"""
        return _itkFrequencyShrinkImageFilterPython.itkFrequencyShrinkImageFilterICF3_GetPointer(self)
...
itkFrequencyShrinkImageFilterICF3.GetPointer = new_instancemethod(_itkFrequencyShrinkImageFilterPython.itkFrequencyShrinkImageFilterICF3_GetPointer, None, itkFrequencyShrinkImageFilterICF3)
