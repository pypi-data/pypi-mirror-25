...
class itkFrequencyBandImageFilterICF2(itkImageToImageFilterBPython.itkImageToImageFilterICF2ICF2):
    ...
    def SetLowFrequencyThresholdInRadians(self, freq_low_in_radians: 'double const &') -> "void":
    ...
    def SetHighFrequencyThresholdInRadians(self, freq_high_in_radians: 'double const &') -> "void":
    ...
    def SetFrequencyThresholds(self, freq_low: 'double const &', freq_high: 'double const &') -> "void":
    ...
    def SetFrequencyThresholdsInRadians(self, freq_low_in_radians: 'double const &', freq_high_in_radians: 'double const &') -> "void":
    ...
    def GetPointer(self) -> "itkFrequencyBandImageFilterICF2 *":
...
class itkFrequencyBandImageFilterICF3(itkImageToImageFilterBPython.itkImageToImageFilterICF3ICF3):
    ...
    def GetPointer(self) -> "itkFrequencyBandImageFilterICF3 *":
