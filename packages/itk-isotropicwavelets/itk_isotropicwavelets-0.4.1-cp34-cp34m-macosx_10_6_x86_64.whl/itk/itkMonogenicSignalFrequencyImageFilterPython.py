...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkMonogenicSignalFrequencyImageFilterPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkMonogenicSignalFrequencyImageFilterPython')
...
class itkImageSourceVICF2(ITKCommonBasePython.itkProcessObject):
    ...
    def GetPointer(self) -> "itkImageSourceVICF2 *":
        """GetPointer(itkImageSourceVICF2 self) -> itkImageSourceVICF2"""
        return _itkMonogenicSignalFrequencyImageFilterPython.itkImageSourceVICF2_GetPointer(self)
...
itkImageSourceVICF2.GetPointer = new_instancemethod(_itkMonogenicSignalFrequencyImageFilterPython.itkImageSourceVICF2_GetPointer, None, itkImageSourceVICF2)
...
class itkImageSourceVICF3(ITKCommonBasePython.itkProcessObject):
    ...
    def GetPointer(self) -> "itkImageSourceVICF3 *":
        """GetPointer(itkImageSourceVICF3 self) -> itkImageSourceVICF3"""
        return _itkMonogenicSignalFrequencyImageFilterPython.itkImageSourceVICF3_GetPointer(self)
...
itkImageSourceVICF3.GetPointer = new_instancemethod(_itkMonogenicSignalFrequencyImageFilterPython.itkImageSourceVICF3_GetPointer, None, itkImageSourceVICF3)
...
class itkImageToImageFilterICF2VICF2(itkImageSourceVICF2):
    ...
    def GetPointer(self) -> "itkImageToImageFilterICF2VICF2 *":
        """GetPointer(itkImageToImageFilterICF2VICF2 self) -> itkImageToImageFilterICF2VICF2"""
        return _itkMonogenicSignalFrequencyImageFilterPython.itkImageToImageFilterICF2VICF2_GetPointer(self)
...
itkImageToImageFilterICF2VICF2.GetPointer = new_instancemethod(_itkMonogenicSignalFrequencyImageFilterPython.itkImageToImageFilterICF2VICF2_GetPointer, None, itkImageToImageFilterICF2VICF2)
...
class itkImageToImageFilterICF3VICF3(itkImageSourceVICF3):
    ...
    def GetPointer(self) -> "itkImageToImageFilterICF3VICF3 *":
        """GetPointer(itkImageToImageFilterICF3VICF3 self) -> itkImageToImageFilterICF3VICF3"""
        return _itkMonogenicSignalFrequencyImageFilterPython.itkImageToImageFilterICF3VICF3_GetPointer(self)
...
itkImageToImageFilterICF3VICF3.GetPointer = new_instancemethod(_itkMonogenicSignalFrequencyImageFilterPython.itkImageToImageFilterICF3VICF3_GetPointer, None, itkImageToImageFilterICF3VICF3)
...
class itkMonogenicSignalFrequencyImageFilterICF2(itkImageToImageFilterICF2VICF2):
    ...
    def GetPointer(self) -> "itkMonogenicSignalFrequencyImageFilterICF2 *":
        """GetPointer(itkMonogenicSignalFrequencyImageFilterICF2 self) -> itkMonogenicSignalFrequencyImageFilterICF2"""
        return _itkMonogenicSignalFrequencyImageFilterPython.itkMonogenicSignalFrequencyImageFilterICF2_GetPointer(self)
...
itkMonogenicSignalFrequencyImageFilterICF2.GetPointer = new_instancemethod(_itkMonogenicSignalFrequencyImageFilterPython.itkMonogenicSignalFrequencyImageFilterICF2_GetPointer, None, itkMonogenicSignalFrequencyImageFilterICF2)
...
class itkMonogenicSignalFrequencyImageFilterICF3(itkImageToImageFilterICF3VICF3):
    ...
    def GetPointer(self) -> "itkMonogenicSignalFrequencyImageFilterICF3 *":
        """GetPointer(itkMonogenicSignalFrequencyImageFilterICF3 self) -> itkMonogenicSignalFrequencyImageFilterICF3"""
        return _itkMonogenicSignalFrequencyImageFilterPython.itkMonogenicSignalFrequencyImageFilterICF3_GetPointer(self)
...
itkMonogenicSignalFrequencyImageFilterICF3.GetPointer = new_instancemethod(_itkMonogenicSignalFrequencyImageFilterPython.itkMonogenicSignalFrequencyImageFilterICF3_GetPointer, None, itkMonogenicSignalFrequencyImageFilterICF3)
