...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkPhaseAnalysisImageFilterPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkPhaseAnalysisImageFilterPython')
...
class itkPhaseAnalysisImageFilterVIF2IF2(itkImageToImageFilterBPython.itkImageToImageFilterVIF2IF2):
    ...
    def GetPointer(self) -> "itkPhaseAnalysisImageFilterVIF2IF2 *":
        """GetPointer(itkPhaseAnalysisImageFilterVIF2IF2 self) -> itkPhaseAnalysisImageFilterVIF2IF2"""
        return _itkPhaseAnalysisImageFilterPython.itkPhaseAnalysisImageFilterVIF2IF2_GetPointer(self)
...
itkPhaseAnalysisImageFilterVIF2IF2.GetPointer = new_instancemethod(_itkPhaseAnalysisImageFilterPython.itkPhaseAnalysisImageFilterVIF2IF2_GetPointer, None, itkPhaseAnalysisImageFilterVIF2IF2)
...
class itkPhaseAnalysisImageFilterVIF3IF3(itkImageToImageFilterBPython.itkImageToImageFilterVIF3IF3):
    ...
    def GetPointer(self) -> "itkPhaseAnalysisImageFilterVIF3IF3 *":
        """GetPointer(itkPhaseAnalysisImageFilterVIF3IF3 self) -> itkPhaseAnalysisImageFilterVIF3IF3"""
        return _itkPhaseAnalysisImageFilterPython.itkPhaseAnalysisImageFilterVIF3IF3_GetPointer(self)
...
itkPhaseAnalysisImageFilterVIF3IF3.GetPointer = new_instancemethod(_itkPhaseAnalysisImageFilterPython.itkPhaseAnalysisImageFilterVIF3IF3_GetPointer, None, itkPhaseAnalysisImageFilterVIF3IF3)
