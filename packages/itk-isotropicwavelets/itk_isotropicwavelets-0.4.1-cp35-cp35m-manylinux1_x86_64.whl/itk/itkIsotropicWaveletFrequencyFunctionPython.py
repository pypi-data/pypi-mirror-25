...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkIsotropicWaveletFrequencyFunctionPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkIsotropicWaveletFrequencyFunctionPython')
...
class itkIsotropicWaveletFrequencyFunctionF2PD2(itkIsotropicFrequencyFunctionPython.itkIsotropicFrequencyFunctionF2PD2):
    ...
    def GetPointer(self) -> "itkIsotropicWaveletFrequencyFunctionF2PD2 *":
        """GetPointer(itkIsotropicWaveletFrequencyFunctionF2PD2 self) -> itkIsotropicWaveletFrequencyFunctionF2PD2"""
        return _itkIsotropicWaveletFrequencyFunctionPython.itkIsotropicWaveletFrequencyFunctionF2PD2_GetPointer(self)
...
itkIsotropicWaveletFrequencyFunctionF2PD2.GetPointer = new_instancemethod(_itkIsotropicWaveletFrequencyFunctionPython.itkIsotropicWaveletFrequencyFunctionF2PD2_GetPointer, None, itkIsotropicWaveletFrequencyFunctionF2PD2)
...
class itkIsotropicWaveletFrequencyFunctionF3PD3(itkIsotropicFrequencyFunctionPython.itkIsotropicFrequencyFunctionF3PD3):
    ...
    def GetPointer(self) -> "itkIsotropicWaveletFrequencyFunctionF3PD3 *":
        """GetPointer(itkIsotropicWaveletFrequencyFunctionF3PD3 self) -> itkIsotropicWaveletFrequencyFunctionF3PD3"""
        return _itkIsotropicWaveletFrequencyFunctionPython.itkIsotropicWaveletFrequencyFunctionF3PD3_GetPointer(self)
...
itkIsotropicWaveletFrequencyFunctionF3PD3.GetPointer = new_instancemethod(_itkIsotropicWaveletFrequencyFunctionPython.itkIsotropicWaveletFrequencyFunctionF3PD3_GetPointer, None, itkIsotropicWaveletFrequencyFunctionF3PD3)
