...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkFrequencyExpandViaInverseFFTImageFilterPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkFrequencyExpandViaInverseFFTImageFilterPython')
...
class itkFrequencyExpandViaInverseFFTImageFilterICF2(itkImageToImageFilterBPython.itkImageToImageFilterICF2ICF2):
    ...
    def GetPointer(self) -> "itkFrequencyExpandViaInverseFFTImageFilterICF2 *":
        """GetPointer(itkFrequencyExpandViaInverseFFTImageFilterICF2 self) -> itkFrequencyExpandViaInverseFFTImageFilterICF2"""
        return _itkFrequencyExpandViaInverseFFTImageFilterPython.itkFrequencyExpandViaInverseFFTImageFilterICF2_GetPointer(self)
...
itkFrequencyExpandViaInverseFFTImageFilterICF2.GetPointer = new_instancemethod(_itkFrequencyExpandViaInverseFFTImageFilterPython.itkFrequencyExpandViaInverseFFTImageFilterICF2_GetPointer, None, itkFrequencyExpandViaInverseFFTImageFilterICF2)
...
class itkFrequencyExpandViaInverseFFTImageFilterICF3(itkImageToImageFilterBPython.itkImageToImageFilterICF3ICF3):
    ...
    def GetPointer(self) -> "itkFrequencyExpandViaInverseFFTImageFilterICF3 *":
        """GetPointer(itkFrequencyExpandViaInverseFFTImageFilterICF3 self) -> itkFrequencyExpandViaInverseFFTImageFilterICF3"""
        return _itkFrequencyExpandViaInverseFFTImageFilterPython.itkFrequencyExpandViaInverseFFTImageFilterICF3_GetPointer(self)
...
itkFrequencyExpandViaInverseFFTImageFilterICF3.GetPointer = new_instancemethod(_itkFrequencyExpandViaInverseFFTImageFilterPython.itkFrequencyExpandViaInverseFFTImageFilterICF3_GetPointer, None, itkFrequencyExpandViaInverseFFTImageFilterICF3)
