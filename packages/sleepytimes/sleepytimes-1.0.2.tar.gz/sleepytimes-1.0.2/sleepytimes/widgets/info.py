...
class Info(QWidget):
    ...
    dataset : instance of sleepytimes.Dataset
    ...
    def open_dataset(self, recent=None, debug_filename=None):
        ...
        chan_name = self.dataset.header['chan_name']
        chan_name = [x.replace('—', '-') for x in chan_name] # no em dashes        
        self.parent.channels.chan_name = chan_name
