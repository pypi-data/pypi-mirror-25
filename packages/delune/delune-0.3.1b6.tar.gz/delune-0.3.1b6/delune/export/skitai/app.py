...
def get (was, alias, _id, **args):
	if was.request.command == "get":
		if args.get ("q"):
			return error (was.response, "406 Conflict", 40602, "remove parameter q")
		return query (was, alias, q = "_id:" + _id, **args)
...
def query (was, alias, **args):
	...
	if type (q) is list:
		return was.jstream ([delune.query (alias, eq, o, f, s, w, r, l, d, analyze, data, limit = 1) for eq in q])
	return was.jstream (delune.query (alias, q, o, f, s, w, r, d, l, analyze, data, limit = 1))
