...
_UAS = (
    ...
    'Mozilla/5.0 (Linux; Android 7.0; XT1585 Build/NCK25.118-10.2) '
    'AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.116 Mobile '
    'Safari/537.36',

    'Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG SM-G531F Build/LMY48B) '
    ...
    def repeat(self):
        ...
        while True:
            try:
                ...
                if self.gently:
                    # min 7 second, max 5+1 seconds
                    sleep_time = 7 + random.random() * 5
                else:
                    # min 3 second, max 3+3 seconds
