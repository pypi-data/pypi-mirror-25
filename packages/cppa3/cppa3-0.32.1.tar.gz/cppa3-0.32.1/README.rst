...
package is compatible with the latest draft version 2017-08-5, available from
https://www.oasis-open.org/committees/document.php?document_id=61444 (specification WD08)
and
https://www.oasis-open.org/committees/document.php?document_id=61443 (XML schema draft #20)
 ...
 * HTTP 1.1, HTTP/2, FTP, SMTP and WebSocket transports.
...
A test suite is provided for the all modules.  To run the test suite, you can optionally
...
v0.32  2017-09-19   WebSocket transport support in unify. Match module functionality adds delegation, named channel, payload profile, authorization (allowed/denied) features. 
