...
class _SLC(object):
    ...
    def open(self, projectName):
        ...
        if not projectName in self._projects:
            raise SLCError('Faile to find project with name: ' + projectName)
    ...
    def is_open(self):
        ...
        return self._protosock.is_open
...
def init(host=None, agent_path=None, itar_path=None, license_server=None, license_proxy=None):
