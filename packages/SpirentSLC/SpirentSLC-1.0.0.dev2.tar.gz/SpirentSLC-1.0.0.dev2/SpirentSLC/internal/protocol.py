...
def _force_connect(host, port, timeout):
    ...
    established, raises a socket.error.
    """
...
class Type(object):
    ...
    PropertiesGroup = pb.NewSession.PropertiesGroup
    Property = pb.NewSession.PropertiesGroup.Property
...
class ProtocolSocket(object):
    ...
    def __init__(self, host, port, timeout=10):
        ...
        try:
            self._sock = _force_connect(host, port, timeout)
    ...
    def start_session(self, session_uri, dependencies=None, param_files=None, requirements=None, property_group=None):
    ...
    def invoke_action(self, session_id, action, command=None, params=None, response_map=None):
        ...
        self._write(msg)
        return self._read(lambda msg: msg.type in [msg.SESSION_ACTION_RESPONSE, msg.INVOKE_RESPONSE])
