...
setup(
  ...
  url='http://hoonds.readthedocs.io/en/latest/index.html',  # Use the URL to the github repo.
  download_url='https://github.com/pblair/ploogz/archive/{version}.tar.gz'.format(version=hoonds.__version__),
