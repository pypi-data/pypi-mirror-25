...
@override_settings(ACSERV_AUTH_HEADER={'auth-header': 'hello'})
...
class LoginACViewTest(TestCase):
    ...
    def test_exceed_max_clients(self):
        self.user.max_clients = 1
        self.user.cur_clients = 1
        self.user.save()
...
class KickSessionACViewTest(TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(self.user.cur_clients, 2, '去掉一个，加上一个，还是2个')
