...
# -*- coding: utf-8 -*-
#
# certbotlib documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''certbotlib''')])
...
version = certbotlib.__version__
# The full version, including alpha/beta/rc tags.
release = certbotlib.__version__
...
htmlhelp_basename = '''certbotlibdoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''certbotlib.tex''',
     u'''certbotlib Documentation''',
