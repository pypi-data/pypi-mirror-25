...
_libsedml.NUML_DEFAULT_LEVEL_swigconstant(_libsedml)
NUML_DEFAULT_LEVEL = _libsedml.NUML_DEFAULT_LEVEL

_libsedml.NUML_DEFAULT_VERSION_swigconstant(_libsedml)
NUML_DEFAULT_VERSION = _libsedml.NUML_DEFAULT_VERSION

_libsedml.NUML_XMLNS_L1_swigconstant(_libsedml)
NUML_XMLNS_L1 = _libsedml.NUML_XMLNS_L1

_libsedml.NUML_XMLNS_L1V1_swigconstant(_libsedml)
...
class NUMLErrorLog(XMLErrorLog):
    ...
    def logError(self, *args):
        """
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details, unsigned int const line=0, unsigned int const column=0, unsigned int const severity=LIBNUML_SEV_ERROR, unsigned int const category=LIBNUML_CAT_NUML)
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details, unsigned int const line=0, unsigned int const column=0, unsigned int const severity=LIBNUML_SEV_ERROR)
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details, unsigned int const line=0, unsigned int const column=0)
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details, unsigned int const line=0)
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details)
...
class NUMLError(XMLError):
    ...
    def __init__(self, *args):
        """
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details, unsigned int const line=0, unsigned int const column=0, unsigned int const severity=LIBNUML_SEV_ERROR, unsigned int const category=LIBNUML_CAT_NUML) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details, unsigned int const line=0, unsigned int const column=0, unsigned int const severity=LIBNUML_SEV_ERROR) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details, unsigned int const line=0, unsigned int const column=0) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details, unsigned int const line=0) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=1, unsigned int const version=1, string details) -> NUMLError
