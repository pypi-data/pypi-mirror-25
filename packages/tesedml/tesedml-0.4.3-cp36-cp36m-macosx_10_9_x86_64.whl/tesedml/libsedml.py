...
class SedDataDescription(SedBase):
    ...
    def setFormat(self, *args):
        ...
        return _libsedml.SedDataDescription_setFormat(self, *args)
...
class NUMLNamespaces(_object):
    ...
    def __init__(self, *args): 
        ...
        __init__(NUMLNamespaces self, unsigned int level=NUML_DEFAULT_LEVEL) -> NUMLNamespaces
...
class NUMLDocument(NMBase):
    ...
    def getResultComponent(self, *args):
        """getResultComponent(NUMLDocument self, unsigned int index) -> ResultComponent"""
        return _libsedml.NUMLDocument_getResultComponent(self, *args)
...
class ResultComponent(NMBase):
    ...
    def setNUMLDocument(self, *args):
        ...
        return _libsedml.ResultComponent_setNUMLDocument(self, *args)

    def setParentNUMLObject(self, *args):
        """setParentNUMLObject(ResultComponent self, NMBase sb)"""
        return _libsedml.ResultComponent_setParentNUMLObject(self, *args)
...
class CompositeValue(Dimension):
    ...
    __swig_setmethods__ = {}
    for _s in [Dimension]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CompositeValue, name, value)
    __swig_getmethods__ = {}
    for _s in [Dimension]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class CompositeDescription(DimensionDescription):
    ...
    __swig_setmethods__ = {}
    for _s in [DimensionDescription]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CompositeDescription, name, value)
    __swig_getmethods__ = {}
    for _s in [DimensionDescription]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class NUMLErrorLog(XMLErrorLog):
    ...
    def logError(self, *args):
        """
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION, 
            string details="", unsigned int const line=0, 
            unsigned int const column=0, unsigned int const severity=LIBNUML_SEV_ERROR, 
        ...
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION, 
            string details="")
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION)
        logError(NUMLErrorLog self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL)
...
class NUMLError(XMLError):
    ...
    def __init__(self, *args): 
        """
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION, 
            string details="", unsigned int const line=0, 
            unsigned int const column=0, unsigned int const severity=LIBNUML_SEV_ERROR, 
            unsigned int const category=LIBNUML_CAT_NUML) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION, 
            string details="", unsigned int const line=0, 
            unsigned int const column=0, unsigned int const severity=LIBNUML_SEV_ERROR) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION, 
            string details="", unsigned int const line=0, 
            unsigned int const column=0) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION, 
            string details="", unsigned int const line=0) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION, 
            string details="") -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL, unsigned int const version=NUML_DEFAULT_VERSION) -> NUMLError
        __init__(NUMLError self, unsigned int const errorId=0, unsigned int const level=NUML_DEFAULT_LEVEL) -> NUMLError
