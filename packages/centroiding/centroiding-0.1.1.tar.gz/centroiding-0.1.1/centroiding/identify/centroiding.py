...
########################################################################### 
#MYTOOLS_PATH = '/Users/mx/Data/Studium_aktuelles/PhD/NGTS/MYTOOLS/'
#if not MYTOOLS_PATH in sys.path:
#    sys.path.append(MYTOOLS_PATH)
...
class centroid():
    ...
    def __init__(self, fieldname, obj_id, ngts_version = 'TEST18', source = 'CANVAS', \
                 ...
                 do_plot=True, show_plot=False, flagfile=None, dic=None, nancut=None):
        '''
