...
#        self.dic = set_nan.set_nan(self.dic) 
    ...
    def load_neighbours(self):
        ...
        #::: get infos of blends
        self.dic_blends = ngtsio.get( self.fieldname, ['OBJ_ID','RA','DEC','HJD','CCDX','CCDY','SYSREM_FLUX3','FLUX_MEAN'], obj_id = obj_id_blends, time_hjd = self.time_hjd, ngts_version = self.ngts_version, bls_rank = self.bls_rank, silent = True) 
