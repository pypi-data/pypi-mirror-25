...
try:
    ...
    readme_text[-1] = "[![Analytics](https://ga-beacon.appspot.com/UA-58170643-5/automl/pypi)](https://github.com/igrigorik/ga-beacon)"
...
setup(
    ...
    install_requires=['dill', 'h5py', 'keras', 'numpy', 'pandas', 'pathos', 'python-dateutil', 'scikit-learn', 'scipy', 'sklearn-deap2', 'tabulate', 'tensorflow'],
