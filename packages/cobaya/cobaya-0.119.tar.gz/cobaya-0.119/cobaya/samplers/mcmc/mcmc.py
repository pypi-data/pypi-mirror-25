...
#        print "<<<>>>", trial - self.current_point[self.parametrisation.sampled_params()]
...
#        print "---slow---", end_slow_point - start_slow_point
#        print "---tot----", end_slow_point
...
#            print "+++fast+++", delta_fast
#            print "+++tot++++", current_start_point + delta_fast
...
#            print "================", "SIII", logp_trial, logp_current
            return True
        else:
#            print "++++++++++++++++", logp_trial, logp_current, logp_trial - logp_current
