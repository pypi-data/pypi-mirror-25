...
class DisplayMessageRequest(Message):
    ...
    def __init__(self, identifier=None):
        super().__init__(create_preliminary_identifier() if identifier is None else identifier, [], False)
...
class ProgramExecutionRequest(Event):
    ...
    """
    def __init__(self, identifier=None):
        super().__init__(create_preliminary_identifier() if identifier is None else identifier, 'execute_program', {})
        self.args['program_identifier'] = None
        self.args['argument_identifiers'] = []
    def program(self, program_identifier):
        ...
        if isinstance(program_identifier, Identifier):
            ...
            self.program_identifier = Identifier(program_identifier, 'program', preliminary=False, name=None)
        elif isinstance(program_identifier, str):
            self.program_identifier = Identifier(None, 'program', preliminary=False, name=program_identifier)
        else:
            raise ValueError(error_message)
        self.args['program_identifier'].to_json()
        return self
    def arguments(self, argument_identifiers):
        ...
        self.args['argument_identifiers'] = argument_identifiers
        return self
...
class ObjectManager:
    ...
    def get_tag_backreferences(self, object_identifier):
        ...
        return tags
    def get_all_objects(self, object_type=None):
        """
        return a list of Objects stored in this ObjectManager.
        """
        res = []
        for identifier in self.identifiers:
            if object_type is None or identifier.type == object_type:
    ...
    def to_json(self):
        ...
        res = {
            ...
            'ordered_list_of_event_identifiers' : [a.to_json() for a in ordered_list_of_event_identifiers],
        }
        return res
