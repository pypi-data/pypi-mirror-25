...
from .basics import Identifier, parse_identifier, create_preliminary_identifier, FileObject, parse_file_object, Tag, parse_tag, TagRequest, Event, ProgramExecutionRequest, DisplayMessageRequest, parse_object_manager
...
def create_tag(symbol):
    """
    creates a new Tag using method chaining.
...
def create_option(trigger_rule, display, actions, description=None):
    ...
    """
    option = basics.Option(create_preliminary_identifier('option'), description, trigger_rule, display, actions)
