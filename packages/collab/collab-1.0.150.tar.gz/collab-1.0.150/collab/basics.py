...
class EventRequest:
    ...
    """
    def __init__(self, event_type, args=None, priority=False):
        self.event_type = event_type
        self.args = args # if this is None, assume the value is provided by a subclass of EventRequest through self._args_to_json()
        self.priority = priority
    def priority(self, priority=True):
        """
        mark the event as a priority.
        Priority events are put on top of the event queue instead of the bottom.
        """
        self.priority = priority
    def to_json(self):
        """
...
def parse_event_request(dictionary):
    ...
    res = EventRequest(event_type, args=args, priority=priority)
    return res
