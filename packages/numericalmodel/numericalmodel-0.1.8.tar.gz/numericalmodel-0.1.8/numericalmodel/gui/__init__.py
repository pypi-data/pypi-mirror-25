        ...
        try:
            ...
            for attr in MODEL_CONTENT:
                ...
                for ivid,iv in sorted(getattr(self.model,attr).items()):
                    ...
                    spinbutton.set_tooltip_markup(("The value used in "
                        ...
                        "to see the actual value.").format(iv.value,ivid)
                        )
            ...
            if self["plot_{}_box".format(tab)] == current_box:
                ...
                try:
                    ...
                    if str(e) == \
                        ...
                        self.error("Plot area is too small",
                    ...
                    self.error("Plotting error",str(e))
...
class FigureCanvasFile(Gtk.Image):
    """
    Class to mimic a
    ...
    Args:
        ...
        args,kwargs : further arguments passed to the :class:`Gtk.Image`
            constructor
    """
    ...
    def load(self):
        ...
        self.set_from_file( self.imagefile )
