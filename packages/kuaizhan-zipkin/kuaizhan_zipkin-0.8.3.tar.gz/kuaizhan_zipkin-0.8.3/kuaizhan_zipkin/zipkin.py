...
from py_zipkin.util import generate_random_64bit_string, signed_int_to_unsigned_hex
...
def long_to_hex(num):
    return signed_int_to_unsigned_hex(num).zfill(16)
...
def bottle_zipkin(callback):
    ...
    def wrapper(*args, **kwargs):
        ...
        local_http_headers.headers = None
        return result
...
def get_http_header():
    if hasattr(local_http_headers, 'headers'):
        return local_http_headers.headers
