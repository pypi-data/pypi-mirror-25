...
class CreateLocalSourceIPPortTranslationNatRuleRequest(Request):

	def __init__(self):
		Request.__init__(self, 'vpc', 'qcloudcliV1', 'CreateLocalSourceIPPortTranslationNatRule', 'vpc.api.qcloud.com')
