...
class CreateLocalDestinationIPPortTranslationNatRuleRequest(Request):

	def __init__(self):
		Request.__init__(self, 'vpc', 'qcloudcliV1', 'CreateLocalDestinationIPPortTranslationNatRule', 'vpc.api.qcloud.com')
