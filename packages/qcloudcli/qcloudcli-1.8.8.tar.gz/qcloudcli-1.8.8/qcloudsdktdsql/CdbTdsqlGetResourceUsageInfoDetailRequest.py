...
class CdbTdsqlGetResourceUsageInfoDetailRequest(Request):

	def __init__(self):
		Request.__init__(self, 'tdsql', 'qcloudcliV1', 'CdbTdsqlGetResourceUsageInfoDetail', 'tdsql.api.qcloud.com')
