...
class SimpleConsole():
    """A singleton which sets up a console interface to handle IO in 
       a dedicated thread and exposes a threadsafe interface.
    ...
    where input_handler is a callable that consumes the string 
    entered at the main prompt. input_handler gets 
    called in a dedicated thread, so make sure it 
    communicates nicely with the rest of your
    program."""
