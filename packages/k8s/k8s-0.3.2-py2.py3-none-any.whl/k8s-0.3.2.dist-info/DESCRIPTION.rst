...
* `c2fab1c`_: Fix tests
* `1991a63`_: Add support for envFrom and optional configmaps and secrets

.. _1991a63: https://github.com/fiaas/k8s/commit/1991a63
.. _c2fab1c: https://github.com/fiaas/k8s/commit/c2fab1c
