...
namespace csvmorph {
    ...
    std::vector<double> CSVStat::get_mean() {
    ...
    std::vector<double> CSVStat::get_variance() {
    ...
    std::vector<double> CSVStat::get_mins() {
        // Return current variances
        std::vector<double> ret;        
        for (size_t i = 0; i < this->subset.size(); i++) {
    ...
    std::vector<double> CSVStat::get_maxes() {
        // Return current variances
        std::vector<double> ret;        
        for (size_t i = 0; i < this->subset.size(); i++) {
    ...
    void CSVStat::calc(bool variance=true, bool count=true,
        bool min_max=true) {
    ...
    void CSVStat::min_max(double &x_n, size_t &i) {
    ...
    void CSVStat::variance(double &x_n, size_t &i) {
        // Given a record update rolling mean and variance for all columns
        // using Welford's Algorithm
        double * current_rolling_mean = &this->rolling_means[i];
        double * current_rolling_var = &this->rolling_vars[i];
