...
class UtilsStringsTestCase(unittest.TestCase):
    ...
    def test_normalizer(self):
        ...
        self.assertTrue(
            any([x.isupper() for x in normalizer(text, lower=False)]))
    ...
    def test_normalizer_dict(self):
        ...
        result1 = normalize_dict(test_dict)
        result2 = normalize_dict(test_dict2)

        self.assertEqual(result1, {'a-a': 1, '2c**c21': 3, '*asd231__dab': 2})
