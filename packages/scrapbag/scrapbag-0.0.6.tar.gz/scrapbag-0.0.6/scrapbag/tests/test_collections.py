...
class UtilsCollectionsTestCase(unittest.TestCase):
    ...
    def test_add_element(self):
        ...
        self.assertEqual(add_element({'a': [1, 3]}, 'a.1.0', 2), {'a': [1, 3]})

        self.assertEqual(add_element({'a': [1, 3]}, 'a.1.0', 2, override=True), {'a': [1, [2]]})

        self.assertEqual(add_element({'a': [1, 3]}, 'a.1.test', 2, override=True), {'a': [1, {'test': 2}]})

        self.assertEqual(add_element({'a': [1, 3]}, 'a.1.test.0', 2, override=True), {'a': [1, {'test': [2]}]})

        self.assertEqual(add_element({'a': [1, 3]}, 'a.1.test.1', 2, override=True), {'a': [1, {'test': ["", 2]}]})

        self.assertEqual(add_element({'a': [1, {'test': [2]}]}, 'a.1.test.1', 3, override=True), {'a': [1, {'test': [2, 3]}]})
    ...
    def test_flatten(self):
        ...
        for retrieved_result, test_result in [(result_1a, test_result_1a),
