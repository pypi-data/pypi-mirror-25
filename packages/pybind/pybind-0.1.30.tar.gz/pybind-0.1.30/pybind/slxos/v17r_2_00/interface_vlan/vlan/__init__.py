...
to this list.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__statistics','__loop_detection','__loop_detection_shutdown_disable','__router_interface','__ifindex','__description','__vlan_name','__mac','__suppress_arp','__suppress_nd','__remote_span','__spanning_tree',)
  ...
  _pyangbind_elements = {'name': name, 'statistics': statistics, 'loop_detection': loop_detection, 'loop_detection_shutdown_disable': loop_detection_shutdown_disable, 'router_interface': router_interface, 'ifindex': ifindex, 'description': description, 'vlan_name': vlan_name, 'mac': mac, 'suppress_arp': suppress_arp, 'suppress_nd': suppress_nd, 'remote_span': remote_span, 'spanning_tree': spanning_tree, }
