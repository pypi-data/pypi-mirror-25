...
class unicast(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__max_route','__route_taret_container','__route_target_container_ipv4','__import_','__export','__bgp','__arp_entry',)
  ...
  _pyangbind_elements = {'max_route': max_route, 'route_taret_container': route_taret_container, 'route_target_container_ipv4': route_target_container_ipv4, 'import_': import_, 'export': export, 'bgp': bgp, 'arp_entry': arp_entry, }
