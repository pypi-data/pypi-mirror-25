...
class ipv6(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ipv6_config','__ipv6_anycast_address','__ipv6_vrrp_extended','__ipv6_local_anycast_gateway','__access_group','__policy','__ipv6_nd_ra','__intf_ipv6_router_isis','__interface_ospfv3_conf','__vrrpv3','__vrrpv3e',)
  ...
  _pyangbind_elements = {'ipv6_config': ipv6_config, 'ipv6_anycast_address': ipv6_anycast_address, 'ipv6_vrrp_extended': ipv6_vrrp_extended, 'ipv6_local_anycast_gateway': ipv6_local_anycast_gateway, 'access_group': access_group, 'policy': policy, 'ipv6_nd_ra': ipv6_nd_ra, 'intf_ipv6_router_isis': intf_ipv6_router_isis, 'interface_ospfv3_conf': interface_ospfv3_conf, 'vrrpv3': vrrpv3, 'vrrpv3e': vrrpv3e, }
