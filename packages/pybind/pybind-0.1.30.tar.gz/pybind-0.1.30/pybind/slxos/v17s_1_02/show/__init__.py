...
class show(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__fabric','__telnet','__ssh','__infra',)
...
(standalone mode) fabric does not exist.
  ...
  _pyangbind_elements = {'fabric': fabric, 'telnet': telnet, 'ssh': ssh, 'infra': infra, }
