...
class unicast(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__max_route','__arp_entry',)
  ...
  _pyangbind_elements = {'max_route': max_route, 'arp_entry': arp_entry, }
