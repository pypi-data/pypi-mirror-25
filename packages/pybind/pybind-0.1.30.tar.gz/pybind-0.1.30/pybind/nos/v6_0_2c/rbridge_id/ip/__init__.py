...
class ip(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__receive','__prefix_list','__as_path','__community_list','__extcommunity_list',)
  ...
  _pyangbind_elements = {'receive': receive, 'prefix_list': prefix_list, 'as_path': as_path, 'community_list': community_list, 'extcommunity_list': extcommunity_list, }
