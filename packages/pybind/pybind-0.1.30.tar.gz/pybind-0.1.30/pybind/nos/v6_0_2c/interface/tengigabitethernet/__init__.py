...
all the rbridges in the cluster.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__long_distance_isl','__cee','__speed','__ifindex','__description','__shutdown','__channel_group','__mtu','__switchport_basic','__switchport','__mac_learning','__ip','__vrf','__ipv6','__snmp','__track','__bfd','__vepa','__edge_loop_detection','__mac','__vrrp','__storm_control','__ip_acl_interface','__ip_pbr_interface','__service_policy','__port_profile_port','__port_profile_to_interface_associations','__priority_tag_enable','__qos','__sflow','__vlan','__bpdu_drop','__tunnel','__spanning_tree',)
...
following MAC learning process.
  ...
  _pyangbind_elements = {'name': name, 'long_distance_isl': long_distance_isl, 'cee': cee, 'speed': speed, 'ifindex': ifindex, 'description': description, 'shutdown': shutdown, 'channel_group': channel_group, 'mtu': mtu, 'switchport_basic': switchport_basic, 'switchport': switchport, 'mac_learning': mac_learning, 'ip': ip, 'vrf': vrf, 'ipv6': ipv6, 'snmp': snmp, 'track': track, 'bfd': bfd, 'vepa': vepa, 'edge_loop_detection': edge_loop_detection, 'mac': mac, 'vrrp': vrrp, 'storm_control': storm_control, 'ip_acl_interface': ip_acl_interface, 'ip_pbr_interface': ip_pbr_interface, 'service_policy': service_policy, 'port_profile_port': port_profile_port, 'port_profile_to_interface_associations': port_profile_to_interface_associations, 'priority_tag_enable': priority_tag_enable, 'qos': qos, 'sflow': sflow, 'vlan': vlan, 'bpdu_drop': bpdu_drop, 'tunnel': tunnel, 'spanning_tree': spanning_tree, }
