...
class ip(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip_config','__interface_fo_ospf_conf',)
  ...
  _pyangbind_elements = {'ip_config': ip_config, 'interface_fo_ospf_conf': interface_fo_ospf_conf, }
