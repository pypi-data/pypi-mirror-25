...
class pw_profile(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__pw_profile_name','__mtu','__mtu_enforce','__vc_mode','__flow_label','__control_word',)
  ...
  _pyangbind_elements = {'pw_profile_name': pw_profile_name, 'mtu': mtu, 'mtu_enforce': mtu_enforce, 'vc_mode': vc_mode, 'flow_label': flow_label, 'control_word': control_word, }
