...
class peer(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__flow_label = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="flow-label", rest_name="flow-label", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Enable Flow-label', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-bridge-domain', defining_module='brocade-bridge-domain', yang_type='empty', is_config=True)
