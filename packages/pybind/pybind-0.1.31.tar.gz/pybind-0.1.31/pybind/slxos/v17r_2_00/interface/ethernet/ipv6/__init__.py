...
class ipv6(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__raguard','__ipv6_config','__access_group','__policy','__ipv6_nd_ra','__intf_ipv6_router_isis','__interface_ospfv3_conf','__vrrpv3_group','__vrrpv3e_group',)
  ...
  _pyangbind_elements = {'raguard': raguard, 'ipv6_config': ipv6_config, 'access_group': access_group, 'policy': policy, 'ipv6_nd_ra': ipv6_nd_ra, 'intf_ipv6_router_isis': intf_ipv6_router_isis, 'interface_ospfv3_conf': interface_ospfv3_conf, 'vrrpv3_group': vrrpv3_group, 'vrrpv3e_group': vrrpv3e_group, }
