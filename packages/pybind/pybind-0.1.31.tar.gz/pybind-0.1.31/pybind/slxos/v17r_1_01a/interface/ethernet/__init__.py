...
following MAC learning process.
  ...
  _pyangbind_elements = {'name': name, 'long_distance_isl': long_distance_isl, 'speed': speed, 'ifindex': ifindex, 'description': description, 'shutdown': shutdown, 'channel_group': channel_group, 'mtu': mtu, 'route_only': route_only, 'switchport_basic': switchport_basic, 'switchport': switchport, 'ip': ip, 'vrf': vrf, 'ipv6': ipv6, 'track': track, 'bfd': bfd, 'vepa': vepa, 'edge_loop_detection_native': edge_loop_detection_native, 'edge_loop_detection': edge_loop_detection, 'priority_tag_enable': priority_tag_enable, 'tunable_optics': tunable_optics, 'mac': mac, 'vrrp': vrrp, 'logical_interface': logical_interface, 'ip_acl_interface': ip_acl_interface, 'ip_pbr_interface': ip_pbr_interface, 'interface_eth_isis_conf': interface_eth_isis_conf, 'port_profile_port': port_profile_port, 'port_profile_to_interface_associations': port_profile_to_interface_associations, 'storm_control': storm_control, 'qos': qos, 'sflow': sflow, 'service_policy': service_policy, 'spanning_tree': spanning_tree, }
