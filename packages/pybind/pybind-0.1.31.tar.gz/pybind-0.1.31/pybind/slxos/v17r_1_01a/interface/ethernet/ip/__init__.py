...
class ip(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip_config','__intf_router_isis','__interface_eth_ospf_conf',)
  ...
  _pyangbind_elements = {'ip_config': ip_config, 'intf_router_isis': intf_router_isis, 'interface_eth_ospf_conf': interface_eth_ospf_conf, }
