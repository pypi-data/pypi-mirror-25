...
class ipv6(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ipv6_config','__ipv6_vrrp_extended','__ipv6_local_anycast_gateway','__access_group','__policy','__ipv6_nd_ra','__intf_ipv6_router_isis','__interface_ospfv3_conf','__vrrpv3','__vrrpv3e',)
