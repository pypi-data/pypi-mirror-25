...
class ip(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip_config','__intf_router_isis','__interface_loopback_ospf_conf',)
  ...
  _pyangbind_elements = {'ip_config': ip_config, 'intf_router_isis': intf_router_isis, 'interface_loopback_ospf_conf': interface_loopback_ospf_conf, }
