...
class show(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__fabric','__show_firmware_dummy','__telnet','__ssh','__infra',)
...
(standalone mode) fabric does not exist.
  ...
  _pyangbind_elements = {'fabric': fabric, 'show_firmware_dummy': show_firmware_dummy, 'telnet': telnet, 'ssh': ssh, 'infra': infra, }
