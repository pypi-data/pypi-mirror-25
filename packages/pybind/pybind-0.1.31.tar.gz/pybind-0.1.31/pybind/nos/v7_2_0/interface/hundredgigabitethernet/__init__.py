...
following MAC learning process.
  ...
  _pyangbind_elements = {'name': name, 'cee': cee, 'fec': fec, 'ifindex': ifindex, 'description': description, 'shutdown': shutdown, 'channel_group': channel_group, 'mtu': mtu, 'switchport_basic': switchport_basic, 'switchport': switchport, 'protected_port': protected_port, 'mac_learning': mac_learning, 'ip': ip, 'vrf': vrf, 'ipv6': ipv6, 'snmp': snmp, 'track': track, 'bfd': bfd, 'edge_loop_detection': edge_loop_detection, 'tunable_optics': tunable_optics, 'mac': mac, 'vrrp': vrrp, 'storm_control': storm_control, 'ip_acl_interface': ip_acl_interface, 'ip_pbr_interface': ip_pbr_interface, 'sflow': sflow, 'service_policy': service_policy, 'port_profile_port': port_profile_port, 'port_profile_to_interface_associations': port_profile_to_interface_associations, 'priority_tag_enable': priority_tag_enable, 'qos': qos, 'vlan': vlan, 'bpdu_drop': bpdu_drop, 'spanning_tree': spanning_tree, }
