...
class ipv6(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__router','__static_ag_ipv6_config','__ipv6route','__receive','__prefix_list','__ipv6_global_cmds','__proto_vrrpv3',)
  ...
  _pyangbind_elements = {'router': router, 'static_ag_ipv6_config': static_ag_ipv6_config, 'ipv6route': ipv6route, 'receive': receive, 'prefix_list': prefix_list, 'ipv6_global_cmds': ipv6_global_cmds, 'proto_vrrpv3': proto_vrrpv3, }
