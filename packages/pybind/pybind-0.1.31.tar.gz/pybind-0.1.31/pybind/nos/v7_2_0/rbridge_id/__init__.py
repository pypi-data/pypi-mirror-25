...
class rbridge_id(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__rbridge_id','__swbd_number','__interface_nodespecific','__ip','__ipv6','__router','__switch_attributes','__system_mode','__interface','__protocol','__vrrp','__vrf','__system_max','__arp_entry','__host_table','__bfd_session_setup_delay','__evpn_instance','__fabric','__route_map','__filter_change_update_delay','__qos','__telnet','__ssh','__vrrp_rbridge_global','__spanning_tree',)
...
and multicast priority.
  ...
  _pyangbind_elements = {'rbridge_id': rbridge_id, 'swbd_number': swbd_number, 'interface_nodespecific': interface_nodespecific, 'ip': ip, 'ipv6': ipv6, 'router': router, 'switch_attributes': switch_attributes, 'system_mode': system_mode, 'interface': interface, 'protocol': protocol, 'vrrp': vrrp, 'vrf': vrf, 'system_max': system_max, 'arp_entry': arp_entry, 'host_table': host_table, 'bfd_session_setup_delay': bfd_session_setup_delay, 'evpn_instance': evpn_instance, 'fabric': fabric, 'route_map': route_map, 'filter_change_update_delay': filter_change_update_delay, 'qos': qos, 'telnet': telnet, 'ssh': ssh, 'vrrp_rbridge_global': vrrp_rbridge_global, 'spanning_tree': spanning_tree, }
