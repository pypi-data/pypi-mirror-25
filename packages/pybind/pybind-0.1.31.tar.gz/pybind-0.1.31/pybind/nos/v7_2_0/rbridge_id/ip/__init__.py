...
class ip(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__static_ag_ip_config','__receive','__prefix_list','__as_path','__community_list','__extcommunity_list','__rtm_config','__import_',)
  ...
  _pyangbind_elements = {'static_ag_ip_config': static_ag_ip_config, 'receive': receive, 'prefix_list': prefix_list, 'as_path': as_path, 'community_list': community_list, 'extcommunity_list': extcommunity_list, 'rtm_config': rtm_config, 'import_': import_, }
