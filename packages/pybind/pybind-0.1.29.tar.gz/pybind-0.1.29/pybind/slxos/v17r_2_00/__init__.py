...
class brocade_mc_hms_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__igmp_snooping_state','__igmp_snooping_bridge_domain_mrouters_state','__igmp_snooping_bridge_domains_state',)
  ...
  _pyangbind_elements = {'igmp_snooping_state': igmp_snooping_state, 'igmp_snooping_bridge_domain_mrouters_state': igmp_snooping_bridge_domain_mrouters_state, 'igmp_snooping_bridge_domains_state': igmp_snooping_bridge_domains_state, }
