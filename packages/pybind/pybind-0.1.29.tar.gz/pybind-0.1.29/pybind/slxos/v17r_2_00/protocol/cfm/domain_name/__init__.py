...
class domain_name(PybindBase):
  ...
  def _get_domain_id(self):
    """
    Getter method for domain_id, mapped from YANG variable /protocol/cfm/domain_name/domain_id (uint32)
    """
    return self.__domain_id
      
  def _set_domain_id(self, v, load=False):
    """
    Setter method for domain_id, mapped from YANG variable /protocol/cfm/domain_name/domain_id (uint32)
    If this variable is read-only (config: false) in the
