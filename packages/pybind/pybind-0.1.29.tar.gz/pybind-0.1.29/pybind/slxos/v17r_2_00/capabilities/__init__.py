...
class capabilities(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__power','__temperature','__qos','__l3','__l2','__ipv6','__ssm','__lag','__license','__tm','__overlay','__openflow',)
  ...
  _pyangbind_elements = {'power': power, 'temperature': temperature, 'qos': qos, 'l3': l3, 'l2': l2, 'ipv6': ipv6, 'ssm': ssm, 'lag': lag, 'license': license, 'tm': tm, 'overlay': overlay, 'openflow': openflow, }
