...
#        self.SliderSingularValues.SetRange(1, hlsvdpro.MAX_SINGULAR_VALUES)
    ...
    def on_ecc_browse(self, event):
        ...
        if ecc_dataset:
            ...
            self.block.set.ecc_dataset    = ecc_dataset
            self.block.set.ecc_dataset_id = ecc_dataset.id
            self.block.set.ecc_raw        = raw_data
            self.block.set.ecc_filename   = block.data_source
