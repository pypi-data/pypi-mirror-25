...
#                                                                    dataset)
    ...
    def on_menu_view_results(self, event):
        # EVENT_TO_TYPE maps menu items to file types
        EVENT_TO_TYPE = { util_menu.ViewIdsVoigt.RESULTS_LCM_PDF   : ("lcm","pdf"),
                          util_menu.ViewIdsVoigt.RESULTS_LCM_PNG   : ("lcm","png"),
                          util_menu.ViewIdsVoigt.RESULTS_2PLOT_PDF : ("2plot","pdf"),
                          util_menu.ViewIdsVoigt.RESULTS_2PLOT_PNG : ("2plot","png"),
                          util_menu.ViewIdsVoigt.RESULTS_4PLOT_PDF : ("4plot","pdf"),
                          util_menu.ViewIdsVoigt.RESULTS_4PLOT_PNG : ("4plot","png"),
                        }
...
#        self.dynamic_macromolecule_list.reset_to_default()
    ...
    def on_batch_fit_all(self, event): 
        ...
        self._tab_dataset.batch_fit_all(statusbar=self.top.statusbar)   # bjs - maybe could do direct call to self._dataset.batch_fit_all() ???
