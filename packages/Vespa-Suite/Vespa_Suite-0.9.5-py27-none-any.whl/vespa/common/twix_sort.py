...
class TwixSort(object):
    ...
    def __init__(self, twix_obj):
        """
        On being passed a TwixRaid object that has evps and scans in it we 
...
if __name__ == "__main__":
    ...
    # fname = 'D:\\bsoher\\code\\repository_svn\\orphans\\soher\\twix_parser\\testdata\\meas_MID00098_FID12966_PRESS97ms_uncomb.dat'
    # fname  = 'D:\\Users\\bsoher\\code\\repository_svn\\orphans\\soher\\twix_parser\\testdata\\meas_MID00098_FID12966_PRESS97ms_uncomb.dat'
    # fname2 = 'D:\\Users\\bsoher\\code\\repository_svn\\orphans\\soher\\twix_parser\\testdata\\meas_MID00141_FID01694_svs_slaser_dkd2_testing_WS8_refscans.dat'
    fname2 = 'D:\\Users\\bsoher\\Dropbox\\VE11C_WBNAA_Data_4_Brian\\meas_MID00765_FID24095_fid_WBNAA_h.dat'
...
#     data12 = sort.get_data_numpy_rep_channel_scan_order()
    ...
    twix.populate_from_file(fname2)

    sort2 = TwixMultiSort(twix)
    
    # data21 = sort2.get_data_numpy_ice_indexed()
    data21 = sort2.get_data_numpy_channel_scan_order()
    data22 = sort2.get_data_numpy_rep_channel_scan_order()
