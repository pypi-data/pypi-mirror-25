...
from discourse_django_sso.utils import SSOProducerUtils, ConsumerType
...
def test_get_noonce(sso_producer):
...
def test_validate_eol(sso_producer):
    """
    ...
    """
    sso_producer.sso = b"bm9uY2U9Y2I2ODI1MWVlZmI1MjExZTU4YzAwZmYxMzk1ZjBjMGI="
    with pytest.raises(ValueError):
        sso_producer.validate()
    sso_producer.validate(consumer_type=ConsumerType.OTHER)


def test_validate_noonce(sso_producer):
