...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        from pcart_data_collections.models import (
            DataCollection,
            DataCollectionField,
            WebForm,
            MailHook,
        ...
        ProductStatus.objects.language('uk').create(
...
'''
        ...
        one_click_email = EmailTemplate.objects.create(
        ...
        MailHook.objects.create(
            title='one-click-purchase',
            data_collection=data_collection,
            user_group=order_group,
            email_template=one_click_email,
        )
