...
def patch():
    if sys.version_info[0] >= 3:
        ...
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'ensemble', 'weight_boosting', 'AdaBoostClassifier',
                                                        'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'ensemble', 'bagging', 'BaggingClassifier', 'fit',
                                                        fit_logger))
        ...
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'calibration', 'CalibratedClassifierCV', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'tree', 'tree', 'DecisionTreeClassifier', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'tree', 'tree', 'ExtraTreeClassifier', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'ensemble', 'forest', 'ExtraTreesClassifier', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'naive_bayes', 'GaussianNB', 'fit', fit_logger))
        sys.meta_path.insert(0,
                             class_loader_py2.Finder('sklearn', 'gaussian_process', 'gpc', 'GaussianProcessClassifier',
                                                     'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'ensemble', 'gradient_boosting',
                                                        'GradientBoostingClassifier', 'fit', fit_logger))
        sys.meta_path.insert(0,
                             class_loader_py2.Finder('sklearn', 'neighbors', 'classification', 'KNeighborsClassifier',
                                                     'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'semi_supervised', 'label_propagation',
                                                        'LabelPropagation', 'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'semi_supervised', 'label_propagation',
                                                        'LabelSpreading', 'fit', fit_logger))
        sys.meta_path.insert(0,
        ...
        sys.meta_path.insert(0,
                             class_loader_py2.Finder('sklearn', 'linear_model', 'logistic', 'LogisticRegression', 'fit',
                                                     fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'linear_model', 'logistic', 'LogisticRegressionCV',
                                                        'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'neural_network', 'multilayer_perceptron',
                                                        'MLPClassifier', 'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'naive_bayes', 'MultinomialNB', 'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'neighbors', 'nearest_centroid', 'NearestCentroid',
                                                        'fit', fit_logger))
        ...
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'linear_model', 'passive_aggressive',
                                                        'PassiveAggressiveClassifier', 'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'linear_model', 'perceptron', 'Perceptron', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'discriminant_analysis',
                                                        'QuadraticDiscriminantAnalysis', 'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'neighbors', 'classification',
                                                        'RadiusNeighborsClassifier', 'fit', fit_logger))
        sys.meta_path.insert(0,
                             class_loader_py2.Finder('sklearn', 'ensemble', 'forest', 'RandomForestClassifier', 'fit',
                                                     fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'linear_model', 'ridge', 'RidgeClassifier', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'linear_model', 'ridge', 'RidgeClassifierCV', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0,
                             class_loader_py2.Finder('sklearn', 'linear_model', 'stochastic_gradient', 'SGDClassifier',
                                                     'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'svm', 'classes', 'SVC', 'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'linear_model', 'bayes', 'ARDRegression', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'ensemble', 'weight_boosting', 'AdaBoostRegressor',
                                                        'fit', fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'ensemble', 'bagging', 'BaggingRegressor', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'linear_model', 'bayes', 'BayesianRidge', 'fit',
                                                        fit_logger))
        sys.meta_path.insert(0, class_loader_py2.Finder('sklearn', 'cross_decomposition', 'cca_', 'CCA', 'fit',
                                                        fit_logger))
