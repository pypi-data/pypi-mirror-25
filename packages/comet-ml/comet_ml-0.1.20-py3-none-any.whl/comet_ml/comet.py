...
class RestServerConnection(object):
    ...
    def get_run_id(api_key):
        ...
        run_id_server = json.loads(r.content)["runId"]
        ws_server = json.loads(r.content)["ws_url"]
...
class Experiment(object):
    ...
    def keras_callback(self):
        if self.alive:
            from frameworks import KerasCallback
            return KerasCallback(self)
        else:
            from frameworks import EmptyKerasCallback
