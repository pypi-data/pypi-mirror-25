...
setup(
  ...
  url='https://github.com/j00bar/asnible',
  install_requires=['ansible']
)

print('*** WARNING ***')
print('You mistyped "ansible" and instead typed "asnible". I have ')
print('installed Ansible anyway, but you really should uninstall asnible ')
