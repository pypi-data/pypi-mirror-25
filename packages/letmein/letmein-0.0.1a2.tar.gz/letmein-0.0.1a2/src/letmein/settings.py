...
class LetMeInSettings(object):
    ...
    def user_settings(self):
        if not hasattr(self, '_user_settings'):
            self._user_settings = getattr(settings, 'LETMEIN', {})
...
letmein_settings = LetMeInSettings(None, DEFAULTS, IMPORT_STRINGS)


def reload_db_settings(*args, **kwargs):
    global letmein_settings
    setting, value = kwargs['setting'], kwargs['value']
    if setting == 'LETMEIN':
        letmein_settings = LetMeInSettings(value, DEFAULTS, IMPORT_STRINGS)
