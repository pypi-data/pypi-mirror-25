...
class DBInterface(object):
    ...
    def create_index(self, tablename, columns, primary=False, commit=True, verbose=True):
    ...
    def create_indexes(self, index_map, primary=False, commit=True, verbose=True):
        for tablename, columns in index_map.iteritems():
