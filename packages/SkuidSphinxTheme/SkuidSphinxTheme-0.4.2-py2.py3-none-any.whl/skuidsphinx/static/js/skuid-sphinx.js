...
function expandAll (){
  $('#main').find('.collapsible').siblings('.colsection').children().unwrap();
  $('#main').find('.collapsible').siblings().slideDown(300);
  $('#main').find('.collapsible').removeClass('collapsed');
  $('#main').find('.collapsible').attr('aria-expanded','true')
  $('#main').find('.collapsible').each(function addColSecAll(){$(this).siblings().wrapAll('<div class="colsection"></div>')});
}
function collapseAll (){
  $('#main').find('.collapsible').siblings('.colsection').children().slideToggle(300);
  $('#main').find("span[id]").attr('style','display: none;')
  $('#main').find('.collapsible').siblings('.colsection').children().unwrap();
  $('#main').find('.collapsible').addClass('collapsed');
  $('#main').find('.collapsible').attr('aria-expanded','false')
}
