...
import os
import numpy as np 
import JMI_FeatureSelection_primitive


class JMIFeatSelector:
	"""
	...
	def fit_transform(self, A, B):
		...
		my_jmi = JMI_FeatureSelection_primitive.initialize()
		W = np.array(my_jmi.JMI_search())
...
if __name__ == "__main__":
	...
	import scipy.io
	import os
	from JMI_FeatureSelection_primitive import JMIFeatSelector
	jmi = JMIFeatSelector.JMIFeatSelector()
	W = jmi.fit_transform(A, B)
