...
if __name__ == '__main__':
    ...
    setup(
        name="JMI_FeatureSelection_primitive",
        version="1.0.0",
        description='JMI feature selection code',
        author='Keyi Liu',
	author_email='liuk7@rpi.edu',
        url='https://www.ecse.rpi.edu/~cvrl/liuk',
        platforms=['Linux', 'Windows', 'MacOS'],
        packages=[
            'JMI_FeatureSelection_primitive'
        ],
        package_data={'JMI_FeatureSelection_primitive': ['*.ctf']},
