...
version_ns = {}
with open(os.path.join(here, 'kernel_gateway_quarc_custom_fix', '_version.py')) as f:
    exec(f.read(), {}, version_ns)

setup_args = dict(
    name='jupyter_kernel_gateway_quarc_custom_fix',
...
''',
    ...
    packages=[
        'kernel_gateway_quarc_custom_fix',
        'kernel_gateway_quarc_custom_fix.base',
        'kernel_gateway_quarc_custom_fix.jupyter_websocket',
        'kernel_gateway_quarc_custom_fix.notebook_http',
        'kernel_gateway_quarc_custom_fix.notebook_http.cell',
        'kernel_gateway_quarc_custom_fix.notebook_http.swagger',
        'kernel_gateway_quarc_custom_fix.services',
        'kernel_gateway_quarc_custom_fix.services.kernels',
        'kernel_gateway_quarc_custom_fix.services.kernelspecs',
        'kernel_gateway_quarc_custom_fix.services.sessions',
    ],
    install_requires=[
        'jupyter_core>=4.0',
