...
class Base(object):
    ...
    def estimator(self, value):
        ...
        if isinstance(self._estimator, lore.estimators.Keras):
    ...
    def k_folds(self, k=3):
        folds = sklearn.model_selection.KFold(n_splits=k, shuffle=False, random_state=1)
    ...
    def hyper_parameter_search(
        ...
        # cache the encoded training data before starting the search
        self.pipeline.encoded_training_data
