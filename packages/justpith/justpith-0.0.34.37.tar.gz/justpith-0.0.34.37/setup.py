...
setup(
    ...
    packages=['justpith','justpith.rabbit', 'justpith.mongo','justpith.mongo.teacher', 'justpith.mongo.factorizer', 'justpith.mongo.common', 'justpith.mongo.controller', 'justpith.mongo.web_app', 'justpith.logger', 'justpith.util'],
    install_requires=[
