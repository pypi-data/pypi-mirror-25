...
.. image:: https://travis-ci.org/ClearcodeHQ/pytest-postgresql.svg?branch=v1.3.1
    :target: https://travis-ci.org/ClearcodeHQ/pytest-postgresql
    :alt: Tests

.. image:: https://coveralls.io/repos/ClearcodeHQ/pytest-postgresql/badge.png?branch=v1.3.1
    :target: https://coveralls.io/r/ClearcodeHQ/pytest-postgresql?branch=v1.3.1
    :alt: Coverage Status

.. image:: https://requires.io/github/ClearcodeHQ/pytest-postgresql/requirements.svg?tag=v1.3.1
     :target: https://requires.io/github/ClearcodeHQ/pytest-postgresql/requirements/?tag=v1.3.1
